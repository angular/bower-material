 ...
 * v0.7.0-rc2-master-6a087a0
 */
function(){"use strict";function e(e,t,n,r,o){function a(a,i){var c=a.find("md-tab-label");c.length?c.remove():c=angular.isDefined(i.label)?angular.element("<md-tab-label>").html(i.label):angular.element("<md-tab-label>").append(a.contents().remove());var d=a.contents().remove();return function(a,i,l,m){function u(){var e=c.clone();i.append(e),t(e)(a.$parent),v.content=d.clone()}function s(){a.$apply(function(){$.select(v),$.focus(v)})}function p(e){e.keyCode==r.KEY_CODE.SPACE||e.keyCode==r.KEY_CODE.ENTER?(i.triggerHandler("click"),e.preventDefault()):e.keyCode===r.KEY_CODE.LEFT_ARROW?a.$evalAsync(function(){$.focus($.previous(v))}):e.keyCode===r.KEY_CODE.RIGHT_ARROW&&a.$evalAsync(function(){$.focus($.next(v))})}function f(e){a.$apply(function(){"swipeleft"===e.type?$.select($.next()):$.select($.previous())})}function h(){a.$watch("$parent.$index",function(e){$.move(v,e)})}function g(){function e(e){var t=$.getSelectedItem()===v;e&&!t?$.select(v):!e&&t&&$.deselect(v)}var t=a.$parent.$watch("!!("+l.mdActive+")",e);a.$on("$destroy",t)}function E(){function e(e){i.attr("aria-disabled",e);var t=$.getSelectedItem()===v;t&&e&&$.select($.next()||$.previous())}a.$watch(v.isDisabled,e)}function b(){var e=l.id||"tab_"+n.nextUid();if(i.attr({id:e,role:"tab",tabIndex:-1}),d.length){var t="content_"+e;i.attr("aria-controls")||i.attr("aria-controls",t),v.contentContainer.attr({id:t,role:"tabpanel","aria-labelledby":e})}}var v=m[0],$=m[1];a.$watch(function(){return l.label},function(){o(function(){$.scope.$broadcast("$mdTabsChanged")},0,!1)}),u(),b();var M=e.attachTabBehavior(a,i,{colorElement:$.inkBarElement});$.add(v),a.$on("$destroy",function(){M(),$.remove(v)}),i.on("$destroy",function(){o(function(){$.scope.$broadcast("$mdTabsChanged")},0,!1)}),angular.isDefined(l.ngClick)||i.on("click",s),i.on("keydown",p),a.onSwipe=f,angular.isNumber(a.$parent.$index)&&h(),angular.isDefined(l.mdActive)&&g(),E()}}return{restrict:"E",require:["mdTab","^mdTabs"],controller:"$mdTab",scope:{onSelect:"&mdOnSelect",onDeselect:"&mdOnDeselect",label:"@"},compile:a}}angular.module("material.components.tabs").directive("mdTab",e),e.$inject=["$mdInkRipple","$compile","$mdUtil","$mdConstant","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2-master-6a087a0
 */
function(){"use strict";function e(e,t,n){function r(){return E(e.selectedIndex)}function o(){return e.selectedIndex}function a(t,n){f.add(t,n),angular.isDefined(t.element.attr("md-active"))||-1!==e.selectedIndex&&angular.isNumber(e.selectedIndex)&&e.selectedIndex!==h.indexOf(t)?t.onAdd(h.contentArea,!0):(t.onAdd(h.contentArea,!1),h.select(t)),e.$broadcast("$mdTabsChanged")}function i(t,n){if(f.contains(t)&&!n){var o=r()===t,a=s()||u();m(t),f.remove(t),t.onRemove(),e.$broadcast("$mdTabsChanged"),o&&d(a)}}function c(t,n){var o=r()===t;f.remove(t),f.add(t,n),o&&d(t),e.$broadcast("$mdTabsChanged")}function d(t,n){!t||t.isSelected||t.isDisabled()||f.contains(t)&&(angular.isDefined(n)||(n=g(t)<e.selectedIndex),m(r(),n),e.selectedIndex=g(t),t.isSelected=!0,t.onSelect(n),e.$broadcast("$mdTabsChanged"))}function l(e){h.tabToFocus=e}function m(t,n){t&&t.isSelected&&f.contains(t)&&(e.selectedIndex=-1,t.isSelected=!1,t.onDeselect(n))}function u(e,t){return f.next(e||r(),t||p)}function s(e,t){return f.previous(e||r(),t||p)}function p(e){return e&&!e.isDisabled()}var f=n.iterator([],!1),h=this;h.$element=t,h.scope=e;var g=(h.contentArea=angular.element(t[0].querySelector(".md-tabs-content")),h.inRange=f.inRange,h.indexOf=f.indexOf),E=h.itemAt=f.itemAt;h.count=f.count,h.getSelectedItem=r,h.getSelectedIndex=o,h.add=a,h.remove=i,h.move=c,h.select=d,h.focus=l,h.deselect=m,h.next=u,h.previous=s,e.$on("$destroy",function(){m(r());for(var e=f.count()-1;e>=0;e--)i(f[e],!0)})}angular.module("material.components.tabs").controller("$mdTabs",e),e.$inject=["$scope","$element","$mdUtil","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2-master-6a087a0

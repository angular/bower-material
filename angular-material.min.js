 ...
 * v0.9.0-rc1-master-bf6ef07
 */
function(){"use strict";function e(e,a,i){function d(t,d){function c(e){if(d.ngModel){var t=l[0].querySelector(e);return t&&t.outerHTML}}var l=d.$mdUserTemplate;d.$mdUserTemplate=null;var m=c("[md-chip-remove]")||o,s=c("md-chip-template")||r,u=c("md-autocomplete")||c("input")||n,p=l.find("md-chip");return function(t,r,o,c){e(r),r.attr("tabindex","0");var l=c[0];if(l.chipContentsTemplate=s,l.chipRemoveTemplate=m,l.chipInputTemplate=u,r.on("focus",function(){l.onFocus()}),d.ngModel&&(l.configureNgModel(r.controller("ngModel")),o.mdOnAppend&&l.useMdOnAppendExpression(),u!=n&&i(function(){0===u.indexOf("<md-autocomplete")&&l.configureAutocomplete(r.find("md-autocomplete").controller("mdAutocomplete")),l.configureUserInput(r.find("input"))})),p.length>0){var f=a(p)(t.$parent);i(function(){r.find("md-chips-wrap").prepend(f)})}}}return{template:function(e,n){return n.$mdUserTemplate=e.clone(),n.tabindex="0",t},require:["mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:d,scope:{readonly:"=readonly",placeholder:"@",secondaryPlaceholder:"@",mdOnAppend:"&",deleteHint:"@",deleteButtonLabel:"@"}}}angular.module("material.components.chips").directive("mdChips",e);var t='      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index}">          <div class="md-chip-content"              tabindex="-1"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div class="md-chip-remove-container"              md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',n='        <input            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.resetSelectedChip()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',r="      <span>{{$chip}}</span>",o='      <button          class="md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index)"          tabindex="-1">        <md-icon md-svg-icon="close"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>';e.$inject=["$mdTheming","$compile","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-bf6ef07

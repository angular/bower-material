 ...
 * v0.7.1-master-dd6bafa
 */
function(){"use strict";function e(e,t,n,r,o,a,i,c){function d(d,l,m,s){function u(){E(),A(),b()}function f(e){G=parseFloat(e),l.attr("aria-valuemin",e),u()}function p(e){W=parseFloat(e),l.attr("aria-valuemax",e),u()}function h(e){X=parseFloat(e),b()}function g(e){l.attr("aria-disabled",!!e)}function b(){if(angular.isDefined(m.mdDiscrete)){var e=Math.floor((W-G)/X);if(!Z){var n=t.getComputedStyle(U[0]);Z=angular.element('<canvas style="position:absolute;">'),Q=Z[0].getContext("2d"),Q.fillStyle=n.backgroundColor||"black",U.append(Z)}var r=v();Z[0].width=r.width,Z[0].height=r.height;for(var o,a=0;e>=a;a++)o=Math.floor(r.width*(a/e)),Q.fillRect(o-1,0,2,r.height)}}function E(){J=B[0].getBoundingClientRect()}function v(){return Y(),J}function $(e){if(!l[0].hasAttribute("disabled")){var t;e.keyCode===o.KEY_CODE.LEFT_ARROW?t=-X:e.keyCode===o.KEY_CODE.RIGHT_ARROW&&(t=X),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),d.$evalAsync(function(){M(s.$viewValue+t)}))}}function M(e){s.$setViewValue(T(k(e)))}function A(){isNaN(s.$viewValue)&&(s.$viewValue=s.$modelValue);var e=(s.$viewValue-G)/(W-G);d.modelValue=s.$viewValue,l.attr("aria-valuenow",s.$viewValue),w(e),L.text(s.$viewValue)}function T(e){return angular.isNumber(e)?Math.max(G,Math.min(W,e)):void 0}function k(e){return angular.isNumber(e)?Math.round(e/X)*X:void 0}function w(e){V.css("width",100*e+"%"),q.css(o.CSS.TRANSFORM,"translate3d("+100*e+"%,0,0)"),l.toggleClass("md-min",0===e)}function y(e){if(!j()){l.addClass("active"),l[0].focus(),E();var t=I(O(e.pointer.x)),n=T(k(t));d.$apply(function(){M(n),w(R(n))})}}function C(e){if(!j()){l.removeClass("dragging active");var t=I(O(e.pointer.x)),n=T(k(t));d.$apply(function(){M(n)})}}function N(e){j()||(et=!0,e.stopPropagation(),l.addClass("dragging"),S(e))}function x(e){et&&(e.stopPropagation(),S(e))}function _(e){et&&(e.stopPropagation(),et=!1)}function S(e){tt?D(e.pointer.x):H(e.pointer.x)}function H(e){d.$evalAsync(function(){M(I(O(e)))})}function D(e){var t=I(O(e)),n=T(k(t));w(O(e)),L.text(n)}function O(e){return Math.max(0,Math.min(1,(e-J.left)/J.width))}function I(e){return G+e*(W-G)}function R(e){return(e-G)/(W-G)}a(l),s=s||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var P=m.ngDisabled&&c(m.ngDisabled),j=P?function(){return P(d.$parent)}:angular.noop,F=angular.element(l[0].querySelector(".md-thumb")),L=angular.element(l[0].querySelector(".md-thumb-text")),q=F.parent(),B=angular.element(l[0].querySelector(".md-track-container")),V=angular.element(l[0].querySelector(".md-track-fill")),U=angular.element(l[0].querySelector(".md-track-ticks")),Y=r.throttle(E,5e3);m.min?m.$observe("min",f):f(0),m.max?m.$observe("max",p):p(100),m.step?m.$observe("step",h):h(1);var K=angular.noop;m.ngDisabled&&(K=d.$parent.$watch(m.ngDisabled,g)),n.expect(l,"aria-label"),i.register(l,"drag"),l.attr({tabIndex:0,role:"slider"}).on("keydown",$).on("$md.pressdown",y).on("$md.pressup",C).on("$md.dragstart",N).on("$md.drag",x).on("$md.dragend",_),setTimeout(u);var z=e.throttle(u);angular.element(t).on("resize",z),d.$on("$destroy",function(){angular.element(t).off("resize",z),K()}),s.$render=A,s.$viewChangeListeners.push(A),s.$formatters.push(T),s.$formatters.push(k);var G,W,X,Z,Q,J={};E();var et=!1,tt=angular.isDefined(m.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-track-container"><div class="md-track"></div><div class="md-track md-track-fill"></div><div class="md-track-ticks"></div></div><div class="md-thumb-container"><div class="md-thumb"></div><div class="md-focus-thumb"></div><div class="md-focus-ring"></div><div class="md-sign"><span class="md-thumb-text"></span></div><div class="md-disabled-thumb"></div></div>',link:d}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-dd6bafa
 ...
 * v0.7.1-master-dd6bafa
 */
function(){"use strict";function e(e,t,n,r,o,a,i){function c(c,m,s){function u(t){u.value=!!t,u.queued||(t?(u.queued=!0,e(function(){c.visible=u.value,u.queued=!1},c.delay)):e(function(){c.visible=!1}))}function f(){m.removeClass("md-hide"),g.attr("aria-describedby",m.attr("id")),E.append(m),h(),n(function(){n(function(){h(),c.visible&&m.addClass("md-show")})})}function p(){m.removeClass("md-show").addClass("md-hide"),g.removeAttr("aria-describedby"),e(function(){c.visible||m.detach()},200,!1)}function h(){var e=o.elementRect(m,E),t=o.elementRect(g,E),n="bottom",r={left:t.left+t.width/2-e.width/2,top:t.top+t.height};r.left=Math.min(r.left,E.prop("scrollWidth")-e.width-l),r.left=Math.max(r.left,l),r.top+e.height>E.prop("scrollHeight")&&(r.top=t.top-e.height,n="top"),m.css({top:r.top+"px",left:r.left+"px"}),m.attr("width-32",Math.ceil(e.width/32)),m.attr("md-direction",n)}a(m);for(var g=m.parent();"none"==t.getComputedStyle(g[0])["pointer-events"];)g=g.parent();for(var b=m.parent()[0];b&&b!==i[0]&&b!==document.body&&(!b.tagName||"md-content"!=b.tagName.toLowerCase());)b=b.parentNode;var E=angular.element(b||document.body);angular.isDefined(s.mdDelay)||(c.delay=d),m.detach(),m.attr("role","tooltip"),m.attr("id",s.id||"tooltip_"+o.nextUid()),g.on("focus mouseenter touchstart",function(){u(!0)}),g.on("blur mouseleave touchend touchcancel",function(){r[0].activeElement!==g[0]&&u(!1)}),c.$watch("visible",function(e){e?f():p()});var v=n.throttle(function(){c.visible&&h()});angular.element(t).on("resize",v),c.$on("$destroy",function(){c.visible=!1,m.remove(),angular.element(t).off("resize",v)})}var d=400,l=8;return{restrict:"E",transclude:!0,template:'<div class="md-background"></div><div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay"},link:c}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-dd6bafa
 ...
 * v0.7.1-master-dd6bafa
 */
function(){"use strict";function e(e,t,n,r,o){function a(a,i){var c=a.find("md-tab-label");c.length?c.remove():c=angular.isDefined(i.label)?angular.element("<md-tab-label>").html(i.label):angular.element("<md-tab-label>").append(a.contents().remove());var d=a.contents().remove();return function(a,i,l,m){function s(){var e=c.clone();i.append(e),t(e)(a.$parent),E.content=d.clone()}function u(){a.$apply(function(){v.select(E),v.focus(E)})}function f(e){e.keyCode==r.KEY_CODE.SPACE||e.keyCode==r.KEY_CODE.ENTER?(i.triggerHandler("click"),e.preventDefault()):e.keyCode===r.KEY_CODE.LEFT_ARROW?a.$evalAsync(function(){v.focus(v.previous(E))}):e.keyCode===r.KEY_CODE.RIGHT_ARROW&&a.$evalAsync(function(){v.focus(v.next(E))})}function p(){a.$watch("$parent.$index",function(e){v.move(E,e)})}function h(){function e(e){var t=v.getSelectedItem()===E;e&&!t?v.select(E):!e&&t&&v.deselect(E)}var t=a.$parent.$watch("!!("+l.mdActive+")",e);a.$on("$destroy",t)}function g(){function e(e){i.attr("aria-disabled",e);var t=v.getSelectedItem()===E;t&&e&&v.select(v.next()||v.previous())}a.$watch(E.isDisabled,e)}function b(){var e=l.id||"tab_"+n.nextUid();if(i.attr({id:e,role:"tab",tabIndex:-1}),d.length){var t="content_"+e;i.attr("aria-controls")||i.attr("aria-controls",t),E.contentContainer.attr({id:t,role:"tabpanel","aria-labelledby":e})}}var E=m[0],v=m[1];o(i.addClass.bind(i,"md-tab-themed"),0,!1),a.$watch(function(){return l.label},function(){o(function(){v.scope.$broadcast("$mdTabsChanged")},0,!1)}),s(),b();var $=e.attachTabBehavior(a,i,{colorElement:v.inkBarElement});v.add(E),a.$on("$destroy",function(){$(),v.remove(E)}),i.on("$destroy",function(){o(function(){v.scope.$broadcast("$mdTabsChanged")},0,!1)}),angular.isDefined(l.ngClick)||i.on("click",u),i.on("keydown",f),angular.isNumber(a.$parent.$index)&&p(),angular.isDefined(l.mdActive)&&h(),g()}}return{restrict:"E",require:["mdTab","^mdTabs"],controller:"$mdTab",scope:{onSelect:"&mdOnSelect",onDeselect:"&mdOnDeselect",label:"@"},compile:a}}angular.module("material.components.tabs").directive("mdTab",e),e.$inject=["$mdInkRipple","$compile","$mdUtil","$mdConstant","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-dd6bafa

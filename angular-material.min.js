 ...
 * v0.7.1-master-f331cfa
 */
function(){"use strict";function e(e,t,n,r,o,a,i,c){function d(d,l,m,u){function s(){E(),A(),b()}function f(e){z=parseFloat(e),l.attr("aria-valuemin",e),s()}function p(e){W=parseFloat(e),l.attr("aria-valuemax",e),s()}function h(e){X=parseFloat(e),b()}function g(e){l.attr("aria-disabled",!!e)}function b(){if(angular.isDefined(m.mdDiscrete)){var e=Math.floor((W-z)/X);if(!Q){var n=t.getComputedStyle(U[0]);Q=angular.element('<canvas style="position:absolute;">'),Z=Q[0].getContext("2d"),Z.fillStyle=n.backgroundColor||"black",U.append(Q)}var r=v();Q[0].width=r.width,Q[0].height=r.height;for(var o,a=0;e>=a;a++)o=Math.floor(r.width*(a/e)),Z.fillRect(o-1,0,2,r.height)}}function E(){J=B[0].getBoundingClientRect()}function v(){return Y(),J}function $(e){if(!l[0].hasAttribute("disabled")){var t;e.keyCode===o.KEY_CODE.LEFT_ARROW?t=-X:e.keyCode===o.KEY_CODE.RIGHT_ARROW&&(t=X),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),d.$evalAsync(function(){M(u.$viewValue+t)}))}}function M(e){u.$setViewValue(T(w(e)))}function A(){isNaN(u.$viewValue)&&(u.$viewValue=u.$modelValue);var e=(u.$viewValue-z)/(W-z);d.modelValue=u.$viewValue,l.attr("aria-valuenow",u.$viewValue),k(e),L.text(u.$viewValue)}function T(e){return angular.isNumber(e)?Math.max(z,Math.min(W,e)):void 0}function w(e){return angular.isNumber(e)?Math.round(e/X)*X:void 0}function k(e){V.css("width",100*e+"%"),q.css(o.CSS.TRANSFORM,"translate3d("+100*e+"%,0,0)"),l.toggleClass("md-min",0===e)}function y(e){if(!j()){l.addClass("active"),l[0].focus(),E();var t=R(I(e.pointer.x)),n=T(w(t));d.$apply(function(){M(n),k(O(n))})}}function C(e){if(!j()){l.removeClass("dragging active");var t=R(I(e.pointer.x)),n=T(w(t));d.$apply(function(){M(n)})}}function N(e){j()||(et=!0,e.stopPropagation(),l.addClass("dragging"),S(e))}function x(e){et&&(e.stopPropagation(),S(e))}function _(e){et&&(e.stopPropagation(),et=!1)}function S(e){tt?D(e.pointer.x):H(e.pointer.x)}function H(e){d.$evalAsync(function(){M(R(I(e)))})}function D(e){var t=R(I(e)),n=T(w(t));k(I(e)),L.text(n)}function I(e){return Math.max(0,Math.min(1,(e-J.left)/J.width))}function R(e){return z+e*(W-z)}function O(e){return(e-z)/(W-z)}a(l),u=u||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var P=m.ngDisabled&&c(m.ngDisabled),j=P?function(){return P(d.$parent)}:angular.noop,F=angular.element(l[0].querySelector(".md-thumb")),L=angular.element(l[0].querySelector(".md-thumb-text")),q=F.parent(),B=angular.element(l[0].querySelector(".md-track-container")),V=angular.element(l[0].querySelector(".md-track-fill")),U=angular.element(l[0].querySelector(".md-track-ticks")),Y=r.throttle(E,5e3);m.min?m.$observe("min",f):f(0),m.max?m.$observe("max",p):p(100),m.step?m.$observe("step",h):h(1);var K=angular.noop;m.ngDisabled&&(K=d.$parent.$watch(m.ngDisabled,g)),n.expect(l,"aria-label"),i.register(l,"drag"),l.attr({tabIndex:0,role:"slider"}).on("keydown",$).on("$md.pressdown",y).on("$md.pressup",C).on("$md.dragstart",N).on("$md.drag",x).on("$md.dragend",_),setTimeout(s);var G=e.throttle(s);angular.element(t).on("resize",G),d.$on("$destroy",function(){angular.element(t).off("resize",G),K()}),u.$render=A,u.$viewChangeListeners.push(A),u.$formatters.push(T),u.$formatters.push(w);var z,W,X,Q,Z,J={};E();var et=!1,tt=angular.isDefined(m.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-track-container"><div class="md-track"></div><div class="md-track md-track-fill"></div><div class="md-track-ticks"></div></div><div class="md-thumb-container"><div class="md-thumb"></div><div class="md-focus-thumb"></div><div class="md-focus-ring"></div><div class="md-sign"><span class="md-thumb-text"></span></div><div class="md-disabled-thumb"></div></div>',link:d}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-f331cfa
 ...
 * v0.7.1-master-f331cfa
 */
function(){"use strict";function e(e,t,n,r,o){function a(a,i){var c=a.find("md-tab-label");c.length?c.remove():c=angular.isDefined(i.label)?angular.element("<md-tab-label>").html(i.label):angular.element("<md-tab-label>").append(a.contents().remove());var d=a.contents().remove();return function(a,i,l,m){function u(){var e=c.clone();i.append(e),t(e)(a.$parent),E.content=d.clone()}function s(){a.$apply(function(){v.select(E),v.focus(E)})}function f(e){e.keyCode==r.KEY_CODE.SPACE||e.keyCode==r.KEY_CODE.ENTER?(i.triggerHandler("click"),e.preventDefault()):e.keyCode===r.KEY_CODE.LEFT_ARROW?a.$evalAsync(function(){v.focus(v.previous(E))}):e.keyCode===r.KEY_CODE.RIGHT_ARROW&&a.$evalAsync(function(){v.focus(v.next(E))})}function p(){a.$watch("$parent.$index",function(e){v.move(E,e)})}function h(){function e(e){var t=v.getSelectedItem()===E;e&&!t?v.select(E):!e&&t&&v.deselect(E)}var t=a.$parent.$watch("!!("+l.mdActive+")",e);a.$on("$destroy",t)}function g(){function e(e){i.attr("aria-disabled",e);var t=v.getSelectedItem()===E;t&&e&&v.select(v.next()||v.previous())}a.$watch(E.isDisabled,e)}function b(){var e=l.id||"tab_"+n.nextUid();if(i.attr({id:e,role:"tab",tabIndex:-1}),d.length){var t="content_"+e;i.attr("aria-controls")||i.attr("aria-controls",t),E.contentContainer.attr({id:t,role:"tabpanel","aria-labelledby":e})}}var E=m[0],v=m[1];o(i.addClass.bind(i,"md-tab-themed"),0,!1),a.$watch(function(){return l.label},function(){o(function(){v.scope.$broadcast("$mdTabsChanged")},0,!1)}),u(),b();var $=e.attachTabBehavior(a,i,{colorElement:v.inkBarElement});v.add(E),a.$on("$destroy",function(){$(),v.remove(E)}),i.on("$destroy",function(){o(function(){v.scope.$broadcast("$mdTabsChanged")},0,!1)}),angular.isDefined(l.ngClick)||i.on("click",s),i.on("keydown",f),angular.isNumber(a.$parent.$index)&&p(),angular.isDefined(l.mdActive)&&h(),g()}}return{restrict:"E",require:["mdTab","^mdTabs"],controller:"$mdTab",scope:{onSelect:"&mdOnSelect",onDeselect:"&mdOnDeselect",label:"@"},compile:a}}angular.module("material.components.tabs").directive("mdTab",e),e.$inject=["$mdInkRipple","$compile","$mdUtil","$mdConstant","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-f331cfa

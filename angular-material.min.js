 ...
 * v0.9.0-rc2-master-e620228
 */
function(){"use strict";function e(e,r,a,i,d,c,l,m){function s(){h(),d(function(){g(),f(),p()})}function u(){function e(){var e=U.ul.getBoundingClientRect(),n={};e.right>a.right-o&&(n.left=t.right-e.width+"px"),U.$.ul.css(n)}if(!U)return d(u,0,!1);var t=U.wrap.getBoundingClientRect(),r=U.snap.getBoundingClientRect(),a=U.root.getBoundingClientRect(),i=r.bottom-a.top,c=a.bottom-r.top,l=t.left-a.left,m=t.width,s={left:l+"px",minWidth:m+"px",maxWidth:Math.max(t.right-a.left,a.right-t.left)-o+"px"};i>c&&a.height-t.bottom-o<n?(s.top="auto",s.bottom=c+"px",s.maxHeight=Math.min(n,t.top-a.top-o)+"px"):(s.top=i+"px",s.bottom="auto",s.maxHeight=Math.min(n,a.bottom-t.bottom-o)+"px"),U.$.ul.css(s),d(e,0,!1)}function p(){U.$.root.length&&(c(U.$.ul),U.$.ul.detach(),U.$.root.append(U.$.ul))}function f(){e.autofocus&&U.input.focus()}function h(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(T,t):T),$(v),e.$watch("selectedItem",M),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){!e&&t&&u()}),angular.element(l).on("resize",u)}function g(){U={main:r[0],ul:r.find("ul")[0],input:r.find("input")[0],wrap:r.find("md-autocomplete-wrap")[0],root:document.body},U.snap=b(),U.$=E(U)}function b(){for(var e=r;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return U.wrap}function E(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function v(t,n){t&&(e.searchText=x(t)),e.itemChange&&t!==n&&e.itemChange(N(t))}function M(e,t){for(var n=0;n<z.length;++n)z[n](e,t)}function $(e){-1==z.indexOf(e)&&z.push(e)}function A(e){var t=z.indexOf(e);-1!=t&&z.splice(t,1)}function T(t,n){B.index=_(),(t||t!==n)&&t!==x(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(N(e.selectedItem)),I()?F():(B.loading=!1,B.matches=[],B.hidden=H(),L()))}function C(){G=!1,W||(B.hidden=!0)}function w(){G=!0,angular.isString(e.searchText)||(e.searchText=""),e.minLength>0||(B.hidden=H(),B.hidden||F())}function k(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(B.loading)return;e.preventDefault(),B.index=Math.min(B.index+1,B.matches.length-1),j(),P();break;case i.KEY_CODE.UP_ARROW:if(B.loading)return;e.preventDefault(),B.index=B.index<0?B.matches.length-1:Math.max(0,B.index-1),j(),P();break;case i.KEY_CODE.ENTER:if(B.hidden||B.loading||B.index<0)return;e.preventDefault(),D(B.index);break;case i.KEY_CODE.ESCAPE:B.matches=[],B.hidden=!0,B.index=_();break;case i.KEY_CODE.TAB:}}function y(){return angular.isNumber(e.minLength)?e.minLength:1}function x(t){return t&&e.itemText?e.itemText(N(t)):t}function N(e){if(e){var t={};return B.itemName&&(t[B.itemName]=e),t}}function _(){return e.autoselect?0:-1}function H(){return I()?void 0:!0}function S(){return x(B.matches[B.index])}function I(){return e.searchText.length>=y()}function D(t){e.selectedItem=B.matches[t],e.searchText=x(e.selectedItem)||e.searchText,B.hidden=!0,B.index=0,B.matches=[]}function O(){e.searchText="",D(-1),U.input.focus()}function R(t){function n(n){Y[r]=n,t===e.searchText&&(V=null,B.loading=!1,B.matches=n,B.hidden=H(),L(),u())}var o=e.$parent.$eval(K),r=t.toLowerCase();angular.isArray(o)?n(o):(B.loading=!0,o.success&&o.success(n),o.then&&o.then(n),o.error&&o.error(function(){B.loading=!1}))}function L(){if(!B.hidden)switch(B.matches.length){case 0:return B.messages.splice(0);case 1:return B.messages.push({display:"There is 1 match available."});default:return B.messages.push({display:"There are "+B.matches.length+" matches available."})}}function P(){B.messages.push({display:S()})}function j(){var e=t*B.index,n=e+t,o=U.ul.clientHeight;e<U.ul.scrollTop?U.ul.scrollTop=e:n>U.ul.scrollTop+o&&(U.ul.scrollTop=n-o)}function F(){var t=e.searchText,n=t.toLowerCase();V&&V.cancel&&(V.cancel(),V=null),!e.noCache&&Y[n]?(B.matches=Y[n],L()):R(t),B.hidden=H()}var B=this,q=e.itemsExpr.split(/ in /i),K=q[1],U=null,V=null,Y={},W=!1,z=[],G=!1;return B.scope=e,B.parent=e.$parent,B.itemName=q[0],B.matches=[],B.loading=!1,B.hidden=!0,B.index=null,B.messages=[],B.id=a.nextUid(),B.keydown=k,B.blur=C,B.focus=w,B.clear=O,B.select=D,B.getCurrentDisplayValue=S,B.registerSelectedItemWatcher=$,B.unregisterSelectedItemWatcher=A,B.listEnter=function(){W=!0},B.listLeave=function(){W=!1,G||(B.hidden=!0)},B.mouseUp=function(){U.input.focus()},s()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,o=8;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window","$rootElement"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-e620228
 ...
 * v0.9.0-rc2-master-e620228
 */
function(){"use strict";function e(e,a,i){function d(t,d){function c(e){if(d.ngModel){var t=l[0].querySelector(e);return t&&t.outerHTML}}var l=d.$mdUserTemplate;d.$mdUserTemplate=null;var m=c("[md-chip-remove]")||r,s=c("md-chip-template")||o,u=c("md-autocomplete")||c("input")||n,p=l.find("md-chip");return function(t,o,r,c){angular.forEach(t.$$isolateBindings,function(e,n){e.optional&&angular.isUndefined(t[n])&&(t[n]=d.hasOwnProperty(d.$normalize(e.attrName)))}),e(o);var l=c[0];if(l.chipContentsTemplate=s,l.chipRemoveTemplate=m,l.chipInputTemplate=u,o.attr({ariaHidden:!0,tabindex:-1}).on("focus",function(){l.onFocus()}),d.ngModel&&(l.configureNgModel(o.controller("ngModel")),r.mdOnAppend&&l.useMdOnAppendExpression(),u!=n&&i(function(){0===u.indexOf("<md-autocomplete")&&l.configureAutocomplete(o.find("md-autocomplete").controller("mdAutocomplete")),l.configureUserInput(o.find("input"))})),p.length>0){var f=a(p)(t.$parent);i(function(){o.find("md-chips-wrap").prepend(f)})}}}return{template:function(e,n){return n.$mdUserTemplate=e.clone(),t},require:["mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:d,scope:{readonly:"=readonly",placeholder:"@",secondaryPlaceholder:"@",mdOnAppend:"&",deleteHint:"@",deleteButtonLabel:"@",requireMatch:"=?mdRequireMatch"}}}angular.module("material.components.chips").directive("mdChips",e);var t='      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus() }"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index}">          <div class="md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-focus="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div class="md-chip-remove-container"              md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',n='        <input            tabindex="0"            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.onInputFocus()"            ng-blur="$mdChipsCtrl.onInputBlur()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',o="      <span>{{$chip}}</span>",r='      <button          class="md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index)"          aria-hidden="true"          tabindex="-1">        <md-icon md-svg-icon="close"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>';e.$inject=["$mdTheming","$compile","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-e620228

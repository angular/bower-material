 ...
 * v0.8.3-master-3ca2a63
 */
function(){"use strict";function e(e,t,n,r,o,a,i,d,c){function l(l,u,p){function f(){h(),b(),$(),g()}function h(){angular.isDefined(p.mdDelay)||(l.delay=m)}function g(){l.$watch("visible",function(e){e?A():T()}),l.$on("$destroy",function(){l.visible=!1,u.remove(),angular.element(t).off("resize",H)})}function b(){u.detach(),u.attr("role","tooltip"),u.attr("id",p.id||"tooltip_"+o.nextUid())}function E(){for(var e=u.parent();"none"==t.getComputedStyle(e[0])["pointer-events"];)e=e.parent();return e}function v(){for(var e=u.parent()[0];e&&e!==i[0]&&e!==document.body&&(!e.tagName||"md-content"!=e.tagName.toLowerCase());)e=e.parentNode;return e}function $(){var e=l.hasOwnProperty("autohide")?l.autohide:p.hasOwnProperty("mdAutohide");C.on("focus mouseenter touchstart",function(){M(!0)}),C.on("blur mouseleave touchend touchcancel",function(){(r[0].activeElement!==C[0]||e)&&M(!1)}),angular.element(t).on("resize",H)}function M(t){M.value=!!t,M.queued||(t?(M.queued=!0,e(function(){l.visible=M.value,M.queued=!1},l.delay)):e(function(){l.visible=!1}))}function A(){C.attr("aria-describedby",u.attr("id")),_.append(u),w(),angular.forEach([u,k,y],function(e){d.addClass(e,"md-show")})}function T(){C.removeAttr("aria-describedby"),c.all([d.removeClass(y,"md-show"),d.removeClass(k,"md-show"),d.removeClass(u,"md-show")]).then(function(){l.visible||u.detach()})}function w(){function e(){var e="left"===x||"right"===x?2*Math.sqrt(Math.pow(r.width,2)+Math.pow(r.height/2,2)):2*Math.sqrt(Math.pow(r.width/2,2)+Math.pow(r.height,2)),t="left"===x?{left:100,top:50}:"right"===x?{left:0,top:50}:"top"===x?{left:50,top:100}:{left:50,top:0};k.css({width:e+"px",height:e+"px",left:t.left+"%",top:t.top+"%"})}function t(e){var t={left:e.left,top:e.top};return t.left=Math.min(t.left,_.prop("scrollWidth")-r.width-s),t.left=Math.max(t.left,s),t.top=Math.min(t.top,_.prop("scrollHeight")-r.height-s),t.top=Math.max(t.top,s),t}function n(e){return"left"===e?{left:a.left-r.width-s,top:a.top+a.height/2-r.height/2}:"right"===e?{left:a.left+a.width+s,top:a.top+a.height/2-r.height/2}:"top"===e?{left:a.left+a.width/2-r.width/2,top:a.top-r.height-s}:{left:a.left+a.width/2-r.width/2,top:a.top+a.height+s}}var r=o.offsetRect(u,_),a=o.offsetRect(C,_),i=n(x);x?i=t(i):i.top>u.prop("offsetParent").scrollHeight-r.height-s&&(i=t(n("top"))),u.css({top:i.top+"px",left:i.left+"px"}),e()}a(u);var C=E(),k=angular.element(u[0].getElementsByClassName("md-background")[0]),y=angular.element(u[0].getElementsByClassName("md-content")[0]),x=p.mdDirection,N=v(),_=angular.element(N||document.body),H=n.throttle(function(){l.visible&&w()});return f()}var m=300,s=8;return{restrict:"E",transclude:!0,template:'        <div class="md-background"></div>        <div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay",autohide:"=?mdAutohide"},link:l}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-3ca2a63
 ...
 * v0.8.3-master-3ca2a63
 */
function(){"use strict";function e(e,o,a,i,d,c,l){function m(){f(),d(function(){h(),p(),u()})}function s(){if(!q)return d(s,0,!1);var e=q.wrap.getBoundingClientRect(),t=q.root.getBoundingClientRect(),o=e.bottom-t.top,a=t.height-e.top,i=e.left-t.left,c=e.width,l={left:i+"px",width:c+"px"};o>a&&t.height-e.bottom-r<n?(l.top="auto",l.bottom=a+"px",l.maxHeight=Math.min(n,e.top-t.top-r)+"px"):(l.top=o+"px",l.bottom="auto",l.maxHeight=Math.min(n,t.height-e.bottom-r)+"px"),q.$.ul.css(l)}function u(){q.$.root.length&&(c(q.$.ul),q.$.ul.detach(),q.$.root.append(q.$.ul))}function p(){e.autofocus&&q.input.focus()}function f(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(M,t):M),v(b),e.$watch("selectedItem",E),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){e&&!t&&s()}),angular.element(l).on("resize",s)}function h(){q={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:document.body},q.$=g(q)}function g(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function b(t,n){t&&(e.searchText=k(t)),e.itemChange&&t!==n&&e.itemChange(y(t))}function E(e,t){for(var n=0;n<Y.length;++n)Y[n](e,t)}function v(e){-1==Y.indexOf(e)&&Y.push(e)}function $(e){var t=Y.indexOf(e);-1!=t&&Y.splice(t,1)}function M(t,n){j.index=x(),(t||t!==n)&&t!==k(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(y(e.selectedItem)),H()?P():(j.loading=!1,j.matches=[],j.hidden=N(),O()))}function A(){K||(j.hidden=!0)}function T(){return angular.isString(e.searchText)?(j.hidden=N(),j.hidden||P(),void 0):e.searchText=""}function w(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(j.loading)return;e.preventDefault(),j.index=Math.min(j.index+1,j.matches.length-1),L(),R();break;case i.KEY_CODE.UP_ARROW:if(j.loading)return;e.preventDefault(),j.index=j.index<0?j.matches.length-1:Math.max(0,j.index-1),L(),R();break;case i.KEY_CODE.ENTER:if(j.hidden||j.loading||j.index<0)return;e.preventDefault(),S(j.index);break;case i.KEY_CODE.ESCAPE:j.matches=[],j.hidden=!0,j.index=x();break;case i.KEY_CODE.TAB:}}function C(){return angular.isNumber(e.minLength)?e.minLength:1}function k(t){return t&&e.itemText?e.itemText(y(t)):t}function y(e){if(e){var t={};return j.itemName&&(t[j.itemName]=e),t}}function x(){return e.autoselect?0:-1}function N(){return H()?1===j.matches.length&&e.searchText===k(j.matches[0])&&e.selectedItem===j.matches[0]:!0}function _(){return k(j.matches[j.index])}function H(){return e.searchText.length>=C()}function S(t){e.selectedItem=j.matches[t],e.searchText=k(e.selectedItem)||e.searchText,j.hidden=!0,j.index=0,j.matches=[]}function I(){e.searchText="",S(-1),q.input.focus()}function D(t){function n(n){V[o]=n,t===e.searchText&&(U=null,j.loading=!1,j.matches=n,j.hidden=N(),O(),s())}var r=e.$parent.$eval(F),o=t.toLowerCase();angular.isArray(r)?n(r):(j.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){j.loading=!1}))}function O(){if(!j.hidden)switch(j.matches.length){case 0:return j.messages.splice(0);case 1:return j.messages.push({display:"There is 1 match available."});default:return j.messages.push({display:"There are "+j.matches.length+" matches available."})}}function R(){j.messages.push({display:_()})}function L(){var e=t*j.index,n=e+t,r=q.ul.clientHeight;e<q.ul.scrollTop?q.ul.scrollTop=e:n>q.ul.scrollTop+r&&(q.ul.scrollTop=n-r)}function P(){var t=e.searchText,n=t.toLowerCase();U&&U.cancel&&(U.cancel(),U=null),!e.noCache&&V[n]?(j.matches=V[n],O()):D(t),j.hidden=N()}var j=this,B=e.itemsExpr.split(/ in /i),F=B[1],q=null,U=null,V={},K=!1,Y=[];return j.scope=e,j.parent=e.$parent,j.itemName=B[0],j.matches=[],j.loading=!1,j.hidden=!0,j.index=null,j.messages=[],j.id=a.nextUid(),j.keydown=w,j.blur=A,j.focus=T,j.clear=I,j.select=S,j.fetch=a.debounce(D),j.getCurrentDisplayValue=_,j.registerSelectedItemWatcher=v,j.unregisterSelectedItemWatcher=$,j.listEnter=function(){K=!0},j.listLeave=function(){K=!1},j.mouseUp=function(){q.input.focus()},m()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=16;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-3ca2a63

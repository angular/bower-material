 ...
 * v0.9.0-rc1-master-1e3f1a5
 */
function(){"use strict";function e(e,r,a,i,d,c,l,m){function s(){h(),d(function(){g(),p(),f()})}function u(){function e(){var e=K.ul.getBoundingClientRect(),n={};e.right>a.right-o&&(n.left=t.right-e.width+"px"),K.$.ul.css(n)}if(!K)return d(u,0,!1);var t=K.wrap.getBoundingClientRect(),r=K.snap.getBoundingClientRect(),a=K.root.getBoundingClientRect(),i=r.bottom-a.top,c=a.bottom-r.top,l=t.left-a.left,m=t.width,s={left:l+"px",minWidth:m+"px",maxWidth:Math.max(t.right-a.left,a.right-t.left)-o+"px"};i>c&&a.height-t.bottom-o<n?(s.top="auto",s.bottom=c+"px",s.maxHeight=Math.min(n,t.top-a.top-o)+"px"):(s.top=i+"px",s.bottom="auto",s.maxHeight=Math.min(n,a.bottom-t.bottom-o)+"px"),K.$.ul.css(s),d(e,0,!1)}function f(){K.$.root.length&&(c(K.$.ul),K.$.ul.detach(),K.$.root.append(K.$.ul))}function p(){e.autofocus&&K.input.focus()}function h(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(T,t):T),$(v),e.$watch("selectedItem",M),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){!e&&t&&u()}),angular.element(l).on("resize",u)}function g(){K={main:r[0],ul:r.find("ul")[0],input:r.find("input")[0],wrap:r.find("md-autocomplete-wrap")[0],root:document.body},K.snap=b(),K.$=E(K)}function b(){for(var e=r;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return K.wrap}function E(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function v(t,n){t&&(e.searchText=x(t)),e.itemChange&&t!==n&&e.itemChange(N(t))}function M(e,t){for(var n=0;n<z.length;++n)z[n](e,t)}function $(e){-1==z.indexOf(e)&&z.push(e)}function A(e){var t=z.indexOf(e);-1!=t&&z.splice(t,1)}function T(t,n){B.index=_(),(t||t!==n)&&t!==x(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(N(e.selectedItem)),I()?F():(B.loading=!1,B.matches=[],B.hidden=H(),L()))}function C(){W||(B.hidden=!0)}function w(){return angular.isString(e.searchText)?(B.hidden=H(),void(B.hidden||F())):e.searchText=""}function k(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(B.loading)return;e.preventDefault(),B.index=Math.min(B.index+1,B.matches.length-1),j(),P();break;case i.KEY_CODE.UP_ARROW:if(B.loading)return;e.preventDefault(),B.index=B.index<0?B.matches.length-1:Math.max(0,B.index-1),j(),P();break;case i.KEY_CODE.ENTER:if(B.hidden||B.loading||B.index<0)return;e.preventDefault(),D(B.index);break;case i.KEY_CODE.ESCAPE:B.matches=[],B.hidden=!0,B.index=_();break;case i.KEY_CODE.TAB:}}function y(){return angular.isNumber(e.minLength)?e.minLength:1}function x(t){return t&&e.itemText?e.itemText(N(t)):t}function N(e){if(e){var t={};return B.itemName&&(t[B.itemName]=e),t}}function _(){return e.autoselect?0:-1}function H(){return I()?1===B.matches.length&&e.searchText===x(B.matches[0])&&e.selectedItem===B.matches[0]:!0}function S(){return x(B.matches[B.index])}function I(){return e.searchText.length>=y()}function D(t){e.selectedItem=B.matches[t],e.searchText=x(e.selectedItem)||e.searchText,B.hidden=!0,B.index=0,B.matches=[]}function O(){e.searchText="",D(-1),K.input.focus()}function R(t){function n(n){Y[r]=n,t===e.searchText&&(V=null,B.loading=!1,B.matches=n,B.hidden=H(),L(),u())}var o=e.$parent.$eval(U),r=t.toLowerCase();angular.isArray(o)?n(o):(B.loading=!0,o.success&&o.success(n),o.then&&o.then(n),o.error&&o.error(function(){B.loading=!1}))}function L(){if(!B.hidden)switch(B.matches.length){case 0:return B.messages.splice(0);case 1:return B.messages.push({display:"There is 1 match available."});default:return B.messages.push({display:"There are "+B.matches.length+" matches available."})}}function P(){B.messages.push({display:S()})}function j(){var e=t*B.index,n=e+t,o=K.ul.clientHeight;e<K.ul.scrollTop?K.ul.scrollTop=e:n>K.ul.scrollTop+o&&(K.ul.scrollTop=n-o)}function F(){var t=e.searchText,n=t.toLowerCase();V&&V.cancel&&(V.cancel(),V=null),!e.noCache&&Y[n]?(B.matches=Y[n],L()):R(t),B.hidden=H()}var B=this,q=e.itemsExpr.split(/ in /i),U=q[1],K=null,V=null,Y={},W=!1,z=[];return B.scope=e,B.parent=e.$parent,B.itemName=q[0],B.matches=[],B.loading=!1,B.hidden=!0,B.index=null,B.messages=[],B.id=a.nextUid(),B.keydown=k,B.blur=C,B.focus=w,B.clear=O,B.select=D,B.getCurrentDisplayValue=S,B.registerSelectedItemWatcher=$,B.unregisterSelectedItemWatcher=A,B.listEnter=function(){W=!0},B.listLeave=function(){W=!1},B.mouseUp=function(){K.input.focus()},s()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,o=8;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window","$rootElement"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e3f1a5
 ...
 * v0.9.0-rc1-master-1e3f1a5
 */
function(){"use strict";function e(e){function n(n,o){return n.append(t),function(t,n,o,r){r&&angular.element(n[0].querySelector(".md-chip-content")).on("blur",function(){r.$scope.$apply(function(){r.selectedChip=-1})}),n.addClass("md-chip"),e(n)}}return{restrict:"E",require:"^?mdChips",compile:n}}angular.module("material.components.chips").directive("mdChip",e);var t='      <span ng-if="!$mdChipsCtrl.readonly" class="md-visually-hidden">        {{$mdChipsCtrl.deleteHint}}      </span>';e.$inject=["$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e3f1a5
 ...
 * v0.9.0-rc1-master-1e3f1a5
 */
function(){"use strict";function e(e){function t(t,n,o,r){if(r){var a=t.$parent.$index;t.$watch("template",function(t){n.html(t),e(n.contents())(r.tabs[a].parent)})}}return{restrict:"A",link:t,scope:{template:"=mdLabelTemplate"},require:"^?mdTabs"}}angular.module("material.components.tabs").directive("mdLabelTemplate",e),e.$inject=["$compile"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e3f1a5
 ...
 * v0.9.0-rc1-master-1e3f1a5
 */
function(){"use strict";function e(){function e(e,t,n,o){function r(){function e(){return n.label}function o(){var e=t.find("md-tab-label");return e.length?e.remove().html():void 0}function r(){var e=t.html();return t.empty(),e}n.label||(t.find("md-tab-label")[0]||t[0]).innerHTML;return e()||o()||r()}function a(){var e=t.find("md-tab-body"),o=e.length?e.html():n.label?t.html():null;return e.length?e.remove():n.label&&t.empty(),o}if(o){var i=t.parent()[0].getElementsByTagName("md-tab"),d=Array.prototype.indexOf.call(i,t[0]),c=o.insertTab({scope:e,parent:e.$parent,index:d,template:a(),label:r()},d);e.deselect=e.deselect||angular.noop,e.select=e.select||angular.noop,e.$watch("active",function(e){e&&o.select(c.getIndex())}),e.$watch("disabled",function(){o.refreshIndex()}),e.$on("$destroy",function(){o.removeTab(c)})}}return{require:"^?mdTabs",terminal:!0,scope:{label:"@",active:"=?mdActive",disabled:"=?ngDisabled",select:"&?mdOnSelect",deselect:"&?mdOnDeselect"},link:e}}angular.module("material.components.tabs").directive("mdTab",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e3f1a5
 */
function(){"use strict";function e(){function e(e,t,n,o){o&&o.attachRipple(e,t)}return{require:"^?mdTabs",link:e}}angular.module("material.components.tabs").directive("mdTabItem",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e3f1a5
 ...
 * v0.9.0-rc1-master-1e3f1a5
 */
function(){"use strict";function e(e,t,n,o,r,a,i,d){function c(){e.$watch("selectedIndex",T),e.$watch("$mdTabsCtrl.focusIndex",p),e.$watch("$mdTabsCtrl.offsetLeft",f),e.$watch("$mdTabsCtrl.hasContent",l),angular.element(n).on("resize",function(){e.$apply(b)}),o(k,0,!1),o(w,0,!1)}function l(e){t[e?"removeClass":"hasClass"]("md-no-tab-content")}function m(){var e={};return e.wrapper=t[0].getElementsByTagName("md-tabs-wrapper")[0],e.canvas=e.wrapper.getElementsByTagName("md-tabs-canvas")[0],e.paging=e.canvas.getElementsByTagName("md-pagination-wrapper")[0],e.tabs=e.paging.getElementsByTagName("md-tab-item"),e.dummies=e.canvas.getElementsByTagName("md-dummy-tab"),e.inkBar=e.paging.getElementsByTagName("md-ink-bar")[0],e.contentsWrapper=t[0].getElementsByTagName("md-tabs-content-wrapper")[0],e.contents=e.contentsWrapper.getElementsByTagName("md-tab-content"),e}function s(t){switch(t.keyCode){case r.KEY_CODE.LEFT_ARROW:t.preventDefault(),u(-1,!0);break;case r.KEY_CODE.RIGHT_ARROW:t.preventDefault(),u(1,!0);break;case r.KEY_CODE.SPACE:case r.KEY_CODE.ENTER:t.preventDefault(),B||(e.selectedIndex=F.focusIndex)}F.lastClick=!1}function u(t,n){var o,r=n?F.focusIndex:e.selectedIndex;for(o=r+t;F.tabs[o]&&F.tabs[o].scope.disabled;o+=t);F.tabs[o]&&(n?F.focusIndex=o:e.selectedIndex=o)}function f(t){var n=_()?"":"-"+t+"px";angular.element(q.paging).css("left",n),e.$broadcast("$mdTabsPaginationChanged")}function p(e,t){e!==t&&q.tabs[e]&&(g(),h())}function h(){q.dummies[F.focusIndex].focus()}function g(){if(!_()){var e=q.tabs[F.focusIndex],t=e.offsetLeft,n=e.offsetWidth+t;F.offsetLeft=Math.max(F.offsetLeft,D(n-q.canvas.clientWidth)),F.offsetLeft=Math.min(F.offsetLeft,D(t))}}function b(){F.lastSelectedIndex=e.selectedIndex,k(),F.offsetLeft=D(F.offsetLeft)}function E(){U.forEach(function(e){o(e)}),U=[]}function v(t,n){var o={getIndex:function(){return F.tabs.indexOf(r)},isActive:function(){return this.getIndex()===e.selectedIndex},isLeft:function(){return this.getIndex()<e.selectedIndex},isRight:function(){return this.getIndex()>e.selectedIndex},hasFocus:function(){return!F.lastClick&&F.hasFocus&&this.getIndex()===F.focusIndex},id:i.nextUid()},r=angular.extend(o,t);return angular.isDefined(n)?F.tabs.splice(n,0,r):F.tabs.push(r),E(),M(),r}function M(){var e=!1;angular.forEach(F.tabs,function(t){t.template&&(e=!0)}),F.hasContent=e}function $(e){F.tabs.splice(e.getIndex(),1),A(),o(function(){k(),F.offsetLeft=D(F.offsetLeft)})}function A(){e.selectedIndex=x(e.selectedIndex),F.focusIndex=x(F.focusIndex)}function T(t,n){t!==n&&(e.selectedIndex=x(t),F.lastSelectedIndex=n,k(),w(),e.$broadcast("$mdTabsChanged"),F.tabs[n]&&F.tabs[n].scope.deselect(),F.tabs[t]&&F.tabs[t].scope.select())}function C(){C.watcher||(C.watcher=e.$watch(function(){o(function(){C.watcher&&t.prop("offsetParent")&&(C.watcher(),C.watcher=null,e.$apply(b))},0,!1)}))}function w(){if(!e.dynamicHeight)return t.css("height","");if(!F.tabs.length)return U.push(w);var n=q.contents[e.selectedIndex],o=n?n.offsetHeight:0,r=q.wrapper.offsetHeight,a=o+r,i=t.prop("clientHeight");i!==a&&(B=!0,d.animate(t,{height:i+"px"},{height:a+"px"}).then(function(){t.css("height",""),B=!1}))}function k(){if(!F.tabs.length)return U.push(k);if(!t.prop("offsetParent"))return C();var n=e.selectedIndex,o=q.paging.offsetWidth,r=q.tabs[n],a=r.offsetLeft,i=o-a-r.offsetWidth;y(),angular.element(q.inkBar).css({left:a+"px",right:i+"px"})}function y(){var t=e.selectedIndex,n=F.lastSelectedIndex,o=angular.element(q.inkBar);o.removeClass("md-left md-right"),angular.isNumber(n)&&(n>t?o.addClass("md-left"):t>n&&o.addClass("md-right"))}function x(e){var t,n,o=Math.max(F.tabs.length-e,e);for(t=0;o>=t;t++){if(n=F.tabs[e+t],n&&n.scope.disabled!==!0)return n.getIndex();if(n=F.tabs[e-t],n&&n.scope.disabled!==!0)return n.getIndex()}return e}function N(){switch(e.stretchTabs){case"always":return!0;case"never":return!1;default:return!H()&&n.matchMedia("(max-width: 600px)").matches}}function _(){return e.centerTabs&&!H()}function H(){if(e.noPagination)return!1;var n=t.prop("clientWidth");return angular.forEach(q.tabs,function(e){n-=e.offsetWidth}),0>n}function S(t){B||(F.focusIndex=e.selectedIndex=t),F.lastClick=!0}function I(e){H()&&(e.preventDefault(),F.offsetLeft=D(F.offsetLeft-e.wheelDelta))}function D(e){if(!q.tabs.length||!H())return 0;var t=q.tabs[q.tabs.length-1],n=t.offsetLeft+t.offsetWidth;return e=Math.max(0,e),e=Math.min(n-q.canvas.clientWidth,e)}function O(){var e,t,n=q.canvas.clientWidth,o=n+F.offsetLeft;for(e=0;e<q.tabs.length&&(t=q.tabs[e],!(t.offsetLeft+t.offsetWidth>o));e++);F.offsetLeft=D(t.offsetLeft)}function R(){var e,t;for(e=0;e<q.tabs.length&&(t=q.tabs[e],!(t.offsetLeft+t.offsetWidth>=F.offsetLeft));e++);F.offsetLeft=D(t.offsetLeft+t.offsetWidth-q.canvas.clientWidth)}function L(){return F.offsetLeft>0}function P(){var e=q.tabs[q.tabs.length-1];return e&&e.offsetLeft+e.offsetWidth>q.canvas.clientWidth+F.offsetLeft}function j(e,t){var n={colorElement:angular.element(q.inkBar)};a.attachTabBehavior(e,t,n)}var F=this,B=!1,q=m(),U=[];F.scope=e,F.parent=e.$parent,F.tabs=[],F.lastSelectedIndex=null,F.focusIndex=0,F.offsetLeft=0,F.hasContent=!1,F.hasFocus=!1,F.lastClick=!1,F.redirectFocus=h,F.attachRipple=j,F.shouldStretchTabs=N,F.shouldPaginate=H,F.shouldCenterTabs=_,F.insertTab=v,F.removeTab=$,F.select=S,F.scroll=I,F.nextPage=O,F.previousPage=R,F.keydown=s,F.canPageForward=P,F.canPageBack=L,F.refreshIndex=A,F.incrementSelectedIndex=u,F.updateInkBarStyles=k,c()}angular.module("material.components.tabs").controller("MdTabsController",e),e.$inject=["$scope","$element","$window","$timeout","$mdConstant","$mdInkRipple","$mdUtil","$animate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e3f1a5

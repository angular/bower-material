 ...
 * v0.7.0-rc1-master-60fcd6f
 */
function(){function e(e,t){function n(){return[].concat(v)}function r(){return v.length}function o(e){return v.length&&e>-1&&e<v.length}function a(e){return e?o(u(e)+1):!1}function i(e){return e?o(u(e)-1):!1}function c(e){return o(e)?v[e]:null}function d(e,t){return v.filter(function(n){return n[e]===t})}function l(e,t){return e?(angular.isNumber(t)||(t=v.length),v.splice(t,0,e),u(e)):-1}function m(e){s(e)&&v.splice(u(e),1)}function u(e){return v.indexOf(e)}function s(e){return e&&u(e)>-1}function p(e,n,r){n=n||E;var a=u(e)+1,i=o(a)?v[a]:t?h():null;return i=b(i,r)?null:i,!i||n(i)?i:p(i,n,r||a)}function f(e,n,r){n=n||E;var a=u(e)-1,i=o(a)?v[a]:t?g():null;return i=b(i,r)?null:i,!i||n(i)?i:f(i,n,r||a)}function h(){return v.length?v[0]:null}function g(){return v.length?v[v.length-1]:null}function b(e,t){return t&&e&&u(e)==t}var E=function(){return!0};t=!!t;var v=e||[];return{items:n,count:r,inRange:o,contains:s,indexOf:u,itemAt:c,findBy:d,add:l,remove:m,first:h,last:g,next:p,previous:f,hasPrevious:i,hasNext:a}}angular.module("material.core").config(["$provide",function(t){t.decorator("$mdUtil",["$delegate",function(t){return t.iterator=e,t}])}])}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc1-master-60fcd6f
 ...
 * v0.7.0-rc1-master-60fcd6f
 */
function(){"use strict";var e=["0","0","0"];angular.module("material.core").factory("$mdUtil",["$cacheFactory","$document",function(t,n){function r(e,t){function r(){r.called||(r.called=!0,t.off(f,o),n.off(h,i).off(g,c),u=p=!1)}function o(e){var n=e.type.charAt(0),r=a.now();s&&s.pointerType!==n&&r-s.endTime<400||p||(p=!0,u={pointerType:n,startX:l(e),startTime:r},t.one("$md.dragstart",function(e){e.defaultPrevented&&(u=null)}),t.triggerHandler("$md.dragstart",u))}function i(e){u&&m(e,u)&&(("t"===u.pointerType||"p"===u.pointerType)&&e.preventDefault(),d(e),t.triggerHandler("$md.drag",u))}function c(e){p=!1,u&&m(e,u)&&(u.endTime=a.now(),d(e),t.triggerHandler("$md.dragend",u),s=u,u=null)}function d(e){var t=l(e);u.distance=u.startX-t,u.direction=u.distance>0?"left":u.distance<0?"right":"",u.duration=u.startTime-a.now(),u.velocity=Math.abs(u.duration)/u.time}function l(e){e=e.originalEvent||e;var t=e.touches&&e.touches[0]||e.changedTouches&&e.changedTouches[0]||e;return t.pageX}function m(e,t){return t&&e&&(e.type||"").charAt(0)===t.pointerType}var u,s,p,f="mousedown touchstart pointerdown",h="mousemove touchmove pointermove",g="mouseup mouseleave touchend touchcancel pointerup pointercancel";return t.on(f,o),n.on(h,i).on(g,c),e.$on("$destroy",r),r}function o(e,n){var r=t(e,n),o={};return r._put=r.put,r.put=function(e,t){return o[e]=!0,r._put(e,t)},r._remove=r.remove,r.remove=function(e){return delete o[e],r._remove(e)},r._removeAll=r.removeAll,r.removeAll=function(){return o={},r._removeAll()},r._destroy=r.destroy,r.destroy=function(){return o={},r._destroy()},r.keys=function(){return Object.keys(o)},r}var a;return a={now:window.performance?angular.bind(window.performance,window.performance.now):Date.now,attachDragBehavior:r,elementRect:function(e,t){var n=e[0];t=t||n.offsetParent||document.body,t=t[0]||t;var r=n.getBoundingClientRect(),o=t.getBoundingClientRect();return{left:r.left-o.left+t.scrollLeft,top:r.top-o.top+t.scrollTop,width:r.width,height:r.height}},fakeNgModel:function(){return{$setViewValue:function(e){this.$viewValue=e,this.$render(e),this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[],$render:angular.noop}},cacheFactory:o,debounce:function(e,t,n){var r;return function(){var o=this,a=arguments;clearTimeout(r),r=setTimeout(function(){r=null,n||e.apply(o,a)},t),n&&!r&&e.apply(o,a)}},throttle:function(e,t){var n;return function(){var r=this,o=arguments,i=a.now();(!n||n-i>t)&&(e.apply(r,o),n=i)}},nextUid:function(){for(var t,n=e.length;n;){if(n--,t=e[n].charCodeAt(0),57==t)return e[n]="A",e.join("");if(90!=t)return e[n]=String.fromCharCode(t+1),e.join("");e[n]="0"}return e.unshift("0"),e.join("")},disconnectScope:function(e){if(e&&e.$root!==e&&!e.$$destroyed){var t=e.$parent;e.$$disconnected=!0,t.$$childHead===e&&(t.$$childHead=e.$$nextSibling),t.$$childTail===e&&(t.$$childTail=e.$$prevSibling),e.$$prevSibling&&(e.$$prevSibling.$$nextSibling=e.$$nextSibling),e.$$nextSibling&&(e.$$nextSibling.$$prevSibling=e.$$prevSibling),e.$$nextSibling=e.$$prevSibling=null}},reconnectScope:function(e){if(e&&e.$root!==e&&e.$$disconnected){var t=e,n=t.$parent;t.$$disconnected=!1,t.$$prevSibling=n.$$childTail,n.$$childHead?(n.$$childTail.$$nextSibling=t,n.$$childTail=t):n.$$childHead=n.$$childTail=t}},getClosest:function(e,t){t=t.toUpperCase();do if(e.nodeName===t)return e;while(e=e.parentNode);return null}}}]),angular.element.prototype.focus=angular.element.prototype.focus||function(){return this.length&&this[0].focus(),this},angular.element.prototype.blur=angular.element.prototype.blur||function(){return this.length&&this[0].blur(),this}}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc1-master-60fcd6f
 ...
 * v0.7.0-rc1-master-60fcd6f
 */
function(){function e(e){function t(t,n){e(n)}function n(e,t){var n=this;n.setFocused=function(e){t.toggleClass("md-input-focused",!!e)},n.setHasValue=function(e){t.toggleClass("md-input-has-value",!!e)},e.$watch(function(){return n.label&&n.input},function(e){e&&!n.label.attr("for")&&n.label.attr("for",n.input.attr("id"))})}return n.$inject=["$scope","$element","$mdUtil"],{restrict:"E",link:t,controller:n}}function t(){return{restrict:"E",require:"^?mdInputContainer",link:function(e,t,n,r){r&&(r.label=t,e.$on("$destroy",function(){r.label=null}))}}}function n(e){function t(e){return e.addClass("md-input"),n}function n(t,n,r,o){function a(e){return i.setHasValue(!c.$isEmpty(e)),e}var i=o[0],c=o[1];if(i){if(i.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");n.attr("id")||n.attr("id","input_"+e.nextUid()),i.input=n,c?(c.$formatters.push(a),c.$parsers.push(a)):(n.on("input",function(){i.setHasValue((""+n.val()).length>0)}),i.setHasValue((""+n.val()).length>0)),n.on("focus",function(){i.setFocused(!0)}).on("blur",function(){i.setFocused(!1)}),t.$on("$destroy",function(){i.setFocused(!1),i.setHasValue(!1),i.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel"],compile:t}}angular.module("material.components.input",["material.core"]).directive("mdInputContainer",e).directive("label",t).directive("input",n).directive("textarea",n),e.$inject=["$mdTheming"],n.$inject=["$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc1-master-60fcd6f
 ...
 * v0.7.0-rc1-master-60fcd6f
 */
function(){"use strict";function e(e,t,n,r,o,a,i,c){function d(){return f(e.$parent)}function l(t,n){p.content.length&&(p.contentContainer.append(p.content),p.contentScope=e.$parent.$new(),t.append(p.contentContainer),r(p.contentContainer)(p.contentScope),n===!0&&c(function(){a.disconnectScope(p.contentScope)},0,!1))}function m(){p.hammertime.destroy(),o.leave(p.contentContainer).then(function(){p.contentScope&&p.contentScope.$destroy(),p.contentScope=null})}function u(){a.reconnectScope(p.contentScope),p.hammertime.on("swipeleft swiperight",e.onSwipe),t.addClass("active"),t.attr("aria-selected",!0),t.attr("tabIndex",0),o.removeClass(p.contentContainer,"ng-hide"),e.onSelect()}function s(){a.disconnectScope(p.contentScope),p.hammertime.off("swipeleft swiperight",e.onSwipe),t.removeClass("active"),t.attr("aria-selected",!1),t.attr("tabIndex",-1),o.addClass(p.contentContainer,"ng-hide"),e.onDeselect()}var p=this;p.contentContainer=angular.element('<div class="md-tab-content ng-hide">'),p.hammertime=new Hammer(p.contentContainer[0]),p.element=t,p.isDisabled=d,p.onAdd=l,p.onRemove=m,p.onSelect=u,p.onDeselect=s;var f=i(n.ngDisabled)}angular.module("material.components.tabs").controller("$mdTab",e),e.$inject=["$scope","$element","$attrs","$compile","$animate","$mdUtil","$parse","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc1-master-60fcd6f

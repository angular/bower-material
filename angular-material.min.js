 ...
 * v0.9.0-rc1-master-aff50d5
 */
function(){"use strict";function e(e,t,n,r,o,a,i){function d(t,d){return d.type="checkbox",d.tabindex=d.tabindex||"0",t.attr("role",d.type),function(t,d,l,m){function s(e,n,r){l[e]&&t.$watch(l[e],function(e){r[e]&&d.attr(n,r[e])})}function u(e){var t=e.which||e.keyCode;(t===r.KEY_CODE.SPACE||t===r.KEY_CODE.ENTER)&&(e.preventDefault(),d.hasClass("md-focused")||d.addClass("md-focused"),f(e))}function f(e){d[0].hasAttribute("disabled")||t.$apply(function(){var t=l.ngChecked?l.checked:!m.$viewValue;m.$setViewValue(t,e&&e.type),m.$render()})}function p(){m.$viewValue?d.addClass(c):d.removeClass(c)}m=m||a.fakeNgModel(),o(d),l.ngChecked&&t.$watch(t.$eval.bind(t,l.ngChecked),m.$setViewValue.bind(m)),s("ngDisabled","tabindex",{"true":"-1","false":l.tabindex}),n.expectWithText(d,"aria-label"),e.link.pre(t,{on:angular.noop,0:{}},l,[m]),t.mouseActive=!1,d.on("click",f).on("keypress",u).on("mousedown",function(){t.mouseActive=!0,i(function(){t.mouseActive=!1},100)}).on("focus",function(){t.mouseActive===!1&&d.addClass("md-focused")}).on("blur",function(){d.removeClass("md-focused")}),m.$render=p}}e=e[0];var c="md-checked";return{restrict:"E",transclude:!0,require:"?ngModel",template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:d}}angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",e),e.$inject=["inputDirective","$mdInkRipple","$mdAria","$mdConstant","$mdTheming","$mdUtil","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-aff50d5
 */
function(){"use strict";function e(){return{restrict:"E"}}function t(e){function t(e,t,o,a,i,d,c,l,m){function s(n,r,m){r=o.extractElementByName(r,"md-bottom-sheet"),p=i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n),p.on("click",function(){a(c.cancel)}),d.inherit(p,m.parent),e.enter(p,m.parent,null);var s=new f(r,m.parent);return m.bottomSheet=s,m.targetEvent&&angular.element(m.targetEvent.target).blur(),d.inherit(s.element,m.parent),m.disableParentScroll&&(m.lastOverflow=m.parent.css("overflow"),m.parent.css("overflow","hidden")),e.enter(s.element,m.parent).then(function(){var e=angular.element(r[0].querySelector("button")||r[0].querySelector("a")||r[0].querySelector("[ng-click]"));e.focus(),m.escapeToClose&&(m.rootElementKeyupCallback=function(e){e.keyCode===t.KEY_CODE.ESCAPE&&a(c.cancel)},l.on("keyup",m.rootElementKeyupCallback))})}function u(t,n,r){var o=r.bottomSheet;return e.leave(p),e.leave(o.element).then(function(){r.disableParentScroll&&(r.parent.css("overflow",r.lastOverflow),delete r.lastOverflow),o.cleanup(),r.targetEvent&&angular.element(r.targetEvent.target).focus()})}function f(e,o){function i(n){e.css(t.CSS.TRANSITION_DURATION,"0ms")}function d(n){var o=n.pointer.distanceY;5>o&&(o=Math.max(-r,o/2)),e.css(t.CSS.TRANSFORM,"translate3d(0,"+(r+o)+"px,0)")}function l(r){if(r.pointer.distanceY>0&&(r.pointer.distanceY>20||Math.abs(r.pointer.velocityY)>n)){var o=e.prop("offsetHeight")-r.pointer.distanceY,i=Math.min(o/r.pointer.velocityY*.75,500);e.css(t.CSS.TRANSITION_DURATION,i+"ms"),a(c.cancel)}else e.css(t.CSS.TRANSITION_DURATION,""),e.css(t.CSS.TRANSFORM,"")}var s=m.register(o,"drag",{horizontal:!1});return o.on("$md.dragstart",i).on("$md.drag",d).on("$md.dragend",l),{element:e,cleanup:function(){s(),o.off("$md.dragstart",i).off("$md.drag",d).off("$md.dragend",l)}}}var p;return{themable:!0,targetEvent:null,onShow:s,onRemove:u,escapeToClose:!0,disableParentScroll:!0}}var n=.5,r=80;return t.$inject=["$animate","$mdConstant","$mdUtil","$timeout","$compile","$mdTheming","$mdBottomSheet","$rootElement","$mdGesture"],e("$mdBottomSheet").setDefaults({methods:["disableParentScroll","escapeToClose","targetEvent"],options:t})}angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",e).provider("$mdBottomSheet",t),t.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-aff50d5
 */
function(){"use strict";function e(e){return{restrict:"E",link:function(t,n,r){e(n)}}}angular.module("material.components.card",["material.core"]).directive("mdCard",e),e.$inject=["$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-aff50d5
 ...
 * v0.9.0-rc1-master-aff50d5
 */
function(){"use strict";function e(){function e(e,t,n,r){function o(){function e(){return n.label}function r(){var e=t.find("md-tab-label");return e.length?e.remove().html():void 0}function o(){var e=t.html();return t.empty(),e}n.label||(t.find("md-tab-label")[0]||t[0]).innerHTML;return e()||r()||o()}function a(){var e=t.find("md-tab-body"),r=e.length?e.html():n.label?t.html():null;return e.length?e.remove():n.label&&t.empty(),r}var i=t.parent()[0].getElementsByTagName("md-tab"),d=Array.prototype.indexOf.call(i,t[0]),c=r.insertTab({scope:e,parent:e.$parent,index:d,template:a(),label:o()},d);e.deselect=e.deselect||angular.noop,e.select=e.select||angular.noop,e.$watch("active",function(e){e&&r.select(c.getIndex())}),e.$watch("disabled",function(){r.refreshIndex()}),e.$on("$destroy",function(){r.removeTab(c)})}return{require:"^mdTabs",terminal:!0,scope:{label:"@",active:"=?mdActive",disabled:"=?ngDisabled",select:"&?mdOnSelect",deselect:"&?mdOnDeselect"},link:e}}angular.module("material.components.tabs").directive("mdTab",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-aff50d5

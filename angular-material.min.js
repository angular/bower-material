 ...
 * v0.8.3-master-859ecb5
 */
function(){"use strict";function e(e,t,n,r,o,a,i,d){function c(){e.$watch("selectedIndex",$),e.$watch("$mdTabsCtrl.focusIndex",p),e.$watch("$mdTabsCtrl.offsetLeft",u),angular.element(n).on("resize",function(){e.$apply(g)}),r(T,0,!1),r(A,0,!1)}function l(){var e={};return e.wrapper=t[0].getElementsByTagName("md-tabs-wrapper")[0],e.canvas=e.wrapper.getElementsByTagName("md-tabs-canvas")[0],e.paging=e.canvas.getElementsByTagName("md-pagination-wrapper")[0],e.tabs=e.paging.getElementsByTagName("md-tab-item"),e.dummies=e.canvas.getElementsByTagName("md-dummy-tab"),e.inkBar=e.paging.getElementsByTagName("md-ink-bar")[0],e.contentsWrapper=t[0].getElementsByTagName("md-tabs-content-wrapper")[0],e.contents=e.contentsWrapper.getElementsByTagName("md-tab-content"),e}function m(t){switch(t.keyCode){case o.KEY_CODE.LEFT_ARROW:t.preventDefault(),s(-1,!0);break;case o.KEY_CODE.RIGHT_ARROW:t.preventDefault(),s(1,!0);break;case o.KEY_CODE.SPACE:case o.KEY_CODE.ENTER:t.preventDefault(),e.selectedIndex=L.focusIndex}L.lastClick=!1}function s(t,n){var r,o=n?L.focusIndex:e.selectedIndex;for(r=o+t;L.tabs[r]&&L.tabs[r].scope.disabled;r+=t);L.tabs[r]&&(n?L.focusIndex=r:e.selectedIndex=r)}function u(t){var n=k()?"":"-"+t+"px";angular.element(P.paging).css("left",n),e.$broadcast("$mdTabsPaginationChanged")}function p(e,t){e!==t&&P.tabs[e]&&(h(),f())}function f(){P.dummies[L.focusIndex].focus()}function h(){if(!k()){var e=P.tabs[L.focusIndex],t=e.offsetLeft,n=e.offsetWidth+t;L.offsetLeft=Math.max(L.offsetLeft,H(n-P.canvas.clientWidth)),L.offsetLeft=Math.min(L.offsetLeft,H(t))}}function g(){L.lastSelectedIndex=e.selectedIndex,T(),L.offsetLeft=H(L.offsetLeft)}function b(n,r){var o={getIndex:function(){return L.tabs.indexOf(a)},isActive:function(){return this.getIndex()===e.selectedIndex},isLeft:function(){return this.getIndex()<e.selectedIndex},isRight:function(){return this.getIndex()>e.selectedIndex},hasFocus:function(){return!L.lastClick&&L.hasFocus&&this.getIndex()===L.focusIndex},id:i.nextUid()},a=angular.extend(o,n);return n.template||(L.hasContent=!1,t.addClass("md-no-tab-content")),angular.isDefined(r)?L.tabs.splice(r,0,a):L.tabs.push(a),a}function E(e){L.tabs.splice(e.getIndex(),1),v(),r(function(){T(),L.offsetLeft=H(L.offsetLeft)})}function v(){e.selectedIndex=w(e.selectedIndex),L.focusIndex=w(L.focusIndex)}function $(t,n){t!==n&&(e.selectedIndex=w(t),L.lastSelectedIndex=n,T(),A(),e.$broadcast("$mdTabsChanged"),L.tabs[n]&&L.tabs[n].scope.deselect(),L.tabs[t]&&L.tabs[t].scope.select())}function M(){M.watcher||(M.watcher=e.$watch(function(){r(function(){M.watcher&&t.prop("offsetParent")&&(M.watcher(),M.watcher=null,e.$apply(g))},0,!1)}))}function A(){if(!e.dynamicHeight)return t.css("height","");var n=P.contents[e.selectedIndex],o=n.offsetHeight,a=P.wrapper.offsetHeight,i=o+a,c=t.prop("clientHeight");c!==i&&(console.log("animateing from "+c+" to "+i),d.animate(t,{height:c+"px"},{height:i+"px"}).then(function(){r(function(){t.css("height","")},0,!1)}))}function T(){if(L.tabs.length){if(!t.prop("offsetParent"))return M();var n=e.selectedIndex,r=P.paging.offsetWidth,o=P.tabs[n],a=o.offsetLeft,i=r-a-o.offsetWidth;C(),angular.element(P.inkBar).css({left:a+"px",right:i+"px"})}}function C(){var t=e.selectedIndex,n=L.lastSelectedIndex,r=angular.element(P.inkBar);r.removeClass("md-left md-right"),angular.isNumber(n)&&(n>t?r.addClass("md-left"):t>n&&r.addClass("md-right"))}function w(e){var t,n,r=Math.max(L.tabs.length-e,e);for(t=0;r>=t;t++){if(n=L.tabs[e+t],n&&n.scope.disabled!==!0)return n.getIndex();if(n=L.tabs[e-t],n&&n.scope.disabled!==!0)return n.getIndex()}return e}function y(){switch(e.stretchTabs){case"always":return!0;case"never":return!1;default:return!x()&&n.matchMedia("(max-width: 600px)").matches}}function k(){return e.centerTabs&&!x()}function x(){if(e.noPagination)return!1;var n=t.prop("clientWidth");return angular.forEach(P.tabs,function(e){n-=e.offsetWidth}),0>n}function N(t){L.focusIndex=e.selectedIndex=t,L.lastClick=!0}function _(e){x()&&(e.preventDefault(),L.offsetLeft=H(L.offsetLeft-e.wheelDelta))}function H(e){if(P.tabs.length){var t=P.tabs[P.tabs.length-1],n=t.offsetLeft+t.offsetWidth;return e=Math.max(0,e),e=Math.min(n-P.canvas.clientWidth,e)}}function S(){var e,t,n=P.canvas.clientWidth,r=n+L.offsetLeft;for(e=0;e<P.tabs.length&&(t=P.tabs[e],!(t.offsetLeft+t.offsetWidth>r));e++);L.offsetLeft=H(t.offsetLeft)}function I(){var e,t;for(e=0;e<P.tabs.length&&(t=P.tabs[e],!(t.offsetLeft+t.offsetWidth>=L.offsetLeft));e++);L.offsetLeft=H(t.offsetLeft+t.offsetWidth-P.canvas.clientWidth)}function D(){return L.offsetLeft>0}function O(){var e=P.tabs[P.tabs.length-1];return e&&e.offsetLeft+e.offsetWidth>P.canvas.clientWidth+L.offsetLeft}function R(e,t){var n={colorElement:angular.element(P.inkBar)};a.attachTabBehavior(e,t,n)}var L=this,P=l();L.scope=e,L.parent=e.$parent,L.tabs=[],L.lastSelectedIndex=null,L.focusIndex=0,L.offsetLeft=0,L.hasContent=!0,L.hasFocus=!1,L.lastClick=!1,L.redirectFocus=f,L.attachRipple=R,L.shouldStretchTabs=y,L.shouldPaginate=x,L.shouldCenterTabs=k,L.insertTab=b,L.removeTab=E,L.select=N,L.scroll=_,L.nextPage=S,L.previousPage=I,L.keydown=m,L.canPageForward=O,L.canPageBack=D,L.refreshIndex=v,L.incrementSelectedIndex=s,L.updateInkBarStyles=T,c()}angular.module("material.components.tabs").controller("MdTabsController",e),e.$inject=["$scope","$element","$window","$timeout","$mdConstant","$mdInkRipple","$mdUtil","$animate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-859ecb5

 ...
 * v0.7.0-master-572da37
 */
function(){"use strict";function e(e,t,n,r,o,a,i,d){function c(c,l,m,s){function u(){E(),A(),b()}function f(e){K=parseFloat(e),l.attr("aria-valuemin",e),u()}function p(e){X=parseFloat(e),l.attr("aria-valuemax",e),u()}function h(e){z=parseFloat(e),b()}function g(e){l.attr("aria-disabled",!!e)}function b(){if(angular.isDefined(m.mdDiscrete)){var e=Math.floor((X-K)/z);if(!Z){var n=t.getComputedStyle(U[0]);Z=angular.element('<canvas style="position:absolute;">'),J=Z[0].getContext("2d"),J.fillStyle=n.backgroundColor||"black",U.append(Z)}var r=v();Z[0].width=r.width,Z[0].height=r.height;for(var o,a=0;e>=a;a++)o=Math.floor(r.width*(a/e)),J.fillRect(o-1,0,2,r.height)}}function E(){Q=B[0].getBoundingClientRect()}function v(){return Y(),Q}function $(e){if(!l[0].hasAttribute("disabled")){var t;e.keyCode===o.KEY_CODE.LEFT_ARROW?t=-z:e.keyCode===o.KEY_CODE.RIGHT_ARROW&&(t=z),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),c.$evalAsync(function(){M(s.$viewValue+t)}))}}function M(e){s.$setViewValue(T(k(e)))}function A(){isNaN(s.$viewValue)&&(s.$viewValue=s.$modelValue);var e=(s.$viewValue-K)/(X-K);c.modelValue=s.$viewValue,l.attr("aria-valuenow",s.$viewValue),w(e),L.text(s.$viewValue)}function T(e){return angular.isNumber(e)?Math.max(K,Math.min(X,e)):void 0}function k(e){return angular.isNumber(e)?Math.round(e/z)*z:void 0}function w(e){V.css("width",100*e+"%"),q.css(o.CSS.TRANSFORM,"translate3d("+100*e+"%,0,0)"),l.toggleClass("md-min",0===e)}function y(e){if(!P()){l.addClass("active"),l[0].focus(),E();var t=R(O(e.pointer.x)),n=T(k(t));c.$apply(function(){M(n),w(I(n))})}}function C(e){if(!P()){l.removeClass("dragging active");var t=R(O(e.pointer.x)),n=T(k(t));c.$apply(function(){M(n)})}}function N(e){P()||(et=!0,e.stopPropagation(),l.addClass("dragging"),H(e))}function x(e){et&&(e.stopPropagation(),H(e))}function _(e){et&&(e.stopPropagation(),et=!1)}function H(e){tt?D(e.pointer.x):S(e.pointer.x)}function S(e){c.$evalAsync(function(){M(R(O(e)))})}function D(e){var t=R(O(e)),n=T(k(t));w(O(e)),L.text(n)}function O(e){return Math.max(0,Math.min(1,(e-Q.left)/Q.width))}function R(e){return K+e*(X-K)}function I(e){return(e-K)/(X-K)}a(l),s=s||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var j=m.ngDisabled&&d(m.ngDisabled),P=j?function(){return j(c.$parent)}:angular.noop,F=angular.element(l[0].querySelector(".md-thumb")),L=angular.element(l[0].querySelector(".md-thumb-text")),q=F.parent(),B=angular.element(l[0].querySelector(".md-track-container")),V=angular.element(l[0].querySelector(".md-track-fill")),U=angular.element(l[0].querySelector(".md-track-ticks")),Y=r.throttle(E,5e3);m.min?m.$observe("min",f):f(0),m.max?m.$observe("max",p):p(100),m.step?m.$observe("step",h):h(1);var G=angular.noop;m.ngDisabled&&(G=c.$parent.$watch(m.ngDisabled,g)),n.expect(l,"aria-label"),i.register(l,"drag"),l.attr({tabIndex:0,role:"slider"}).on("keydown",$).on("$md.pressdown",y).on("$md.pressup",C).on("$md.dragstart",N).on("$md.drag",x).on("$md.dragend",_),setTimeout(u);var W=e.throttle(u);angular.element(t).on("resize",W),c.$on("$destroy",function(){angular.element(t).off("resize",W),G()}),s.$render=A,s.$viewChangeListeners.push(A),s.$formatters.push(T),s.$formatters.push(k);var K,X,z,Z,J,Q={};E();var et=!1,tt=angular.isDefined(m.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-track-container"><div class="md-track"></div><div class="md-track md-track-fill"></div><div class="md-track-ticks"></div></div><div class="md-thumb-container"><div class="md-thumb"></div><div class="md-focus-thumb"></div><div class="md-focus-ring"></div><div class="md-sign"><span class="md-thumb-text"></span></div><div class="md-disabled-thumb"></div></div>',link:c}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-master-572da37

 ...
 * v0.8.3-master-06d3856
 */
function(){"use strict";function e(e,o,a,i,d,c,l){function s(){p(),d(function(){h(),f(),u()})}function m(){if(!q)return d(m,0,!1);var e=q.wrap.getBoundingClientRect(),t=q.root.getBoundingClientRect(),o=e.bottom-t.top,a=t.height-e.top,i=e.left-t.left,c=e.width,l={left:i+"px",width:c+"px"};o>a&&t.height-e.bottom-r<n?(l.top="auto",l.bottom=a+"px",l.maxHeight=Math.min(n,e.top-t.top-r)+"px"):(l.top=o+"px",l.bottom="auto",l.maxHeight=Math.min(n,t.height-e.bottom-r)+"px"),q.$.ul.css(l)}function u(){q.$.root.length&&(c(q.$.ul),q.$.ul.detach(),q.$.root.append(q.$.ul))}function f(){e.autofocus&&q.input.focus()}function p(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(M,t):M),v(b),e.$watch("selectedItem",E),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){e&&!t&&m()}),angular.element(l).on("resize",m)}function h(){q={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:document.body},q.$=g(q)}function g(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function b(t,n){t&&(e.searchText=y(t)),e.itemChange&&t!==n&&e.itemChange(k(t))}function E(e,t){for(var n=0;n<Y.length;++n)Y[n](e,t)}function v(e){-1==Y.indexOf(e)&&Y.push(e)}function $(e){var t=Y.indexOf(e);-1!=t&&Y.splice(t,1)}function M(t,n){j.index=x(),(t||t!==n)&&t!==y(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(k(e.selectedItem)),H()?P():(j.loading=!1,j.matches=[],j.hidden=N(),O()))}function A(){K||(j.hidden=!0)}function T(){return angular.isString(e.searchText)?(j.hidden=N(),j.hidden||P(),void 0):e.searchText=""}function w(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(j.loading)return;e.preventDefault(),j.index=Math.min(j.index+1,j.matches.length-1),L(),R();break;case i.KEY_CODE.UP_ARROW:if(j.loading)return;e.preventDefault(),j.index=j.index<0?j.matches.length-1:Math.max(0,j.index-1),L(),R();break;case i.KEY_CODE.ENTER:if(j.hidden||j.loading||j.index<0)return;e.preventDefault(),S(j.index);break;case i.KEY_CODE.ESCAPE:j.matches=[],j.hidden=!0,j.index=x();break;case i.KEY_CODE.TAB:}}function C(){return angular.isNumber(e.minLength)?e.minLength:1}function y(t){return t&&e.itemText?e.itemText(k(t)):t}function k(e){if(e){var t={};return j.itemName&&(t[j.itemName]=e),t}}function x(){return e.autoselect?0:-1}function N(){return H()?1===j.matches.length&&e.searchText===y(j.matches[0])&&e.selectedItem===j.matches[0]:!0}function _(){return y(j.matches[j.index])}function H(){return e.searchText.length>=C()}function S(t){e.selectedItem=j.matches[t],e.searchText=y(e.selectedItem)||e.searchText,j.hidden=!0,j.index=0,j.matches=[]}function I(){e.searchText="",S(-1),q.input.focus()}function D(t){function n(n){V[o]=n,t===e.searchText&&(U=null,j.loading=!1,j.matches=n,j.hidden=N(),O(),m())}var r=e.$parent.$eval(F),o=t.toLowerCase();angular.isArray(r)?n(r):(j.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){j.loading=!1}))}function O(){if(!j.hidden)switch(j.matches.length){case 0:return j.messages.splice(0);case 1:return j.messages.push({display:"There is 1 match available."});default:return j.messages.push({display:"There are "+j.matches.length+" matches available."})}}function R(){j.messages.push({display:_()})}function L(){var e=t*j.index,n=e+t,r=q.ul.clientHeight;e<q.ul.scrollTop?q.ul.scrollTop=e:n>q.ul.scrollTop+r&&(q.ul.scrollTop=n-r)}function P(){var t=e.searchText,n=t.toLowerCase();U&&U.cancel&&(U.cancel(),U=null),!e.noCache&&V[n]?(j.matches=V[n],O()):D(t),j.hidden=N()}var j=this,B=e.itemsExpr.split(/ in /i),F=B[1],q=null,U=null,V={},K=!1,Y=[];return j.scope=e,j.parent=e.$parent,j.itemName=B[0],j.matches=[],j.loading=!1,j.hidden=!0,j.index=null,j.messages=[],j.id=a.nextUid(),j.keydown=w,j.blur=A,j.focus=T,j.clear=I,j.select=S,j.fetch=a.debounce(D),j.getCurrentDisplayValue=_,j.registerSelectedItemWatcher=v,j.unregisterSelectedItemWatcher=$,j.listEnter=function(){K=!0},j.listLeave=function(){K=!1},j.mouseUp=function(){q.input.focus()},s()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=16;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-06d3856
 ...
 * v0.8.3-master-06d3856
 */
function(){"use strict";function e(e){function n(n){return n.append(t),function(t,n){n.addClass("md-chip"),e(n)}}return{restrict:"E",requires:"^mdChips",compile:n}}angular.module("material.components.chips").directive("mdChip",e);var t='      <span ng-if="!$mdChipsCtrl.readonly" class="visually-hidden">        {{$mdChipsCtrl.deleteHint}}      </span>';e.$inject=["$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-06d3856
 */
function(){"use strict";function e(e){function t(t,n,r,o){n.on("click",function(){t.$apply(function(){o.removeChip(t.$index)})}),e(function(){n.find("button").attr("tabindex","-1")})}return{restrict:"A",require:"^mdChips",scope:!1,link:t}}angular.module("material.components.chips").directive("mdChipRemove",e),e.$inject=["$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-06d3856
 */
function(){"use strict";function e(e,t,n,r,o){this.$mdConstant=n,this.$scope=e,this.$log=r,this.$element=o,this.ngModelCtrl=null,this.mdAutocompleteCtrl=null,this.userInputNgModelCtrl=null,this.userInputElement=null,this.items=[],this.selectedChip=-1,this.deleteHint="Press delete to remove this chip.",this.deleteButtonLabel="Remove",this.chipBuffer="",this.useMdOnAppend=!1}angular.module("material.components.chips").controller("MdChipsCtrl",e),e.$inject=["$scope","$mdUtil","$mdConstant","$log","$element"],e.prototype.inputKeydown=function(e){switch(e.keyCode){case this.$mdConstant.KEY_CODE.ENTER:var t=this.getChipBuffer();t&&(e.preventDefault(),this.appendChip(t),this.resetChipBuffer());break;case this.$mdConstant.KEY_CODE.BACKSPACE:this.chipBuffer||(e.preventDefault(),this.items.length>0&&this.removeChip(this.items.length-1),e.target.focus())}},e.prototype.chipKeydown=function(e,t){switch(t.keyCode){case this.$mdConstant.KEY_CODE.BACKSPACE:case this.$mdConstant.KEY_CODE.DELETE:e>=0&&(t.preventDefault(),this.removeAndSelectAdjacentChip(e));break;case this.$mdConstant.KEY_CODE.LEFT_ARROW:this.selectChipSafe(this.selectedChip-1);break;case this.$mdConstant.KEY_CODE.RIGHT_ARROW:this.selectChipSafe(this.selectedChip+1)}},e.prototype.getPlaceholder=function(){var e=this.items.length&&(""==this.secondaryPlaceholder||this.secondaryPlaceholder);return e?this.placeholder:this.secondaryPlaceholder},e.prototype.removeAndSelectAdjacentChip=function(e){var t=this.getAdjacentChipIndex(e);this.removeChip(e),this.selectAndFocusChip(t)},e.prototype.resetSelectedChip=function(){this.selectedChip=-1},e.prototype.getAdjacentChipIndex=function(e){var t=this.items.length-1;return 0==t?-1:e==t?e-1:e},e.prototype.appendChip=function(e){this.useMdOnAppend&&this.mdOnAppend&&(e=this.mdOnAppend({$chip:e})),this.items.push(e)},e.prototype.useMdOnAppendExpression=function(){this.useMdOnAppend=!0},e.prototype.getChipBuffer=function(){if(this.mdAutocompleteCtrl)throw Error("getChipBuffer should not be called if there is an md-autocomplete");return this.userInputElement?this.userInputNgModelCtrl?this.userInputNgModelCtrl.$viewValue:this.userInputElement[0].value:this.chipBuffer},e.prototype.resetChipBuffer=function(){this.userInputElement?this.userInputNgModelCtrl?(this.userInputNgModelCtrl.$setViewValue(""),this.userInputNgModelCtrl.$render()):this.userInputElement[0].value="":this.chipBuffer=""},e.prototype.removeChip=function(e){this.items.splice(e,1)},e.prototype.selectChipSafe=function(e){return 0==this.items.length?(this.selectChip(-1),void 0):(0>e?e=0:e>this.items.length-1&&(e=this.items.length-1),this.selectChip(e),this.focusChip(e),void 0)},e.prototype.selectChip=function(e){e>=-1&&e<=this.items.length?this.selectedChip=e:this.$log.warn("Selected Chip index out of bounds; ignoring.")},e.prototype.selectAndFocusChip=function(e){this.selectChip(e),-1!=e&&this.focusChip(e)},e.prototype.focusChip=function(e){this.$element[0].querySelector('md-chip[index="'+e+'"] .md-chip-content').focus()},e.prototype.configureNgModel=function(e){this.ngModelCtrl=e;var t=this;e.$render=function(){t.items=t.ngModelCtrl.$viewValue}},e.prototype.configureMdAutocomplete=function(e){this.mdAutocompleteCtrl=e,this.mdAutocompleteCtrl.registerSelectedItemWatcher(this.mdAutocompleteSelectedItemWatcher.bind(this))},e.prototype.mdAutocompleteSelectedItemWatcher=function(e,t){e&&e!==t&&(this.appendChip(e),this.mdAutocompleteCtrl.clear())},e.prototype.configureUserInput=function(e){this.userInputElement=e,this.userInputNgModelCtrl=e.controller("ngModel");var t=this.$scope,n=this;e.on("keydown",function(e){t.$apply(function(){n.inputKeydown(e)})})}}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-06d3856
 */
function(){"use strict";function e(e,a,i,d){function c(t,a){var c=a.$mdUserTemplate;a.$mdUserTemplate=null;var s=!!a.ngModel,m=null,u=!1,f=c.find("md-chip");if(s){var p,h=c.find("md-chip-template"),g=o;if(0===h.length)p=r;else{var b=angular.element(h[0].querySelector("[md-chip-remove]"));b.length>0?(g=b[0].outerHTML,p=h[0].innerHTML.replace(g,"")):p=h[0].innerHTML}var E=angular.element(t[0].querySelector(".md-chip-content"));E.append(p);var v=t.find("md-chip");v.append(g);var $=c.find("md-autocomplete");$.length>0?(u=!0,m=$[0]):($=c.find("input"),$.length>0?m=$[0]:l(t).append(angular.element(n)))}return function(t,n,r,o){if(e(n),n.attr("tabindex","-1"),s){var a=o[0],c=n.controller("ngModel");if(a.configureNgModel(c),r.mdOnAppend&&a.useMdOnAppendExpression(),m){var p=i(m)(t.$parent);if(u){var h=p.controller("mdAutocomplete");a.configureMdAutocomplete(h)}else a.configureUserInput(angular.element(m));d(function(){var e=l(n);e.append(p)})}}if(f.length>0){var g=i(f)(t.$parent);d(function(){n.find("md-chips-wrap").prepend(g)})}}}function l(e){return angular.element(e[0].querySelector(".md-chip-input-container"))}return{template:function(e,n){return n.$mdUserTemplate=e.clone(),n.tabindex="-1",t},require:["mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:c,scope:{readonly:"=readonly",placeholder:"@",secondaryPlaceholder:"@",mdOnAppend:"&",deleteHint:"@",deleteButtonLabel:"@"}}}angular.module("material.components.chips").directive("mdChips",e);var t='      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0" class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{selected: $mdChipsCtrl.selectedChip == $index}">          <div class="md-chip-content"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              ng-keydown="$mdChipsCtrl.chipKeydown($index, $event)"></div>        </md-chip>        <div            ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"             class="md-chip-input-container"></div>      </md-chips-wrap>',n='        <input            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.resetSelectedChip()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',r="      <span>{{$chip}}</span>",o='      <md-button           class="md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChip($index)"          tabindex="-1">        <md-icon md-svg-icon="close"></md-icon>        <span class="visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </md-button>';e.$inject=["$mdTheming","$log","$compile","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-06d3856

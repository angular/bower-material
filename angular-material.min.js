 ...
 * v0.9.0-rc1-master-68395a2
 */
function(){"use strict";function e(e){return{restrict:"E",compile:function(t){return t[0].setAttribute("role","list"),e}}}function t(e){var t=["md-checkbox","md-switch"];return{restrict:"E",compile:function(n,r){function o(){for(var e,t,r=["md-switch","md-checkbox"],o=0;t=r[o];++o)if((e=n.find(t)[0])&&!e.hasAttribute("aria-label")){var a=n.find("p")[0];if(!a)return;e.setAttribute("aria-label","Toggle "+a.textContent)}}function a(t){var o;"div"==t?(o=angular.element('<div class="md-no-style md-list-item-inner">'),o.append(n.contents()),n.addClass("md-proxy-focus")):(o=angular.element('<button tabindex="0" class="md-no-style"><div class="md-list-item-inner"></div></button>'),o[0].setAttribute("ng-click",n[0].getAttribute("ng-click")),n[0].removeAttribute("ng-click"),o.children().eq(0).append(n.contents())),n[0].setAttribute("tabindex","-1"),n.append(o),m&&m.hasAttribute("ng-click")&&e.expect(m,"aria-label"),m&&(m.hasAttribute("ng-click")||r.ngClick&&i(m))&&(n.addClass("md-with-secondary"),n.append(m))}function i(e){return-1!=t.indexOf(e.nodeName.toLowerCase())}function d(e,n,r){function o(){n.children()[0].hasAttribute("ng-click")||angular.forEach(t,function(e){angular.forEach(n[0].firstElementChild.querySelectorAll(e),function(e){i.push(e)})})}function a(){(i.length||n[0].firstElementChild.hasAttribute("ng-click"))&&n.addClass("md-clickable")}var i=[];o(),a(),n.hasClass("md-proxy-focus")&&i.length&&angular.forEach(i,function(e){e=angular.element(e),e.on("focus",function(){n.addClass("md-focused"),e.on("blur",function t(){n.removeClass("md-focused"),e.off("blur",t)})})}),n[0].firstElementChild.hasAttribute("ng-click")||i.length||n[0].firstElementChild.addEventListener("keypress",function(e){(13==e.keyCode||32==e.keyCode)&&(n[0].firstElementChild.click(),e.preventDefault(),e.stopPropagation())}),n.off("click"),n.off("keypress"),i.length&&n.children().eq(0).on("click",function(e){n[0].firstElementChild.contains(e.target)&&angular.forEach(i,function(t){e.target===t||t.contains(e.target)||(angular.element(t).triggerHandler("click"),t.focus())})})}var c,l,m=n[0].querySelector(".md-secondary");if(n[0].setAttribute("role","listitem"),r.ngClick)a("button");else{for(var s,u=0;s=t[u];++u)if(l=n[0].querySelector(s)){c=!0;break}c?a("div"):n.addClass("md-no-proxy")}return o(),d}}}angular.module("material.components.list",["material.core"]).directive("mdList",e).directive("mdListItem",t),e.$inject=["$mdTheming"],t.$inject=["$mdAria"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-68395a2

 ...
 * v0.8.3-master-0b15c97
 */
function(){"use strict";function e(e,o,a,i,d,c,l,s){function m(){h(),d(function(){g(),p(),f()})}function u(){var e=U.wrap.getBoundingClientRect(),t=U.root.getBoundingClientRect(),o=e.bottom-t.top,a=t.height-e.top,i=e.left-t.left,d=e.width,c={left:i+"px",width:d+"px"};o>a&&t.height-e.bottom-r<n?(c.top="auto",c.bottom=a+"px",c.maxHeight=Math.min(n,e.top-t.top-r)+"px"):(c.top=o+"px",c.bottom="auto",c.maxHeight=Math.min(n,t.height-e.bottom-r)+"px"),U.$.ul.css(c)}function f(){U.$.root.length&&(l(U.$.ul),U.$.ul.detach(),U.$.root.append(U.$.ul))}function p(){e.autofocus&&U.input.focus()}function h(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(A,t):A),$(E),e.$watch("selectedItem",v),e.$watch("$mdAutocompleteCtrl.hidden",function(e){e&&d(u,null,!1)}),angular.element(s).on("resize",u)}function g(){U={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:c[0]},U.$=b(U)}function b(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function E(t,n){t&&(e.searchText=k(t)),e.itemChange&&t!==n&&e.itemChange(x(t))}function v(e,t){for(var n=0;n<W.length;++n)W[n](e,t)}function $(e){-1==W.indexOf(e)&&W.push(e)}function M(e){var t=W.indexOf(e);-1!=t&&W.splice(t,1)}function A(t,n){B.index=N(),(t||t!==n)&&t!==k(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(x(e.selectedItem)),S()?j():(B.loading=!1,B.matches=[],B.hidden=_(),R()))}function T(){K||(B.hidden=!0)}function w(){return angular.isString(e.searchText)?(B.hidden=_(),B.hidden||j(),void 0):e.searchText=""}function y(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(B.loading)return;e.preventDefault(),B.index=Math.min(B.index+1,B.matches.length-1),P(),L();break;case i.KEY_CODE.UP_ARROW:if(B.loading)return;e.preventDefault(),B.index=B.index<0?B.matches.length-1:Math.max(0,B.index-1),P(),L();break;case i.KEY_CODE.ENTER:if(B.loading||B.index<0)return;e.preventDefault(),I(B.index);break;case i.KEY_CODE.ESCAPE:B.matches=[],B.hidden=!0,B.index=N();break;case i.KEY_CODE.TAB:}}function C(){return angular.isNumber(e.minLength)?e.minLength:1}function k(t){return t&&e.itemText?e.itemText(x(t)):t}function x(e){if(e){var t={};return B.itemName&&(t[B.itemName]=e),t}}function N(){return e.autoselect?0:-1}function _(){return S()?1===B.matches.length&&e.searchText===k(B.matches[0])&&e.selectedItem===B.matches[0]:!0}function H(){return k(B.matches[B.index])}function S(){return e.searchText.length>=C()}function I(t){e.selectedItem=B.matches[t],e.searchText=k(e.selectedItem)||e.searchText,B.hidden=!0,B.index=0,B.matches=[]}function D(){e.searchText="",I(-1),U.input.focus()}function O(t){function n(n){Y[o]=n,t===e.searchText&&(V=null,B.loading=!1,B.matches=n,B.hidden=_(),R())}var r=e.$parent.$eval(q),o=t.toLowerCase();angular.isArray(r)?n(r):(B.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){B.loading=!1}))}function R(){if(!B.hidden)switch(B.matches.length){case 0:return B.messages.splice(0);case 1:return B.messages.push({display:"There is 1 match available."});default:return B.messages.push({display:"There are "+B.matches.length+" matches available."})}}function L(){B.messages.push({display:H()})}function P(){var e=t*B.index,n=e+t,r=U.ul.clientHeight;e<U.ul.scrollTop?U.ul.scrollTop=e:n>U.ul.scrollTop+r&&(U.ul.scrollTop=n-r)}function j(){var t=e.searchText,n=t.toLowerCase();V&&V.cancel&&(V.cancel(),V=null),!e.noCache&&Y[n]?(B.matches=Y[n],R()):O(t),B.hidden=_()}var B=this,F=e.itemsExpr.split(/ in /i),q=F[1],U=null,V=null,Y={},K=!1,W=[];return B.scope=e,B.parent=e.$parent,B.itemName=F[0],B.matches=[],B.loading=!1,B.hidden=!0,B.index=null,B.messages=[],B.id=a.nextUid(),B.keydown=y,B.blur=T,B.focus=w,B.clear=D,B.select=I,B.fetch=a.debounce(O),B.getCurrentDisplayValue=H,B.registerSelectedItemWatcher=$,B.unregisterSelectedItemWatcher=M,B.listEnter=function(){K=!0},B.listLeave=function(){K=!1},B.mouseUp=function(){U.input.focus()},m()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=16;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$rootElement","$mdTheming","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-0b15c97

 ...
 * v0.8.3-master-cf70325
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(t,i){return i.type="checkbox",i.tabIndex=0,t.attr("role",i.type),function(t,i,c,l){function m(e){(e.which===r.KEY_CODE.SPACE||e.which===r.KEY_CODE.ENTER)&&(e.preventDefault(),s(e))}function s(e){i[0].hasAttribute("disabled")||t.$apply(function(){l.$setViewValue(!l.$viewValue,e&&e.type),l.$render()})}function u(){l.$viewValue?i.addClass(d):i.removeClass(d)}l=l||a.fakeNgModel(),o(i),c.ngChecked&&t.$watch(t.$eval.bind(t,c.ngChecked),l.$setViewValue.bind(l)),n.expectWithText(i,"aria-label"),e.link.pre(t,{on:angular.noop,0:{}},c,[l]),i.on("click",s).on("keypress",m),l.$render=u}}e=e[0];var d="md-checked";return{restrict:"E",transclude:!0,require:"?ngModel",template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:i}}angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",e),e.$inject=["inputDirective","$mdInkRipple","$mdAria","$mdConstant","$mdTheming","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-cf70325

 ...
 * v0.9.0-rc1-master-0e2ccd2
 */
function(){"use strict";function e(e,t,n,r,o,a,i,d){function c(){e.$watch("selectedIndex",$),e.$watch("$mdTabsCtrl.focusIndex",f),e.$watch("$mdTabsCtrl.offsetLeft",u),angular.element(n).on("resize",function(){e.$apply(g)}),r(C,0,!1),r(T,0,!1)}function l(){var e={};return e.wrapper=t[0].getElementsByTagName("md-tabs-wrapper")[0],e.canvas=e.wrapper.getElementsByTagName("md-tabs-canvas")[0],e.paging=e.canvas.getElementsByTagName("md-pagination-wrapper")[0],e.tabs=e.paging.getElementsByTagName("md-tab-item"),e.dummies=e.canvas.getElementsByTagName("md-dummy-tab"),e.inkBar=e.paging.getElementsByTagName("md-ink-bar")[0],e.contentsWrapper=t[0].getElementsByTagName("md-tabs-content-wrapper")[0],e.contents=e.contentsWrapper.getElementsByTagName("md-tab-content"),e}function m(t){switch(t.keyCode){case o.KEY_CODE.LEFT_ARROW:t.preventDefault(),s(-1,!0);break;case o.KEY_CODE.RIGHT_ARROW:t.preventDefault(),s(1,!0);break;case o.KEY_CODE.SPACE:case o.KEY_CODE.ENTER:t.preventDefault(),j||(e.selectedIndex=P.focusIndex)}P.lastClick=!1}function s(t,n){var r,o=n?P.focusIndex:e.selectedIndex;for(r=o+t;P.tabs[r]&&P.tabs[r].scope.disabled;r+=t);P.tabs[r]&&(n?P.focusIndex=r:e.selectedIndex=r)}function u(t){var n=x()?"":"-"+t+"px";angular.element(B.paging).css("left",n),e.$broadcast("$mdTabsPaginationChanged")}function f(e,t){e!==t&&B.tabs[e]&&(h(),p())}function p(){B.dummies[P.focusIndex].focus()}function h(){if(!x()){var e=B.tabs[P.focusIndex],t=e.offsetLeft,n=e.offsetWidth+t;P.offsetLeft=Math.max(P.offsetLeft,S(n-B.canvas.clientWidth)),P.offsetLeft=Math.min(P.offsetLeft,S(t))}}function g(){P.lastSelectedIndex=e.selectedIndex,C(),P.offsetLeft=S(P.offsetLeft)}function b(){F.forEach(function(e){r(e)}),F=[]}function E(n,r){var o={getIndex:function(){return P.tabs.indexOf(a)},isActive:function(){return this.getIndex()===e.selectedIndex},isLeft:function(){return this.getIndex()<e.selectedIndex},isRight:function(){return this.getIndex()>e.selectedIndex},hasFocus:function(){return!P.lastClick&&P.hasFocus&&this.getIndex()===P.focusIndex},id:i.nextUid()},a=angular.extend(o,n);return n.template||(P.hasContent=!1,t.addClass("md-no-tab-content")),angular.isDefined(r)?P.tabs.splice(r,0,a):P.tabs.push(a),b(),a}function v(e){P.tabs.splice(e.getIndex(),1),M(),r(function(){C(),P.offsetLeft=S(P.offsetLeft)})}function M(){e.selectedIndex=k(e.selectedIndex),P.focusIndex=k(P.focusIndex)}function $(t,n){t!==n&&(e.selectedIndex=k(t),P.lastSelectedIndex=n,C(),T(),e.$broadcast("$mdTabsChanged"),P.tabs[n]&&P.tabs[n].scope.deselect(),P.tabs[t]&&P.tabs[t].scope.select())}function A(){A.watcher||(A.watcher=e.$watch(function(){r(function(){A.watcher&&t.prop("offsetParent")&&(A.watcher(),A.watcher=null,e.$apply(g))},0,!1)}))}function T(){if(!e.dynamicHeight)return t.css("height","");if(!P.tabs.length)return F.push(T);var n=B.contents[e.selectedIndex],r=n.offsetHeight,o=B.wrapper.offsetHeight,a=r+o,i=t.prop("clientHeight");i!==a&&(j=!0,d.animate(t,{height:i+"px"},{height:a+"px"}).then(function(){t.css("height",""),j=!1}))}function C(){if(!P.tabs.length)return F.push(C);if(!t.prop("offsetParent"))return A();var n=e.selectedIndex,r=B.paging.offsetWidth,o=B.tabs[n],a=o.offsetLeft,i=r-a-o.offsetWidth;w(),angular.element(B.inkBar).css({left:a+"px",right:i+"px"})}function w(){var t=e.selectedIndex,n=P.lastSelectedIndex,r=angular.element(B.inkBar);r.removeClass("md-left md-right"),angular.isNumber(n)&&(n>t?r.addClass("md-left"):t>n&&r.addClass("md-right"))}function k(e){var t,n,r=Math.max(P.tabs.length-e,e);for(t=0;r>=t;t++){if(n=P.tabs[e+t],n&&n.scope.disabled!==!0)return n.getIndex();if(n=P.tabs[e-t],n&&n.scope.disabled!==!0)return n.getIndex()}return e}function y(){switch(e.stretchTabs){case"always":return!0;case"never":return!1;default:return!N()&&n.matchMedia("(max-width: 600px)").matches}}function x(){return e.centerTabs&&!N()}function N(){if(e.noPagination)return!1;var n=t.prop("clientWidth");return angular.forEach(B.tabs,function(e){n-=e.offsetWidth}),0>n}function _(t){j||(P.focusIndex=e.selectedIndex=t),P.lastClick=!0}function H(e){N()&&(e.preventDefault(),P.offsetLeft=S(P.offsetLeft-e.wheelDelta))}function S(e){if(!B.tabs.length||!N())return 0;var t=B.tabs[B.tabs.length-1],n=t.offsetLeft+t.offsetWidth;return e=Math.max(0,e),e=Math.min(n-B.canvas.clientWidth,e)}function I(){var e,t,n=B.canvas.clientWidth,r=n+P.offsetLeft;for(e=0;e<B.tabs.length&&(t=B.tabs[e],!(t.offsetLeft+t.offsetWidth>r));e++);P.offsetLeft=S(t.offsetLeft)}function D(){var e,t;for(e=0;e<B.tabs.length&&(t=B.tabs[e],!(t.offsetLeft+t.offsetWidth>=P.offsetLeft));e++);P.offsetLeft=S(t.offsetLeft+t.offsetWidth-B.canvas.clientWidth)}function O(){return P.offsetLeft>0}function R(){var e=B.tabs[B.tabs.length-1];return e&&e.offsetLeft+e.offsetWidth>B.canvas.clientWidth+P.offsetLeft}function L(e,t){var n={colorElement:angular.element(B.inkBar)};a.attachTabBehavior(e,t,n)}var P=this,j=!1,B=l(),F=[];P.scope=e,P.parent=e.$parent,P.tabs=[],P.lastSelectedIndex=null,P.focusIndex=0,P.offsetLeft=0,P.hasContent=!0,P.hasFocus=!1,P.lastClick=!1,P.redirectFocus=p,P.attachRipple=L,P.shouldStretchTabs=y,P.shouldPaginate=N,P.shouldCenterTabs=x,P.insertTab=E,P.removeTab=v,P.select=_,P.scroll=H,P.nextPage=I,P.previousPage=D,P.keydown=m,P.canPageForward=R,P.canPageBack=O,P.refreshIndex=M,P.incrementSelectedIndex=s,P.updateInkBarStyles=C,c()}angular.module("material.components.tabs").controller("MdTabsController",e),e.$inject=["$scope","$element","$window","$timeout","$mdConstant","$mdInkRipple","$mdUtil","$animate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-0e2ccd2

 ...
 * v0.9.0-rc1-master-b65236b
 */
function(){"use strict";function e(){function e(e,t,n,r){function o(){return n.label||(t.find("md-tab-label")[0]||t[0]).innerHTML}function a(){var e=t.find("md-tab-template"),r=e.length?e.html():n.label?t.html():null;return e.length?e.remove():t.empty(),r}var i=t.parent()[0].getElementsByTagName("md-tab"),d=Array.prototype.indexOf.call(i,t[0]),c=r.insertTab({scope:e,parent:e.$parent,index:d,template:a(),label:o()},d);e.deselect=e.deselect||angular.noop,e.select=e.select||angular.noop,e.$watch("active",function(e){e&&r.select(c.getIndex())}),e.$watch("disabled",function(){r.refreshIndex()}),e.$on("$destroy",function(){r.removeTab(c)})}return{require:"^mdTabs",terminal:!0,scope:{label:"@",active:"=?mdActive",disabled:"=?ngDisabled",select:"&?mdOnSelect",deselect:"&?mdOnDeselect"},link:e}}angular.module("material.components.tabs").directive("mdTab",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-b65236b

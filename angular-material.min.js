 ...
 * v0.8.3-master-7f355f6
 */
function(){"use strict";function e(e,t,n,r,o,a,i){function d(){u(),o(function(){f(),m(),s()})}function c(){for(var e=t.parent()[0];e&&e!==a[0]&&e!==document.body&&(!e.tagName||"md-content"!==e.tagName.toLowerCase());)e=e.parentNode;return e}function l(){B.$.ul.css({left:t.prop("offsetLeft")+"px",top:t.prop("offsetTop")+t.prop("offsetHeight")+"px",width:t.prop("offsetWidth")+"px"})}function s(){B.$.root.length&&(i(B.$.ul),B.$.ul.detach(),B.$.root.append(B.$.ul))}function m(){e.autofocus&&B.input.focus()}function u(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?n.debounce(v,t):v),b(h),e.$watch("selectedItem",g)}function f(){B={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0],root:c()},B.$=p(B)}function p(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function h(t,n){t&&(e.searchText=w(t)),e.itemChange&&t!==n&&e.itemChange(y(t))}function g(e,t){for(var n=0;n<V.length;++n)V[n](e,t)}function b(e){-1==V.indexOf(e)&&V.push(e)}function E(e){var t=V.indexOf(e);-1!=t&&V.splice(t,1)}function v(t,n){L.index=C(),(t||t!==n)&&t!==w(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(y(e.selectedItem)),N()?R():(L.loading=!1,L.matches=[],L.hidden=k(),l(),I()))}function $(){U||(L.hidden=!0)}function M(){return angular.isString(e.searchText)?(L.hidden=k(),L.hidden||R(),void 0):e.searchText=""}function A(e){switch(e.keyCode){case r.KEY_CODE.DOWN_ARROW:if(L.loading)return;e.preventDefault(),L.index=Math.min(L.index+1,L.matches.length-1),O(),D();break;case r.KEY_CODE.UP_ARROW:if(L.loading)return;e.preventDefault(),L.index=Math.max(0,L.index-1),O(),D();break;case r.KEY_CODE.ENTER:if(L.loading||L.index<0)return;e.preventDefault(),_(L.index);break;case r.KEY_CODE.ESCAPE:L.matches=[],L.hidden=!0,L.index=C();break;case r.KEY_CODE.TAB:}}function T(){return angular.isNumber(e.minLength)?e.minLength:1}function w(t){return t&&e.itemText?e.itemText(y(t)):t}function y(e){if(e){var t={};return L.itemName&&(t[L.itemName]=e),t}}function C(){return e.autoselect?0:-1}function k(){return N()?1===L.matches.length&&e.searchText===w(L.matches[0])&&e.selectedItem===L.matches[0]:!0}function x(){return w(L.matches[L.index])}function N(){return e.searchText.length>=T()}function _(t){e.selectedItem=L.matches[t],e.searchText=w(e.selectedItem)||e.searchText,L.hidden=!0,L.index=0,L.matches=[]}function H(){e.searchText="",_(-1),B.input.focus()}function S(t){function n(n){q[o]=n,t===e.searchText&&(F=null,L.loading=!1,L.matches=n,L.hidden=k(),I())}var r=e.$parent.$eval(j),o=t.toLowerCase();angular.isArray(r)?n(r):(L.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){L.loading=!1}))}function I(){if(!L.hidden)switch(L.matches.length){case 0:return L.messages.splice(0);case 1:return L.messages.push({display:"There is 1 match available."});default:return L.messages.push({display:"There are "+L.matches.length+" matches available."})}}function D(){L.messages.push({display:x()})}function O(){var e=41*L.index,t=e+41,n=225.5;e<B.ul.scrollTop?B.ul.scrollTop=e:t>B.ul.scrollTop+n&&(B.ul.scrollTop=t-n)}function R(){var t=e.searchText,n=t.toLowerCase();F&&F.cancel&&(F.cancel(),F=null),!e.noCache&&q[n]?(L.matches=q[n],I()):S(t),L.hidden=k()}var L=this,P=e.itemsExpr.split(/ in /i),j=P[1],B=null,F=null,q={},U=!1,V=[];return L.scope=e,L.parent=e.$parent,L.itemName=P[0],L.matches=[],L.loading=!1,L.hidden=!0,L.index=null,L.messages=[],L.id=n.nextUid(),L.keydown=A,L.blur=$,L.focus=M,L.clear=H,L.select=_,L.fetch=n.debounce(S),L.getCurrentDisplayValue=x,L.registerSelectedItemWatcher=b,L.unregisterSelectedItemWatcher=E,L.listEnter=function(){U=!0},L.listLeave=function(){U=!1},L.mouseUp=function(){B.input.focus()},d()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$rootElement","$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-7f355f6
 */
function(){"use strict";function e(e){function t(t,n,r){t.contents=r.$mdAutocompleteTemplate,angular.forEach(t.$$isolateBindings,function(e,n){e.optional&&angular.isUndefined(t[n])&&(t[n]=r.hasOwnProperty(r.$normalize(e.attrName)))}),e(n)}return{controller:"MdAutocompleteCtrl",controllerAs:"$mdAutocompleteCtrl",link:t,scope:{name:"@",searchText:"=?mdSearchText",selectedItem:"=?mdSelectedItem",itemsExpr:"@mdItems",itemText:"&mdItemText",placeholder:"@placeholder",noCache:"=?mdNoCache",itemChange:"&?mdSelectedItemChange",textChange:"&?mdSearchTextChange",isDisabled:"=?ngDisabled",minLength:"=?mdMinLength",delay:"=?mdDelay",autofocus:"=?mdAutofocus",floatingLabel:"@?mdFloatingLabel",autoselect:"=?mdAutoselect"},template:function(e,t){return t.$mdAutocompleteTemplate=e.html(),'          <md-autocomplete-wrap role="listbox">            <md-input-container ng-if="floatingLabel">              <label>{{floatingLabel}}</label>              <input type="text"                  id="fl-input-{{$mdAutocompleteCtrl.id}}"                  name="{{name}}"                  autocomplete="off"                  ng-disabled="isDisabled"                  ng-model="$mdAutocompleteCtrl.scope.searchText"                  ng-keydown="$mdAutocompleteCtrl.keydown($event)"                  ng-blur="$mdAutocompleteCtrl.blur()"                  ng-focus="$mdAutocompleteCtrl.focus()"                  aria-owns="ul-{{$mdAutocompleteCtrl.id}}"                  aria-label="{{floatingLabel}}"                  aria-autocomplete="list"                  aria-haspopup="true"                  aria-activedescendant=""                  aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>                            </md-input-container>            <input type="text"                id="input-{{$mdAutocompleteCtrl.id}}"                name="{{name}}"                ng-if="!floatingLabel"                autocomplete="off"                ng-disabled="isDisabled"                ng-model="$mdAutocompleteCtrl.scope.searchText"                ng-keydown="$mdAutocompleteCtrl.keydown($event)"                ng-blur="$mdAutocompleteCtrl.blur()"                ng-focus="$mdAutocompleteCtrl.focus()"                placeholder="{{placeholder}}"                aria-owns="ul-{{$mdAutocompleteCtrl.id}}"                aria-label="{{placeholder}}"                aria-autocomplete="list"                aria-haspopup="true"                aria-activedescendant=""                aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>            <button                type="button"                ng-if="$mdAutocompleteCtrl.scope.searchText && !isDisabled"                ng-click="$mdAutocompleteCtrl.clear()">              <md-icon md-svg-icon="cancel"></md-icon>              <span class="visually-hidden">Clear</span>            </button>            <md-progress-linear                ng-if="$mdAutocompleteCtrl.loading"                md-mode="indeterminate"></md-progress-linear>            <ul role="presentation"                class="md-autocomplete-suggestions"                id="ul-{{$mdAutocompleteCtrl.id}}"                ng-mouseenter="$mdAutocompleteCtrl.listEnter()"                ng-mouseleave="$mdAutocompleteCtrl.listLeave()"                ng-mouseup="$mdAutocompleteCtrl.mouseUp()">              <li ng-repeat="(index, item) in $mdAutocompleteCtrl.matches"                  ng-class="{ selected: index === $mdAutocompleteCtrl.index }"                  ng-hide="$mdAutocompleteCtrl.hidden"                  ng-click="$mdAutocompleteCtrl.select(index)"                  md-autocomplete-list-item-template="contents"                  md-autocomplete-list-item="$mdAutocompleteCtrl.itemName">              </li>            </ul>          </md-autocomplete-wrap>          <aria-status              class="visually-hidden"              role="status"              aria-live="assertive">            <p ng-repeat="message in $mdAutocompleteCtrl.messages">{{message.display}}</p>          </aria-status>'}}}angular.module("material.components.autocomplete").directive("mdAutocomplete",e),e.$inject=["$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-7f355f6

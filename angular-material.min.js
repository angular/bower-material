 ...
 * v0.7.0-rc2-master-95ab29a
 */
function(){function e(e){function t(t,n){e(n)}function n(e,t){var n=this;n.setFocused=function(e){t.toggleClass("md-input-focused",!!e)},n.setHasValue=function(e){t.toggleClass("md-input-has-value",!!e)},e.$watch(function(){return n.label&&n.input},function(e){e&&!n.label.attr("for")&&n.label.attr("for",n.input.attr("id"))})}return n.$inject=["$scope","$element","$mdUtil"],{restrict:"E",link:t,controller:n}}function t(){return{restrict:"E",require:"^?mdInputContainer",link:function(e,t,n,r){r&&(r.label=t,e.$on("$destroy",function(){r.label=null}))}}}function n(e,t){function n(e){return e.addClass("md-input"),r}function r(n,r,o,a){function i(e){return d.setHasValue(!l.$isEmpty(e)),e}function c(){function e(e){a.style.height="auto";var t=a.scrollHeight-a.offsetHeight;a.scrollTop=0;var n=a.offsetHeight+(t>0?t:0);return a.style.height=n+"px",e}function o(){a.scrollTop=0;var e=a.scrollHeight-a.offsetHeight,t=a.offsetHeight+e;a.style.height=t+"px"}var a=r[0];l?(l.$formatters.push(e),l.$parsers.push(e)):(r.on("input",e),e()),r.on("keyup",e),r.on("scroll",o),angular.element(t).on("resize",e),n.$on("$destroy",function(){angular.element(t).off("resize",e)})}var d=a[0],l=a[1];if(d){if("textarea"===r[0].tagName.toLowerCase()&&c(),d.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");r.attr("id")||r.attr("id","input_"+e.nextUid()),d.input=r,l?(l.$formatters.push(i),l.$parsers.push(i)):(r.on("input",function(){d.setHasValue((""+r.val()).length>0)}),d.setHasValue((""+r.val()).length>0)),r.on("focus",function(){d.setFocused(!0)}).on("blur",function(){d.setFocused(!1)}),n.$on("$destroy",function(){d.setFocused(!1),d.setHasValue(!1),d.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel"],compile:n}}angular.module("material.components.input",["material.core"]).directive("mdInputContainer",e).directive("label",t).directive("input",n).directive("textarea",n),e.$inject=["$mdTheming"],n.$inject=["$mdUtil","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2-master-95ab29a

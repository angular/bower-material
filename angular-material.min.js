 ...
 * v0.8.3-master-2d188d0
 */
function(){"use strict";function e(e,o,a,i,d,c,l){function m(){f(),d(function(){h(),p(),u()})}function s(){function e(){var e=B.ul.getBoundingClientRect(),n={opacity:1};e.right>a.right-r&&(n.left=t.right-e.width+"px"),B.$.ul.css(n)}if(!B)return d(s,0,!1);var t=B.wrap.getBoundingClientRect(),o=B.snap.getBoundingClientRect(),a=B.root.getBoundingClientRect(),i=o.bottom-a.top,c=a.height-o.top,l=t.left-a.left,m=t.width,u={left:l+"px",minWidth:m+"px",maxWidth:Math.max(t.right-a.left,a.right-t.left)-r+"px",opacity:0};i>c&&a.height-t.bottom-r<n?(u.top="auto",u.bottom=c+"px",u.maxHeight=Math.min(n,t.top-a.top-r)+"px"):(u.top=i+"px",u.bottom="auto",u.maxHeight=Math.min(n,a.height-t.bottom-r)+"px"),d(e,0,!1),B.$.ul.css(u)}function u(){B.$.root.length&&(c(B.$.ul),B.$.ul.detach(),B.$.root.append(B.$.ul))}function p(){e.autofocus&&B.input.focus()}function f(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(v,t):v),e.$watch("selectedItem",E),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){e&&!t&&s()}),angular.element(l).on("resize",s)}function h(){B={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:document.body},B.snap=g(),B.$=b(B)}function g(){for(var e=o;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return B.wrap}function b(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function E(t,n){t&&(e.searchText=C(t)),e.itemChange&&t!==n&&e.itemChange(w(t))}function v(t,n){L.index=y(),(t||t!==n)&&t!==C(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(w(e.selectedItem)),N()?R():(L.loading=!1,L.matches=[],L.hidden=k(),I()))}function $(){U||(L.hidden=!0)}function M(){return angular.isString(e.searchText)?(L.hidden=k(),L.hidden||R(),void 0):e.searchText=""}function A(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(L.loading)return;e.preventDefault(),L.index=Math.min(L.index+1,L.matches.length-1),O(),D();break;case i.KEY_CODE.UP_ARROW:if(L.loading)return;e.preventDefault(),L.index=L.index<0?L.matches.length-1:Math.max(0,L.index-1),O(),D();break;case i.KEY_CODE.ENTER:if(L.hidden||L.loading||L.index<0)return;e.preventDefault(),_(L.index);break;case i.KEY_CODE.ESCAPE:L.matches=[],L.hidden=!0,L.index=y();break;case i.KEY_CODE.TAB:}}function T(){return angular.isNumber(e.minLength)?e.minLength:1}function C(t){return t&&e.itemText?e.itemText(w(t)):t}function w(e){if(e){var t={};return L.itemName&&(t[L.itemName]=e),t}}function y(){return e.autoselect?0:-1}function k(){return N()?1===L.matches.length&&e.searchText===C(L.matches[0])&&e.selectedItem===L.matches[0]:!0}function x(){return C(L.matches[L.index])}function N(){return e.searchText.length>=T()}function _(t){e.selectedItem=L.matches[t],e.searchText=C(e.selectedItem)||e.searchText,L.hidden=!0,L.index=0,L.matches=[],L.parent.$emit("$mdAutocompleteSelected",e.selectedItem)}function H(){e.searchText="",_(-1),B.input.focus()}function S(t){function n(n){q[o]=n,t===e.searchText&&(F=null,L.loading=!1,L.matches=n,L.hidden=k(),I(),s())}var r=e.$parent.$eval(j),o=t.toLowerCase();angular.isArray(r)?n(r):(L.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){L.loading=!1}))}function I(){if(!L.hidden)switch(L.matches.length){case 0:return L.messages.splice(0);case 1:return L.messages.push({display:"There is 1 match available."});default:return L.messages.push({display:"There are "+L.matches.length+" matches available."})}}function D(){L.messages.push({display:x()})}function O(){var e=t*L.index,n=e+t,r=B.ul.clientHeight;e<B.ul.scrollTop?B.ul.scrollTop=e:n>B.ul.scrollTop+r&&(B.ul.scrollTop=n-r)}function R(){var t=e.searchText,n=t.toLowerCase();F&&F.cancel&&(F.cancel(),F=null),!e.noCache&&q[n]?(L.matches=q[n],I()):S(t),L.hidden=k()}var L=this,P=e.itemsExpr.split(/ in /i),j=P[1],B=null,F=null,q={},U=!1;return L.scope=e,L.parent=e.$parent,L.itemName=P[0],L.matches=[],L.loading=!1,L.hidden=!0,L.index=null,L.messages=[],L.id=a.nextUid(),L.keydown=A,L.blur=$,L.focus=M,L.clear=H,L.select=_,L.fetch=a.debounce(S),L.getCurrentDisplayValue=x,L.listEnter=function(){U=!0},L.listLeave=function(){U=!1},L.mouseUp=function(){B.input.focus()},m()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=16;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-2d188d0

 ...
 * v0.8.0-rc1-master-91053dc
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(){d(),c()}function c(){var e=angular.element(M.ul),t=angular.element(M.input),n=e.attr("id")||"ul_"+o.nextUid();e.attr("id",n),t.attr("aria-owns",n)}function d(){e.$watch("searchText",function(e){if(!e)return E.loading=!1,E.matches=[];var t=e.toLowerCase();A&&A.cancel&&(A.cancel(),A=null),T[t]?E.matches=T[t]:E.hidden||E.fetch(e)})}function l(t){function n(n){T[a]=n,t===e.searchText&&(A=null,E.loading=!1,E.matches=n)}var o=e.$parent.$eval($),a=t.toLowerCase();angular.isArray(o)?n(o):(E.loading=!0,A=r.when(o).then(n))}function m(){E.hidden=!0}function u(e){switch(e.keyCode){case a.KEY_CODE.DOWN_ARROW:if(E.loading)return;e.preventDefault(),E.index=Math.min(E.index+1,E.matches.length-1),b();break;case a.KEY_CODE.UP_ARROW:if(E.loading)return;e.preventDefault(),E.index=Math.max(0,E.index-1),b();break;case a.KEY_CODE.ENTER:if(E.loading)return;e.preventDefault(),g(E.index);break;case a.KEY_CODE.ESCAPE:E.matches=[],E.hidden=!0,E.index=-1;break;case a.KEY_CODE.TAB:break;default:E.index=-1,E.hidden=f(),n(function(){E.hidden=f()})}}function s(){e.searchText="",g(-1),M.input.focus()}function f(){return 1===E.matches.length&&e.searchText===h(E.matches[0])}function p(){return h(E.matches[E.index])}function h(t){return t&&e.itemText?t[e.itemText]:t}function g(t){e.selectedItem=E.matches[t],e.searchText=h(e.selectedItem)||e.searchText,E.hidden=!0,E.index=-1,E.matches=[]}function b(){var e=41*E.index,t=e+41,n=225.5;e<M.ul.scrollTop?M.ul.scrollTop=e:t>M.ul.scrollTop+n&&(M.ul.scrollTop=t-n)}var E=this,v=e.itemsExpr.split(/\ in\ /i),$=v[1],M={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0]},A=null,T={};return E.scope=e,E.parent=e.$parent,E.itemName=v[0],E.matches=[],E.loading=!1,E.hidden=!0,E.index=0,E.keydown=u,E.blur=m,E.clear=s,E.select=g,E.getCurrentDisplayValue=p,E.fetch=o.debounce(l),i()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$timeout","$q","$mdUtil","$mdConstant"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-91053dc
 */
function(){"use strict";function e(){return{template:'        <md-autocomplete-wrap role="listbox">          <input type="text"              ng-model="searchText"              ng-keydown="$mdAutocompleteCtrl.keydown($event)"              ng-blur="$mdAutocompleteCtrl.blur($event)"              placeholder="{{placeholder}}"              aria-label="{{placeholder}}"              aria-autocomplete="list"              aria-haspopup="true"              aria-activedescendant=""              aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>          <button              type="button"              ng-if="searchText"              ng-click="$mdAutocompleteCtrl.clear()">              <md-icon md-svg-icon="cancel"></md-icon>              <span class="visually-hidden">Clear</span>              </button>          <md-progress-linear ng-if="$mdAutocompleteCtrl.loading" md-mode="indeterminate"></md-progress-linear>        </md-autocomplete-wrap>        <ul role="presentation">          <li ng-repeat="(index, item) in $mdAutocompleteCtrl.matches"              ng-class="{ selected: index === $mdAutocompleteCtrl.index }"              ng-if="searchText && !$mdAutocompleteCtrl.hidden"              ng-click="$mdAutocompleteCtrl.select(index)"              ng-transclude              md-autocomplete-list-item="$mdAutocompleteCtrl.itemName">          </li>        </ul>        <aria-status            class="visually-hidden"            role="status"            aria-live="assertive">          <p ng-if="$mdAutocompleteCtrl.index === -1 && $mdAutocompleteCtrl.matches.length === 1">There is 1 match available.</p>          <p ng-if="$mdAutocompleteCtrl.index === -1 && $mdAutocompleteCtrl.matches.length > 1">There are {{$mdAutocompleteCtrl.matches.length}} matches available.</p>          <p ng-if="$mdAutocompleteCtrl.index >= 0">{{ $mdAutocompleteCtrl.getCurrentDisplayValue() }}</p>        </aria-status>',transclude:!0,controller:"MdAutocompleteCtrl",controllerAs:"$mdAutocompleteCtrl",scope:{searchText:"=mdSearchText",selectedItem:"=mdSelectedItem",itemsExpr:"@mdItems",itemText:"@mdItemText",placeholder:"@placeholder"}}}angular.module("material.components.autocomplete").directive("mdAutocomplete",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-91053dc

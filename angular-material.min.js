 ...
 * v0.9.0-rc2-master-0813284
 */
function(){"use strict";function e(e,t,n,o,r,a,i,d,c){function l(l,u,p){function f(){h(),b(),M(),g()}function h(){angular.isDefined(p.mdDelay)||(l.delay=m)}function g(){l.$watch("visible",function(e){e?A():T()}),l.$on("$destroy",function(){l.visible=!1,u.remove(),angular.element(t).off("resize",H)})}function b(){u.detach(),u.attr("role","tooltip"),u.attr("id",p.id||"tooltip_"+r.nextUid())}function E(){for(var e=u.parent();"none"==t.getComputedStyle(e[0])["pointer-events"];)e=e.parent();return e}function v(){for(var e=u.parent()[0];e&&e!==i[0]&&e!==document.body&&(!e.tagName||"md-content"!=e.tagName.toLowerCase());)e=e.parentNode;return e}function M(){var e=l.hasOwnProperty("autohide")?l.autohide:p.hasOwnProperty("mdAutohide");w.on("focus mouseenter touchstart",function(){$(!0)}),w.on("blur mouseleave touchend touchcancel",function(){(o[0].activeElement!==w[0]||e)&&$(!1)}),angular.element(t).on("resize",H)}function $(t){$.value=!!t,$.queued||(t?($.queued=!0,e(function(){l.visible=$.value,$.queued=!1},l.delay)):e(function(){l.visible=!1}))}function A(){_.append(u);var e=t.getComputedStyle(u[0]);return angular.isDefined(e.display)&&"none"==e.display?void u.detach():(w.attr("aria-describedby",u.attr("id")),C(),void angular.forEach([u,y,k],function(e){d.addClass(e,"md-show")}))}function T(){w.removeAttr("aria-describedby"),c.all([d.removeClass(k,"md-show"),d.removeClass(y,"md-show"),d.removeClass(u,"md-show")]).then(function(){l.visible||u.detach()})}function C(){function e(){var e="left"===x||"right"===x?2*Math.sqrt(Math.pow(o.width,2)+Math.pow(o.height/2,2)):2*Math.sqrt(Math.pow(o.width/2,2)+Math.pow(o.height,2)),t="left"===x?{left:100,top:50}:"right"===x?{left:0,top:50}:"top"===x?{left:50,top:100}:{left:50,top:0};y.css({width:e+"px",height:e+"px",left:t.left+"%",top:t.top+"%"})}function t(e){var t={left:e.left,top:e.top};return t.left=Math.min(t.left,_.prop("scrollWidth")-o.width-s),t.left=Math.max(t.left,s),t.top=Math.min(t.top,_.prop("scrollHeight")-o.height-s),t.top=Math.max(t.top,s),t}function n(e){return"left"===e?{left:a.left-o.width-s,top:a.top+a.height/2-o.height/2}:"right"===e?{left:a.left+a.width+s,top:a.top+a.height/2-o.height/2}:"top"===e?{left:a.left+a.width/2-o.width/2,top:a.top-o.height-s}:{left:a.left+a.width/2-o.width/2,top:a.top+a.height+s}}var o=r.offsetRect(u,_),a=r.offsetRect(w,_),i=n(x);x?i=t(i):i.top>u.prop("offsetParent").scrollHeight-o.height-s&&(i=t(n("top"))),u.css({top:i.top+"px",left:i.left+"px"}),e()}a(u);var w=E(),y=angular.element(u[0].getElementsByClassName("md-background")[0]),k=angular.element(u[0].getElementsByClassName("md-content")[0]),x=p.mdDirection,N=v(),_=angular.element(N||document.body),H=n.throttle(function(){l.visible&&C()});return f()}var m=300,s=8;return{restrict:"E",transclude:!0,template:'        <div class="md-background"></div>        <div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay",autohide:"=?mdAutohide"},link:l}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-0813284

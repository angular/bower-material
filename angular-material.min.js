 ...
 * v0.8.0-rc1-master-6c5fdba
 */
function(){"use strict";function e(e,n,r,o){function a(t,a,i,c){function d(){for(var e in n.MEDIA)o(e),o.getQuery(n.MEDIA[e]).addListener(M);return o.watchResponsiveAttributes(["md-cols","md-row-height"],i,m)}function l(){A();for(var e in n.MEDIA)o.getQuery(n.MEDIA[e]).removeListener(M)}function m(e){null==e?c.invalidateLayout():o(e)&&c.invalidateLayout()}function u(){var e=p(),n=g(),o=v(),i=E(),c=b(),d=r(n,h(),p()).map(function(t,r){return{grid:{element:a,style:f(n,r,c,o,i)},tiles:t.map(function(t,a){return{element:angular.element(e[a]),style:s(t.position,t.spans,n,r,c,o,i)}})}}).reflow().performance();t.mdOnLayout({$event:{performance:d}})}function s(e,t,n,r,o,a,i){var c=1/n*100,d=1===n?0:(n-1)/n,l=T({share:c,gutterShare:d,gutter:o}),m={left:w({unit:l,offset:e.col,gutter:o}),width:k({unit:l,span:t.col,gutter:o}),paddingTop:"",marginTop:"",top:"",height:""};switch(a){case"fixed":m.top=w({unit:i,offset:e.row,gutter:o}),m.height=k({unit:i,span:t.row,gutter:o});break;case"ratio":var u=c*(1/i),s=T({share:u,gutterShare:d,gutter:o});m.paddingTop=k({unit:s,span:t.row,gutter:o}),m.marginTop=w({unit:s,offset:e.row,gutter:o});break;case"fit":var f=1===r?0:(r-1)/r,u=1/r*100,s=T({share:u,gutterShare:f,gutter:o});m.top=w({unit:s,offset:e.row,gutter:o}),m.height=k({unit:s,span:t.row,gutter:o})}return m}function f(e,t,n,r,o){var a={height:"",paddingBottom:""};switch(r){case"fixed":a.height=k({unit:o,span:t,gutter:n});break;case"ratio":var i=1===e?0:(e-1)/e,c=1/e*100,d=c*(1/o),l=T({share:d,gutterShare:i,gutter:n});a.paddingBottom=k({unit:l,span:t,gutter:n});break;case"fit":}return a}function p(){return Array.prototype.slice.call(a[0].childNodes).filter(function(e){return"MD-GRID-TILE"==e.tagName})}function h(){return c.tiles.map(function(e){return{row:parseInt(o.getResponsiveAttribute(e,"md-rowspan"),10)||1,col:parseInt(o.getResponsiveAttribute(e,"md-colspan"),10)||1}})}function g(){var e=parseInt(o.getResponsiveAttribute(i,"md-cols"),10);if(isNaN(e))throw"md-grid-list: md-cols attribute was not found, or contained a non-numeric value";return e}function b(){return $(o.getResponsiveAttribute(i,"md-gutter")||1)}function E(){var e=o.getResponsiveAttribute(i,"md-row-height");switch(v()){case"fixed":return $(e);case"ratio":var t=e.split(":");return parseFloat(t[0])/parseFloat(t[1]);case"fit":return 0}}function v(){var e=o.getResponsiveAttribute(i,"md-row-height");return"fit"==e?"fit":-1!==e.indexOf(":")?"ratio":"fixed"}function $(e){return/\D$/.test(e)?e:e+"px"}a.attr("role","list"),c.layoutDelegate=u;var M=angular.bind(c,c.invalidateLayout),A=d();t.$on("$destroy",l);var T=e("{{ share }}% - ({{ gutter }} * {{ gutterShare }})"),w=e("calc(({{ unit }}) * {{ offset }} + {{ offset }} * {{ gutter }})"),k=e("calc(({{ unit }}) * {{ span }} + ({{ span }} - 1) * {{ gutter }})")}return{restrict:"E",controller:t,scope:{mdOnLayout:"&"},link:a}}function t(e){this.invalidated=!1,this.$timeout_=e,this.tiles=[],this.layoutDelegate=angular.noop}function n(e){function t(e,t){e.element.css(e.style),t.forEach(function(e){e.element.css(e.style)})}function n(e,t){function n(t,n){if(t.col>e)throw"md-grid-list: Tile at position "+n+" has a colspan ("+t.col+") that exceeds the column count ("+e+")";for(var i=0,m=0;m-i<t.col;)c>=e?r():(i=l.indexOf(0,c),-1!==i&&-1!==(m=a(i+1))?c=m+1:(i=m=0,r()));return o(i,t.col,t.row),c=i+t.col,{col:i,row:d}}function r(){c=0,d++,o(0,e,-1)}function o(e,t,n){for(var r=e;e+t>r;r++)l[r]=Math.max(l[r]+n,0)}function a(e){var t;for(t=e;t<l.length;t++)if(0!==l[t])return t;return t===l.length?t:void 0}function i(){for(var t=[],n=0;e>n;n++)t.push(0);return t}var c=0,d=0,l=i();return{positioning:t.map(function(e,t){return{spans:e,position:n(e,t)}}),rowCount:d+Math.max.apply(Math,l)}}return function(r,o){var a,i,c,d,l,m,i,u=t;return d=e.time(function(){i=n(r,o)}),a={animateWith:function(e){u=angular.isFunction(e)?e:t},layoutInfo:function(){return i},map:function(t){return l=e.time(function(){var e=a.layoutInfo();c=t(e.positioning,e.rowCount)}),a},reflow:function(t){return m=e.time(function(){var e=t||u;e(c.grid,c.tiles)}),a},performance:function(){return{tileCount:o.length,layoutTime:d,mapTime:l,reflowTime:m,totalTime:d+l+m}}}}}function r(e){function t(t,n,r,o){n.attr("role","listitem");var a=e.watchResponsiveAttributes(["md-colspan","md-rowspan"],r,angular.bind(o,o.invalidateLayout));o.addTile(r,t.$parent.$index),t.$on("$destroy",function(){a(),o.removeTile(r)})}return{restrict:"E",require:"^mdGridList",template:"<figure ng-transclude></figure>",transclude:!0,link:t}}function o(){return{template:"<figcaption ng-transclude></figcaption>",transclude:!0}}angular.module("material.components.gridList",["material.core"]).directive("mdGridList",e).directive("mdGridTile",r).directive("mdGridTileFooter",o).directive("mdGridTileHeader",o).factory("$mdGridLayout",n),e.$inject=["$interpolate","$mdConstant","$mdGridLayout","$mdMedia","$mdUtil"],t.$inject=["$timeout"],t.prototype={addTile:function(e,t){angular.isUndefined(t)?this.tiles.push(e):this.tiles.splice(t,0,e),this.invalidateLayout()},removeTile:function(e){var t=this.tiles.indexOf(e);-1!==t&&(this.tiles.splice(t,1),this.invalidateLayout())},invalidateLayout:function(){this.invalidated||(this.invalidated=!0,this.$timeout_(angular.bind(this,this.layout)))},layout:function(){try{this.layoutDelegate()}finally{this.invalidated=!1}}},n.$inject=["$mdUtil"],r.$inject=["$mdMedia"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-6c5fdba
 ...
 * v0.8.0-rc1-master-6c5fdba
 */
function(){"use strict";function e(e,t,n,r,o,a,i,c){function d(e){return e.attr({tabIndex:0,role:"slider"}),n.expect(e,"aria-label"),l}function l(n,d,l,m){function u(){b(),M(),g()}function s(e){z=parseFloat(e),d.attr("aria-valuemin",e),u()}function f(e){G=parseFloat(e),d.attr("aria-valuemax",e),u()}function p(e){W=parseFloat(e),g()}function h(e){d.attr("aria-disabled",!!e)}function g(){if(angular.isDefined(l.mdDiscrete)){var e=Math.floor((G-z)/W);if(!X){var n=t.getComputedStyle(U[0]);X=angular.element('<canvas style="position:absolute;">'),Q=X[0].getContext("2d"),Q.fillStyle=n.backgroundColor||"black",U.append(X)}var r=E();X[0].width=r.width,X[0].height=r.height;for(var o,a=0;e>=a;a++)o=Math.floor(r.width*(a/e)),Q.fillRect(o-1,0,2,r.height)}}function b(){Z=q[0].getBoundingClientRect()}function E(){return V(),Z}function v(e){if(!d[0].hasAttribute("disabled")){var t;e.keyCode===o.KEY_CODE.LEFT_ARROW?t=-W:e.keyCode===o.KEY_CODE.RIGHT_ARROW&&(t=W),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),n.$evalAsync(function(){$(m.$viewValue+t)}))}}function $(e){m.$setViewValue(A(T(e)))}function M(){isNaN(m.$viewValue)&&(m.$viewValue=m.$modelValue);var e=(m.$viewValue-z)/(G-z);n.modelValue=m.$viewValue,d.attr("aria-valuenow",m.$viewValue),w(e),F.text(m.$viewValue)}function A(e){return angular.isNumber(e)?Math.max(z,Math.min(G,e)):void 0}function T(e){return angular.isNumber(e)?Math.round(e/W)*W:void 0}function w(e){B.css("width",100*e+"%"),L.css("left",100*e+"%"),d.toggleClass("md-min",0===e)}function k(e){if(!P()){d.addClass("active"),d[0].focus(),b();var t=I(D(e.pointer.x)),r=A(T(t));n.$apply(function(){$(r),w(R(r))})}}function y(e){if(!P()){d.removeClass("dragging active");var t=I(D(e.pointer.x)),r=A(T(t));n.$apply(function(){$(r),M()})}}function x(e){P()||(J=!0,e.stopPropagation(),d.addClass("dragging"),_(e))}function C(e){J&&(e.stopPropagation(),_(e))}function N(e){J&&(e.stopPropagation(),J=!1)}function _(e){et?H(e.pointer.x):S(e.pointer.x)}function S(e){n.$evalAsync(function(){$(I(D(e)))})}function H(e){var t=I(D(e)),n=A(T(t));w(D(e)),F.text(n)}function D(e){return Math.max(0,Math.min(1,(e-Z.left)/Z.width))}function I(e){return z+e*(G-z)}function R(e){return(e-z)/(G-z)}a(d),m=m||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var O=l.ngDisabled&&c(l.ngDisabled),P=O?function(){return O(n.$parent)}:angular.noop,j=angular.element(d[0].querySelector(".md-thumb")),F=angular.element(d[0].querySelector(".md-thumb-text")),L=j.parent(),q=angular.element(d[0].querySelector(".md-track-container")),B=angular.element(d[0].querySelector(".md-track-fill")),U=angular.element(d[0].querySelector(".md-track-ticks")),V=r.throttle(b,5e3);l.min?l.$observe("min",s):s(0),l.max?l.$observe("max",f):f(100),l.step?l.$observe("step",p):p(1);var Y=angular.noop;l.ngDisabled&&(Y=n.$parent.$watch(l.ngDisabled,h)),i.register(d,"drag"),d.on("keydown",v).on("$md.pressdown",k).on("$md.pressup",y).on("$md.dragstart",x).on("$md.drag",C).on("$md.dragend",N),setTimeout(u);var K=e.throttle(u);angular.element(t).on("resize",K),n.$on("$destroy",function(){angular.element(t).off("resize",K),Y()}),m.$render=M,m.$viewChangeListeners.push(M),m.$formatters.push(A),m.$formatters.push(T);var z,G,W,X,Q,Z={};b();var J=!1,et=angular.isDefined(l.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-slider-wrapper">        <div class="md-track-container">          <div class="md-track"></div>          <div class="md-track md-track-fill"></div>          <div class="md-track-ticks"></div>        </div>        <div class="md-thumb-container">          <div class="md-thumb"></div>          <div class="md-focus-thumb"></div>          <div class="md-focus-ring"></div>          <div class="md-sign">            <span class="md-thumb-text"></span>          </div>          <div class="md-disabled-thumb"></div>        </div>      </div>',compile:d}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-6c5fdba
 ...
 * v0.8.0-rc1-master-6c5fdba
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(){d(),c()}function c(){var e=angular.element($.ul),t=angular.element($.input),n=e.attr("id")||"ul_"+o.nextUid();e.attr("id",n),t.attr("aria-owns",n)}function d(){e.$watch("searchText",function(e){if(!e)return b.loading=!1,b.matches=[];var t=e.toLowerCase();M&&M.cancel&&(M.cancel(),M=null),A[t]?b.matches=A[t]:b.hidden||b.fetch(e)})}function l(t){function n(n){A[a]=n,t===e.searchText&&(M=null,b.loading=!1,b.matches=n)}var o=e.$parent.$eval(v),a=t.toLowerCase();angular.isArray(o)?n(o):(b.loading=!0,M=r.when(o).then(n))}function m(e){switch(e.keyCode){case a.KEY_CODE.DOWN_ARROW:if(b.loading)return;e.preventDefault(),b.index=Math.min(b.index+1,b.matches.length-1),g();break;case a.KEY_CODE.UP_ARROW:if(b.loading)return;e.preventDefault(),b.index=Math.max(0,b.index-1),g();break;case a.KEY_CODE.ENTER:if(b.loading)return;e.preventDefault(),h(b.index);break;case a.KEY_CODE.ESCAPE:b.matches=[],b.hidden=!0,b.index=-1;break;default:b.index=-1,b.hidden=s(),n(function(){b.hidden=s()})}}function u(){e.searchText="",h(-1),$.input.focus()}function s(){return 1===b.matches.length&&e.searchText===p(b.matches[0])}function f(){return p(b.matches[b.index])}function p(t){return t&&e.itemText?t[e.itemText]:t}function h(t){e.selectedItem=b.matches[t],e.searchText=p(e.selectedItem)||e.searchText,b.hidden=!0,b.index=-1,b.matches=[]}function g(){var e=41*b.index,t=e+41,n=225.5;e<$.ul.scrollTop?$.ul.scrollTop=e:t>$.ul.scrollTop+n&&($.ul.scrollTop=t-n)}var b=this,E=e.itemsExpr.split(/\ in\ /i),v=E[1],$={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0]},M=null,A={};return b.scope=e,b.parent=e.$parent,b.itemName=E[0],b.matches=[],b.loading=!1,b.hidden=!0,b.index=0,b.keydown=m,b.clear=u,b.select=h,b.getCurrentDisplayValue=f,b.fetch=o.debounce(l),i()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$timeout","$q","$mdUtil","$mdConstant"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-6c5fdba
 */
function(){"use strict";function e(){return{template:'        <md-autocomplete-wrap role="listbox">          <input type="text"              ng-model="searchText"              ng-keydown="$mdAutocompleteCtrl.keydown($event)"              placeholder="{{placeholder}}"              aria-label="{{placeholder}}"              aria-autocomplete="list"              aria-haspopup="true"              aria-activedescendant=""              aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>          <button              type="button"              ng-if="searchText"              ng-click="$mdAutocompleteCtrl.clear()">              <md-icon md-svg-icon="cancel"></md-icon>              <span class="visually-hidden">Clear</span>              </button>          <md-progress-linear ng-if="$mdAutocompleteCtrl.loading" md-mode="indeterminate"></md-progress-linear>        </md-autocomplete-wrap>        <ul role="presentation">          <li ng-repeat="(index, item) in $mdAutocompleteCtrl.matches"              ng-class="{ selected: index === $mdAutocompleteCtrl.index }"              ng-if="searchText && !$mdAutocompleteCtrl.hidden"              ng-click="$mdAutocompleteCtrl.select(index)"              ng-transclude              md-autocomplete-list-item="$mdAutocompleteCtrl.itemName">          </li>        </ul>        <aria-status            class="visually-hidden"            role="status"            aria-live="assertive">          <p ng-if="$mdAutocompleteCtrl.index === -1 && $mdAutocompleteCtrl.matches.length === 1">There is 1 match available.</p>          <p ng-if="$mdAutocompleteCtrl.index === -1 && $mdAutocompleteCtrl.matches.length > 1">There are {{$mdAutocompleteCtrl.matches.length}} matches available.</p>          <p ng-if="$mdAutocompleteCtrl.index >= 0">{{ $mdAutocompleteCtrl.getCurrentDisplayValue() }}</p>        </aria-status>',transclude:!0,controller:"MdAutocompleteCtrl",controllerAs:"$mdAutocompleteCtrl",scope:{searchText:"=mdSearchText",selectedItem:"=mdSelectedItem",itemsExpr:"@mdItems",itemText:"@mdItemText",placeholder:"@placeholder"}}}angular.module("material.components.autocomplete").directive("mdAutocomplete",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-6c5fdba

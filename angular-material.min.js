 ...
 * v0.8.0-rc1-master-a80804b
 */
function(){"use strict";function e(e,t,n){function r(r,o){var a=r.find("md-select-label").remove();a.length||((a=r.find("input")).length?a.remove():a=angular.element("<md-select-label>").html("<span>{{"+o.ngModel+" ? "+o.ngModel+": '"+o.placeholder+"'}}</span>")),a.append('<span class="md-select-icon" aria-hidden="true"></span>'),a.addClass("md-select-label"),a.addClass("{{ "+o.ngModel+" ? '' : 'md-placeholder'}}"),r.find("md-content").length||r.append(angular.element("<md-content>").append(r.contents())),o.mdOnOpen&&r.find("md-content").prepend(angular.element("<md-progress-circular>").attr("md-mode","indeterminate").attr("ng-hide","$$loadingAsyncDone").wrap("<div>").parent());var i='<div class="md-select-menu-container"><md-select-menu ng-model="$parent.'+o.ngModel+'" '+(angular.isDefined(o.multiple)?"multiple":"")+">"+r.html()+"</md-select-menu></div>";return r.empty().append(a),n(r),function(n,r,o){function a(e){var t=[32,13,38,40];-1!=t.indexOf(e.keyCode)&&(e.preventDefault(),c(e))}function c(){n.$evalAsync(function(){e.show({scope:n.$new(),template:i,target:r[0],hasBackdrop:!0,loadingAsync:o.mdOnOpen?n.$eval(o.mdOnOpen):!1}).then(function(){r.attr("aria-expanded",!1)})})}r.on("click",c),r.on("keydown",a),r.attr({role:"combobox",id:"select_"+t.nextUid(),"aria-haspopup":!0,"aria-expanded":"false"})}}return{restrict:"E",compile:r}}function t(e,t,n){function r(e,r,o,a){function i(){r.attr({id:"select_menu_"+t.nextUid(),role:"listbox","aria-multiselectable":l.isMultiple?"true":"false"})}function c(e){(13==e.keyCode||32==e.keyCode)&&d(e)}function d(n){var r=t.getClosest(n.target,"md-option"),o=r&&angular.element(r).data("$mdOptionController");if(r&&o){var a=l.hashGetter(o.value),i=angular.isDefined(l.selected[a]);e.$apply(function(){l.isMultiple?i?l.deselect(a):l.select(a,o.value):i||(l.deselect(Object.keys(l.selected)[0]),l.select(a,o.value)),l.refreshViewValue()})}}var l=a[0],m=a[1];n(r),r.on("click",d),r.on("keypress",c),l.init(m),i()}function o(t,n){function r(){var e=a.ngModel.$modelValue||a.ngModel.$viewValue;if(angular.isArray(e)){var t=Object.keys(a.selected),n=e.map(a.hashGetter),r=t.filter(function(e){return-1===n.indexOf(e)});r.forEach(a.deselect),n.forEach(function(t,n){a.select(t,e[n])})}}function o(){var e=a.ngModel.$viewValue||a.ngModel.$modelValue;Object.keys(a.selected).forEach(a.deselect),a.select(a.hashGetter(e),e)}var a=this;a.isMultiple=angular.isDefined(n.multiple),a.selected={},a.options={},a.init=function(c){function d(e,t){return angular.isArray(e||t||[])}if(a.ngModel=c,c.$options&&c.$options.trackBy){var l={},m=e(c.$options.trackBy);a.hashGetter=function(e,n){return l.$value=e,m(n||t,l)}}else a.hashGetter=function(e){return angular.isObject(e)?"$$object_"+(e.$$mdSelectId||(e.$$mdSelectId=++i)):e};a.isMultiple?(c.$validators["md-multiple"]=d,c.$render=r,t.$watchCollection(n.ngModel,function(e){d(e)&&r(e)})):c.$render=o},a.select=function(e,t){var n=a.options[e];n&&n.setSelected(!0),a.selected[e]=t},a.deselect=function(e){var t=a.options[e];t&&t.setSelected(!1),delete a.selected[e]},a.addOption=function(e,t){if(angular.isDefined(a.options[e]))throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "'+t.value+'" found.');a.options[e]=t,angular.isDefined(a.selected[e])&&(a.select(e,t.value),a.refreshViewValue())},a.removeOption=function(e){delete a.options[e]},a.refreshViewValue=function(){var e,t=[];for(var n in a.selected)(e=a.options[n])?t.push(e.value):t.push(a.selected[n]);a.ngModel.$setViewValue(a.isMultiple?t:t[0])}}return o.$inject=["$scope","$attrs"],{restrict:"E",require:["mdSelectMenu","ngModel"],controller:o,link:{pre:r}}}function n(e,t){function n(e,t){return e.append(angular.element('<div class="md-text">').append(e.contents())),void 0===t.tabindex&&e.attr("tabindex",0),r}function r(n,r,o,a){function i(e,t){var r=l.hashGetter(t,n),o=l.hashGetter(e,n);d.hashKey=o,d.value=e,l.removeOption(r,d),l.addOption(o,d)}function c(){r.attr({role:"option","aria-selected":"false",id:"select_option_"+t.nextUid()})}var d=a[0],l=a[1];if(angular.isDefined(o.ngValue))n.$watch(o.ngValue,i);else{if(!angular.isDefined(o.value))throw new Error("Expected either ngValue or value attr");i(o.value)}e.attachButtonBehavior(n,r),c(),n.$on("$destroy",function(){l.removeOption(d.hashKey,d)})}function o(e){this.selected=!1,this.setSelected=function(t){t&&!this.selected?e.attr({selected:"selected","aria-selected":"true"}):!t&&this.selected&&(e.removeAttr("selected"),e.attr("aria-selected","false")),this.selected=t}}return o.$inject=["$element"],{restrict:"E",require:["mdOption","^^mdSelectMenu"],controller:o,compile:n}}function r(){function e(e,t){var n=e.find("label");n.length||(n=angular.element("<label>"),e.prepend(n)),t.label&&n.text(t.label)}return{restrict:"E",compile:e}}function o(e){function t(e,t,o,i,c,d){function l(n,r,a){function l(){a.selectEl.attr("aria-labelledby",a.target.attr("id")),a.target.attr("aria-owns",a.selectEl.attr("id")),a.target.attr("aria-expanded","true")}function m(){function o(){var e,t=Array.prototype.slice.call(a.selectEl[0].querySelectorAll("md-option"));-1==(e=t.indexOf(a.focusedNode))?e=Math.floor((t.length-1)/2):e<t.length-1&&++e,a.focusedNode=t[e],t[e].focus()}function i(){var e,t=Array.prototype.slice.call(a.selectEl[0].querySelectorAll("md-option"));-1==(e=t.indexOf(a.focusedNode))?e=Math.floor((t.length-1)/2):e>0&&--e,a.focusedNode=t[e],t[e].focus()}function c(){a.restoreFocus=!0,n.$evalAsync(function(){e.hide(d.ngModel.$viewValue)})}if(!a.isRemoved){var d=a.selectEl.controller("mdSelectMenu")||{};r.addClass("md-clickable"),a.backdrop&&a.backdrop.on("click",function(){a.restoreFocus=!1,n.$apply(e.cancel)}),a.selectEl.on("keydown",function(r){switch(r.keyCode){case t.KEY_CODE.ESCAPE:a.restoreFocus=!0,n.$apply(e.cancel)}}),a.selectEl.on("keydown",function(e){switch(e.keyCode){case t.KEY_CODE.UP_ARROW:return i();case t.KEY_CODE.DOWN_ARROW:return o()}}),d.isMultiple||(a.selectEl.on("click",c),a.selectEl.on("keydown",function(e){(32==e.keyCode||13==e.keyCode)&&c()}))}}if(!a.target)throw new Error('$mdSelect.show() expected a target element in options.target but got "'+a.target+'"!');return angular.extend(a,{target:angular.element(a.target),parent:angular.element(a.parent),selectEl:r.find("md-select-menu"),contentEl:r.find("md-content"),backdrop:a.hasBackdrop&&angular.element("<md-backdrop>")}),l(),a.loadingAsync&&a.loadingAsync.then&&a.loadingAsync.then(function(){n.$$loadingAsyncDone=!0,o(function(){o(function(){s(n,r,a)})})}),a.disableParentScroll&&(a.disableTarget=a.parent.find("md-content"),a.disableTarget.length||(a.disableTarget=a.parent),a.lastOverflow=a.disableTarget.css("overflow")),d(m,75,!1),a.backdrop&&(c.inherit(a.backdrop,a.parent),a.parent.append(a.backdrop)),a.parent.append(r),o(function(){o(function(){a.isRemoved||s(n,r,a)})}),i.transitionEndPromise(a.selectEl)}function m(e,t,n){return n.isRemoved=!0,t.addClass("md-leave").removeClass("md-clickable"),n.target.attr("aria-expanded","false"),n.disableParentScroll&&(n.disableTarget.css("overflow",n.lastOverflow),delete n.lastOverflow,delete n.disableTarget),i.transitionEndPromise(t).then(function(){t.remove(),n.backdrop&&n.backdrop.remove(),n.restoreFocus&&n.target.focus()})}function s(e,c,d){var l,m=c[0],s=d.target[0],u=d.parent[0],f=d.selectEl[0],p=d.contentEl[0],h=u.getBoundingClientRect(),g=i.clientRect(s,u),b=!1,E={left:u.scrollLeft+a,top:u.scrollTop+a,bottom:h.height+u.scrollTop-a,right:h.width-u.scrollLeft-a},v={top:g.top-E.top,left:g.left-E.bottom},$=h.width-2*a,M=p.scrollHeight>p.offsetHeight,A=f.querySelector("md-option[selected]"),T=f.getElementsByTagName("md-option"),w=f.getElementsByTagName("md-optgroup");l=A?A:w.length?T[0]:T.length?T[Math.floor(T.length/2)]:p.firstElementChild,p.offsetWidth>$&&(p.style["max-width"]=$+"px"),b&&(p.style["min-width"]=g.width+"px"),M&&f.classList.add("md-overflow");var k=f.getBoundingClientRect(),y=r(l);if(l){var x=window.getComputedStyle(l);y.paddingLeft=parseInt(x["padding-left"],10),y.paddingRight=parseInt(x["padding-right"],10)}var C=l||T[0];if(C&&(d.focusedNode=C,C.focus()),M){var N=p.offsetHeight/2;p.scrollTop=y.top+y.height/2-N,v.top<N?p.scrollTop=Math.min(y.top,p.scrollTop+N-v.top):v.bottom<N&&(p.scrollTop=Math.max(y.top+y.height-k.height,p.scrollTop-N+v.bottom))}var _,S,H;b?(_=g.left,S=g.top+g.height,H="50% 0",S+k.height>E.bottom&&(S=g.top-k.height,H="50% 100%")):(_=g.left+y.left-y.paddingLeft,S=g.top+g.height/2-y.height/2-y.top+p.scrollTop,H=y.left+g.width/2+"px "+(y.top+y.height/2-p.scrollTop)+"px 0px"),m.style.left=n(E.left,_,E.right)+"px",m.style.top=n(E.top,S,E.bottom)+"px",f.style[t.CSS.TRANSFORM_ORIGIN]=H,f.style[t.CSS.TRANSFORM]="scale("+Math.min(g.width/k.width,1)+","+Math.min(g.height/k.height,1)+")",o(function(){c.addClass("md-active"),f.style[t.CSS.TRANSFORM]=""})}return{parent:"body",onShow:l,onRemove:m,hasBackdrop:!0,disableParentScroll:!0,themable:!0}}function n(e,t,n){return Math.min(n,Math.max(t,e))}function r(e){return e?{left:e.offsetLeft,top:e.offsetTop,width:e.offsetWidth,height:e.offsetHeight}:{left:0,top:0,width:0,height:0}}return t.$inject=["$mdSelect","$mdConstant","$$rAF","$mdUtil","$mdTheming","$timeout"],e("$mdSelect").setDefaults({methods:["target"],options:t})}var a=8,i=0;angular.module("material.components.select",["material.core","material.components.backdrop"]).directive("mdSelect",e).directive("mdSelectMenu",t).directive("mdOption",n).directive("mdOptgroup",r).provider("$mdSelect",o),e.$inject=["$mdSelect","$mdUtil","$mdTheming"],t.$inject=["$parse","$mdUtil","$mdTheming"],n.$inject=["$mdInkRipple","$mdUtil"],o.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-a80804b

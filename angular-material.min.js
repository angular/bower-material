 ...
 * v0.8.0-rc1-master-fcc1e63
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(){l(),c()}function c(){var e=angular.element(A.ul),t=angular.element(A.input),n=e.attr("id")||"ul_"+o.nextUid();e.attr("id",n),t.attr("aria-owns",n)}function d(t){if(t){var n={};return v.itemName&&(n[v.itemName]=e.selectedItem),n}}function l(){e.$watch("searchText",function(t){if(!t)return v.loading=!1,v.matches=[];var n=t.toLowerCase();T&&T.cancel&&(T.cancel(),T=null),!e.noCache&&w[n]?v.matches=w[n]:v.hidden||v.fetch(t),e.textChange&&e.textChange(d(e.selectedItem))}),e.$watch("selectedItem",function(t){e.itemChange&&e.itemChange(d(t))})}function m(t){function n(n){w[a]=n,t===e.searchText&&(T=null,v.loading=!1,v.matches=n)}var o=e.$parent.$eval(M),a=t.toLowerCase();angular.isArray(o)?n(o):(v.loading=!0,T=r.when(o).then(n))}function u(){v.hidden=!0}function s(e){switch(e.keyCode){case a.KEY_CODE.DOWN_ARROW:if(v.loading)return;e.preventDefault(),v.index=Math.min(v.index+1,v.matches.length-1),E();break;case a.KEY_CODE.UP_ARROW:if(v.loading)return;e.preventDefault(),v.index=Math.max(0,v.index-1),E();break;case a.KEY_CODE.ENTER:if(v.loading||v.index<0)return;e.preventDefault(),b(v.index);break;case a.KEY_CODE.ESCAPE:v.matches=[],v.hidden=!0,v.index=-1;break;case a.KEY_CODE.TAB:break;default:v.index=-1,v.hidden=p(),n(function(){v.hidden=p()})}}function f(){e.searchText="",b(-1),A.input.focus()}function p(){return 1===v.matches.length&&e.searchText===g(v.matches[0])}function h(){return g(v.matches[v.index])}function g(t){return t&&e.itemText?e.itemText(d(t)):t}function b(t){e.selectedItem=v.matches[t],e.searchText=g(e.selectedItem)||e.searchText,v.hidden=!0,v.index=-1,v.matches=[]}function E(){var e=41*v.index,t=e+41,n=225.5;e<A.ul.scrollTop?A.ul.scrollTop=e:t>A.ul.scrollTop+n&&(A.ul.scrollTop=t-n)}var v=this,$=e.itemsExpr.split(/ in /i),M=$[1],A={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0]},T=null,w={};return v.scope=e,v.parent=e.$parent,v.itemName=$[0],v.matches=[],v.loading=!1,v.hidden=!0,v.index=0,v.keydown=s,v.blur=u,v.clear=f,v.select=b,v.getCurrentDisplayValue=h,v.fetch=o.debounce(m),i()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$timeout","$q","$mdUtil","$mdConstant"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.0-rc1-master-fcc1e63

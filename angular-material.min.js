 ...
 */
function BackdropDirective(e){return e}function MdBottomSheetDirective(){return{restrict:"E"}}function MdBottomSheetProvider(e){function t(e,t,o,a,i,d,c,l,m){function s(n,r,m){r=o.extractElementByName(r,"md-bottom-sheet"),f=i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n),f.on("click",function(){a(c.cancel)}),d.inherit(f,m.parent),e.enter(f,m.parent,null);var s=new p(r,m.parent);return m.bottomSheet=s,m.targetEvent&&angular.element(m.targetEvent.target).blur(),d.inherit(s.element,m.parent),m.disableParentScroll&&(m.lastOverflow=m.parent.css("overflow"),m.parent.css("overflow","hidden")),e.enter(s.element,m.parent).then(function(){var e=angular.element(r[0].querySelector("button")||r[0].querySelector("a")||r[0].querySelector("[ng-click]"));e.focus(),m.escapeToClose&&(m.rootElementKeyupCallback=function(e){e.keyCode===t.KEY_CODE.ESCAPE&&a(c.cancel)},l.on("keyup",m.rootElementKeyupCallback))})}function u(t,n,r){var o=r.bottomSheet;return e.leave(f),e.leave(o.element).then(function(){r.disableParentScroll&&(r.parent.css("overflow",r.lastOverflow),delete r.lastOverflow),o.cleanup(),r.targetEvent&&angular.element(r.targetEvent.target).focus()})}function p(e,o){function i(n){e.css(t.CSS.TRANSITION_DURATION,"0ms")}function d(n){var o=n.pointer.distanceY;5>o&&(o=Math.max(-r,o/2)),e.css(t.CSS.TRANSFORM,"translate3d(0,"+(r+o)+"px,0)")}function l(r){if(r.pointer.distanceY>0&&(r.pointer.distanceY>20||Math.abs(r.pointer.velocityY)>n)){var o=e.prop("offsetHeight")-r.pointer.distanceY,i=Math.min(o/r.pointer.velocityY*.75,500);e.css(t.CSS.TRANSITION_DURATION,i+"ms"),a(c.cancel)}else e.css(t.CSS.TRANSITION_DURATION,""),e.css(t.CSS.TRANSFORM,"")}var s=m.register(o,"drag",{horizontal:!1});return o.on("$md.dragstart",i).on("$md.drag",d).on("$md.dragend",l),{element:e,cleanup:function(){s(),o.off("$md.dragstart",i).off("$md.drag",d).off("$md.dragend",l)}}}var f;return{themable:!0,targetEvent:null,onShow:s,onRemove:u,escapeToClose:!0,disableParentScroll:!0}}var n=.5,r=80;return t.$inject=["$animate","$mdConstant","$mdUtil","$timeout","$compile","$mdTheming","$mdBottomSheet","$rootElement","$mdGesture"],e("$mdBottomSheet").setDefaults({methods:["disableParentScroll","escapeToClose","targetEvent"],options:t})}function MdButtonDirective(e,t,n,r){function o(e){return angular.isDefined(e.href)||angular.isDefined(e.ngHref)||angular.isDefined(e.ngLink)||angular.isDefined(e.uiSref)}function a(e,t){return o(t)?'<a class="md-button" ng-transclude></a>':'<button class="md-button" ng-transclude></button>'}function i(a,i,d){var c=i[0];t(i),e.attachButtonBehavior(a,i);var l=c.textContent.trim();l||n.expect(i,"aria-label"),o(d)&&angular.isDefined(d.ngDisabled)&&a.$watch(d.ngDisabled,function(e){i.attr("tabindex",e?-1:0)}),i.on("click",function(e){d.disabled===!0&&(e.preventDefault(),e.stopImmediatePropagation())}),a.mouseActive=!1,i.on("mousedown",function(){a.mouseActive=!0,r(function(){a.mouseActive=!1},100)}).on("focus",function(){a.mouseActive===!1&&i.addClass("md-focused")}).on("blur",function(){i.removeClass("md-focused")})}return{restrict:"EA",replace:!0,transclude:!0,template:a,link:i}}function mdCardDirective(e){return{restrict:"E",link:function(t,n,r){e(n)}}}function MdCheckboxDirective(e,t,n,r,o,a,i){function d(t,d){return d.type="checkbox",d.tabindex=d.tabindex||"0",t.attr("role",d.type),function(t,d,l,m){function s(e,n,r){l[e]&&t.$watch(l[e],function(e){r[e]&&d.attr(n,r[e])})}function u(e){var t=e.which||e.keyCode;(t===r.KEY_CODE.SPACE||t===r.KEY_CODE.ENTER)&&(e.preventDefault(),d.hasClass("md-focused")||d.addClass("md-focused"),p(e))}function p(e){d[0].hasAttribute("disabled")||t.$apply(function(){var t=l.ngChecked?l.checked:!m.$viewValue;m.$setViewValue(t,e&&e.type),m.$render()})}function f(){m.$viewValue?d.addClass(c):d.removeClass(c)}m=m||a.fakeNgModel(),o(d),l.ngChecked&&t.$watch(t.$eval.bind(t,l.ngChecked),m.$setViewValue.bind(m)),s("ngDisabled","tabindex",{"true":"-1","false":l.tabindex}),n.expectWithText(d,"aria-label"),e.link.pre(t,{on:angular.noop,0:{}},l,[m]),t.mouseActive=!1,d.on("click",p).on("keypress",u).on("mousedown",function(){t.mouseActive=!0,i(function(){t.mouseActive=!1},100)}).on("focus",function(){t.mouseActive===!1&&d.addClass("md-focused")}).on("blur",function(){d.removeClass("md-focused")}),m.$render=f}}e=e[0];var c="md-checked";return{restrict:"E",transclude:!0,require:"?ngModel",template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:d}}function mdContentDirective(e){function t(e,t){this.$scope=e,this.$element=t}return{restrict:"E",controller:["$scope","$element",t],link:function(t,n,r){n[0];e(n),t.$broadcast("$mdContentLoaded",n),iosScrollFix(n[0])}}}function iosScrollFix(e){angular.element(e).on("$md.pressdown",function(t){"t"===t.pointer.type&&(t.$materialScrollFixed||(t.$materialScrollFixed=!0,0===e.scrollTop?e.scrollTop=1:e.scrollHeight===e.scrollTop+e.offsetHeight&&(e.scrollTop-=1)))})}function MdDialogDirective(e,t){return{restrict:"E",link:function(n,r,o){t(r),e(function(){var e=r[0].querySelector("md-dialog-content");e&&e.scrollHeight>e.clientHeight&&r.addClass("md-content-overflow")})}}}function MdDialogProvider(e){function t(e,t){return{template:['<md-dialog md-theme="{{ dialog.theme }}" aria-label="{{ dialog.ariaLabel }}">','<md-dialog-content role="document" tabIndex="0">','<h2 class="md-title">{{ dialog.title }}</h2>',"<p>{{ dialog.content }}</p>","</md-dialog-content>",'<div class="md-actions">','<md-button ng-if="dialog.$type == \'confirm\'" ng-click="dialog.abort()" class="md-primary">',"{{ dialog.cancel }}","</md-button>",'<md-button ng-click="dialog.hide()" class="md-primary">',"{{ dialog.ok }}","</md-button>","</div>","</md-dialog>"].join(""),controller:function(){this.hide=function(){e.hide(!0)},this.abort=function(){e.cancel()}},controllerAs:"dialog",bindToController:!0,theme:t.defaultTheme()}}function n(e,t,n,r,o,a,i,d,c,l,m){function s(e){var t=document.querySelector("md-dialog");t&&!t.contains(e.target)&&(e.stopImmediatePropagation(),t.focus())}function u(e,l,m){function u(){var e=l[0].querySelector(".dialog-close");if(!e){var t=l[0].querySelectorAll(".md-actions button");e=t[t.length-1]}return angular.element(e)}l=n.extractElementByName(l,"md-dialog"),m.parent=angular.element(m.parent),m.popInTarget=angular.element((m.targetEvent||{}).target);var p=u();if(m.hasBackdrop){var h=m.parent[0]==t[0].body&&t[0].documentElement&&t[0].documentElement.scrollTop?angular.element(t[0].documentElement):m.parent,E=h.prop("scrollTop");m.backdrop=angular.element('<md-backdrop class="md-dialog-backdrop md-opaque">'),m.backdrop.css("top",E+"px"),o.inherit(m.backdrop,m.parent),c.enter(m.backdrop,m.parent),l.css("top",E+"px")}var v="dialog",M=p;return"alert"===m.$type&&(v="alertdialog",M=l.find("md-dialog-content")),f(l.find("md-dialog"),v,m),document.addEventListener("focus",s,!0),m.disableParentScroll&&(m.lastOverflow=m.parent.css("overflow"),m.parent.css("overflow","hidden")),b(l,m.parent,m.popInTarget&&m.popInTarget.length&&m.popInTarget).then(function(){g(l,!0),m.escapeToClose&&(m.rootElementKeyupCallback=function(e){e.keyCode===r.KEY_CODE.ESCAPE&&i(a.cancel)},d.on("keyup",m.rootElementKeyupCallback)),m.clickOutsideToClose&&(m.dialogClickOutsideCallback=function(e){e.target===l[0]&&i(a.cancel)},l.on("click",m.dialogClickOutsideCallback)),m.focusOnOpen&&M.focus()})}function p(e,t,n){return n.backdrop&&c.leave(n.backdrop),n.disableParentScroll&&(n.parent.css("overflow",n.lastOverflow),delete n.lastOverflow),n.escapeToClose&&d.off("keyup",n.rootElementKeyupCallback),n.clickOutsideToClose&&t.off("click",n.dialogClickOutsideCallback),g(t,!1),document.removeEventListener("focus",s,!0),E(t,n.parent,n.popInTarget&&n.popInTarget.length&&n.popInTarget).then(function(){n.scope.$destroy(),t.remove(),n.popInTarget&&n.popInTarget.focus()})}function f(t,r,o){t.attr({role:r,tabIndex:"-1"});var a=t.find("md-dialog-content");0===a.length&&(a=t);var i=t.attr("id")||"dialog_"+n.nextUid();a.attr("id",i),t.attr("aria-describedby",i),o.ariaLabel?e.expect(t,"aria-label",o.ariaLabel):e.expectAsync(t,"aria-label",function(){var e=a.text().split(/\s+/);return e.length>3&&(e=e.slice(0,3).concat("...")),e.join(" ")})}function h(e,t){return-1!==t.indexOf(e.nodeName)?!0:void 0}function g(e,t){function n(e){for(;e.parentNode;){if(e===document.body)return;for(var o=e.parentNode.children,a=0;a<o.length;a++)e===o[a]||h(o[a],["SCRIPT","STYLE"])||o[a].setAttribute(r,t);n(e=e.parentNode)}}var r="aria-hidden";e=e[0],n(e)}function b(e,t,o){var a=e.find("md-dialog");return t.append(e),v(a,o),l(function(){a.addClass("transition-in").css(r.CSS.TRANSFORM,"")}),n.transitionEndPromise(a)}function E(e,t,r){var o=e.find("md-dialog");return o.addClass("transition-out").removeClass("transition-in"),v(o,r),n.transitionEndPromise(o)}function v(e,t){if(t){var n=t[0].getBoundingClientRect(),o=e[0].getBoundingClientRect(),a=Math.min(.5,n.width/o.width),i=Math.min(.5,n.height/o.height);e.css(r.CSS.TRANSFORM,"translate3d("+(-o.left+n.left+n.width/2-o.width/2)+"px,"+(-o.top+n.top+n.height/2-o.height/2)+"px,0) scale("+a+","+i+")")}}return{hasBackdrop:!0,isolateScope:!0,onShow:u,onRemove:p,clickOutsideToClose:!1,escapeToClose:!0,targetEvent:null,focusOnOpen:!0,disableParentScroll:!0,transformTemplate:function(e){return'<div class="md-dialog-container">'+e+"</div>"}}}return t.$inject=["$mdDialog","$mdTheming"],n.$inject=["$mdAria","$document","$mdUtil","$mdConstant","$mdTheming","$mdDialog","$timeout","$rootElement","$animate","$$rAF","$q"],e("$mdDialog").setDefaults({methods:["disableParentScroll","hasBackdrop","clickOutsideToClose","escapeToClose","targetEvent","parent"],options:n}).addPreset("alert",{methods:["title","content","ariaLabel","ok","theme"],options:t}).addPreset("confirm",{methods:["title","content","ariaLabel","ok","cancel","theme"],options:t})}function MdDividerDirective(e){return{restrict:"E",link:e}}function GridListDirective(e,t,n,r){function o(o,a,i,d){function c(){for(var e in t.MEDIA)r(e),r.getQuery(t.MEDIA[e]).addListener(C);return r.watchResponsiveAttributes(["md-cols","md-row-height"],i,m)}function l(){A();for(var e in t.MEDIA)r.getQuery(t.MEDIA[e]).removeListener(C)}function m(e){null==e?d.invalidateLayout():r(e)&&d.invalidateLayout()}function s(e){var t={tileSpans:g(),colCount:b(),rowMode:M(),rowHeight:v(),gutter:E()};if(e||!angular.equals(t,T)){var r=h(),i=n(t.colCount,t.tileSpans,r).map(function(e,n){return{grid:{element:a,style:f(t.colCount,n,t.gutter,t.rowMode,t.rowHeight)},tiles:e.map(function(e,n){return{element:angular.element(r[n]),style:p(e.position,e.spans,t.colCount,t.rowCount,t.gutter,t.rowMode,t.rowHeight)}})}}).reflow().performance();o.mdOnLayout({$event:{performance:i}}),T=t}}function u(e){return y+e+k}function p(e,t,n,r,o,a,i){var d=1/n*100,c=(n-1)/n,l=w({share:d,gutterShare:c,gutter:o}),m={left:N({unit:l,offset:e.col,gutter:o}),width:x({unit:l,span:t.col,gutter:o}),paddingTop:"",marginTop:"",top:"",height:""};switch(a){case"fixed":m.top=N({unit:i,offset:e.row,gutter:o}),m.height=x({unit:i,span:t.row,gutter:o});break;case"ratio":var s=d/i,u=w({share:s,gutterShare:c,gutter:o});m.paddingTop=x({unit:u,span:t.row,gutter:o}),m.marginTop=N({unit:u,offset:e.row,gutter:o});break;case"fit":var p=(r-1)/r,s=1/r*100,u=w({share:s,gutterShare:p,gutter:o});m.top=N({unit:u,offset:e.row,gutter:o}),m.height=x({unit:u,span:t.row,gutter:o})}return m}function f(e,t,n,r,o){var a={height:"",paddingBottom:""};switch(r){case"fixed":a.height=x({unit:o,span:t,gutter:n});break;case"ratio":var i=1===e?0:(e-1)/e,d=1/e*100,c=d*(1/o),l=w({share:c,gutterShare:i,gutter:n});a.paddingBottom=x({unit:l,span:t,gutter:n});break;case"fit":}return a}function h(){return d.tiles.map(function(e){return e.element})}function g(){return d.tiles.map(function(e){return{row:parseInt(r.getResponsiveAttribute(e.attrs,"md-rowspan"),10)||1,col:parseInt(r.getResponsiveAttribute(e.attrs,"md-colspan"),10)||1}})}function b(){var e=parseInt(r.getResponsiveAttribute(i,"md-cols"),10);if(isNaN(e))throw"md-grid-list: md-cols attribute was not found, or contained a non-numeric value";return e}function E(){return $(r.getResponsiveAttribute(i,"md-gutter")||1)}function v(){var e=r.getResponsiveAttribute(i,"md-row-height");switch(M()){case"fixed":return $(e);case"ratio":var t=e.split(":");return parseFloat(t[0])/parseFloat(t[1]);case"fit":return 0}}function M(){var e=r.getResponsiveAttribute(i,"md-row-height");return"fit"==e?"fit":-1!==e.indexOf(":")?"ratio":"fixed"}function $(e){return/\D$/.test(e)?e:e+"px"}a.attr("role","list"),d.layoutDelegate=s;var C=angular.bind(d,d.invalidateLayout),A=c();o.$on("$destroy",l);var T,y=e.startSymbol(),k=e.endSymbol(),w=e(u("share")+"% - ("+u("gutter")+" * "+u("gutterShare")+")"),N=e("calc(("+u("unit")+" + "+u("gutter")+") * "+u("offset")+")"),x=e("calc(("+u("unit")+") * "+u("span")+" + ("+u("span")+" - 1) * "+u("gutter")+")")}return{restrict:"E",controller:GridListController,scope:{mdOnLayout:"&"},link:o}}function GridListController(e){this.invalidated=!1,this.tilesAdded=!1,this.$timeout_=e,this.tiles=[],this.layoutDelegate=angular.noop}function GridLayoutFactory(e){function t(t,n){var a,i,d,c,l,m;return c=e.time(function(){i=r(t,n)}),a={layoutInfo:function(){return i},map:function(t){return l=e.time(function(){var e=a.layoutInfo();d=t(e.positioning,e.rowCount)}),a},reflow:function(t){return m=e.time(function(){var e=t||o;e(d.grid,d.tiles)}),a},performance:function(){return{tileCount:n.length,layoutTime:c,mapTime:l,reflowTime:m,totalTime:c+l+m}}}}function n(e,t){e.element.css(e.style),t.forEach(function(e){e.element.css(e.style)})}function r(e,t){function n(t,n){if(t.col>e)throw"md-grid-list: Tile at position "+n+" has a colspan ("+t.col+") that exceeds the column count ("+e+")";for(var i=0,m=0;m-i<t.col;)d>=e?r():(i=l.indexOf(0,d),-1!==i&&-1!==(m=a(i+1))?d=m+1:(i=m=0,r()));return o(i,t.col,t.row),d=i+t.col,{col:i,row:c}}function r(){d=0,c++,o(0,e,-1)}function o(e,t,n){for(var r=e;e+t>r;r++)l[r]=Math.max(l[r]+n,0)}function a(e){var t;for(t=e;t<l.length;t++)if(0!==l[t])return t;return t===l.length?t:void 0}function i(){for(var t=[],n=0;e>n;n++)t.push(0);return t}var d=0,c=0,l=i();return{positioning:t.map(function(e,t){return{spans:e,position:n(e,t)}}),rowCount:c+Math.max.apply(Math,l)}}var o=n;return t.animateWith=function(e){o=angular.isFunction(e)?e:n},t}function GridTileDirective(e){function t(t,n,r,o){n.attr("role","listitem");var a=e.watchResponsiveAttributes(["md-colspan","md-rowspan"],r,angular.bind(o,o.invalidateLayout));o.addTile(n,r,t.$parent.$index),t.$on("$destroy",function(){a(),o.removeTile(n,r)}),angular.isDefined(t.$parent.$index)&&t.$watch(function(){return t.$parent.$index},function(e,t){o.removeTile(n,r),o.addTile(n,r,e)})}return{restrict:"E",require:"^mdGridList",template:"<figure ng-transclude></figure>",transclude:!0,scope:{},link:t}}function GridTileCaptionDirective(){return{template:"<figcaption ng-transclude></figcaption>",transclude:!0}}function mdIconDirective(e,t,n){function r(e,t){return t.mdFontIcon?'<span class="md-font" ng-class="fontIcon"></span>':""}function o(r,o,a){function i(){var e=o.parent();return e.attr("aria-label")||e.text()?!0:e.parent().attr("aria-label")||e.parent().text()?!0:!1}t(o);var d=a.alt||r.fontIcon||r.svgIcon,c=a.$normalize(a.$attr.mdSvgIcon||a.$attr.mdSvgSrc||"");""==a.alt||i()?n.expect(o,"aria-hidden","true"):(n.expect(o,"aria-label",d),n.expect(o,"role","img")),c&&a.$observe(c,function(t){o.empty(),t&&e(t).then(function(e){o.append(e)})})}return{scope:{fontIcon:"@mdFontIcon",svgIcon:"@mdSvgIcon",svgSrc:"@mdSvgSrc"},restrict:"E",template:r,link:o}}function MdIconProvider(){}function ConfigurationItem(e,t){this.url=e,this.iconSize=t||config.defaultIconSize}function MdIconService(e,t,n,r,o){function a(t){return function(n){return h[t]=s(n)?n:new u(n,e[t]),h[t].clone()}}function i(t){var r=e[t];return r?c(r.url).then(function(e){return new u(e,r)}):n.reject(t)}function d(t){function r(e){var r=t.slice(t.lastIndexOf(":")+1),o=e.querySelector("#"+r);return o?new u(o,a):n.reject(t)}var o=t.substring(0,t.lastIndexOf(":"))||"$default",a=e[o];return a?c(a.url).then(r):n.reject(t)}function c(e){return t.get(e,{cache:o}).then(function(e){return angular.element("<div>").append(e.data).find("svg")[0]})}function l(e){var t;return angular.isString(e)&&(t="icon "+e+" not found",r.warn(t)),n.reject(t||e)}function m(e){var t=angular.isString(e)?e:e.message||e.data||e.statusText;return r.warn(t),n.reject(t)}function s(e){return angular.isDefined(e.element)&&angular.isDefined(e.config)}function u(e,t){"svg"!=e.tagName&&(e=angular.element('<svg xmlns="http://www.w3.org/2000/svg">').append(e)[0]),e.getAttribute("xmlns")||e.setAttribute("xmlns","http://www.w3.org/2000/svg"),this.element=e,this.config=t,this.prepare()}function p(){var t=this.config?this.config.iconSize:e.defaultIconSize;angular.forEach({fit:"",height:"100%",width:"100%",preserveAspectRatio:"xMidYMid meet",viewBox:this.element.getAttribute("viewBox")||"0 0 "+t+" "+t},function(e,t){this.element.setAttribute(t,e)},this),angular.forEach({"pointer-events":"none",display:"block"},function(e,t){this.element.style[t]=e},this)}function f(){return this.element.cloneNode(!0)}var h={},g=/[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?/i;return u.prototype={clone:f,prepare:p},function(e){return e=e||"",h[e]?n.when(h[e].clone()):g.test(e)?c(e).then(a(e)):(-1==e.indexOf(":")&&(e="$default:"+e),i(e)["catch"](d)["catch"](l)["catch"](m).then(a(e)))}}function mdListDirective(e){return{restrict:"E",compile:function(t){return t[0].setAttribute("role","list"),e}}}function mdListItemDirective(e,t,n){var r=["md-checkbox","md-switch"];return{restrict:"E",controller:"MdListController",compile:function(o,a){function i(){for(var e,t,n=["md-switch","md-checkbox"],r=0;t=n[r];++r)if((e=o.find(t)[0])&&!e.hasAttribute("aria-label")){var a=o.find("p")[0];if(!a)return;e.setAttribute("aria-label","Toggle "+a.textContent)}}function d(t){var n;if("div"==t?(n=angular.element('<div class="md-no-style md-list-item-inner">'),n.append(o.contents()),o.addClass("md-proxy-focus")):(n=angular.element('<md-button class="md-no-style"><div class="md-list-item-inner"></div></md-button>'),n[0].setAttribute("ng-click",o[0].getAttribute("ng-click")),o[0].removeAttribute("ng-click"),n.children().eq(0).append(o.contents())),o[0].setAttribute("tabindex","-1"),o.append(n),u&&u.hasAttribute("ng-click")){e.expect(u,"aria-label");var r=angular.element('<md-button class="md-secondary-container md-icon-button">');r.attr("ng-click",u.getAttribute("ng-click")),u.removeAttribute("ng-click"),u.setAttribute("tabindex","-1"),u.classList.remove("md-secondary"),r.append(u),u=r[0]}u&&(u.hasAttribute("ng-click")||a.ngClick&&c(u))&&(o.addClass("md-with-secondary"),o.append(u))}function c(e){return-1!=r.indexOf(e.nodeName.toLowerCase())}function l(e,o,a,i){function d(){var e=o.children();e.length&&!e[0].hasAttribute("ng-click")&&angular.forEach(r,function(e){angular.forEach(o[0].firstElementChild.querySelectorAll(e),function(e){l.push(e)})})}function c(){(l.length||o[0].firstElementChild.hasAttribute("ng-click"))&&(o.addClass("md-clickable"),i.attachRipple(e,angular.element(o[0].querySelector(".md-no-style"))))}var l=[];d(),c(),o.hasClass("md-proxy-focus")&&l.length&&angular.forEach(l,function(t){t=angular.element(t),e.mouseActive=!1,t.on("mousedown",function(){e.mouseActive=!0,n(function(){e.mouseActive=!1},100)}).on("focus",function(){e.mouseActive===!1&&o.addClass("md-focused"),t.on("blur",function n(){o.removeClass("md-focused"),t.off("blur",n)})})}),o[0].firstElementChild.hasAttribute("ng-click")||l.length||o[0].firstElementChild.addEventListener("keypress",function(e){"INPUT"!=e.target.nodeName&&e.keyCode==t.KEY_CODE.SPACE&&(o[0].firstElementChild.click(),e.preventDefault(),e.stopPropagation())}),o.off("click"),o.off("keypress"),l.length&&o.children().eq(0).on("click",function(e){o[0].firstElementChild.contains(e.target)&&angular.forEach(l,function(t){e.target===t||t.contains(e.target)||angular.element(t).triggerHandler("click")})})}var m,s,u=o[0].querySelector(".md-secondary");if(o[0].setAttribute("role","listitem"),a.ngClick)d("button");else{for(var p,f=0;p=r[f];++f)if(s=o[0].querySelector(p)){m=!0;break}m?d("div"):o.addClass("md-no-proxy")}return i(),l}}}function MdListController(e,t,n){function r(e,t){var r={};n.attachListControlBehavior(e,t,r)}var o=this;o.attachRipple=r}function MdProgressCircularDirective(e,t){function n(e){return e.attr("aria-valuemin",0),e.attr("aria-valuemax",100),e.attr("role","progressbar"),r}function r(n,r,a){t(r);var i=r[0],d=a.mdDiameter||48,c=d/48;i.style[e.CSS.TRANSFORM]="scale("+c+")",a.$observe("value",function(e){var t=o(e);r.attr("aria-valuenow",t)})}function o(e){return Math.max(0,Math.min(e||0,100))}return{restrict:"E",template:'<div class="md-spinner-wrapper"><div class="md-inner"><div class="md-gap"></div><div class="md-left"><div class="md-half-circle"></div></div><div class="md-right"><div class="md-half-circle"></div></div></div></div>',compile:n}}function MdProgressLinearDirective(e,t,n){function r(e,t,n){return e.attr("aria-valuemin",0),e.attr("aria-valuemax",100),e.attr("role","progressbar"),o}function o(r,o,i){n(o);var d=o[0].querySelector(".md-bar1").style,c=o[0].querySelector(".md-bar2").style,l=angular.element(o[0].querySelector(".md-container"));i.$observe("value",function(e){if("query"!=i.mdMode){var n=a(e);o.attr("aria-valuenow",n),c[t.CSS.TRANSFORM]=transforms[n]}}),i.$observe("mdBufferValue",function(e){d[t.CSS.TRANSFORM]=transforms[a(e)]}),e(function(){l.addClass("md-ready")})}function a(e){return e>100?100:0>e?0:Math.ceil(e||0)}return{restrict:"E",template:'<div class="md-container"><div class="md-dashed"></div><div class="md-bar md-bar1"></div><div class="md-bar md-bar2"></div></div>',compile:r}}function SelectDirective(e,t,n,r,o,a){function i(r,i){var d=r.find("md-select-label").remove();if(d.length){if(!d[0].firstElementChild){var c=angular.element("<span>");c.append(d.contents()),d.append(c)}}else d=angular.element("<md-select-label><span></span></md-select-label>");if(d.append('<span class="md-select-icon" aria-hidden="true"></span>'),d.addClass("md-select-label"),d.attr("id","select_label_"+t.nextUid()),r.find("md-content").length||r.append(angular.element("<md-content>").append(r.contents())),i.mdOnOpen&&r.find("md-content").prepend(angular.element("<md-progress-circular>").attr("md-mode","indeterminate").attr("ng-hide","$$loadingAsyncDone").wrap("<div>").parent()),i.name){var l=angular.element('<select class="md-visually-hidden">');l.attr({name:"."+i.name,"ng-model":i.ngModel,"aria-hidden":"true",tabindex:"-1"});var m=r.find("md-option");angular.forEach(m,function(e){var t=angular.element("<option>"+e.innerHTML+"</option>");e.hasAttribute("ng-value")?t.attr("ng-value",e.getAttribute("ng-value")):e.hasAttribute("value")&&t.attr("value",e.getAttribute("value")),l.append(t)}),r.parent().append(l)}var s='<div class="md-select-menu-container"><md-select-menu '+(angular.isDefined(i.multiple)?"multiple":"")+">"+r.html()+"</md-select-menu></div>";return r.empty().append(d),i.tabindex=i.tabindex||"0",n(r),function(n,r,i,d){function c(){h&&(b=b||h.find("md-select-menu").controller("mdSelectMenu"),E.setLabelText(b.selectedLabels()))}function l(){h=angular.element(s);var e=h.find("md-select-menu");e.data("$ngModelController",v),e.data("$mdSelectController",E),g=n.$new(),h=o(h)(g),b=h.find("md-select-menu").controller("mdSelectMenu")}function m(e){var t=[32,13,38,40];if(-1!=t.indexOf(e.keyCode))e.preventDefault(),u(e);else if(e.keyCode<=90&&e.keyCode>=31){e.preventDefault();var n=b.optNodeForKeyboardSearch(e);if(!n)return;var r=angular.element(n).controller("mdOption");b.isMultiple||b.deselect(Object.keys(b.selected)[0]),b.select(r.hashKey,r.value),b.refreshViewValue(),v.$render()}}function u(){n.$evalAsync(function(){p=!0,e.show({scope:g,preserveScope:!0,skipCompile:!0,element:h,target:r[0],hasBackdrop:!0,loadingAsync:i.mdOnOpen?n.$eval(i.mdOnOpen)||!0:!1}).then(function(e){p=!1})})}var p,f,h,g,b,E=d[0],v=d[1],M=d[2],$=r.find("md-select-label"),C=0!==$.text().length;if(l(),i.name&&M){var A=r.parent()[0].querySelector('select[name=".'+i.name+'"]');M.$removeControl(angular.element(A).controller())}var T=v.$render;v.$render=function(){T(),c()};var y;E.setLabelText=function(e){if(!C){E.setIsPlaceholder(!e);var t=e||i.placeholder||"",n=C?$:$.children().eq(0);y||(n.text("M"),y=n[0].offsetHeight);var r=!1,o=!1;do n.text(t),n[0].offsetHeight>y?(t=t.slice(0,-1),o=!0):(1==o&&(t=t.slice(0,-3)+"...",n.text(t)),r=!0);while(!r)}},E.setIsPlaceholder=function(e){e?$.addClass("md-placeholder"):$.removeClass("md-placeholder")},n.$$postDigest(c);var k;i.$observe("ngMultiple",function(e){k&&k();var t=a(e);k=n.$watch(function(){return t(n)},function(e,t){(void 0!==e||void 0!==t)&&(e?r.attr("multiple","multiple"):r.removeAttr("multiple"),h&&(b.setMultiple(e),T=v.$render,v.$render=function(){T(),c()},b.refreshViewValue(),v.$render()))})}),i.$observe("disabled",function(e){"string"==typeof e&&(e=!0),(void 0===f||f!==e)&&(f=e,e?(r.attr({tabindex:-1,"aria-disabled":"true"}),r.off("click",u),r.off("keydown",m)):(r.attr({tabindex:i.tabindex,"aria-disabled":"false"}),r.on("click",u),r.on("keydown",m)))}),i.disabled||i.ngDisabled||(r.attr({tabindex:i.tabindex,"aria-disabled":"false"}),r.on("click",u),r.on("keydown",m)),r.attr({role:"combobox",id:"select_"+t.nextUid(),"aria-expanded":"false","aria-labelledby":$.attr("id")}),n.$on("$destroy",function(){p?e.cancel().then(function(){h.remove()}):h.remove()})}}r.startSymbol(),r.endSymbol();return{restrict:"E",require:["mdSelect","ngModel","?^form"],compile:i,controller:function(){}}}function SelectMenuDirective(e,t,n){function r(e,r,o,a){function i(){r.attr({id:"select_menu_"+t.nextUid(),role:"listbox","aria-multiselectable":l.isMultiple?"true":"false"})}function d(e){(13==e.keyCode||32==e.keyCode)&&c(e)}function c(n){var r=t.getClosest(n.target,"md-option"),o=r&&angular.element(r).data("$mdOptionController");if(r&&o){var a=l.hashGetter(o.value),i=angular.isDefined(l.selected[a]);e.$apply(function(){l.isMultiple?i?l.deselect(a):l.select(a,o.value):i||(l.deselect(Object.keys(l.selected)[0]),l.select(a,o.value)),l.refreshViewValue()})}}var l=a[0],m=a[1];n(r),r.on("click",c),r.on("keypress",d),m&&l.init(m),i()}function o(t,n,r){function o(){var e=i.ngModel.$modelValue||i.ngModel.$viewValue;if(angular.isArray(e)){var t=Object.keys(i.selected),n=e.map(i.hashGetter),r=t.filter(function(e){return-1===n.indexOf(e)});r.forEach(i.deselect),n.forEach(function(t,n){i.select(t,e[n])})}}function a(){var e=i.ngModel.$viewValue||i.ngModel.$modelValue;Object.keys(i.selected).forEach(i.deselect),i.select(i.hashGetter(e),e)}var i=this;i.isMultiple=angular.isDefined(n.multiple),i.selected={},i.options={};var d;i.setMultiple=function(e){function r(e,t){return angular.isArray(e||t||[])}var c=i.ngModel;i.isMultiple=e,d&&d(),i.isMultiple?(c.$validators["md-multiple"]=r,c.$render=o,t.$watchCollection(n.ngModel,function(e){r(e)&&o(e)})):(delete c.$validators["md-multiple"],c.$render=a)};var c,l,m,s="",u=300;i.optNodeForKeyboardSearch=function(e){c&&clearTimeout(c),c=setTimeout(function(){c=void 0,s="",m=void 0,l=void 0},u),s+=String.fromCharCode(e.keyCode);var t=new RegExp("^"+s,"i");l||(l=r.find("md-option"),m=new Array(l.length),angular.forEach(l,function(e,t){m[t]=e.textContent.trim()}));for(var n=0;n<m.length;++n)if(t.test(m[n]))return l[n]},i.init=function(n){if(i.ngModel=n,n.$options&&n.$options.trackBy){var r={},o=e(n.$options.trackBy);i.hashGetter=function(e,n){return r.$value=e,o(n||t,r)}}else i.hashGetter=function(e){return angular.isObject(e)?"$$object_"+(e.$$mdSelectId||(e.$$mdSelectId=++selectNextId)):e};i.setMultiple(i.isMultiple)},i.selectedLabels=function(){var e=nodesToArray(r[0].querySelectorAll("md-option[selected]"));return e.length?e.map(function(e){return e.textContent}).join(", "):""},i.select=function(e,t){var n=i.options[e];n&&n.setSelected(!0),i.selected[e]=t},i.deselect=function(e){var t=i.options[e];t&&t.setSelected(!1),delete i.selected[e]},i.addOption=function(e,t){if(angular.isDefined(i.options[e]))throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "'+t.value+'" found.');i.options[e]=t,angular.isDefined(i.selected[e])&&(i.select(e,t.value),i.refreshViewValue())},i.removeOption=function(e){delete i.options[e]},i.refreshViewValue=function(){var e,t=[];for(var n in i.selected)t.push((e=i.options[n])?e.value:i.selected[n]);i.ngModel.$setViewValue(i.isMultiple?t:t[0])}}return o.$inject=["$scope","$attrs","$element"],{restrict:"E",require:["mdSelectMenu","?ngModel"],controller:o,link:{pre:r}}}function OptionDirective(e,t){function n(e,t){return e.append(angular.element('<div class="md-text">').append(e.contents())),e.attr("tabindex",t.tabindex||"0"),r}function r(n,r,o,a){function i(e,t){var r=l.hashGetter(t,n),o=l.hashGetter(e,n);c.hashKey=o,c.value=e,l.removeOption(r,c),l.addOption(o,c)}function d(){r.attr({role:"option","aria-selected":"false",id:"select_option_"+t.nextUid()})}var c=a[0],l=a[1];angular.isDefined(o.ngValue)?n.$watch(o.ngValue,i):angular.isDefined(o.value)?i(o.value):n.$watch(function(){return r.text()},i),n.$$postDigest(function(){o.$observe("selected",function(e){angular.isDefined(e)&&(e?(l.isMultiple||l.deselect(Object.keys(l.selected)[0]),l.select(c.hashKey,c.value)):l.deselect(c.hashKey),l.refreshViewValue(),l.ngModel.$render())})}),e.attachButtonBehavior(n,r),d(),n.$on("$destroy",function(){l.removeOption(c.hashKey,c)})}function o(e){this.selected=!1,this.setSelected=function(t){t&&!this.selected?e.attr({selected:"selected","aria-selected":"true"}):!t&&this.selected&&(e.removeAttr("selected"),e.attr("aria-selected","false")),this.selected=t}}return o.$inject=["$element"],{restrict:"E",require:["mdOption","^^mdSelectMenu"],controller:o,compile:n}}function OptgroupDirective(){function e(e,t){var n=e.find("label");n.length||(n=angular.element("<label>"),e.prepend(n)),t.label&&n.text(t.label)}return{restrict:"E",compile:e}}function SelectProvider(e){function t(e,t,o,a,i,d,c){function l(n,r,l){function m(){l.selectEl.attr("aria-labelledby",l.target.attr("id")),l.target.attr("aria-expanded","true")}function u(){function o(e){var t=nodesToArray(p),n=t.indexOf(l.focusedNode);-1===n?n=0:"next"===e&&n<t.length-1?n++:"prev"===e&&n>0&&n--;var r=l.focusedNode=t[n];r&&r.focus()}function i(){o("next")}function d(){o("prev")}function c(){m.isMultiple||(l.restoreFocus=!0,n.$evalAsync(function(){e.hide(m.ngModel.$viewValue)}))}if(!l.isRemoved){var m=l.selectEl.controller("mdSelectMenu")||{};r.addClass("md-clickable"),l.backdrop&&l.backdrop.on("click",function(t){t.preventDefault(),t.stopPropagation(),l.restoreFocus=!1,n.$apply(e.cancel)}),l.selectEl.on("keydown",function(r){switch(r.keyCode){case t.KEY_CODE.SPACE:case t.KEY_CODE.ENTER:var o=a.getClosest(r.target,"md-option");o&&(l.selectEl.triggerHandler({type:"click",target:o}),r.preventDefault());break;case t.KEY_CODE.TAB:case t.KEY_CODE.ESCAPE:r.preventDefault(),l.restoreFocus=!0,n.$apply(e.cancel)}}),l.selectEl.on("keydown",function(e){switch(e.keyCode){case t.KEY_CODE.UP_ARROW:return d();case t.KEY_CODE.DOWN_ARROW:return i();default:if(e.keyCode>=31&&e.keyCode<=90){var n=l.selectEl.controller("mdSelectMenu").optNodeForKeyboardSearch(e);n&&n.focus()}}}),l.selectEl.on("click",c),l.selectEl.on("keydown",function(e){(32==e.keyCode||13==e.keyCode)&&c()})}}if(!l.target)throw new Error('$mdSelect.show() expected a target element in options.target but got "'+l.target+'"!');angular.extend(l,{isRemoved:!1,target:angular.element(l.target),parent:angular.element(l.parent),selectEl:r.find("md-select-menu"),contentEl:r.find("md-content"),backdrop:l.hasBackdrop&&angular.element('<md-backdrop class="md-select-backdrop md-click-catcher">')}),l.resizeFn=function(){o(function(){o(function(){
s(n,r,l)})})},angular.element(c).on("resize",l.resizeFn),angular.element(c).on("orientationchange",l.resizeFn),m(),r.removeClass("md-leave");var p=l.selectEl[0].getElementsByTagName("md-option");return l.loadingAsync&&l.loadingAsync.then?l.loadingAsync.then(function(){n.$$loadingAsyncDone=!0,o(function(){o(function(){l.isRemoved||s(n,r,l)})})}):l.loadingAsync&&(n.$$loadingAsyncDone=!0),l.disableParentScroll&&!a.getClosest(l.target,"MD-DIALOG")?l.restoreScroll=a.disableScrollAround(l.target):l.disableParentScroll=!1,d(u,75,!1),l.backdrop&&(i.inherit(l.backdrop,l.parent),l.parent.append(l.backdrop)),l.parent.append(r),o(function(){o(function(){l.isRemoved||s(n,r,l)})}),a.transitionEndPromise(l.selectEl,{timeout:350})}function m(e,t,n){n.isRemoved=!0,t.addClass("md-leave").removeClass("md-clickable"),n.target.attr("aria-expanded","false"),angular.element(c).off("resize",n.resizeFn),angular.element(c).off("orientationchange",n.resizefn),n.resizeFn=void 0;var r=n.selectEl.controller("mdSelect");return r&&r.setLabelText(n.selectEl.controller("mdSelectMenu").selectedLabels()),a.transitionEndPromise(t,{timeout:350}).then(function(){t.removeClass("md-active"),n.backdrop&&n.backdrop.remove(),t[0].parentNode===n.parent[0]&&n.parent[0].removeChild(t[0]),n.disableParentScroll&&n.restoreScroll(),n.restoreFocus&&n.target.focus()})}function s(e,i,d){var l,m=i[0],s=d.target[0],u=d.parent[0],p=d.selectEl[0],f=d.contentEl[0],h=u.getBoundingClientRect(),g=s.getBoundingClientRect(),b=!1,E={left:h.left+SELECT_EDGE_MARGIN,top:SELECT_EDGE_MARGIN,bottom:h.height-SELECT_EDGE_MARGIN,right:h.width-SELECT_EDGE_MARGIN-(a.floatingScrollbars()?16:0)},v={top:g.top-E.top,left:g.left-E.left,right:E.right-(g.left+g.width),bottom:E.bottom-(g.top+g.height)},M=h.width-2*SELECT_EDGE_MARGIN,$=f.scrollHeight>f.offsetHeight,C=p.querySelector("md-option[selected]"),A=p.getElementsByTagName("md-option"),T=p.getElementsByTagName("md-optgroup");l=C?C:T.length?T[0]:A.length?A[0]:f.firstElementChild||f,f.offsetWidth>M&&(f.style["max-width"]=M+"px"),b&&(f.style["min-width"]=g.width+"px"),$&&p.classList.add("md-overflow");var y=p.getBoundingClientRect(),k=r(l);if(l){var w=c.getComputedStyle(l);k.paddingLeft=parseInt(w.paddingLeft,10)||0,k.paddingRight=parseInt(w.paddingRight,10)||0}var N=l;if("MD-OPTGROUP"===(N.tagName||"").toUpperCase()&&(N=A[0]||f.firstElementChild||f),$){var x=f.offsetHeight/2;f.scrollTop=k.top+k.height/2-x,v.top<x?f.scrollTop=Math.min(k.top,f.scrollTop+x-v.top):v.bottom<x&&(f.scrollTop=Math.max(k.top+k.height-y.height,f.scrollTop-x+v.bottom))}var _,H,S;b?(_=g.left,H=g.top+g.height,S="50% 0",H+y.height>E.bottom&&(H=g.top-y.height,S="50% 100%")):(_=g.left+k.left-k.paddingLeft,H=g.top+g.height/2-k.height/2-k.top+f.scrollTop,S=k.left+g.width/2+"px "+(k.top+k.height/2-f.scrollTop)+"px 0px",m.style.minWidth=g.width+k.paddingLeft+k.paddingRight+"px");var D=m.getBoundingClientRect();m.style.left=n(E.left,_,E.right-D.width)+"px",m.style.top=n(E.top,H,E.bottom-D.height)+"px",p.style[t.CSS.TRANSFORM_ORIGIN]=S,p.style[t.CSS.TRANSFORM]="scale("+Math.min(g.width/y.width,1)+","+Math.min(g.height/y.height,1)+")",o(function(){i.addClass("md-active"),p.style[t.CSS.TRANSFORM]="",N&&(d.focusedNode=N,N.focus())})}return{parent:"body",onShow:l,onRemove:m,hasBackdrop:!0,disableParentScroll:!0,themable:!0}}function n(e,t,n){return Math.max(e,Math.min(t,n))}function r(e){return e?{left:e.offsetLeft,top:e.offsetTop,width:e.offsetWidth,height:e.offsetHeight}:{left:0,top:0,width:0,height:0}}return t.$inject=["$mdSelect","$mdConstant","$$rAF","$mdUtil","$mdTheming","$timeout","$window"],e("$mdSelect").setDefaults({methods:["target"],options:t})}function nodesToArray(e){for(var t=[],n=0;n<e.length;++n)t.push(e.item(n));return t}function mdRadioGroupDirective(e,t,n,r){function o(o,a,i,d){function c(){a.hasClass("md-focused")||a.addClass("md-focused")}function l(n){var r=n.which||n.keyCode;switch(r){case t.KEY_CODE.LEFT_ARROW:case t.KEY_CODE.UP_ARROW:n.preventDefault(),m.selectPrevious(),c();break;case t.KEY_CODE.RIGHT_ARROW:case t.KEY_CODE.DOWN_ARROW:n.preventDefault(),m.selectNext(),c();break;case t.KEY_CODE.ENTER:var o=angular.element(e.getClosest(a[0],"form"));o.length>0&&o.triggerHandler("submit")}}n(a);var m=d[0],s=d[1]||e.fakeNgModel();m.init(s),o.mouseActive=!1,a.attr({role:"radiogroup",tabIndex:a.attr("tabindex")||"0"}).on("keydown",l).on("mousedown",function(e){o.mouseActive=!0,r(function(){o.mouseActive=!1},100)}).on("focus",function(){o.mouseActive===!1&&m.$element.addClass("md-focused")}).on("blur",function(){m.$element.removeClass("md-focused")})}function a(e){this._radioButtonRenderFns=[],this.$element=e}function i(){return{init:function(e){this._ngModelCtrl=e,this._ngModelCtrl.$render=angular.bind(this,this.render)},add:function(e){this._radioButtonRenderFns.push(e)},remove:function(e){var t=this._radioButtonRenderFns.indexOf(e);-1!==t&&this._radioButtonRenderFns.splice(t,1)},render:function(){this._radioButtonRenderFns.forEach(function(e){e()})},setViewValue:function(e,t){this._ngModelCtrl.$setViewValue(e,t),this.render()},getViewValue:function(){return this._ngModelCtrl.$viewValue},selectNext:function(){return d(this.$element,1)},selectPrevious:function(){return d(this.$element,-1)},setActiveDescendant:function(e){this.$element.attr("aria-activedescendant",e)}}}function d(t,n){var r=e.iterator(t[0].querySelectorAll("md-radio-button"),!0);if(r.count()){var o=function(e){return!angular.element(e).attr("disabled")},a=t[0].querySelector("md-radio-button.md-checked"),i=r[0>n?"previous":"next"](a,o)||r.first();angular.element(i).triggerHandler("click")}}return a.prototype=i(),{restrict:"E",controller:["$element",a],require:["mdRadioGroup","?ngModel"],link:{pre:o}}}function mdRadioButtonDirective(e,t,n){function r(r,a,i,d){function c(e){a[0].hasAttribute("disabled")||r.$apply(function(){d.setViewValue(i.value,e&&e.type)})}function l(){var e=d.getViewValue()==i.value;e!==s&&(s=e,a.attr("aria-checked",e),e?(a.addClass(o),d.setActiveDescendant(a.attr("id"))):a.removeClass(o))}function m(n,r){function o(){return i.id||"radio_"+t.nextUid()}r.ariaId=o(),n.attr({id:r.ariaId,role:"radio","aria-checked":"false"}),e.expectWithText(n,"aria-label")}var s;n(a),m(a,r),d.add(l),i.$observe("value",l),a.on("click",c).on("$destroy",function(){d.remove(l)})}var o="md-checked";return{restrict:"E",require:"^mdRadioGroup",transclude:!0,template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-off"></div><div class="md-on"></div></div><div ng-transclude class="md-label"></div>',link:r}}function SidenavService(e,t){return function(n){function r(){return e.when(n).then(function(e){return i=e,e})}var o,a="SideNav '"+n+"' is not available!",i=e.get(n);return i||e.notFoundError(n),o={isOpen:function(){return i&&i.isOpen()},isLockedOpen:function(){return i&&i.isLockedOpen()},toggle:function(){return i?i.toggle():t.reject(a)},open:function(){return i?i.open():t.reject(a)},close:function(){return i?i.close():t.reject(a)},then:function(e){var n=i?t.when(i):r();return n.then(e||angular.noop)}}}}function SidenavFocusDirective(){return{restrict:"A",require:"^mdSidenav",link:function(e,t,n,r){r.focusElement(t)}}}function SidenavDirective(e,t,n,r,o,a,i,d,c,l){function m(m,s,u,p){function f(e,n){m.isLockedOpen=e,e===n?s.toggleClass("md-locked-open",!!e):t[e?"addClass":"removeClass"](s,"md-locked-open"),y.toggleClass("md-locked-open",!!e)}function h(e){var n=s.parent();n[e?"on":"off"]("keydown",E),y[e?"on":"off"]("click",v),e&&($=l[0].activeElement);var r=p.focusElement();return g(e),C=c.all([e?t.enter(y,n):t.leave(y),t[e?"removeClass":"addClass"](s,"md-closed")]).then(function(){m.isOpen&&r&&r.focus()})}function g(e){var t=s.parent();e?(M=t.css("overflow"),t.css("overflow","hidden")):angular.isDefined(M)&&(t.css("overflow",M),M=void 0)}function b(t){if(m.isOpen==t)return c.when(!0);var n=c.defer();return m.isOpen=t,e(function(){C.then(function(e){m.isOpen||($&&$.focus(),$=null),n.resolve(e)})},0,!1),n.promise}function E(e){var t=e.keyCode===a.KEY_CODE.ESCAPE;return t?v(e):c.when(!0)}function v(e){return e.preventDefault(),e.stopPropagation(),p.close()}var M,$=null,C=c.when(!0),A=n(u.mdIsLockedOpen),T=function(){return A(m.$parent,{$media:function(e){return r.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."),o(e)},$mdMedia:o})},y=i('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(m);s.on("$destroy",p.destroy),d.inherit(y,s),m.$watch(T,f),m.$watch("isOpen",h),p.$toggleOpen=b,p.focusElement(p.focusElement()||s)}return{restrict:"E",scope:{isOpen:"=?mdIsOpen"},controller:"$mdSidenavController",compile:function(e){return e.addClass("md-closed"),e.attr("tabIndex","-1"),m}}}function SidenavController(e,t,n,r,o){var a,i=this;i.isOpen=function(){return!!e.isOpen},i.isLockedOpen=function(){return!!e.isLockedOpen},i.open=function(){return i.$toggleOpen(!0)},i.close=function(){return i.$toggleOpen(!1)},i.toggle=function(){return i.$toggleOpen(!e.isOpen)},i.focusElement=function(e){return angular.isDefined(e)&&(a=e),a},i.$toggleOpen=function(){return o.when(e.isOpen)},i.destroy=r.register(i,n.mdComponentId)}function SliderDirective(e,t,n,r,o,a,i,d){function c(e,t){return e.attr({tabIndex:0,role:"slider"}),n.expect(e,"aria-label"),l}function l(n,c,l,m){function s(){b(),$(),g()}function u(e){Y=parseFloat(e),c.attr("aria-valuemin",e),s()}function p(e){W=parseFloat(e),c.attr("aria-valuemax",e),s()}function f(e){z=parseFloat(e),g()}function h(e){c.attr("aria-disabled",!!e)}function g(){if(angular.isDefined(l.mdDiscrete)){var e=Math.floor((W-Y)/z);if(!X){var n=t.getComputedStyle(G[0]);X=angular.element('<canvas style="position:absolute;">'),Z=X[0].getContext("2d"),Z.fillStyle=n.backgroundColor||"black",G.append(X)}var r=E();X[0].width=r.width,X[0].height=r.height;for(var o,a=0;e>=a;a++)o=Math.floor(r.width*(a/e)),Z.fillRect(o-1,0,2,r.height)}}function b(){Q=j[0].getBoundingClientRect()}function E(){return U(),Q}function v(e){if(!c[0].hasAttribute("disabled")){var t;e.keyCode===o.KEY_CODE.LEFT_ARROW?t=-z:e.keyCode===o.KEY_CODE.RIGHT_ARROW&&(t=z),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),n.$evalAsync(function(){M(m.$viewValue+t)}))}}function M(e){m.$setViewValue(C(A(e)))}function $(){isNaN(m.$viewValue)&&(m.$viewValue=m.$modelValue);var e=(m.$viewValue-Y)/(W-Y);n.modelValue=m.$viewValue,c.attr("aria-valuenow",m.$viewValue),T(e),F.text(m.$viewValue)}function C(e){return angular.isNumber(e)?Math.max(Y,Math.min(W,e)):void 0}function A(e){return angular.isNumber(e)?Math.round(e/z)*z:void 0}function T(e){q.css("width",100*e+"%"),B.css("left",100*e+"%"),c.toggleClass("md-min",0===e)}function y(e){if(!R()){c.addClass("active"),c[0].focus(),b();var t=I(D(e.pointer.x)),r=C(A(t));n.$apply(function(){M(r),T(O(r))})}}function k(e){if(!R()){c.removeClass("dragging active");var t=I(D(e.pointer.x)),r=C(A(t));n.$apply(function(){M(r),$()})}}function w(e){R()||(J=!0,e.stopPropagation(),c.addClass("dragging"),_(e))}function N(e){J&&(e.stopPropagation(),_(e))}function x(e){J&&(e.stopPropagation(),J=!1)}function _(e){ee?S(e.pointer.x):H(e.pointer.x)}function H(e){n.$evalAsync(function(){M(I(D(e)))})}function S(e){var t=I(D(e)),n=C(A(t));T(D(e)),F.text(n)}function D(e){return Math.max(0,Math.min(1,(e-Q.left)/Q.width))}function I(e){return Y+e*(W-Y)}function O(e){return(e-Y)/(W-Y)}a(c),m=m||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var L=l.ngDisabled&&d(l.ngDisabled),R=L?function(){return L(n.$parent)}:angular.noop,P=angular.element(c[0].querySelector(".md-thumb")),F=angular.element(c[0].querySelector(".md-thumb-text")),B=P.parent(),j=angular.element(c[0].querySelector(".md-track-container")),q=angular.element(c[0].querySelector(".md-track-fill")),G=angular.element(c[0].querySelector(".md-track-ticks")),U=r.throttle(b,5e3);l.min?l.$observe("min",u):u(0),l.max?l.$observe("max",p):p(100),l.step?l.$observe("step",f):f(1);var V=angular.noop;l.ngDisabled&&(V=n.$parent.$watch(l.ngDisabled,h)),i.register(c,"drag"),c.on("keydown",v).on("$md.pressdown",y).on("$md.pressup",k).on("$md.dragstart",w).on("$md.drag",N).on("$md.dragend",x),setTimeout(s);var K=e.throttle(s);angular.element(t).on("resize",K),n.$on("$destroy",function(){angular.element(t).off("resize",K),V()}),m.$render=$,m.$viewChangeListeners.push($),m.$formatters.push(C),m.$formatters.push(A);var Y,W,z,X,Z,Q={};b();var J=!1,ee=angular.isDefined(l.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-slider-wrapper">        <div class="md-track-container">          <div class="md-track"></div>          <div class="md-track md-track-fill"></div>          <div class="md-track-ticks"></div>        </div>        <div class="md-thumb-container">          <div class="md-thumb"></div>          <div class="md-focus-thumb"></div>          <div class="md-focus-ring"></div>          <div class="md-sign">            <span class="md-thumb-text"></span>          </div>          <div class="md-disabled-thumb"></div>        </div>      </div>',compile:c}}function MdSticky(e,t,n,r,o){function a(e){function n(e,t){t.addClass("md-sticky-clone"),t.css("top",f+"px");var n={element:e,clone:t};return p.items.push(n),s.parent().prepend(n.clone),u(),function(){p.items.forEach(function(t,n){t.element[0]===e[0]&&(p.items.splice(n,1),t.clone.remove())}),u()}}function o(){p.items.forEach(a),p.items=p.items.sort(function(e,t){return e.top<t.top?-1:1});for(var e,t=s.prop("scrollTop"),n=p.items.length-1;n>=0;n--)if(t>p.items[n].top){e=p.items[n];break}c(e)}function a(e){var t=e.element[0];for(e.top=0,e.left=0;t&&t!==s[0];)e.top+=t.offsetTop,e.left+=t.offsetLeft,t=t.offsetParent;e.height=e.element.prop("offsetHeight"),e.clone.css("margin-left",e.left+"px")}function i(){var e=s.prop("scrollTop"),t=e>(i.prevScrollTop||0);i.prevScrollTop=e,0===e?c(null):t&&p.next?p.next.top-e<=0?c(p.next):p.current&&(p.next.top-e<=p.next.height?m(p.current,p.next.top-p.next.height-e):m(p.current,null)):!t&&p.current&&(e<p.current.top&&c(p.prev),p.current&&p.next&&(e>=p.next.top-p.current.height?m(p.current,p.next.top-e-p.current.height):m(p.current,null)))}function c(e){if(p.current!==e){p.current&&(m(p.current,null),l(p.current,null)),e&&l(e,"active"),p.current=e;var t=p.items.indexOf(e);p.next=p.items[t+1],p.prev=p.items[t-1],l(p.next,"next"),l(p.prev,"prev")}}function l(e,t){e&&e.state!==t&&(e.state&&(e.clone.attr("sticky-prev-state",e.state),e.element.attr("sticky-prev-state",e.state)),e.clone.attr("sticky-state",t),e.element.attr("sticky-state",t),e.state=t)}function m(e,n){e&&(null===n||void 0===n?e.translateY&&(e.translateY=null,e.clone.css(t.CSS.TRANSFORM,"")):(e.translateY=n,e.clone.css(t.CSS.TRANSFORM,"translate3d("+e.left+"px,"+n+"px,0)")))}var s=e.$element,u=r.throttle(o);d(s),s.on("$scrollstart",u),s.on("$scroll",i);var p,f=s.prop("offsetTop");return p={prev:null,current:null,next:null,items:[],add:n,refreshElements:o}}function i(t){var n,r=angular.element("<div>");e[0].body.appendChild(r[0]);for(var o=["sticky","-webkit-sticky"],a=0;a<o.length;++a)if(r.css({position:o[a],top:0,"z-index":2}),r.css("position")==o[a]){n=o[a];break}return r.remove(),n}function d(e){function t(){+o.now()-a>i?(n=!1,e.triggerHandler("$scrollend")):(e.triggerHandler("$scroll"),r(t))}var n,a,i=200;e.on("scroll touchmove",function(){n||(n=!0,r(t),e.triggerHandler("$scrollstart")),e.triggerHandler("$scroll"),a=+o.now()})}var c=i();return function(e,t,n){var r=t.controller("mdContent");if(r)if(c)t.css({position:c,top:0,"z-index":2});else{var o=r.$element.data("$$sticky");o||(o=a(r),r.$element.data("$$sticky",o));var i=o.add(t,n||t.clone());e.$on("$destroy",i)}}}function getDirective(e){function t(e){function t(t,o,a){var i=e(a[n]);o.on(r,function(e){t.$apply(function(){i(t,{$event:e})})})}return{restrict:"A",link:t}}var n="md"+e,r="$md."+e.toLowerCase();return t.$inject=["$parse"],t}function MdSubheaderDirective(e,t,n){return{restrict:"E",replace:!0,transclude:!0,template:'<h2 class="md-subheader"><div class="md-subheader-inner"><span class="md-subheader-content"></span></div></h2>',compile:function(r,o,a){var i=r[0].outerHTML;return function(r,o,d){function c(e){return angular.element(e[0].querySelector(".md-subheader-content"))}n(o),a(r,function(e){c(o).append(e)}),o.hasClass("md-no-sticky")||a(r,function(a){var d=t(angular.element(i))(r);n(d),c(d).append(a),e(r,o,d)})}}}}function MdSwitch(e,t,n,r,o,a,i,d){function c(e,t){var r=l.compile(e,t);return e.addClass("md-dragging"),function(e,t,c,l){function m(n){f(e)||(n.stopPropagation(),t.addClass("md-dragging"),b={width:h.prop("offsetWidth")},t.removeClass("transition"))}function s(e){if(b){e.stopPropagation(),e.srcEvent&&e.srcEvent.preventDefault();var t=e.pointer.distanceX/b.width,n=l.$viewValue?1+t:t;n=Math.max(0,Math.min(1,n)),h.css(o.CSS.TRANSFORM,"translate3d("+100*n+"%,0,0)"),b.translate=n}}function u(e){if(b){e.stopPropagation(),t.removeClass("md-dragging"),h.css(o.CSS.TRANSFORM,"");var n=l.$viewValue?b.translate<.5:b.translate>.5;n&&p(!l.$viewValue),b=null}}function p(t){e.$apply(function(){l.$setViewValue(t),l.$render()})}l=l||n.fakeNgModel();var f=a(c.ngDisabled),h=angular.element(t[0].querySelector(".md-thumb-container")),g=angular.element(t[0].querySelector(".md-container"));i(function(){t.removeClass("md-dragging")}),r(e,t,c,l),angular.isDefined(c.ngDisabled)&&e.$watch(f,function(e){t.attr("tabindex",e?-1:0)}),d.register(g,"drag"),g.on("$md.dragstart",m).on("$md.drag",s).on("$md.dragend",u);var b}}var l=e[0];return{restrict:"E",transclude:!0,template:'<div class="md-container"><div class="md-bar"></div><div class="md-thumb-container"><div class="md-thumb" md-ink-ripple md-ink-ripple-checkbox></div></div></div><div ng-transclude class="md-label"></div>',require:"?ngModel",compile:c}}function MdToastDirective(){return{restrict:"E"}}function MdToastProvider(e){function t(e,t,r,o){function a(a,i,c){return i=o.extractElementByName(i,"md-toast"),n=c.content,i.addClass(c.position.split(" ").map(function(e){return"md-"+e}).join(" ")),c.parent.addClass(d(c.position)),c.onSwipe=function(t,n){i.addClass("md-"+t.type.replace("$md.","")),e(r.cancel)},i.on("$md.swipeleft $md.swiperight",c.onSwipe),t.enter(i,c.parent)}function i(e,n,r){return n.off("$md.swipeleft $md.swiperight",r.onSwipe),r.parent.removeClass(d(r.position)),t.leave(n)}function d(e){return"md-toast-open-"+(e.indexOf("top")>-1?"top":"bottom")}return{onShow:a,onRemove:i,position:"bottom left",themable:!0,hideDelay:3e3}}var n,r=e("$mdToast").setDefaults({methods:["position","hideDelay","capsule"],options:t}).addPreset("simple",{argOption:"content",methods:["content","action","highlightAction","theme","parent"],options:["$mdToast","$mdTheming",function(e,t){var r={template:['<md-toast md-theme="{{ toast.theme }}" ng-class="{\'md-capsule\': toast.capsule}">',"<span flex>{{ toast.content }}</span>",'<md-button class="md-action" ng-if="toast.action" ng-click="toast.resolve()" ng-class="{\'md-highlight\': toast.highlightAction}">',"{{ toast.action }}","</md-button>","</md-toast>"].join(""),controller:["$scope",function(t){var r=this;t.$watch(function(){return n},function(){r.content=n}),this.resolve=function(){e.hide()}}],theme:t.defaultTheme(),controllerAs:"toast",bindToController:!0};return r}]}).addMethod("updateContent",function(e){n=e});return t.$inject=["$timeout","$animate","$mdToast","$mdUtil"],r}function mdToolbarDirective(e,t,n,r){return{restrict:"E",controller:angular.noop,link:function(o,a,i){function d(){function r(t,n){a.parent()[0]===n.parent()[0]&&(m&&m.off("scroll",f),n.on("scroll",f),n.attr("scroll-shrink","true"),m=n,e(d))}function d(){l=a.prop("offsetHeight"),m.css("margin-top",-l*p+"px"),c()}function c(e){var n=e?e.target.scrollTop:u;h(),s=Math.min(l/p,Math.max(0,s+n-u)),a.css(t.CSS.TRANSFORM,"translate3d(0,"+-s*p+"px,0)"),m.css(t.CSS.TRANSFORM,"translate3d(0,"+(l-s)*p+"px,0)"),u=n}var l,m,s=0,u=0,p=i.mdShrinkSpeedFactor||.5,f=e.throttle(c),h=n.debounce(d,5e3);o.$on("$mdContentLoaded",r)}r(a),angular.isDefined(i.mdScrollShrink)&&d()}}}function MdTooltipDirective(e,t,n,r,o,a,i,d,c){function l(l,u,p){function f(){h(),b(),M(),g()}function h(){angular.isDefined(p.mdDelay)||(l.delay=m)}function g(){l.$watch("visible",function(e){e?C():A()}),l.$on("$destroy",function(){l.visible=!1,u.remove(),angular.element(t).off("resize",H)})}function b(){u.detach(),u.attr("role","tooltip"),u.attr("id",p.id||"tooltip_"+o.nextUid())}function E(){for(var e=u.parent();"none"==t.getComputedStyle(e[0])["pointer-events"];)e=e.parent();return e}function v(){for(var e=u.parent()[0];e&&e!==i[0]&&e!==document.body&&(!e.tagName||"md-content"!=e.tagName.toLowerCase());)e=e.parentNode;return e}function M(){var e=l.hasOwnProperty("autohide")?l.autohide:p.hasOwnProperty("mdAutohide");y.on("focus mouseenter touchstart",function(){$(!0)}),y.on("blur mouseleave touchend touchcancel",function(){(r[0].activeElement!==y[0]||e)&&$(!1)}),angular.element(t).on("resize",H)}function $(t){$.value=!!t,$.queued||(t?($.queued=!0,e(function(){l.visible=$.value,$.queued=!1},l.delay)):e(function(){l.visible=!1}))}function C(){_.append(u);var e=t.getComputedStyle(u[0]);return angular.isDefined(e.display)&&"none"==e.display?void u.detach():(y.attr("aria-describedby",u.attr("id")),T(),void angular.forEach([u,k,w],function(e){d.addClass(e,"md-show")}))}function A(){y.removeAttr("aria-describedby"),c.all([d.removeClass(w,"md-show"),d.removeClass(k,"md-show"),d.removeClass(u,"md-show")]).then(function(){l.visible||u.detach()})}function T(){function e(){var e="left"===N||"right"===N?2*Math.sqrt(Math.pow(r.width,2)+Math.pow(r.height/2,2)):2*Math.sqrt(Math.pow(r.width/2,2)+Math.pow(r.height,2)),t="left"===N?{left:100,top:50}:"right"===N?{left:0,top:50}:"top"===N?{left:50,top:100}:{left:50,top:0};k.css({width:e+"px",height:e+"px",left:t.left+"%",top:t.top+"%"})}function t(e){var t={left:e.left,top:e.top};return t.left=Math.min(t.left,_.prop("scrollWidth")-r.width-s),t.left=Math.max(t.left,s),t.top=Math.min(t.top,_.prop("scrollHeight")-r.height-s),t.top=Math.max(t.top,s),t}function n(e){return"left"===e?{left:a.left-r.width-s,top:a.top+a.height/2-r.height/2}:"right"===e?{left:a.left+a.width+s,top:a.top+a.height/2-r.height/2}:"top"===e?{left:a.left+a.width/2-r.width/2,top:a.top-r.height-s}:{left:a.left+a.width/2-r.width/2,top:a.top+a.height+s}}var r=o.offsetRect(u,_),a=o.offsetRect(y,_),i=n(N);N?i=t(i):i.top>u.prop("offsetParent").scrollHeight-r.height-s&&(i=t(n("top"))),u.css({top:i.top+"px",left:i.left+"px"}),e()}a(u);var y=E(),k=angular.element(u[0].getElementsByClassName("md-background")[0]),w=angular.element(u[0].getElementsByClassName("md-content")[0]),N=p.mdDirection,x=v(),_=angular.element(x||document.body),H=n.throttle(function(){l.visible&&T()});return f()}var m=300,s=8;return{restrict:"E",transclude:!0,template:'        <div class="md-background"></div>        <div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay",autohide:"=?mdAutohide"},link:l}}function MdAutocompleteCtrl(e,t,n,r,o,a,i,d,c){function l(){p(),o(function(){f(),u(),s()})}function m(){function e(){var e=q.ul.getBoundingClientRect(),n={};e.right>r.right-MENU_PADDING&&(n.left=t.right-e.width+"px"),q.$.ul.css(n)}if(!q)return o(m,0,!1);var t=q.wrap.getBoundingClientRect(),n=q.snap.getBoundingClientRect(),r=q.root.getBoundingClientRect(),a=n.bottom-r.top,i=r.bottom-n.top,d=t.left-r.left,c=t.width,l={left:d+"px",minWidth:c+"px",maxWidth:Math.max(t.right-r.left,r.right-t.left)-MENU_PADDING+"px"};a>i&&r.height-t.bottom-MENU_PADDING<MAX_HEIGHT?(l.top="auto",l.bottom=i+"px",l.maxHeight=Math.min(MAX_HEIGHT,t.top-r.top-MENU_PADDING)+"px"):(l.top=a+"px",l.bottom="auto",l.maxHeight=Math.min(MAX_HEIGHT,r.bottom-t.bottom-MENU_PADDING)+"px"),q.$.ul.css(l),o(e,0,!1)}function s(){q.$.root.length&&(a(q.$.ul),q.$.ul.detach(),q.$.root.append(q.$.ul),d.pin&&d.pin(q.$.ul,c))}function u(){e.autofocus&&q.input.focus()}function p(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?n.debounce($,t):$),v(b),e.$watch("selectedItem",E),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){!e&&t&&m()}),angular.element(i).on("resize",m)}function f(){q={main:t[0],ul:t.find("ul")[0],input:t.find("input")[0],wrap:t.find("md-autocomplete-wrap")[0],root:document.body},q.snap=h(),q.$=g(q)}function h(){for(var e=t;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return q.wrap}function g(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function b(t,n){t&&(e.searchText=k(t)),e.itemChange&&t!==n&&e.itemChange(w(t))}function E(e,t){for(var n=0;n<K.length;++n)K[n](e,t)}function v(e){-1==K.indexOf(e)&&K.push(e)}function M(e){var t=K.indexOf(e);-1!=t&&K.splice(t,1)}function $(t,n){F.index=N(),(t||t!==n)&&t!==k(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(w(e.selectedItem)),H()?P():(F.loading=!1,F.matches=[],F.hidden=x(),O()))}function C(){Y=!1,V||(F.hidden=!0)}function A(){Y=!0,angular.isString(e.searchText)||(e.searchText=""),e.minLength>0||(F.hidden=x(),F.hidden||P())}function T(e){switch(e.keyCode){case r.KEY_CODE.DOWN_ARROW:if(F.loading)return;e.preventDefault(),F.index=Math.min(F.index+1,F.matches.length-1),R(),L();break;case r.KEY_CODE.UP_ARROW:if(F.loading)return;e.preventDefault(),F.index=F.index<0?F.matches.length-1:Math.max(0,F.index-1),R(),L();break;case r.KEY_CODE.ENTER:if(F.hidden||F.loading||F.index<0)return;e.preventDefault(),S(F.index);break;case r.KEY_CODE.ESCAPE:F.matches=[],F.hidden=!0,F.index=N();break;case r.KEY_CODE.TAB:}}function y(){return angular.isNumber(e.minLength)?e.minLength:1}function k(t){return t&&e.itemText?e.itemText(w(t)):t}function w(e){if(e){var t={};return F.itemName&&(t[F.itemName]=e),t}}function N(){return e.autoselect?0:-1}function x(){return H()?void 0:!0}function _(){return k(F.matches[F.index])}function H(){return e.searchText.length>=y()}function S(t){e.selectedItem=F.matches[t],e.searchText=k(e.selectedItem)||e.searchText,F.hidden=!0,F.index=0,F.matches=[]}function D(){e.searchText="",S(-1);var t=document.createEvent("CustomEvent");t.initCustomEvent("input",!0,!0,{value:e.searchText}),q.input.dispatchEvent(t),q.input.focus()}function I(t){function n(n){U[o]=n,t===e.searchText&&(G=null,F.loading=!1,F.matches=n,F.hidden=x(),O(),m())}var r=e.$parent.$eval(j),o=t.toLowerCase();angular.isArray(r)?n(r):(F.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){F.loading=!1}))}function O(){if(!F.hidden)switch(F.matches.length){case 0:return F.messages.splice(0);case 1:return F.messages.push({display:"There is 1 match available."});default:return F.messages.push({display:"There are "+F.matches.length+" matches available."})}}function L(){F.messages.push({display:_()})}function R(){var e=ITEM_HEIGHT*F.index,t=e+ITEM_HEIGHT,n=q.ul.clientHeight;e<q.ul.scrollTop?q.ul.scrollTop=e:t>q.ul.scrollTop+n&&(q.ul.scrollTop=t-n)}function P(){var t=e.searchText,n=t.toLowerCase();G&&G.cancel&&(G.cancel(),G=null),!e.noCache&&U[n]?(F.matches=U[n],O()):I(t),F.hidden=x()}var F=this,B=e.itemsExpr.split(/ in /i),j=B[1],q=null,G=null,U={},V=!1,K=[],Y=!1;return F.scope=e,F.parent=e.$parent,F.itemName=B[0],F.matches=[],F.loading=!1,F.hidden=!0,F.index=null,F.messages=[],F.id=n.nextUid(),F.keydown=T,F.blur=C,F.focus=A,F.clear=D,F.select=S,F.getCurrentDisplayValue=_,F.registerSelectedItemWatcher=v,F.unregisterSelectedItemWatcher=M,F.listEnter=function(){V=!0},F.listLeave=function(){V=!1,Y||(F.hidden=!0)},F.mouseUp=function(){q.input.focus()},l()}function MdAutocomplete(e,t){function n(n,r,o){o.ngDisabled&&n.$parent.$watch(o.ngDisabled,function(e){n.isDisabled=e}),n.contents=o.$mdAutocompleteTemplate,delete o.$mdAutocompleteTemplate,t.initOptionalProperties(n,o,{searchText:null,selectedItem:null}),e(r)}return{controller:"MdAutocompleteCtrl",controllerAs:"$mdAutocompleteCtrl",link:n,scope:{name:"@",searchText:"=?mdSearchText",selectedItem:"=?mdSelectedItem",itemsExpr:"@mdItems",itemText:"&mdItemText",placeholder:"@placeholder",noCache:"=?mdNoCache",itemChange:"&?mdSelectedItemChange",textChange:"&?mdSearchTextChange",minLength:"=?mdMinLength",delay:"=?mdDelay",autofocus:"=?mdAutofocus",floatingLabel:"@?mdFloatingLabel",autoselect:"=?mdAutoselect",menuClass:"@?mdMenuClass"},template:function(e,t){return t.$mdAutocompleteTemplate=e.html(),'        <md-autocomplete-wrap role="listbox">          <md-input-container ng-if="floatingLabel">            <label>{{floatingLabel}}</label>            <input type="text"                id="fl-input-{{$mdAutocompleteCtrl.id}}"                name="{{name}}"                autocomplete="off"                ng-disabled="isDisabled"                ng-model="$mdAutocompleteCtrl.scope.searchText"                ng-keydown="$mdAutocompleteCtrl.keydown($event)"                ng-blur="$mdAutocompleteCtrl.blur()"                ng-focus="$mdAutocompleteCtrl.focus()"                aria-owns="ul-{{$mdAutocompleteCtrl.id}}"                aria-label="{{floatingLabel}}"                aria-autocomplete="list"                aria-haspopup="true"                aria-activedescendant=""                aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>                        </md-input-container>          <input type="text"              id="input-{{$mdAutocompleteCtrl.id}}"              name="{{name}}"              ng-if="!floatingLabel"              autocomplete="off"              ng-disabled="isDisabled"              ng-model="$mdAutocompleteCtrl.scope.searchText"              ng-keydown="$mdAutocompleteCtrl.keydown($event)"              ng-blur="$mdAutocompleteCtrl.blur()"              ng-focus="$mdAutocompleteCtrl.focus()"              placeholder="{{placeholder}}"              aria-owns="ul-{{$mdAutocompleteCtrl.id}}"              aria-label="{{placeholder}}"              aria-autocomplete="list"              aria-haspopup="true"              aria-activedescendant=""              aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>          <button              type="button"              tabindex="-1"              ng-if="$mdAutocompleteCtrl.scope.searchText && !isDisabled"              ng-click="$mdAutocompleteCtrl.clear()">            <md-icon md-svg-icon="cancel"></md-icon>            <span class="md-visually-hidden">Clear</span>          </button>          <md-progress-linear              ng-if="$mdAutocompleteCtrl.loading"              md-mode="indeterminate"></md-progress-linear>          <ul role="presentation"              class="md-autocomplete-suggestions {{menuClass || \'\'}}"              id="ul-{{$mdAutocompleteCtrl.id}}"              ng-mouseenter="$mdAutocompleteCtrl.listEnter()"              ng-mouseleave="$mdAutocompleteCtrl.listLeave()"              ng-mouseup="$mdAutocompleteCtrl.mouseUp()">            <li ng-repeat="(index, item) in $mdAutocompleteCtrl.matches"                ng-class="{ selected: index === $mdAutocompleteCtrl.index }"                ng-hide="$mdAutocompleteCtrl.hidden"                ng-click="$mdAutocompleteCtrl.select(index)"                md-autocomplete-list-item-template="contents"                md-autocomplete-list-item="$mdAutocompleteCtrl.itemName">            </li>          </ul>        </md-autocomplete-wrap>        <aria-status            class="md-visually-hidden"            role="status"            aria-live="assertive">          <p ng-repeat="message in $mdAutocompleteCtrl.messages">{{message.display}}</p>        </aria-status>'}}}function MdHighlightCtrl(e,t,n){function r(e){return e?e.replace(/[\\\^\$\*\+\?\.\(\)\|\{\}\[\]]/g,"\\$&"):e}function o(e,t){var n="";return t.indexOf("^")>=1&&(n+="^"),n+=e,t.indexOf("$")>=1&&(n+="$"),new RegExp(r(n),t.replace(/[\$\^]/g,""))}var a=t.attr("md-highlight-text"),i=n(t.text())(e),d=t.attr("md-highlight-flags")||"",c=e.$watch(a,function(e){var n=o(e,d),r=i.replace(n,'<span class="highlight">$&</span>');t.html(r)});t.on("$destroy",function(){c();

})}function MdHighlight(){return{terminal:!0,scope:!1,controller:"MdHighlightCtrl"}}function MdAutocompleteListItem(e,t){function n(n,r,o){var a=n.$parent.$mdAutocompleteCtrl,i=a.parent.$new(!1,a.parent),d=a.scope.$eval(o.mdAutocompleteListItem);i[d]=n.item,r.html(a.scope.$eval(o.mdAutocompleteListItemTemplate)),e(r.contents())(i),r.attr({role:"option",id:"item_"+t.nextUid()})}return{terminal:!0,link:n,scope:!1}}function MdChip(e){function t(t,n){return t.append(DELETE_HINT_TEMPLATE),function(t,n,r,o){o&&angular.element(n[0].querySelector(".md-chip-content")).on("blur",function(){o.$scope.$apply(function(){o.selectedChip=-1})}),n.addClass("md-chip"),e(n)}}return{restrict:"E",require:"^?mdChips",compile:t}}function MdChipRemove(e){function t(t,n,r,o){n.on("click",function(e){t.$apply(function(){o.removeChip(t.$$replacedScope.$index)})}),e(function(){n.attr({tabindex:-1,ariaHidden:!0}),n.find("button").attr("tabindex","-1")})}return{restrict:"A",require:"^mdChips",scope:!1,link:t}}function MdChipTransclude(e,t){function n(t,n,r){var o=t.$parent.$mdChipsCtrl,a=o.parent.$new(!1,o.parent);a.$$replacedScope=t,a.$chip=t.$chip,a.$mdChipsCtrl=o,n.html(o.$scope.$eval(r.mdChipTransclude)),e(n.contents())(a)}return{restrict:"EA",terminal:!0,link:n,scope:!1}}function MdChipsCtrl(e,t,n,r,o){this.$timeout=o,this.$mdConstant=t,this.$scope=e,this.parent=e.$parent,this.$log=n,this.$element=r,this.ngModelCtrl=null,this.userInputNgModelCtrl=null,this.userInputElement=null,this.items=[],this.selectedChip=-1,this.deleteHint="Press delete to remove this chip.",this.deleteButtonLabel="Remove",this.chipBuffer="",this.useMdOnAppend=!1}function MdChips(e,t,n,r){function o(o,a){function i(e){if(a.ngModel){var t=d[0].querySelector(e);return t&&t.outerHTML}}var d=a.$mdUserTemplate;a.$mdUserTemplate=null;var c=i("[md-chip-remove]")||CHIP_REMOVE_TEMPLATE,l=i("md-chip-template")||CHIP_DEFAULT_TEMPLATE,m=i("md-autocomplete")||i("input")||CHIP_INPUT_TEMPLATE,s=d.find("md-chip");return function(o,i,d,u){t.initOptionalProperties(o,a),e(i);var p=u[0];if(p.chipContentsTemplate=l,p.chipRemoveTemplate=c,p.chipInputTemplate=m,i.attr({ariaHidden:!0,tabindex:-1}).on("focus",function(){p.onFocus()}),a.ngModel&&(p.configureNgModel(i.controller("ngModel")),d.mdOnAppend&&p.useMdOnAppendExpression(),m!=CHIP_INPUT_TEMPLATE&&r(function(){0===m.indexOf("<md-autocomplete")&&p.configureAutocomplete(i.find("md-autocomplete").controller("mdAutocomplete")),p.configureUserInput(i.find("input"))})),s.length>0){var f=n(s)(o.$parent);r(function(){i.find("md-chips-wrap").prepend(f)})}}}return{template:function(e,t){return t.$mdUserTemplate=e.clone(),MD_CHIPS_TEMPLATE},require:["mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:o,scope:{readonly:"=readonly",placeholder:"@",secondaryPlaceholder:"@",mdOnAppend:"&",deleteHint:"@",deleteButtonLabel:"@",requireMatch:"=?mdRequireMatch"}}}function MdContactChipsCtrl(){this.selectedItem=null,this.searchText=""}function MdContactChips(e,t){function n(n,r){return function(n,o,a,i){t.initOptionalProperties(n,r),e(o),o.attr("tabindex","-1")}}return{template:function(e,t){return MD_CONTACT_CHIPS_TEMPLATE},restrict:"E",controller:"MdContactChipsCtrl",controllerAs:"$mdContactChipsCtrl",bindToController:!0,compile:n,scope:{contactQuery:"&mdContacts",placeholder:"@",secondaryPlaceholder:"@",contactName:"@mdContactName",contactImage:"@mdContactImage",contactEmail:"@mdContactEmail",filterSelected:"=",contacts:"=ngModel",requireMatch:"=?mdRequireMatch"}}}function MdTab(){function e(e,t,n,r){function o(){function e(){return n.label}function r(){var e=t.find("md-tab-label");return e.length?e.remove().html():void 0}function o(){var e=t.html();return t.empty(),e}n.label||(t.find("md-tab-label")[0]||t[0]).innerHTML;return e()||r()||o()}function a(){var e=t.find("md-tab-body"),r=e.length?e.html():n.label?t.html():null;return e.length?e.remove():n.label&&t.empty(),r}if(r){var i=t.parent()[0].getElementsByTagName("md-tab"),d=Array.prototype.indexOf.call(i,t[0]),c=r.insertTab({scope:e,parent:e.$parent,index:d,template:a(),label:o()},d);e.deselect=e.deselect||angular.noop,e.select=e.select||angular.noop,e.$watch("active",function(e){e&&r.select(c.getIndex())}),e.$watch("disabled",function(){r.refreshIndex()}),e.$on("$destroy",function(){r.removeTab(c)})}}return{require:"^?mdTabs",terminal:!0,scope:{label:"@",active:"=?mdActive",disabled:"=?ngDisabled",select:"&?mdOnSelect",deselect:"&?mdOnDeselect"},link:e}}function MdTabItem(){function e(e,t,n,r){r&&r.attachRipple(e,t)}return{require:"^?mdTabs",link:e}}function MdTabScroll(e){return{restrict:"A",compile:function(t,n){var r=e(n.mdTabScroll,null,!0);return function(e,t){t.on("mousewheel",function(t){e.$apply(function(){r(e,{$event:t})})})}}}}function MdTabsController(e,t,n,r,o,a,i,d){function c(){e.$watch("selectedIndex",A),e.$watch("$mdTabsCtrl.focusIndex",f),e.$watch("$mdTabsCtrl.offsetLeft",p),e.$watch("$mdTabsCtrl.hasContent",l),angular.element(n).on("resize",function(){e.$apply(b)}),r(k,0,!1),r(y,0,!1)}function l(e){t[e?"removeClass":"addClass"]("md-no-tab-content")}function m(){var e={};return e.wrapper=t[0].getElementsByTagName("md-tabs-wrapper")[0],e.canvas=e.wrapper.getElementsByTagName("md-tabs-canvas")[0],e.paging=e.canvas.getElementsByTagName("md-pagination-wrapper")[0],e.tabs=e.paging.getElementsByTagName("md-tab-item"),e.dummies=e.canvas.getElementsByTagName("md-dummy-tab"),e.inkBar=e.paging.getElementsByTagName("md-ink-bar")[0],e.contentsWrapper=t[0].getElementsByTagName("md-tabs-content-wrapper")[0],e.contents=e.contentsWrapper.getElementsByTagName("md-tab-content"),e}function s(t){switch(t.keyCode){case o.KEY_CODE.LEFT_ARROW:t.preventDefault(),u(-1,!0);break;case o.KEY_CODE.RIGHT_ARROW:t.preventDefault(),u(1,!0);break;case o.KEY_CODE.SPACE:case o.KEY_CODE.ENTER:t.preventDefault(),j||(e.selectedIndex=B.focusIndex)}B.lastClick=!1}function u(t,n){var r,o=n?B.focusIndex:e.selectedIndex;for(r=o+t;B.tabs[r]&&B.tabs[r].scope.disabled;r+=t);B.tabs[r]&&(n?B.focusIndex=r:e.selectedIndex=r)}function p(t){var n=_()?"":"-"+t+"px";angular.element(q.paging).css("left",n),e.$broadcast("$mdTabsPaginationChanged")}function f(e,t){e!==t&&q.tabs[e]&&(g(),h())}function h(){q.dummies[B.focusIndex].focus()}function g(){if(!_()){var e=q.tabs[B.focusIndex],t=e.offsetLeft,n=e.offsetWidth+t;B.offsetLeft=Math.max(B.offsetLeft,I(n-q.canvas.clientWidth)),B.offsetLeft=Math.min(B.offsetLeft,I(t))}}function b(){B.lastSelectedIndex=e.selectedIndex,k(),B.offsetLeft=I(B.offsetLeft)}function E(){G.forEach(function(e){r(e)}),G=[]}function v(t,n){var r={getIndex:function(){return B.tabs.indexOf(o)},isActive:function(){return this.getIndex()===e.selectedIndex},isLeft:function(){return this.getIndex()<e.selectedIndex},isRight:function(){return this.getIndex()>e.selectedIndex},hasFocus:function(){return!B.lastClick&&B.hasFocus&&this.getIndex()===B.focusIndex},id:i.nextUid()},o=angular.extend(r,t);return angular.isDefined(n)?B.tabs.splice(n,0,o):B.tabs.push(o),E(),M(),o}function M(){var e=!1;angular.forEach(B.tabs,function(t){t.template&&(e=!0)}),B.hasContent=e}function $(e){B.tabs.splice(e.getIndex(),1),C(),r(function(){k(),B.offsetLeft=I(B.offsetLeft)})}function C(){e.selectedIndex=N(e.selectedIndex),B.focusIndex=N(B.focusIndex)}function A(t,n){t!==n&&(e.selectedIndex=N(t),B.lastSelectedIndex=n,k(),y(),e.$broadcast("$mdTabsChanged"),B.tabs[n]&&B.tabs[n].scope.deselect(),B.tabs[t]&&B.tabs[t].scope.select())}function T(){T.watcher||(T.watcher=e.$watch(function(){r(function(){T.watcher&&t.prop("offsetParent")&&(T.watcher(),T.watcher=null,e.$apply(b))},0,!1)}))}function y(){if(!e.dynamicHeight)return t.css("height","");if(!B.tabs.length)return G.push(y);var n=q.contents[e.selectedIndex],r=n?n.offsetHeight:0,o=q.wrapper.offsetHeight,a=r+o,i=t.prop("clientHeight");i!==a&&(j=!0,d.animate(t,{height:i+"px"},{height:a+"px"}).then(function(){t.css("height",""),j=!1}))}function k(){if(!B.tabs.length)return G.push(k);if(!t.prop("offsetParent"))return T();var n=e.selectedIndex,r=q.paging.offsetWidth,o=q.tabs[n],a=o.offsetLeft,i=r-a-o.offsetWidth;w(),angular.element(q.inkBar).css({left:a+"px",right:i+"px"})}function w(){var t=e.selectedIndex,n=B.lastSelectedIndex,r=angular.element(q.inkBar);r.removeClass("md-left md-right"),angular.isNumber(n)&&(n>t?r.addClass("md-left"):t>n&&r.addClass("md-right"))}function N(e){var t,n,r=Math.max(B.tabs.length-e,e);for(t=0;r>=t;t++){if(n=B.tabs[e+t],n&&n.scope.disabled!==!0)return n.getIndex();if(n=B.tabs[e-t],n&&n.scope.disabled!==!0)return n.getIndex()}return e}function x(){switch(e.stretchTabs){case"always":return!0;case"never":return!1;default:return!H()&&n.matchMedia("(max-width: 600px)").matches}}function _(){return e.centerTabs&&!H()}function H(){if(e.noPagination)return!1;var n=t.prop("clientWidth");return angular.forEach(q.tabs,function(e){n-=e.offsetWidth}),0>n}function S(t){j||(B.focusIndex=e.selectedIndex=t),B.lastClick=!0}function D(e){H()&&(e.preventDefault(),B.offsetLeft=I(B.offsetLeft-e.wheelDelta))}function I(e){if(!q.tabs.length||!H())return 0;var t=q.tabs[q.tabs.length-1],n=t.offsetLeft+t.offsetWidth;return e=Math.max(0,e),e=Math.min(n-q.canvas.clientWidth,e)}function O(){var e,t,n=q.canvas.clientWidth,r=n+B.offsetLeft;for(e=0;e<q.tabs.length&&(t=q.tabs[e],!(t.offsetLeft+t.offsetWidth>r));e++);B.offsetLeft=I(t.offsetLeft)}function L(){var e,t;for(e=0;e<q.tabs.length&&(t=q.tabs[e],!(t.offsetLeft+t.offsetWidth>=B.offsetLeft));e++);B.offsetLeft=I(t.offsetLeft+t.offsetWidth-q.canvas.clientWidth)}function R(){return B.offsetLeft>0}function P(){var e=q.tabs[q.tabs.length-1];return e&&e.offsetLeft+e.offsetWidth>q.canvas.clientWidth+B.offsetLeft}function F(e,t){var n={colorElement:angular.element(q.inkBar)};a.attachTabBehavior(e,t,n)}var B=this,j=!1,q=m(),G=[];B.scope=e,B.parent=e.$parent,B.tabs=[],B.lastSelectedIndex=null,B.focusIndex=0,B.offsetLeft=0,B.hasContent=!1,B.hasFocus=!1,B.lastClick=!1,B.redirectFocus=h,B.attachRipple=F,B.shouldStretchTabs=x,B.shouldPaginate=H,B.shouldCenterTabs=_,B.insertTab=v,B.removeTab=$,B.select=S,B.scroll=D,B.nextPage=O,B.previousPage=L,B.keydown=s,B.canPageForward=P,B.canPageBack=R,B.refreshIndex=C,B.incrementSelectedIndex=u,B.updateInkBarStyles=k,c()}function MdTabs(e,t){return{scope:{noPagination:"=?mdNoPagination",dynamicHeight:"=?mdDynamicHeight",centerTabs:"=?mdCenterTabs",selectedIndex:"=?mdSelected",stretchTabs:"@?mdStretchTabs"},transclude:!0,template:'      <md-tabs-wrapper ng-class="{ \'md-stretch-tabs\': $mdTabsCtrl.shouldStretchTabs() }">        <md-tab-data ng-transclude></md-tab-data>        <md-prev-button            tabindex="-1"            role="button"            aria-label="Previous Page"            aria-disabled="{{!$mdTabsCtrl.canPageBack()}}"            ng-class="{ \'md-disabled\': !$mdTabsCtrl.canPageBack() }"            ng-if="$mdTabsCtrl.shouldPaginate()"            ng-click="$mdTabsCtrl.previousPage()">          <md-icon md-svg-icon="tabs-arrow"></md-icon>        </md-prev-button>        <md-next-button            tabindex="-1"            role="button"            aria-label="Next Page"            aria-disabled="{{!$mdTabsCtrl.canPageForward()}}"            ng-class="{ \'md-disabled\': !$mdTabsCtrl.canPageForward() }"            ng-if="$mdTabsCtrl.shouldPaginate()"            ng-click="$mdTabsCtrl.nextPage()">          <md-icon md-svg-icon="tabs-arrow"></md-icon>        </md-next-button>        <md-tabs-canvas            tabindex="0"            aria-activedescendant="tab-item-{{$mdTabsCtrl.tabs[$mdTabsCtrl.focusIndex].id}}"            ng-focus="$mdTabsCtrl.redirectFocus()"            ng-class="{ \'md-paginated\': $mdTabsCtrl.shouldPaginate() }"            ng-keydown="$mdTabsCtrl.keydown($event)"            role="tablist">          <md-pagination-wrapper              ng-class="{ \'md-center-tabs\': $mdTabsCtrl.shouldCenterTabs() }"              md-tab-scroll="$mdTabsCtrl.scroll($event)">            <md-tab-item                tabindex="-1"                class="md-tab"                style="max-width: {{ tabWidth ? tabWidth + \'px\' : \'none\' }}"                ng-repeat="tab in $mdTabsCtrl.tabs"                role="tab"                aria-controls="tab-content-{{tab.id}}"                aria-selected="{{tab.isActive()}}"                aria-disabled="{{tab.scope.disabled || \'false\'}}"                ng-click="$mdTabsCtrl.select(tab.getIndex())"                ng-class="{                    \'md-active\':    tab.isActive(),                    \'md-focused\':   tab.hasFocus(),                    \'md-disabled\':  tab.scope.disabled                }"                ng-disabled="tab.scope.disabled"                md-swipe-left="$mdTabsCtrl.nextPage()"                md-swipe-right="$mdTabsCtrl.previousPage()"                md-template="tab.label"                md-scope="tab.parent"></md-tab-item>            <md-ink-bar ng-hide="noInkBar"></md-ink-bar>          </md-pagination-wrapper>          <div class="md-visually-hidden md-dummy-wrapper">            <md-dummy-tab                tabindex="-1"                id="tab-item-{{tab.id}}"                role="tab"                aria-controls="tab-content-{{tab.id}}"                aria-selected="{{tab.isActive()}}"                aria-disabled="{{tab.scope.disabled || \'false\'}}"                ng-focus="$mdTabsCtrl.hasFocus = true"                ng-blur="$mdTabsCtrl.hasFocus = false"                ng-repeat="tab in $mdTabsCtrl.tabs"                md-template="tab.label"                md-scope="tab.parent"></md-dummy-tab>          </div>        </md-tabs-canvas>      </md-tabs-wrapper>      <md-tabs-content-wrapper ng-show="$mdTabsCtrl.hasContent">        <md-tab-content            id="tab-content-{{tab.id}}"            role="tabpanel"            aria-labelledby="tab-item-{{tab.id}}"            md-swipe-left="$mdTabsCtrl.incrementSelectedIndex(1)"            md-swipe-right="$mdTabsCtrl.incrementSelectedIndex(-1)"            ng-if="$mdTabsCtrl.hasContent"            ng-repeat="(index, tab) in $mdTabsCtrl.tabs"             md-template="tab.template"            md-scope="tab.parent"            ng-class="{              \'md-no-transition\': $mdTabsCtrl.lastSelectedIndex == null,              \'md-active\':        tab.isActive(),              \'md-left\':          tab.isLeft(),              \'md-right\':         tab.isRight(),              \'md-no-scroll\':     dynamicHeight            }"></md-tab-content>      </md-tabs-content-wrapper>    ',controller:"MdTabsController",controllerAs:"$mdTabsCtrl",link:function(n,r,o){t.initOptionalProperties(n,o),o.$observe("mdNoBar",function(e){n.noInkBar=angular.isDefined(e)}),n.selectedIndex=angular.isNumber(n.selectedIndex)?n.selectedIndex:0,e(r)}}}function MdTemplate(e){function t(t,n,r,o){o&&(n.html(t.template),e(n.contents())(t.compileScope))}return{restrict:"A",link:t,scope:{template:"=mdTemplate",compileScope:"=mdScope"},require:"^?mdTabs"}}angular.module("ngMaterial",["ng","ngAnimate","ngAria","material.core","material.core.gestures","material.core.theming.palette","material.core.theming","material.components.autocomplete","material.components.backdrop","material.components.bottomSheet","material.components.button","material.components.card","material.components.checkbox","material.components.chips","material.components.content","material.components.dialog","material.components.divider","material.components.gridList","material.components.icon","material.components.input","material.components.list","material.components.progressCircular","material.components.progressLinear","material.components.select","material.components.radioButton","material.components.sidenav","material.components.slider","material.components.sticky","material.components.swipe","material.components.subheader","material.components.switch","material.components.tabs","material.components.toast","material.components.toolbar","material.components.tooltip","material.components.whiteframe"]),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 ...
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.backdrop",["material.core"]).directive("mdBackdrop",BackdropDirective),BackdropDirective.$inject=["$mdTheming"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",MdBottomSheetDirective).provider("$mdBottomSheet",MdBottomSheetProvider),MdBottomSheetProvider.$inject=["$$interimElementProvider"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.button",["material.core"]).directive("mdButton",MdButtonDirective),MdButtonDirective.$inject=["$mdInkRipple","$mdTheming","$mdAria","$timeout"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.card",["material.core"]).directive("mdCard",mdCardDirective),mdCardDirective.$inject=["$mdTheming"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",MdCheckboxDirective),MdCheckboxDirective.$inject=["inputDirective","$mdInkRipple","$mdAria","$mdConstant","$mdTheming","$mdUtil","$timeout"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 ...
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.content",["material.core"]).directive("mdContent",mdContentDirective),mdContentDirective.$inject=["$mdTheming"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.dialog",["material.core","material.components.backdrop"]).directive("mdDialog",MdDialogDirective).provider("$mdDialog",MdDialogProvider),MdDialogDirective.$inject=["$$rAF","$mdTheming"],MdDialogProvider.$inject=["$$interimElementProvider"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.divider",["material.core"]).directive("mdDivider",MdDividerDirective),MdDividerDirective.$inject=["$mdTheming"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.gridList",["material.core"]).directive("mdGridList",GridListDirective).directive("mdGridTile",GridTileDirective).directive("mdGridTileFooter",GridTileCaptionDirective).directive("mdGridTileHeader",GridTileCaptionDirective).factory("$mdGridLayout",GridLayoutFactory),GridListDirective.$inject=["$interpolate","$mdConstant","$mdGridLayout","$mdMedia"],GridListController.$inject=["$timeout"],GridListController.prototype={addTile:function(e,t,n){var r={element:e,attrs:t};angular.isUndefined(n)?this.tiles.push(r):this.tiles.splice(n,0,r),this.tilesAdded=!0,this.invalidateLayout()},removeTile:function(e,t){var n=this._findTileIndex(t);-1!==n&&(this.tiles.splice(n,1),this.invalidateLayout())},invalidateLayout:function(){this.invalidated||(this.invalidated=!0,this.$timeout_(angular.bind(this,this.layout)))},layout:function(){try{this.layoutDelegate(this.tilesAdded)}finally{this.invalidated=!1,this.tilesAdded=!1}},_findTileIndex:function(e){for(var t=0;t<this.tiles.length;t++)if(this.tiles[t].attrs==e)return t;return-1}},GridLayoutFactory.$inject=["$mdUtil"],GridTileDirective.$inject=["$mdMedia"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.icon",["material.core"]).directive("mdIcon",mdIconDirective),mdIconDirective.$inject=["$mdIcon","$mdTheming","$mdAria"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.icon").provider("$mdIcon",MdIconProvider);var config={defaultIconSize:24};MdIconProvider.prototype={icon:function(e,t,n){return-1==e.indexOf(":")&&(e="$default:"+e),config[e]=new ConfigurationItem(t,n),this},iconSet:function(e,t,n){return config[e]=new ConfigurationItem(t,n),this},defaultIconSet:function(e,t){var n="$default";return config[n]||(config[n]=new ConfigurationItem(e,t)),config[n].iconSize=t||config.defaultIconSize,this},defaultIconSize:function(e){return config.defaultIconSize=e,this},preloadIcons:function(e){var t=this,n=[{id:"tabs-arrow",url:"tabs-arrow.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><polygon points="15.4,7.4 14,6 8,12 14,18 15.4,16.6 10.8,12 "/></g></svg>'},{id:"close",url:"close.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M19 6.41l-1.41-1.41-5.59 5.59-5.59-5.59-1.41 1.41 5.59 5.59-5.59 5.59 1.41 1.41 5.59-5.59 5.59 5.59 1.41-1.41-5.59-5.59z"/></g></svg>'},{id:"cancel",url:"cancel.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M12 2c-5.53 0-10 4.47-10 10s4.47 10 10 10 10-4.47 10-10-4.47-10-10-10zm5 13.59l-1.41 1.41-3.59-3.59-3.59 3.59-1.41-1.41 3.59-3.59-3.59-3.59 1.41-1.41 3.59 3.59 3.59-3.59 1.41 1.41-3.59 3.59 3.59 3.59z"/></g></svg>'},{id:"menu",url:"menu.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 100 100"><path d="M 50 0 L 100 14 L 92 80 L 50 100 L 8 80 L 0 14 Z" fill="#b2b2b2"></path><path d="M 50 5 L 6 18 L 13.5 77 L 50 94 Z" fill="#E42939"></path><path d="M 50 5 L 94 18 L 86.5 77 L 50 94 Z" fill="#B72833"></path><path d="M 50 7 L 83 75 L 72 75 L 65 59 L 50 59 L 50 50 L 61 50 L 50 26 Z" fill="#b2b2b2"></path><path d="M 50 7 L 17 75 L 28 75 L 35 59 L 50 59 L 50 50 L 39 50 L 50 26 Z" fill="#fff"></path></svg>'},{id:"toggle-arrow",url:"toggle-arrow-svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 48 48"><path d="M24 16l-12 12 2.83 2.83 9.17-9.17 9.17 9.17 2.83-2.83z"/><path d="M0 0h48v48h-48z" fill="none"/></svg>'}];n.forEach(function(n){t.icon(n.id,n.url),e.put(n.url,n.svg)})},$get:["$http","$q","$log","$templateCache",function(e,t,n,r){return this.preloadIcons(r),new MdIconService(config,e,t,n,r)}]},/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
function(){function e(e,t){function n(t,n,r){e(n)}function r(e,n,r){var o=this;o.isErrorGetter=r.mdIsError&&t(r.mdIsError),o.delegateClick=function(){o.input.focus()},o.element=n,o.setFocused=function(e){n.toggleClass("md-input-focused",!!e)},o.setHasValue=function(e){n.toggleClass("md-input-has-value",!!e)},o.setInvalid=function(e){n.toggleClass("md-input-invalid",!!e)},e.$watch(function(){return o.label&&o.input},function(e){e&&!o.label.attr("for")&&o.label.attr("for",o.input.attr("id"))})}return r.$inject=["$scope","$element","$attrs"],{restrict:"E",link:n,controller:r}}function t(){return{restrict:"E",require:"^?mdInputContainer",link:function(e,t,n,r){r&&!n.mdNoFloat&&(r.label=t,e.$on("$destroy",function(){r.label=null}))}}}function n(e,t,n){function r(r,o,a,i){function d(e){return m.setHasValue(!s.$isEmpty(e)),e}function c(){m.setHasValue(o.val().length>0||(o[0].validity||{}).badInput)}function l(){function n(e){return l(),e}function a(){c.style.height="auto",c.scrollTop=0;var e=i();e&&(c.style.height=e+"px")}function i(){var e=c.scrollHeight-c.offsetHeight;return c.offsetHeight+(e>0?e:0)}function d(e){c.scrollTop=0;var t=c.scrollHeight-c.offsetHeight,n=c.offsetHeight+t;c.style.height=n+"px"}var c=o[0],l=e.debounce(a,1);s?(s.$formatters.push(n),s.$viewChangeListeners.push(n)):l(),o.on("keydown input",l),o.on("scroll",d),angular.element(t).on("resize",l),r.$on("$destroy",function(){angular.element(t).off("resize",l)})}var m=i[0],s=i[1]||e.fakeNgModel(),u=angular.isDefined(a.readonly);if(m){if(m.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");m.input=o,m.label||n.expect(o,"aria-label",o.attr("placeholder")),o.addClass("md-input"),o.attr("id")||o.attr("id","input_"+e.nextUid()),"textarea"===o[0].tagName.toLowerCase()&&l();var p=m.isErrorGetter||function(){return s.$invalid&&s.$touched};r.$watch(p,m.setInvalid),s.$parsers.push(d),s.$formatters.push(d),o.on("input",c),u||o.on("focus",function(e){m.setFocused(!0)}).on("blur",function(e){m.setFocused(!1),c()}),r.$on("$destroy",function(){m.setFocused(!1),m.setHasValue(!1),m.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel"],link:r}}function r(e){function t(t,n,r,o){function a(e){return l.text((n.val()||e||"").length+"/"+i),e}var i,d=o[0],c=o[1],l=angular.element('<div class="md-char-counter">');r.$set("ngTrim","false"),c.element.append(l),d.$formatters.push(a),d.$viewChangeListeners.push(a),n.on("input keydown",function(){a()}),t.$watch(r.mdMaxlength,function(t){i=t,angular.isNumber(t)&&t>0?(l.parent().length||e.enter(l,c.element,angular.element(c.element[0].lastElementChild)),a()):e.leave(l)}),d.$validators["md-maxlength"]=function(e,t){return!angular.isNumber(i)||0>i?!0:(e||n.val()||t||"").length<=i}}return{restrict:"A",require:["ngModel","^mdInputContainer"],link:t}}function o(e){function t(t,n,r,o){if(o&&!angular.isDefined(o.element.attr("md-no-float"))){var a=r.placeholder;if(n.removeAttr("placeholder"),0==o.element.find("label").length){var i='<label ng-click="delegateClick()">'+a+"</label>";o.element.addClass("md-icon-float"),o.element.prepend(i)}else e.warn("The placeholder='"+a+"' will be ignored since this md-input-container has a child label element.")}}return{restrict:"A",require:"^^?mdInputContainer",priority:200,link:t}}angular.module("material.components.input",["material.core"]).directive("mdInputContainer",e).directive("label",t).directive("input",n).directive("textarea",n).directive("mdMaxlength",r).directive("placeholder",o),e.$inject=["$mdTheming","$parse"],n.$inject=["$mdUtil","$window","$mdAria"],r.$inject=["$animate"],o.$inject=["$log"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.list",["material.core"]).controller("MdListController",MdListController).directive("mdList",mdListDirective).directive("mdListItem",mdListItemDirective),mdListDirective.$inject=["$mdTheming"],mdListItemDirective.$inject=["$mdAria","$mdConstant","$timeout"],MdListController.$inject=["$scope","$element","$mdInkRipple"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.progressCircular",["material.core"]).directive("mdProgressCircular",MdProgressCircularDirective),MdProgressCircularDirective.$inject=["$mdConstant","$mdTheming"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.progressLinear",["material.core"]).directive("mdProgressLinear",MdProgressLinearDirective),MdProgressLinearDirective.$inject=["$$rAF","$mdConstant","$mdTheming"];var transforms=function(){function e(e){var t=e/100,n=(e-100)/2;return"translateX("+n.toString()+"%) scale("+t.toString()+", 1)"}for(var t=new Array(101),n=0;101>n;n++)t[n]=e(n);return t}(),SELECT_EDGE_MARGIN=8,selectNextId=0;angular.module("material.components.select",["material.core","material.components.backdrop"]).directive("mdSelect",SelectDirective).directive("mdSelectMenu",SelectMenuDirective).directive("mdOption",OptionDirective).directive("mdOptgroup",OptgroupDirective).provider("$mdSelect",SelectProvider),SelectDirective.$inject=["$mdSelect","$mdUtil","$mdTheming","$interpolate","$compile","$parse"],SelectMenuDirective.$inject=["$parse","$mdUtil","$mdTheming"],OptionDirective.$inject=["$mdInkRipple","$mdUtil"],SelectProvider.$inject=["$$interimElementProvider"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 ...
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.slider",["material.core"]).directive("mdSlider",SliderDirective),SliderDirective.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.sticky",["material.core","material.components.content"]).factory("$mdSticky",MdSticky),MdSticky.$inject=["$document","$mdConstant","$compile","$$rAF","$mdUtil"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.swipe",["material.core"]).directive("mdSwipeLeft",getDirective("SwipeLeft")).directive("mdSwipeRight",getDirective("SwipeRight")),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.subheader",["material.core","material.components.sticky"]).directive("mdSubheader",MdSubheaderDirective),MdSubheaderDirective.$inject=["$mdSticky","$compile","$mdTheming"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.switch",["material.core","material.components.checkbox"]).directive("mdSwitch",MdSwitch),MdSwitch.$inject=["mdCheckboxDirective","$mdTheming","$mdUtil","$document","$mdConstant","$parse","$$rAF","$mdGesture"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 ...
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.toast",["material.core","material.components.button"]).directive("mdToast",MdToastDirective).provider("$mdToast",MdToastProvider),MdToastProvider.$inject=["$$interimElementProvider"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.toolbar",["material.core","material.components.content"]).directive("mdToolbar",mdToolbarDirective),mdToolbarDirective.$inject=["$$rAF","$mdConstant","$mdUtil","$mdTheming"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",MdTooltipDirective),MdTooltipDirective.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 ...
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",MdAutocompleteCtrl);var ITEM_HEIGHT=41,MAX_HEIGHT=5.5*ITEM_HEIGHT,MENU_PADDING=8;MdAutocompleteCtrl.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window","$animate","$rootElement"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.autocomplete").directive("mdAutocomplete",MdAutocomplete),MdAutocomplete.$inject=["$mdTheming","$mdUtil"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c
 */
angular.module("material.components.autocomplete").controller("MdHighlightCtrl",MdHighlightCtrl),MdHighlightCtrl.$inject=["$scope","$element","$interpolate"],/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc2-master-160df4c

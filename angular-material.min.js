 ...
 * v0.8.3-master-0d9cccc
 */
function(){"use strict";function e(e){function t(t,n,r){var o=t.$parent.$mdChipsCtrl,a=o.parent.$new(!1,o.parent);a.$chip=t.$chip,a.$mdChipsCtrl=o,n.html(o.$scope.$eval(r.mdChipTransclude)),e(n.contents())(a)}return{restrict:"EA",terminal:!0,link:t,scope:!1}}angular.module("material.components.chips").directive("mdChipTransclude",e),e.$inject=["$compile","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-0d9cccc
 */
function(){"use strict";function e(e,t,n,r){this.$mdConstant=t,this.$scope=e,this.parent=e.$parent,this.$log=n,this.$element=r,this.ngModelCtrl=null,this.mdAutocompleteCtrl=null,this.userInputNgModelCtrl=null,this.userInputElement=null,this.items=[],this.selectedChip=-1,this.deleteHint="Press delete to remove this chip.",this.deleteButtonLabel="Remove",this.chipBuffer="",this.useMdOnAppend=!1}angular.module("material.components.chips").controller("MdChipsCtrl",e),e.$inject=["$scope","$mdConstant","$log","$element"],e.prototype.inputKeydown=function(e){switch(e.keyCode){case this.$mdConstant.KEY_CODE.ENTER:var t=this.getChipBuffer();t&&(e.preventDefault(),this.appendChip(t),this.resetChipBuffer());break;case this.$mdConstant.KEY_CODE.BACKSPACE:this.chipBuffer||(e.preventDefault(),this.items.length>0&&this.removeChip(this.items.length-1),e.target.focus())}},e.prototype.chipKeydown=function(e,t){switch(t.keyCode){case this.$mdConstant.KEY_CODE.BACKSPACE:case this.$mdConstant.KEY_CODE.DELETE:e>=0&&(t.preventDefault(),this.removeAndSelectAdjacentChip(e));break;case this.$mdConstant.KEY_CODE.LEFT_ARROW:this.selectChipSafe(this.selectedChip-1);break;case this.$mdConstant.KEY_CODE.RIGHT_ARROW:this.selectChipSafe(this.selectedChip+1)}},e.prototype.getPlaceholder=function(){var e=this.items.length&&(""==this.secondaryPlaceholder||this.secondaryPlaceholder);return e?this.placeholder:this.secondaryPlaceholder},e.prototype.removeAndSelectAdjacentChip=function(e){var t=this.getAdjacentChipIndex(e);this.removeChip(e),this.selectAndFocusChip(t)},e.prototype.resetSelectedChip=function(){this.selectedChip=-1},e.prototype.getAdjacentChipIndex=function(e){var t=this.items.length-1;return 0==t?-1:e==t?e-1:e},e.prototype.appendChip=function(e){this.useMdOnAppend&&this.mdOnAppend&&(e=this.mdOnAppend({$chip:e})),this.items.push(e)},e.prototype.useMdOnAppendExpression=function(){this.useMdOnAppend=!0},e.prototype.getChipBuffer=function(){if(this.mdAutocompleteCtrl)throw Error("getChipBuffer should not be called if there is an md-autocomplete");return this.userInputElement?this.userInputNgModelCtrl?this.userInputNgModelCtrl.$viewValue:this.userInputElement[0].value:this.chipBuffer},e.prototype.resetChipBuffer=function(){this.userInputElement?this.userInputNgModelCtrl?(this.userInputNgModelCtrl.$setViewValue(""),this.userInputNgModelCtrl.$render()):this.userInputElement[0].value="":this.chipBuffer=""},e.prototype.removeChip=function(e){this.items.splice(e,1)},e.prototype.selectChipSafe=function(e){return 0==this.items.length?(this.selectChip(-1),void 0):(0>e?e=0:e>this.items.length-1&&(e=this.items.length-1),this.selectChip(e),this.focusChip(e),void 0)},e.prototype.selectChip=function(e){e>=-1&&e<=this.items.length?this.selectedChip=e:this.$log.warn("Selected Chip index out of bounds; ignoring.")},e.prototype.selectAndFocusChip=function(e){this.selectChip(e),-1!=e&&this.focusChip(e)},e.prototype.focusChip=function(e){this.$element[0].querySelector('md-chip[index="'+e+'"] .md-chip-content').focus()},e.prototype.configureNgModel=function(e){this.ngModelCtrl=e;var t=this;e.$render=function(){t.items=t.ngModelCtrl.$viewValue}},e.prototype.configureMdAutocomplete=function(e){this.mdAutocompleteCtrl=e,this.mdAutocompleteCtrl.registerSelectedItemWatcher(this.mdAutocompleteSelectedItemWatcher.bind(this))},e.prototype.mdAutocompleteSelectedItemWatcher=function(e,t){e&&e!==t&&(this.appendChip(e),this.mdAutocompleteCtrl.clear())},e.prototype.configureUserInput=function(e){this.userInputElement=e;var t=e.controller("ngModel");t!=this.ngModelCtrl&&(this.userInputNgModelCtrl=t);var n=this.$scope,r=this;e.on("keydown",function(e){n.$apply(function(){r.inputKeydown(e)})})}}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-0d9cccc
 */
function(){"use strict";function e(e,a,i,d){function c(t,a){var c=a.$mdUserTemplate;a.$mdUserTemplate=null;var l=o,m=r,s=n,u=!1,p=!!a.ngModel,f=c.find("md-chip");if(p){var h=c.find("md-chip-template");h.length>0&&(m=h[0].outerHTML);var g=c[0].querySelector("[md-chip-remove]");g&&(l=g.outerHTML);var b=c.find("md-autocomplete");b.length>0?(s=b[0].outerHTML,u=!0):(b=c.find("input"),b.length>0&&(s=b[0].outerHTML))}return function(t,r,o,a){e(r),r.attr("tabindex","-1");var c=a[0];if(c.chipContentsTemplate=m,c.chipRemoveTemplate=l,c.chipInputTemplate=s,p){var h=r.controller("ngModel");c.configureNgModel(h),o.mdOnAppend&&c.useMdOnAppendExpression(),s!=n&&d(function(){if(u){var e=r.find("md-autocomplete").controller("mdAutocomplete");c.configureMdAutocomplete(e)}else c.configureUserInput(r.find("input"))})}if(f.length>0){var g=i(f)(t.$parent);d(function(){r.find("md-chips-wrap").prepend(g)})}}}return{template:function(e,n){return n.$mdUserTemplate=e.clone(),n.tabindex="-1",t},require:["mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:c,scope:{readonly:"=readonly",placeholder:"@",secondaryPlaceholder:"@",mdOnAppend:"&",deleteHint:"@",deleteButtonLabel:"@"}}}angular.module("material.components.chips").directive("mdChips",e);var t='      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0" class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{selected: $mdChipsCtrl.selectedChip == $index}">          <div class="md-chip-content"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              ng-keydown="$mdChipsCtrl.chipKeydown($index, $event)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div class="md-chip-remove-container"               md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',n='        <input            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.resetSelectedChip()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',r="      <span>{{$chip}}</span>",o='      <md-button           class="md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChip($index)"          tabindex="-1">        <md-icon md-svg-icon="close"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </md-button>';e.$inject=["$mdTheming","$log","$compile","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-0d9cccc

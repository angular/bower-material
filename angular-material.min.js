 ...
 * v0.7.0-rc2-master-d6311e8
 */
function(){function e(e){function t(t,n){e(n)}function n(e,t){var n=this;n.element=t,n.setFocused=function(e){t.toggleClass("md-input-focused",!!e)},n.setHasValue=function(e){t.toggleClass("md-input-has-value",!!e)},n.setInvalid=function(e){t.toggleClass("md-input-invalid",!!e)},e.$watch(function(){return n.label&&n.input},function(e){e&&!n.label.attr("for")&&n.label.attr("for",n.input.attr("id"))})}return n.$inject=["$scope","$element","$mdUtil"],{restrict:"E",link:t,controller:n}}function t(){return{restrict:"E",require:"^?mdInputContainer",link:function(e,t,n,r){r&&(r.label=t,e.$on("$destroy",function(){r.label=null}))}}}function n(e,t){function n(e){return e.addClass("md-input"),r}function r(n,r,o,a){function i(e){return"rate"===o.name&&window.debug,d.setHasValue(!l.$isEmpty(e)||(r[0].validity||{}).badInput),e}function c(){function o(e){return d(),e}function a(){c.style.height="auto";var e=c.scrollHeight-c.offsetHeight;c.scrollTop=0;var t=c.offsetHeight+(e>0?e:0);c.style.height=t+"px"}function i(){c.scrollTop=0;var e=c.scrollHeight-c.offsetHeight,t=c.offsetHeight+e;c.style.height=t+"px"}var c=r[0],d=e.debounce(a,1);l?(l.$formatters.push(o),l.$viewChangeListeners.push(o)):d(),r.on("keydown input",d),r.on("scroll",i),angular.element(t).on("resize",d),n.$on("$destroy",function(){angular.element(t).off("resize",d)})}var d=a[0],l=a[1];if(d){if(d.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");d.input=r,r.attr("id")||r.attr("id","input_"+e.nextUid()),"textarea"===r[0].tagName.toLowerCase()&&c(),l?(n.$watch(function(){return l.$dirty&&l.$invalid},d.setInvalid),l.$formatters.push(i),l.$parsers.push(i)):i(),r.on("input",i),r.on("focus",function(){d.setFocused(!0)}).on("blur",function(){d.setFocused(!1)}),n.$on("$destroy",function(){d.setFocused(!1),d.setHasValue(!1),d.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel"],compile:n}}function r(){function e(e,t,n,r){function o(e){return d.text(t.val().length+"/"+a),e}var a,i=r[0],c=r[1],d=angular.element('<div class="md-char-counter">');n.$set("ngTrim","false"),c.element.append(d),i.$formatters.push(o),i.$viewChangeListeners.push(o),t.on("input keydown",o),e.$watch(n.mdMaxlength,function(e){a=e,angular.isNumber(e)&&e>0?(d.parent().length||$animate.enter(d,c.element,angular.element(c.element[0].lastElementChild)),o()):$animate.leave(d)}),i.$validators["md-maxlength"]=function(e,n){return!angular.isNumber(a)||0>a?!0:(t.val()||e||n||"").length<=a}}return{restrict:"A",require:["ngModel","^mdInputContainer"],link:e}}angular.module("material.components.input",["material.core"]).directive("mdInputContainer",e).directive("label",t).directive("input",n).directive("textarea",n).directive("mdMaxlength",r),e.$inject=["$mdTheming"],n.$inject=["$mdUtil","$window","$compile","$animate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2-master-d6311e8

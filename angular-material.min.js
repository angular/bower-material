 ...
 * v0.8.1-master-fc223b0
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(){l(),c()}function c(){var e=angular.element(T.ul),t=angular.element(T.input),n=e.attr("id")||"ul_"+o.nextUid();e.attr("id",n),t.attr("aria-owns",n)}function d(t){if(t){var n={};return $.itemName&&(n[$.itemName]=e.selectedItem),n}}function l(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?o.debounce(s,t):s),e.$watch("selectedItem",function(t,n){e.itemChange&&t!==n&&e.itemChange(d(t))})}function s(t,n){if($.index=-1,!t||t.length<Math.max(parseInt(e.minLength,10),1))return $.loading=!1,$.matches=[],$.hidden=h(),void 0;var r=t.toLowerCase();w&&w.cancel&&(w.cancel(),w=null),!e.noCache&&k[r]?$.matches=k[r]:$.fetch(t),$.hidden=h(),e.textChange&&t!==n&&e.textChange(d(e.selectedItem))}function m(t){function n(n){k[a]=n,t===e.searchText&&(w=null,$.loading=!1,$.matches=n,$.hidden=h())}var o=e.$parent.$eval(A),a=t.toLowerCase();angular.isArray(o)?n(o):($.loading=!0,w=r.when(o).then(n))}function u(){$.hidden=!0}function f(e){switch(e.keyCode){case a.KEY_CODE.DOWN_ARROW:if($.loading)return;e.preventDefault(),$.index=Math.min($.index+1,$.matches.length-1),E();break;case a.KEY_CODE.UP_ARROW:if($.loading)return;e.preventDefault(),$.index=Math.max(0,$.index-1),E();break;case a.KEY_CODE.ENTER:if($.loading||$.index<0)return;e.preventDefault(),v($.index);break;case a.KEY_CODE.ESCAPE:$.matches=[],$.hidden=!0,$.index=-1;break;case a.KEY_CODE.TAB:}}function p(){e.searchText="",v(-1),T.input.focus()}function h(){return 1===$.matches.length&&e.searchText===b($.matches[0])}function g(){return b($.matches[$.index])}function b(t){return t&&e.itemText?e.itemText(d(t)):t}function v(t){e.selectedItem=$.matches[t],e.searchText=b(e.selectedItem)||e.searchText,$.hidden=!0,$.index=-1,$.matches=[]}function E(){var e=41*$.index,t=e+41,n=225.5;e<T.ul.scrollTop?T.ul.scrollTop=e:t>T.ul.scrollTop+n&&(T.ul.scrollTop=t-n)}var $=this,M=e.itemsExpr.split(/ in /i),A=M[1],T={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0]},w=null,k={};return $.scope=e,$.parent=e.$parent,$.itemName=M[0],$.matches=[],$.loading=!1,$.hidden=!0,$.index=0,$.keydown=f,$.blur=u,$.clear=p,$.select=v,$.getCurrentDisplayValue=g,$.fetch=o.debounce(m),i()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$timeout","$q","$mdUtil","$mdConstant"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.1-master-fc223b0

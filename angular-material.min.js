 ...
 * v0.8.3-master-d5b77bd
 */
function(){"use strict";function e(e,o,a,i,d,c,l){function m(){f(),d(function(){h(),p(),u()})}function s(){if(!U)return d(s,0,!1);var e=U.wrap.getBoundingClientRect(),t=U.snap.getBoundingClientRect(),o=U.root.getBoundingClientRect(),a=t.bottom-o.top,i=o.height-t.top,c=e.left-o.left,l=e.width,m={left:c+"px",width:l+"px"};a>i&&o.height-e.bottom-r<n?(m.top="auto",m.bottom=i+"px",m.maxHeight=Math.min(n,e.top-o.top-r)+"px"):(m.top=a+"px",m.bottom="auto",m.maxHeight=Math.min(n,o.height-e.bottom-r)+"px"),U.$.ul.css(m)}function u(){U.$.root.length&&(c(U.$.ul),U.$.ul.detach(),U.$.root.append(U.$.ul))}function p(){e.autofocus&&U.input.focus()}function f(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(A,t):A),$(E),e.$watch("selectedItem",v),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){e&&!t&&s()}),angular.element(l).on("resize",s)}function h(){U={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:document.body},U.snap=g(),U.$=b(U)}function g(){for(var e=o;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return U.wrap}function b(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function E(t,n){t&&(e.searchText=y(t)),e.itemChange&&t!==n&&e.itemChange(x(t))}function v(e,t){for(var n=0;n<W.length;++n)W[n](e,t)}function $(e){-1==W.indexOf(e)&&W.push(e)}function M(e){var t=W.indexOf(e);-1!=t&&W.splice(t,1)}function A(t,n){B.index=N(),(t||t!==n)&&t!==y(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(x(e.selectedItem)),S()?j():(B.loading=!1,B.matches=[],B.hidden=_(),R()))}function T(){Y||(B.hidden=!0)}function w(){return angular.isString(e.searchText)?(B.hidden=_(),B.hidden||j(),void 0):e.searchText=""}function C(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(B.loading)return;e.preventDefault(),B.index=Math.min(B.index+1,B.matches.length-1),P(),L();break;case i.KEY_CODE.UP_ARROW:if(B.loading)return;e.preventDefault(),B.index=B.index<0?B.matches.length-1:Math.max(0,B.index-1),P(),L();break;case i.KEY_CODE.ENTER:if(B.hidden||B.loading||B.index<0)return;e.preventDefault(),I(B.index);break;case i.KEY_CODE.ESCAPE:B.matches=[],B.hidden=!0,B.index=N();break;case i.KEY_CODE.TAB:}}function k(){return angular.isNumber(e.minLength)?e.minLength:1}function y(t){return t&&e.itemText?e.itemText(x(t)):t}function x(e){if(e){var t={};return B.itemName&&(t[B.itemName]=e),t}}function N(){return e.autoselect?0:-1}function _(){return S()?1===B.matches.length&&e.searchText===y(B.matches[0])&&e.selectedItem===B.matches[0]:!0}function H(){return y(B.matches[B.index])}function S(){return e.searchText.length>=k()}function I(t){e.selectedItem=B.matches[t],e.searchText=y(e.selectedItem)||e.searchText,B.hidden=!0,B.index=0,B.matches=[]}function D(){e.searchText="",I(-1),U.input.focus()}function O(t){function n(n){K[o]=n,t===e.searchText&&(V=null,B.loading=!1,B.matches=n,B.hidden=_(),R(),s())}var r=e.$parent.$eval(q),o=t.toLowerCase();angular.isArray(r)?n(r):(B.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){B.loading=!1}))}function R(){if(!B.hidden)switch(B.matches.length){case 0:return B.messages.splice(0);case 1:return B.messages.push({display:"There is 1 match available."});default:return B.messages.push({display:"There are "+B.matches.length+" matches available."})}}function L(){B.messages.push({display:H()})}function P(){var e=t*B.index,n=e+t,r=U.ul.clientHeight;e<U.ul.scrollTop?U.ul.scrollTop=e:n>U.ul.scrollTop+r&&(U.ul.scrollTop=n-r)}function j(){var t=e.searchText,n=t.toLowerCase();V&&V.cancel&&(V.cancel(),V=null),!e.noCache&&K[n]?(B.matches=K[n],R()):O(t),B.hidden=_()}var B=this,F=e.itemsExpr.split(/ in /i),q=F[1],U=null,V=null,K={},Y=!1,W=[];return B.scope=e,B.parent=e.$parent,B.itemName=F[0],B.matches=[],B.loading=!1,B.hidden=!0,B.index=null,B.messages=[],B.id=a.nextUid(),B.keydown=C,B.blur=T,B.focus=w,B.clear=D,B.select=I,B.fetch=a.debounce(O),B.getCurrentDisplayValue=H,B.registerSelectedItemWatcher=$,B.unregisterSelectedItemWatcher=M,B.listEnter=function(){Y=!0},B.listLeave=function(){Y=!1},B.mouseUp=function(){U.input.focus()},m()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=16;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-d5b77bd

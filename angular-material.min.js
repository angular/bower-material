 ...
 * v0.8.3-master-9956f62
 */
function(){"use strict";function e(){return{restrict:"E"}}function t(e){function t(e,t,o,a,i,c,d,l,s){function m(n,r,s){r=o.extractElementByName(r,"md-bottom-sheet"),p=i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n),p.on("click",function(){a(d.cancel)}),c.inherit(p,s.parent),e.enter(p,s.parent,null);var m=new f(r,s.parent);return s.bottomSheet=m,s.targetEvent&&angular.element(s.targetEvent.target).blur(),c.inherit(m.element,s.parent),s.disableParentScroll&&(s.lastOverflow=s.parent.css("overflow"),s.parent.css("overflow","hidden")),e.enter(m.element,s.parent).then(function(){var e=angular.element(r[0].querySelector("button")||r[0].querySelector("a")||r[0].querySelector("[ng-click]"));e.focus(),s.escapeToClose&&(s.rootElementKeyupCallback=function(e){e.keyCode===t.KEY_CODE.ESCAPE&&a(d.cancel)},l.on("keyup",s.rootElementKeyupCallback))})}function u(t,n,r){var o=r.bottomSheet;return e.leave(p),e.leave(o.element).then(function(){r.disableParentScroll&&(r.parent.css("overflow",r.lastOverflow),delete r.lastOverflow),o.cleanup(),r.targetEvent&&angular.element(r.targetEvent.target).focus()})}function f(e,o){function i(){e.css(t.CSS.TRANSITION_DURATION,"0ms")}function c(n){var o=n.pointer.distanceY;5>o&&(o=Math.max(-r,o/2)),e.css(t.CSS.TRANSFORM,"translate3d(0,"+(r+o)+"px,0)")}function l(r){if(r.pointer.distanceY>0&&(r.pointer.distanceY>20||Math.abs(r.pointer.velocityY)>n)){var o=e.prop("offsetHeight")-r.pointer.distanceY,i=Math.min(o/r.pointer.velocityY*.75,500);e.css(t.CSS.TRANSITION_DURATION,i+"ms"),a(d.cancel)}else e.css(t.CSS.TRANSITION_DURATION,""),e.css(t.CSS.TRANSFORM,"")}var m=s.register(o,"drag",{horizontal:!1});return o.on("$md.dragstart",i).on("$md.drag",c).on("$md.dragend",l),{element:e,cleanup:function(){m(),o.off("$md.dragstart",i).off("$md.drag",c).off("$md.dragend",l)}}}var p;return{themable:!0,targetEvent:null,onShow:m,onRemove:u,escapeToClose:!0,disableParentScroll:!0}}var n=.5,r=80;return t.$inject=["$animate","$mdConstant","$mdUtil","$timeout","$compile","$mdTheming","$mdBottomSheet","$rootElement","$mdGesture"],e("$mdBottomSheet").setDefaults({methods:["disableParentScroll","escapeToClose","targetEvent"],options:t})}angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",e).provider("$mdBottomSheet",t),t.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-9956f62
 ...
 * v0.8.3-master-9956f62
 */
function(){"use strict";function e(e,t,n,r,o){function a(){e.autofocus&&w.input.focus(),d(),o(i)}function i(){w={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0]}}function c(e){if(e){var t={};return M.itemName&&(t[M.itemName]=e),t}}function d(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?n.debounce(l,t):l),e.$watch("selectedItem",function(t,n){t&&(e.searchText=v(t)),e.itemChange&&t!==n&&e.itemChange(c(t))})}function l(t,n){if(M.index=0,(t||t!==n)&&t!==v(e.selectedItem)){if(e.selectedItem=null,!t||t.length<Math.max(parseInt(e.minLength,10),1))return M.loading=!1,M.matches=[],M.hidden=g(),m(),void 0;var r=t.toLowerCase();y&&y.cancel&&(y.cancel(),y=null),!e.noCache&&k[r]?(M.matches=k[r],m()):s(t),M.hidden=g(),e.textChange&&t!==n&&e.textChange(c(e.selectedItem))}}function s(t){function n(n){k[o]=n,t===e.searchText&&(y=null,M.loading=!1,M.matches=n,M.hidden=g(),m())}var r=e.$parent.$eval(T),o=t.toLowerCase();angular.isArray(r)?n(r):(M.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){M.loading=!1}))}function m(){if(!M.hidden)switch(M.matches.length){case 0:return M.messages.splice(0);case 1:return M.messages.push({display:"There is 1 match available."});default:return M.messages.push({display:"There are "+M.matches.length+" matches available."})}}function u(){M.messages.push({display:b()})}function f(){x||(M.hidden=!0)}function p(e){switch(e.keyCode){case r.KEY_CODE.DOWN_ARROW:if(M.loading)return;e.preventDefault(),M.index=Math.min(M.index+1,M.matches.length-1),$(),u();break;case r.KEY_CODE.UP_ARROW:if(M.loading)return;e.preventDefault(),M.index=Math.max(0,M.index-1),$(),u();break;case r.KEY_CODE.ENTER:if(M.loading||M.index<0)return;e.preventDefault(),E(M.index);break;case r.KEY_CODE.ESCAPE:M.matches=[],M.hidden=!0,M.index=0;break;case r.KEY_CODE.TAB:}}function h(){e.searchText="",E(-1),w.input.focus()}function g(){return 1===M.matches.length&&e.searchText===v(M.matches[0])&&e.selectedItem===M.matches[0]}function b(){return v(M.matches[M.index])}function v(t){return t&&e.itemText?e.itemText(c(t)):t}function E(t){e.selectedItem=M.matches[t],e.searchText=v(e.selectedItem)||e.searchText,M.hidden=!0,M.index=0,M.matches=[]}function $(){var e=41*M.index,t=e+41,n=225.5;e<w.ul.scrollTop?w.ul.scrollTop=e:t>w.ul.scrollTop+n&&(w.ul.scrollTop=t-n)}var M=this,A=e.itemsExpr.split(/ in /i),T=A[1],w=null,y=null,k={},x=!1;return M.scope=e,M.parent=e.$parent,M.itemName=A[0],M.matches=[],M.loading=!1,M.hidden=!0,M.index=0,M.keydown=p,M.blur=f,M.clear=h,M.select=E,M.getCurrentDisplayValue=b,M.fetch=n.debounce(s),M.messages=[],M.id=n.nextUid(),M.listEnter=function(){x=!0},M.listLeave=function(){x=!1},M.mouseUp=function(){w.input.focus()},a()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-9956f62

 ...
 * v0.7.0-master-8364fb5
 */
function(){"use strict";function e(){}function t(e,t){e.decorator("$$rAF",n),t.theme("default").primaryPalette("indigo").accentPalette("pink").warnPalette("red").backgroundPalette("grey")}function n(e){return e.throttle=function(t){var n,r,o,a;return function(){n=arguments,a=this,o=t,r||(r=!0,e(function(){o.apply(a,n),r=!1}))}},e}angular.module("material.core",["material.core.theming"]).run(e).config(t),t.$inject=["$provide","$mdThemingProvider"],n.$inject=["$delegate","$rootScope"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-master-8364fb5
 ...
 * v0.7.0-master-8364fb5
 */
function(){"use strict";function e(e,t){var n;for(var r in c)n=c[r],"start"===e&&n.cancel(),n[e](t,u)}function t(t){if(!u){var n=+Date.now();f&&!o(t,f)&&n-f.endTime<400||(u=d(t),e("start",t))}}function n(t){u&&o(t,u)&&(i(t,u),e("move",t))}function r(t){u&&o(t,u)&&(i(t,u),u.endTime=+Date.now(),e("end",t),f=u,u=null)}function o(e,t){return e&&t&&e.type.charAt(0)===t.type}function a(e){return e=e.originalEvent||e,e.touches&&e.touches[0]||e.changedTouches&&e.changedTouches[0]||e}function i(e,t){var n=a(e),r=t.x=n.pageX,o=t.y=n.pageY;t.distanceX=r-t.startX,t.distanceY=o-t.startY,t.distance=Math.sqrt(t.distanceX*t.distanceX+t.distanceY*t.distanceY),t.directionX=t.distanceX>0?"right":t.distanceX<0?"left":"",t.directionY=t.distanceY>0?"up":t.distanceY<0?"down":"",t.duration=+Date.now()-t.startTime,t.velocityX=t.distanceX/t.duration,t.velocityY=t.distanceY/t.duration}function d(e){var t=a(e),n={startTime:+Date.now(),target:e.target,type:e.type.charAt(0)};return n.startX=n.x=t.pageX,n.startY=n.y=t.pageY,n}var c,l="mousedown touchstart pointerdown",m="mousemove touchmove pointermove",s="mouseup mouseleave touchend touchcancel pointerup pointercancel";document.addEventListener("click",function(e){e.$material||(e.preventDefault(),e.stopPropagation())},!0),angular.element(document).on(l,t).on(m,n).on(s,r).on("$$mdGestureReset",function(){f=u=null});var u,f;angular.module("material.core").run(["$mdGesture",function(){}]).factory("$mdGesture",["$$MdGestureHandler","$$rAF","$timeout",function(e,t,n){function r(t,n){var r=new e(t);return angular.extend(r,n),c[t]=r,a}function o(e,t,n){var r=c[t.replace(/^\$md./,"")];if(!r)throw new Error("Failed to register element with handler "+t+". Available handlers: "+Object.keys(c).join(", "));return r.registerElement(e,n)}c={},r("click",{options:{maxDistance:6},onEnd:function(e,t){t.distance<this.state.options.maxDistance&&this.dispatchEvent(e,"click")}}),r("press",{onStart:function(e){this.dispatchEvent(e,"$md.pressdown")},onEnd:function(e){this.dispatchEvent(e,"$md.pressup")}}),r("hold",{options:{maxDistance:6,delay:500},onCancel:function(){n.cancel(this.state.timeout)},onStart:function(e,t){return this.state.registeredParent?(this.state.pos={x:t.x,y:t.x},this.state.timeout=n(angular.bind(this,function(){this.dispatchEvent(e,"$md.hold"),this.cancel()}),this.state.options.delay,!1),void 0):this.cancel()},onMove:function(e,t){e.preventDefault();var n=this.state.pos.x-t.x,r=this.state.pos.y-t.y;Math.sqrt(n*n+r*r)>this.options.maxDistance&&this.cancel()},onEnd:function(){this.onCancel()}}),r("drag",{options:{minDistance:6,horizontal:!0},onStart:function(){this.state.registeredParent||this.cancel()},onMove:function(e,t){var n,r;e.preventDefault(),this.state.dragPointer?this.dispatchDragMove(e):(this.state.options.horizontal?(n=Math.abs(t.distanceX)>this.state.options.minDistance,r=Math.abs(t.distanceY)>1.5*this.state.options.minDistance):(n=Math.abs(t.distanceY)>this.state.options.minDistance,r=Math.abs(t.distanceX)>1.5*this.state.options.minDistance),n?(this.state.dragPointer=d(e),i(e,this.state.dragPointer),this.dispatchEvent(e,"$md.dragstart",this.state.dragPointer)):r&&this.cancel())},dispatchDragMove:t.throttle(function(e){this.state.isRunning&&(i(e,this.state.dragPointer),this.dispatchEvent(e,"$md.drag",this.state.dragPointer))}),onEnd:function(e){this.state.dragPointer&&(i(e,this.state.dragPointer),this.dispatchEvent(e,"$md.dragend",this.state.dragPointer))}}),r("swipe",{options:{minVelocity:.65,minDistance:10},onEnd:function(e,t){if(Math.abs(t.velocityX)>this.state.options.minVelocity&&Math.abs(t.distanceX)>this.state.options.minDistance){var n="left"==t.directionX?"$md.swipeleft":"$md.swiperight";this.dispatchEvent(e,n)}}});var a;return a={handler:r,register:o}}]).factory("$$MdGestureHandler",["$$rAF",function(){function e(e){this.name=e,this.state={}}function t(e,t,r){r=r||u;var o;o="click"===t?new MouseEvent("click",{clientX:r.x,clientY:r.y,screenX:r.x,screenY:r.y,bubbles:!0,cancelable:!0,view:window}):new CustomEvent(t,n),o.$material=!0,o.pointer=r,o.srcEvent=e,r.target.dispatchEvent(o)}e.prototype={onStart:angular.noop,onMove:angular.noop,onEnd:angular.noop,onCancel:angular.noop,options:{},dispatchEvent:t,start:function(e,t){if(!this.state.isRunning){var n=this.getNearestParent(e.target),r=n&&n.$mdGesture[this.name]||{};this.state={isRunning:!0,options:angular.extend({},this.options,r),registeredParent:n},this.onStart(e,t)}},move:function(e,t){this.state.isRunning&&this.onMove(e,t)},end:function(e,t){this.state.isRunning&&(this.onEnd(e,t),this.state.isRunning=!1)},cancel:function(e,t){this.onCancel(e,t),this.state={}},getNearestParent:function(e){for(var t=e;t;){if((t.$mdGesture||{})[this.name])return t;t=t.parentNode}},registerElement:function(e,t){function n(){delete e[0].$mdGesture[r.name],e.off("$destroy",n)}var r=this;return e[0].$mdGesture=e[0].$mdGesture||{},e[0].$mdGesture[this.name]=t||{},e.on("$destroy",n),n}};var n={bubbles:!0,cancelable:!0};return e}])}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-master-8364fb5
 ...
 * v0.7.0-master-8364fb5
 */
function(){"use strict";function e(){return{restrict:"E"}}function t(e){function t(e,t,o,a,i,d,c,l,m,s){function u(n,r,a){h=i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n),h.on("click",function(){o(c.cancel)}),d.inherit(h,a.parent),e.enter(h,a.parent,null);var m=new p(r,a.parent);return a.bottomSheet=m,a.targetEvent&&angular.element(a.targetEvent.target).blur(),d.inherit(m.element,a.parent),e.enter(m.element,a.parent).then(function(){var e=angular.element(r[0].querySelector("button")||r[0].querySelector("a")||r[0].querySelector("[ng-click]"));e.focus(),a.escapeToClose&&(a.rootElementKeyupCallback=function(e){e.keyCode===t.KEY_CODE.ESCAPE&&o(c.cancel)},l.on("keyup",a.rootElementKeyupCallback))})}function f(t,n,r){var o=r.bottomSheet;return e.leave(h),e.leave(o.element).then(function(){o.cleanup(),r.targetEvent&&angular.element(r.targetEvent.target).focus()})}function p(e,a){function i(){e.css(t.CSS.TRANSITION_DURATION,"0ms")}function d(n){var o=n.pointer.distanceY;5>o&&(o=Math.max(-r,o/2)),e.css(t.CSS.TRANSFORM,"translate3d(0,"+(r+o)+"px,0)")}function l(r){if(r.pointer.distanceY>0&&(r.pointer.distanceY>20||Math.abs(r.pointer.velocityY)>n)){var a=e.prop("offsetHeight")-r.pointer.distanceY,i=Math.min(a/r.pointer.velocityY*.75,500);e.css(t.CSS.TRANSITION_DURATION,i+"ms"),o(c.cancel)}else e.css(t.CSS.TRANSITION_DURATION,""),e.css(t.CSS.TRANSFORM,"")}var m=s.register(a,"drag",{horizontal:!1});return a.on("$md.dragstart",i).on("$md.drag",d).on("$md.dragend",l),{element:e,cleanup:function(){m(),a.off("$md.dragstart",i).off("$md.drag",d).off("$md.dragend",l)}}}var h;return{themable:!0,targetEvent:null,onShow:u,onRemove:f,escapeToClose:!0}}var n=.5,r=80;return t.$inject=["$animate","$mdConstant","$timeout","$$rAF","$compile","$mdTheming","$mdBottomSheet","$rootElement","$rootScope","$mdGesture"],e("$mdBottomSheet").setDefaults({options:t})}angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",e).provider("$mdBottomSheet",t),t.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-master-8364fb5
 ...
 * v0.7.0-master-8364fb5
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(t,i){return i.type="checkbox",i.tabIndex=0,t.attr("role",i.type),function(i,c,l,m){function s(e){e.which===r.KEY_CODE.SPACE&&(e.preventDefault(),u(e))}function u(e){c[0].hasAttribute("disabled")||i.$apply(function(){p=!p,m.$setViewValue(p,e&&e.type),m.$render()})}function f(){p=m.$viewValue,p?c.addClass(d):c.removeClass(d)}m=m||a.fakeNgModel();var p=!1;o(c),n.expectWithText(t,"aria-label"),e.link.pre(i,{on:angular.noop,0:{}},l,[m]),c.on("click",u).on("keypress",s),m.$render=f}}e=e[0];var d="md-checked";return{restrict:"E",transclude:!0,require:"?ngModel",template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:i}}angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",e),e.$inject=["inputDirective","$mdInkRipple","$mdAria","$mdConstant","$mdTheming","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-master-8364fb5
 ...
 * v0.7.0-master-8364fb5
 */
function(){"use strict";function e(e,t,n,r,o,a,i,d){function c(c,l,m,s){function u(){E(),A(),b()}function f(e){G=parseFloat(e),l.attr("aria-valuemin",e),u()}function p(e){K=parseFloat(e),l.attr("aria-valuemax",e),u()}function h(e){z=parseFloat(e),b()}function g(e){l.attr("aria-disabled",!!e)}function b(){if(angular.isDefined(m.mdDiscrete)){var e=Math.floor((K-G)/z);if(!X){var n=t.getComputedStyle(V[0]);X=angular.element('<canvas style="position:absolute;">'),Z=X[0].getContext("2d"),Z.fillStyle=n.backgroundColor||"black",V.append(X)}var r=v();X[0].width=r.width,X[0].height=r.height;for(var o,a=0;e>=a;a++)o=Math.floor(r.width*(a/e)),Z.fillRect(o-1,0,2,r.height)}}function E(){J=q[0].getBoundingClientRect()}function v(){return U(),J}function $(e){if(!l[0].hasAttribute("disabled")){var t;e.keyCode===o.KEY_CODE.LEFT_ARROW?t=-z:e.keyCode===o.KEY_CODE.RIGHT_ARROW&&(t=z),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),c.$evalAsync(function(){M(s.$viewValue+t)}))}}function M(e){s.$setViewValue(T(k(e)))}function A(){isNaN(s.$viewValue)&&(s.$viewValue=s.$modelValue);var e=(s.$viewValue-G)/(K-G);c.modelValue=s.$viewValue,l.attr("aria-valuenow",s.$viewValue),w(e),F.text(s.$viewValue)}function T(e){return angular.isNumber(e)?Math.max(G,Math.min(K,e)):void 0}function k(e){return angular.isNumber(e)?Math.round(e/z)*z:void 0}function w(e){B.css("width",100*e+"%"),L.css(o.CSS.TRANSFORM,"translate3d("+v().width*e+"px,0,0)"),l.toggleClass("md-min",0===e)}function y(e){j(c)||(l.addClass("active"),l[0].focus(),E(),H(e))}function C(){l.removeClass("dragging active")}function N(e){j(c)||(Q=!0,e.stopPropagation(),l.addClass("dragging"),H(e))}function x(e){Q&&(e.stopPropagation(),H(e))}function _(t){if(Q){t.stopPropagation(),Q=!1;var n=R(O(t.pointer.x)),r=T(k(n));w(I(r)),e(function(){M(r)})}}function H(e){et?D(e.pointer.x):S(e.pointer.x)}function S(e){c.$evalAsync(function(){M(R(O(e)))})}function D(e){var t=R(O(e)),n=T(k(t));w(O(e)),F.text(n)}function O(e){return Math.max(0,Math.min(1,(e-J.left)/J.width))}function R(e){return G+e*(K-G)}function I(e){return(e-G)/(K-G)}a(l),s=s||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var j=d(m.ngDisabled),P=angular.element(l[0].querySelector(".md-thumb")),F=angular.element(l[0].querySelector(".md-thumb-text")),L=P.parent(),q=angular.element(l[0].querySelector(".md-track-container")),B=angular.element(l[0].querySelector(".md-track-fill")),V=angular.element(l[0].querySelector(".md-track-ticks")),U=r.throttle(E,5e3);m.min?m.$observe("min",f):f(0),m.max?m.$observe("max",p):p(100),m.step?m.$observe("step",h):h(1);var Y=angular.noop;m.ngDisabled&&(Y=c.$parent.$watch(m.ngDisabled,g)),n.expect(l,"aria-label"),i.register(l,"drag"),l.attr({tabIndex:0,role:"slider"}).on("keydown",$).on("$md.pressdown",y).on("$md.pressup",C).on("$md.dragstart",N).on("$md.drag",x).on("$md.dragend",_),setTimeout(u);var W=e.throttle(u);angular.element(t).on("resize",W),c.$on("$destroy",function(){angular.element(t).off("resize",W),Y()}),s.$render=A,s.$viewChangeListeners.push(A),s.$formatters.push(T),s.$formatters.push(k);var G,K,z,X,Z,J={};E();var Q=!1,et=angular.isDefined(m.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-track-container"><div class="md-track"></div><div class="md-track md-track-fill"></div><div class="md-track-ticks"></div></div><div class="md-thumb-container"><div class="md-thumb"></div><div class="md-focus-thumb"></div><div class="md-focus-ring"></div><div class="md-sign"><span class="md-thumb-text"></span></div><div class="md-disabled-thumb"></div></div>',link:c}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-master-8364fb5
 ...
 * v0.7.0-master-8364fb5
 */
function(){"use strict";function e(e,t,n,r,o){function a(a,i){var d=a.find("md-tab-label");d.length?d.remove():d=angular.isDefined(i.label)?angular.element("<md-tab-label>").html(i.label):angular.element("<md-tab-label>").append(a.contents().remove());var c=a.contents().remove();return function(a,i,l,m){function s(){var e=d.clone();i.append(e),t(e)(a.$parent),E.content=c.clone()}function u(){a.$apply(function(){v.select(E),v.focus(E)})}function f(e){e.keyCode==r.KEY_CODE.SPACE||e.keyCode==r.KEY_CODE.ENTER?(i.triggerHandler("click"),e.preventDefault()):e.keyCode===r.KEY_CODE.LEFT_ARROW?a.$evalAsync(function(){v.focus(v.previous(E))}):e.keyCode===r.KEY_CODE.RIGHT_ARROW&&a.$evalAsync(function(){v.focus(v.next(E))})}function p(){a.$watch("$parent.$index",function(e){v.move(E,e)})}function h(){function e(e){var t=v.getSelectedItem()===E;e&&!t?v.select(E):!e&&t&&v.deselect(E)}var t=a.$parent.$watch("!!("+l.mdActive+")",e);a.$on("$destroy",t)}function g(){function e(e){i.attr("aria-disabled",e);var t=v.getSelectedItem()===E;t&&e&&v.select(v.next()||v.previous())}a.$watch(E.isDisabled,e)}function b(){var e=l.id||"tab_"+n.nextUid();if(i.attr({id:e,role:"tab",tabIndex:-1}),c.length){var t="content_"+e;i.attr("aria-controls")||i.attr("aria-controls",t),E.contentContainer.attr({id:t,role:"tabpanel","aria-labelledby":e})}}var E=m[0],v=m[1];a.$watch(function(){return l.label},function(){o(function(){v.scope.$broadcast("$mdTabsChanged")},0,!1)}),s(),b();var $=e.attachTabBehavior(a,i,{colorElement:v.inkBarElement});v.add(E),a.$on("$destroy",function(){$(),v.remove(E)}),i.on("$destroy",function(){o(function(){v.scope.$broadcast("$mdTabsChanged")},0,!1)}),angular.isDefined(l.ngClick)||i.on("click",u),i.on("keydown",f),angular.isNumber(a.$parent.$index)&&p(),angular.isDefined(l.mdActive)&&h(),g()}}return{restrict:"E",require:["mdTab","^mdTabs"],controller:"$mdTab",scope:{onSelect:"&mdOnSelect",onDeselect:"&mdOnDeselect",label:"@"},compile:a}}angular.module("material.components.tabs").directive("mdTab",e),e.$inject=["$mdInkRipple","$compile","$mdUtil","$mdConstant","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-master-8364fb5

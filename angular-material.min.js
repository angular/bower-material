 ...
 * v0.8.3-master-f34eb80
 */
function(){"use strict";function e(e,t,n,r,o,a,i){function d(){e.$watch("selectedIndex",v),e.$watch("$mdTabsCtrl.focusIndex",u),e.$watch("$mdTabsCtrl.offsetLeft",m),angular.element(n).on("resize",function(){e.$apply(h)}),r($,0,!1)}function c(){var e={};return e.canvas=t[0].getElementsByTagName("md-tabs-canvas")[0],e.wrapper=e.canvas.getElementsByTagName("md-pagination-wrapper")[0],e.tabs=e.wrapper.getElementsByTagName("md-tab-item"),e.dummies=e.canvas.getElementsByTagName("md-dummy-tab"),e.inkBar=e.wrapper.getElementsByTagName("md-ink-bar")[0],e}function l(t){switch(t.keyCode){case o.KEY_CODE.LEFT_ARROW:t.preventDefault(),s(-1,!0);break;case o.KEY_CODE.RIGHT_ARROW:t.preventDefault(),s(1,!0);break;case o.KEY_CODE.SPACE:case o.KEY_CODE.ENTER:t.preventDefault(),e.selectedIndex=I.focusIndex}I.lastClick=!1}function s(t,n){var r,o=n?I.focusIndex:e.selectedIndex;for(r=o+t;I.tabs[r]&&I.tabs[r].scope.disabled;r+=t);I.tabs[r]&&(n?I.focusIndex=r:e.selectedIndex=r)}function m(t){angular.element(D.wrapper).css("left","-"+t+"px"),e.$broadcast("$mdTabsPaginationChanged")}function u(e,t){e!==t&&D.tabs[e]&&(p(),f())}function f(){D.dummies[I.focusIndex].focus()}function p(){var e=D.tabs[I.focusIndex],t=e.offsetLeft,n=e.offsetWidth+t;I.offsetLeft=Math.max(I.offsetLeft,x(n-D.canvas.clientWidth)),I.offsetLeft=Math.min(I.offsetLeft,x(t))}function h(){I.lastSelectedIndex=e.selectedIndex,$(),I.offsetLeft=x(I.offsetLeft)}function g(t,n){var r={getIndex:function(){return I.tabs.indexOf(o)},isActive:function(){return this.getIndex()===e.selectedIndex},isLeft:function(){return this.getIndex()<e.selectedIndex},isRight:function(){return this.getIndex()>e.selectedIndex},hasFocus:function(){return!I.lastClick&&I.hasFocus&&this.getIndex()===I.focusIndex},id:i.nextUid()},o=angular.extend(r,t);return angular.isString(t.template)||(I.hasContent=!1),angular.isDefined(n)?I.tabs.splice(n,0,o):I.tabs.push(o),o}function b(e){I.tabs.splice(e.getIndex(),1),E(),r(function(){$(),I.offsetLeft=x(I.offsetLeft)})}function E(){e.selectedIndex=A(e.selectedIndex),I.focusIndex=A(I.focusIndex)}function v(t,n){t!==n&&(e.selectedIndex=A(t),I.lastSelectedIndex=n,$(),e.$broadcast("$mdTabsChanged"))}function $(){if(I.tabs.length){var t=e.selectedIndex,n=D.wrapper.offsetWidth,r=D.tabs[t],o=r.offsetLeft,a=n-o-r.offsetWidth;M(),angular.element(D.inkBar).css({left:o+"px",right:a+"px"})}}function M(){var t=e.selectedIndex,n=I.lastSelectedIndex,r=angular.element(D.inkBar);r.removeClass("md-left md-right"),angular.isNumber(n)&&(n>t?r.addClass("md-left"):t>n&&r.addClass("md-right"))}function A(e){var t,n,r=Math.max(I.tabs.length-e,e);for(t=0;r>=t;t++){if(n=I.tabs[e+t],n&&n.scope.disabled!==!0)return n.getIndex();if(n=I.tabs[e-t],n&&n.scope.disabled!==!0)return n.getIndex()}return e}function T(){switch(e.stretchTabs){case"always":return!0;case"never":return!1;default:return!w()&&n.matchMedia("(max-width: 600px)").matches}}function w(){var e=t.prop("clientWidth");return angular.forEach(D.tabs,function(t){e-=t.offsetWidth}),0>=e}function k(t){I.focusIndex=e.selectedIndex=t,I.lastClick=!0}function y(e){w()&&(e.preventDefault(),I.offsetLeft=x(I.offsetLeft-e.wheelDelta))}function x(e){var t=D.tabs[D.tabs.length-1],n=t.offsetLeft+t.offsetWidth;return e=Math.max(0,e),e=Math.min(n-D.canvas.clientWidth,e)}function C(){var e,t,n=D.canvas.clientWidth,r=n+I.offsetLeft;for(e=0;e<D.tabs.length&&(t=D.tabs[e],!(t.offsetLeft+t.offsetWidth>r));e++);I.offsetLeft=x(t.offsetLeft)}function N(){var e,t;for(e=0;e<D.tabs.length&&(t=D.tabs[e],!(t.offsetLeft+t.offsetWidth>=I.offsetLeft));e++);I.offsetLeft=x(t.offsetLeft+t.offsetWidth-D.canvas.clientWidth)}function _(){return I.offsetLeft>0}function S(){var e=D.tabs[D.tabs.length-1];return e&&e.offsetLeft+e.offsetWidth>D.canvas.clientWidth+I.offsetLeft}function H(e,t){var n={colorElement:angular.element(D.inkBar)};a.attachTabBehavior(e,t,n)}var I=this,D=c();I.scope=e,I.parent=e.$parent,I.tabs=[],I.lastSelectedIndex=null,I.focusIndex=0,I.offsetLeft=0,I.hasContent=!0,I.hasFocus=!1,I.lastClick=!1,I.redirectFocus=f,I.attachRipple=H,I.shouldStretchTabs=T,I.shouldPaginate=w,I.insertTab=g,I.removeTab=b,I.select=k,I.scroll=y,I.nextPage=C,I.previousPage=N,I.keydown=l,I.canPageForward=S,I.canPageBack=_,I.refreshIndex=E,I.incrementSelectedIndex=s,I.updateInkBarStyles=$,d()}angular.module("material.components.tabs").controller("MdTabsController",e),e.$inject=["$scope","$element","$window","$timeout","$mdConstant","$mdInkRipple","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-f34eb80

 ...
 * v0.8.3-master-7888e4b
 */
function(){"use strict";function e(e,o,a,i,d,c,l){function s(){p(),d(function(){h(),f(),u()})}function m(){var e=q.wrap.getBoundingClientRect(),t=q.root.getBoundingClientRect(),o=e.bottom-t.top,a=t.height-e.top,i=e.left-t.left,d=e.width,c={left:i+"px",width:d+"px"};o>a&&t.height-e.bottom-r<n?(c.top="auto",c.bottom=a+"px",c.maxHeight=Math.min(n,e.top-t.top-r)+"px"):(c.top=o+"px",c.bottom="auto",c.maxHeight=Math.min(n,t.height-e.bottom-r)+"px"),q.$.ul.css(c)}function u(){q.$.root.length&&(c(q.$.ul),q.$.ul.detach(),q.$.root.append(q.$.ul))}function f(){e.autofocus&&q.input.focus()}function p(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(M,t):M),v(b),e.$watch("selectedItem",E),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){e&&!t&&m()}),angular.element(l).on("resize",m)}function h(){q={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:document.body},q.$=g(q)}function g(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function b(t,n){t&&(e.searchText=C(t)),e.itemChange&&t!==n&&e.itemChange(k(t))}function E(e,t){for(var n=0;n<K.length;++n)K[n](e,t)}function v(e){-1==K.indexOf(e)&&K.push(e)}function $(e){var t=K.indexOf(e);-1!=t&&K.splice(t,1)}function M(t,n){j.index=x(),(t||t!==n)&&t!==C(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(k(e.selectedItem)),H()?P():(j.loading=!1,j.matches=[],j.hidden=N(),O()))}function A(){Y||(j.hidden=!0)}function T(){return angular.isString(e.searchText)?(j.hidden=N(),j.hidden||P(),void 0):e.searchText=""}function w(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(j.loading)return;e.preventDefault(),j.index=Math.min(j.index+1,j.matches.length-1),L(),R();break;case i.KEY_CODE.UP_ARROW:if(j.loading)return;e.preventDefault(),j.index=j.index<0?j.matches.length-1:Math.max(0,j.index-1),L(),R();break;case i.KEY_CODE.ENTER:if(j.loading||j.index<0)return;e.preventDefault(),S(j.index);break;case i.KEY_CODE.ESCAPE:j.matches=[],j.hidden=!0,j.index=x();break;case i.KEY_CODE.TAB:}}function y(){return angular.isNumber(e.minLength)?e.minLength:1}function C(t){return t&&e.itemText?e.itemText(k(t)):t}function k(e){if(e){var t={};return j.itemName&&(t[j.itemName]=e),t}}function x(){return e.autoselect?0:-1}function N(){return H()?1===j.matches.length&&e.searchText===C(j.matches[0])&&e.selectedItem===j.matches[0]:!0}function _(){return C(j.matches[j.index])}function H(){return e.searchText.length>=y()}function S(t){e.selectedItem=j.matches[t],e.searchText=C(e.selectedItem)||e.searchText,j.hidden=!0,j.index=0,j.matches=[]}function I(){e.searchText="",S(-1),q.input.focus()}function D(t){function n(n){V[o]=n,t===e.searchText&&(U=null,j.loading=!1,j.matches=n,j.hidden=N(),O(),m())}var r=e.$parent.$eval(F),o=t.toLowerCase();angular.isArray(r)?n(r):(j.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){j.loading=!1}))}function O(){if(!j.hidden)switch(j.matches.length){case 0:return j.messages.splice(0);case 1:return j.messages.push({display:"There is 1 match available."});default:return j.messages.push({display:"There are "+j.matches.length+" matches available."})}}function R(){j.messages.push({display:_()})}function L(){var e=t*j.index,n=e+t,r=q.ul.clientHeight;e<q.ul.scrollTop?q.ul.scrollTop=e:n>q.ul.scrollTop+r&&(q.ul.scrollTop=n-r)}function P(){var t=e.searchText,n=t.toLowerCase();U&&U.cancel&&(U.cancel(),U=null),!e.noCache&&V[n]?(j.matches=V[n],O()):D(t),j.hidden=N()}var j=this,B=e.itemsExpr.split(/ in /i),F=B[1],q=null,U=null,V={},Y=!1,K=[];return j.scope=e,j.parent=e.$parent,j.itemName=B[0],j.matches=[],j.loading=!1,j.hidden=!0,j.index=null,j.messages=[],j.id=a.nextUid(),j.keydown=w,j.blur=A,j.focus=T,j.clear=I,j.select=S,j.fetch=a.debounce(D),j.getCurrentDisplayValue=_,j.registerSelectedItemWatcher=v,j.unregisterSelectedItemWatcher=$,j.listEnter=function(){Y=!0},j.listLeave=function(){Y=!1},j.mouseUp=function(){q.input.focus()},s()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=16;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-7888e4b

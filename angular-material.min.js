 ...
 * v0.8.3-master-dc93bff
 */
function(){"use strict";function e(e,t){return{restrict:"E",link:function(n,r){t(r),e(function(){var e=r[0].querySelector("md-content");e&&e.scrollHeight>e.clientHeight&&r.addClass("md-content-overflow")})}}}function t(e){function t(e,t){return{template:['<md-dialog md-theme="{{ dialog.theme }}" aria-label="{{ dialog.ariaLabel }}">',"<md-content>","<h2>{{ dialog.title }}</h2>","<p>{{ dialog.content }}</p>","</md-content>",'<div class="md-actions">','<md-button ng-if="dialog.$type == \'confirm\'" ng-click="dialog.abort()">',"{{ dialog.cancel }}","</md-button>",'<md-button ng-click="dialog.hide()" class="md-primary">',"{{ dialog.ok }}","</md-button>","</div>","</md-dialog>"].join(""),controller:function(){this.hide=function(){e.hide(!0)},this.abort=function(){e.cancel()}},controllerAs:"dialog",bindToController:!0,theme:t.defaultTheme()}}function n(e,t,n,r,o,a,i,c,d,l,s){function m(e,l,s){function m(){var e=l[0].querySelector(".dialog-close");if(!e){var t=l[0].querySelectorAll(".md-actions button");e=t[t.length-1]}return angular.element(e)}l=n.extractElementByName(l,"md-dialog"),s.parent=angular.element(s.parent),s.popInTarget=angular.element((s.targetEvent||{}).target);var u=m();if(f(l.find("md-dialog")),s.hasBackdrop){var h=s.parent[0]==t[0].body&&t[0].documentElement&&t[0].scrollTop?angular.element(t[0].documentElement):s.parent,g=h.prop("scrollTop");s.backdrop=angular.element('<md-backdrop class="md-dialog-backdrop md-opaque">'),o.inherit(s.backdrop,s.parent),d.enter(s.backdrop,s.parent),l.css("top",g+"px")}return s.disableParentScroll&&(s.lastOverflow=s.parent.css("overflow"),s.parent.css("overflow","hidden")),p(l,s.parent,s.popInTarget&&s.popInTarget.length&&s.popInTarget).then(function(){s.escapeToClose&&(s.rootElementKeyupCallback=function(e){e.keyCode===r.KEY_CODE.ESCAPE&&i(a.cancel)},c.on("keyup",s.rootElementKeyupCallback)),s.clickOutsideToClose&&(s.dialogClickOutsideCallback=function(e){e.target===l[0]&&i(a.cancel)},l.on("click",s.dialogClickOutsideCallback)),u.focus()})}function u(e,t,n){return n.backdrop&&d.leave(n.backdrop),n.disableParentScroll&&(n.parent.css("overflow",n.lastOverflow),delete n.lastOverflow),n.escapeToClose&&c.off("keyup",n.rootElementKeyupCallback),n.clickOutsideToClose&&t.off("click",n.dialogClickOutsideCallback),h(t,n.parent,n.popInTarget&&n.popInTarget.length&&n.popInTarget).then(function(){n.scope.$destroy(),t.remove(),n.popInTarget&&n.popInTarget.focus()})}function f(t){t.attr({role:"dialog"});var n=t.find("md-content");0===n.length&&(n=t),e.expectAsync(t,"aria-label",function(){var e=n.text().split(/\s+/);return e.length>3&&(e=e.slice(0,3).concat("...")),e.join(" ")})}function p(e,t,o){var a=e.find("md-dialog");return t.append(e),g(a,o),l(function(){a.addClass("transition-in").css(r.CSS.TRANSFORM,"")}),n.transitionEndPromise(a)}function h(e,t,r){var o=e.find("md-dialog");return o.addClass("transition-out").removeClass("transition-in"),g(o,r),n.transitionEndPromise(o)}function g(e,t){if(t){var n=t[0].getBoundingClientRect(),o=e[0].getBoundingClientRect(),a=Math.min(.5,n.width/o.width),i=Math.min(.5,n.height/o.height);e.css(r.CSS.TRANSFORM,"translate3d("+(-o.left+n.left+n.width/2-o.width/2)+"px,"+(-o.top+n.top+n.height/2-o.height/2)+"px,0) scale("+a+","+i+")")}}return{hasBackdrop:!0,isolateScope:!0,onShow:m,onRemove:u,clickOutsideToClose:!0,escapeToClose:!0,targetEvent:null,disableParentScroll:!0,transformTemplate:function(e){return'<div class="md-dialog-container">'+e+"</div>"}}}return t.$inject=["$mdDialog","$mdTheming"],n.$inject=["$mdAria","$document","$mdUtil","$mdConstant","$mdTheming","$mdDialog","$timeout","$rootElement","$animate","$$rAF","$q"],e("$mdDialog").setDefaults({methods:["disableParentScroll","hasBackdrop","clickOutsideToClose","escapeToClose","targetEvent"],options:n}).addPreset("alert",{methods:["title","content","ariaLabel","ok","theme"],options:t}).addPreset("confirm",{methods:["title","content","ariaLabel","ok","cancel","theme"],options:t})}angular.module("material.components.dialog",["material.core","material.components.backdrop"]).directive("mdDialog",e).provider("$mdDialog",t),e.$inject=["$$rAF","$mdTheming"],t.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-dc93bff

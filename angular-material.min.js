 ...
 * v0.8.3-master-7b78071
 */
function(){"use strict";function e(e,t,n){function r(e,t,n){var r=s[t.replace(/^\$md./,"")];if(!r)throw new Error("Failed to register element with handler "+t+". Available handlers: "+Object.keys(s).join(", "));return r.registerElement(e,n)}function o(t,n){var r=new e(t);return angular.extend(r,n),s[t]=r,u}var d=navigator.userAgent||navigator.vendor||window.opera,c=d.match(/iPad/i)||d.match(/iPhone/i)||d.match(/iPod/i),l=d.match(/Android/i),m=c||l,u={handler:o,register:r};return(u.$$hijackClicks=m)&&u.handler("click",{options:{maxDistance:6},onEnd:function(e,t){t.distance<this.state.options.maxDistance&&this.dispatchEvent(e,"click")}}),u.handler("press",{onStart:function(e){this.dispatchEvent(e,"$md.pressdown")},onEnd:function(e){this.dispatchEvent(e,"$md.pressup")}}).handler("hold",{options:{maxDistance:6,delay:500},onCancel:function(){n.cancel(this.state.timeout)},onStart:function(e,t){return this.state.registeredParent?(this.state.pos={x:t.x,y:t.y},this.state.timeout=n(angular.bind(this,function(){this.dispatchEvent(e,"$md.hold"),this.cancel()}),this.state.options.delay,!1),void 0):this.cancel()},onMove:function(e,t){e.preventDefault();var n=this.state.pos.x-t.x,r=this.state.pos.y-t.y;Math.sqrt(n*n+r*r)>this.options.maxDistance&&this.cancel()},onEnd:function(){this.onCancel()}}).handler("drag",{options:{minDistance:6,horizontal:!0},onStart:function(){this.state.registeredParent||this.cancel()},onMove:function(e,t){var n,r;e.preventDefault(),this.state.dragPointer?this.dispatchDragMove(e):(this.state.options.horizontal?(n=Math.abs(t.distanceX)>this.state.options.minDistance,r=Math.abs(t.distanceY)>1.5*this.state.options.minDistance):(n=Math.abs(t.distanceY)>this.state.options.minDistance,r=Math.abs(t.distanceX)>1.5*this.state.options.minDistance),n?(this.state.dragPointer=a(e),i(e,this.state.dragPointer),this.dispatchEvent(e,"$md.dragstart",this.state.dragPointer)):r&&this.cancel())},dispatchDragMove:t.throttle(function(e){this.state.isRunning&&(i(e,this.state.dragPointer),this.dispatchEvent(e,"$md.drag",this.state.dragPointer))}),onEnd:function(e){this.state.dragPointer&&(i(e,this.state.dragPointer),this.dispatchEvent(e,"$md.dragend",this.state.dragPointer))}}).handler("swipe",{options:{minVelocity:.65,minDistance:10},onEnd:function(e,t){if(Math.abs(t.velocityX)>this.state.options.minVelocity&&Math.abs(t.distanceX)>this.state.options.minDistance){var n="left"==t.directionX?"$md.swipeleft":"$md.swiperight";this.dispatchEvent(e,n)}}})}function t(e){this.name=e,this.state={}}function n(){function e(e,t,n){n=n||c;var r=new angular.element.Event(t);r.$material=!0,r.pointer=n,r.srcEvent=e,angular.extend(r,{clientX:n.x,clientY:n.y,screenX:n.x,screenY:n.y,pageX:n.x,pageY:n.y,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey,metaKey:e.metaKey}),angular.element(n.target).trigger(r)}function n(e,t,n){n=n||c;var r;"click"===t?(r=document.createEvent("MouseEvents"),r.initMouseEvent("click",!0,!0,window,e.detail,n.x,n.y,n.x,n.y,e.ctrlKey,e.altKey,e.shiftKey,e.metaKey,e.button,e.relatedTarget||null)):(r=document.createEvent("CustomEvent"),r.initCustomEvent(t,!0,!0,{})),r.$material=!0,r.pointer=n,r.srcEvent=e,n.target.dispatchEvent(r)}return t.prototype={onStart:angular.noop,onMove:angular.noop,onEnd:angular.noop,onCancel:angular.noop,options:{},dispatchEvent:"undefined"!=typeof window.jQuery&&angular.element===window.jQuery?e:n,start:function(e,t){if(!this.state.isRunning){var n=this.getNearestParent(e.target),r=n&&n.$mdGesture[this.name]||{};this.state={isRunning:!0,options:angular.extend({},this.options,r),registeredParent:n},this.onStart(e,t)}},move:function(e,t){this.state.isRunning&&this.onMove(e,t)},end:function(e,t){this.state.isRunning&&(this.onEnd(e,t),this.state.isRunning=!1)},cancel:function(e,t){this.onCancel(e,t),this.state={}},getNearestParent:function(e){for(var t=e;t;){if((t.$mdGesture||{})[this.name])return t;t=t.parentNode}},registerElement:function(e,t){function n(){delete e[0].$mdGesture[r.name],e.off("$destroy",n)}var r=this;return e[0].$mdGesture=e[0].$mdGesture||{},e[0].$mdGesture[this.name]=t||{},e.on("$destroy",n),n}},t}function r(e){function n(e,n){var r;for(var o in s)r=s[o],r instanceof t&&("start"===e&&angular.isFunction(r.cancel)&&r.cancel(),r[e](n,c))}function r(e){if(!c){var t=+Date.now();l&&!o(e,l)&&t-l.endTime<1500||(c=a(e),n("start",e))}}function d(e){c&&o(e,c)&&(i(e,c),n("move",e))}function m(e){c&&o(e,c)&&(i(e,c),c.endTime=+Date.now(),n("end",e),l=c,c=null)}var u="mousedown touchstart pointerdown",f="mousemove touchmove pointermove",p="mouseup mouseleave touchend touchcancel pointerup pointercancel";document.contains||(document.contains=function(e){return document.body.contains(e)}),e.$$hijackClicks&&document.addEventListener("click",function(e){var t=0===e.clientX&&0===e.clientY;t||e.$material||(e.preventDefault(),e.stopPropagation())},!0),angular.element(document).on(u,r).on(f,d).on(p,m).on("$$mdGestureReset",function(){l=c=null})}function o(e,t){return e&&t&&e.type.charAt(0)===t.type}function a(e){var t=d(e),n={startTime:+Date.now(),target:e.target,type:e.type.charAt(0)};return n.startX=n.x=t.pageX,n.startY=n.y=t.pageY,n}function i(e,t){var n=d(e),r=t.x=n.pageX,o=t.y=n.pageY;t.distanceX=r-t.startX,t.distanceY=o-t.startY,t.distance=Math.sqrt(t.distanceX*t.distanceX+t.distanceY*t.distanceY),t.directionX=t.distanceX>0?"right":t.distanceX<0?"left":"",t.directionY=t.distanceY>0?"up":t.distanceY<0?"down":"",t.duration=+Date.now()-t.startTime,t.velocityX=t.distanceX/t.duration,t.velocityY=t.distanceY/t.duration}function d(e){return e=e.originalEvent||e,e.touches&&e.touches[0]||e.changedTouches&&e.changedTouches[0]||e}var c,l,s={};angular.module("material.core.gestures",[]).factory("$mdGesture",e).factory("$$MdGestureHandler",n).run(r),e.$inject=["$$MdGestureHandler","$$rAF","$timeout"],n.$inject=["$$rAF"],r.$inject=["$mdGesture"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-7b78071
 ...
 * v0.8.3-master-7b78071
 */
function(){"use strict";function e(){return{restrict:"E",compile:function(e){e[0].setAttribute("role","list")}}}function t(){return{restrict:"E",compile:function(e){e[0].setAttribute("role","listitem")}}}angular.module("material.components.list",["material.core"]).directive("mdList",e).directive("mdItem",t).directive("mdListItem",t)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-7b78071
 ...
 * v0.8.3-master-7b78071
 */
function(){"use strict";function e(){function e(e,t){return function(){t.$apply(function(){e.removeChip(t.$index)})}}return{restrict:"A",require:["^mdChips"],link:function(t,n,r,o){var a=o[0];n.on("click",e(a,t))},scope:!1}}angular.module("material.components.chips").directive("mdChipRemove",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-7b78071
 ...
 * v0.8.3-master-7b78071
 */
function(){"use strict";function e(e,o){function a(t,a){var i=a.$mdUserTemplate,d=i.find("md-chip");0===d.length?d=angular.element(r):d[0].querySelector("[md-chip-remove]")||o.warn("md-chip-remove attribute not found in md-chip template.");var c=angular.element(t[0].querySelector(".md-chip"));c.append(d);var l=i.find("md-autocomplete"),s=l.length>0;if(!s){l=angular.element(n);var m=angular.element(t[0].querySelector(".md-chip-worker"));m.append(l)}return function(t,n,r,a){e(n);var i=a[0],d=a[1];d.configureNgModel(i),r.mdChipAppend&&d.useMdChipAppendExpression(),s&&o.error("md-autocomplete not yet supported")}}return{template:function(e,n){return n.$mdUserTemplate=e.clone(),t},require:["ngModel","mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:a,scope:{readonly:"=readonly",placeholder:"@",secondaryPlaceholder:"@",mdChipAppend:"&"}}}angular.module("material.components.chips").directive("mdChips",e);var t='      <md-chips-wrap ng-class="{readonly : $mdChipsCtrl.readonly}" class="md-chips">        <div role="presentation">          <div ng-repeat="$chip in $mdChipsCtrl.items"              ng-class="{selected: $mdChipsCtrl.selectedChip == $index}"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              class="md-chip">          </div>          <div ng-if="!$mdChipsCtrl.readonly" class="md-chip-worker"></div>        </div>      </md-chips-wrap>',n='        <input            placeholder="{{$mdChipsCtrl.items.length == 0 ? $mdChipsCtrl.placeholder : $mdChipsCtrl.secondaryPlaceholder}}"            class="md-chip-input"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.resetSelectedChip()"            ng-keydown="$mdChipsCtrl.defaultInputKeydown($event)">',r='      <md-chip>        <span>{{$chip}}</span>        <md-button ng-if="!$mdChipsCtrl.readonly"            md-chip-remove>x</md-button>      </md-chip>';e.$inject=["$mdTheming","$log"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-7b78071

 ...
 * v0.9.0-rc1-master-836b438
 */
function(){"use strict";function e(e){function t(t,n,r,o){if(o){var a=t.$parent.$index;t.$watch("template",function(t){n.html(t),e(n.contents())(o.tabs[a].parent)})}}return{restrict:"A",link:t,scope:{template:"=mdLabelTemplate"},require:"^?mdTabs"}}angular.module("material.components.tabs").directive("mdLabelTemplate",e),e.$inject=["$compile"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-836b438
 ...
 * v0.9.0-rc1-master-836b438
 */
function(){"use strict";function e(){function e(e,t,n,r){function o(){function e(){return n.label}function r(){var e=t.find("md-tab-label");return e.length?e.remove().html():void 0}function o(){var e=t.html();return t.empty(),e}n.label||(t.find("md-tab-label")[0]||t[0]).innerHTML;return e()||r()||o()}function a(){var e=t.find("md-tab-body"),r=e.length?e.html():n.label?t.html():null;return e.length?e.remove():n.label&&t.empty(),r}if(r){var i=t.parent()[0].getElementsByTagName("md-tab"),d=Array.prototype.indexOf.call(i,t[0]),c=r.insertTab({scope:e,parent:e.$parent,index:d,template:a(),label:o()},d);e.deselect=e.deselect||angular.noop,e.select=e.select||angular.noop,e.$watch("active",function(e){e&&r.select(c.getIndex())}),e.$watch("disabled",function(){r.refreshIndex()}),e.$on("$destroy",function(){r.removeTab(c)})}}return{require:"^?mdTabs",terminal:!0,scope:{label:"@",active:"=?mdActive",disabled:"=?ngDisabled",select:"&?mdOnSelect",deselect:"&?mdOnDeselect"},link:e}}angular.module("material.components.tabs").directive("mdTab",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-836b438
 */
function(){"use strict";function e(){function e(e,t,n,r){r&&r.attachRipple(e,t)}return{require:"^?mdTabs",link:e}}angular.module("material.components.tabs").directive("mdTabItem",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-836b438
 ...
 * v0.9.0-rc1-master-836b438
 */
function(){"use strict";function e(e,t,n,r,o,a,i,d){function c(){e.$watch("selectedIndex",T),e.$watch("$mdTabsCtrl.focusIndex",p),e.$watch("$mdTabsCtrl.offsetLeft",f),e.$watch("$mdTabsCtrl.hasContent",l),angular.element(n).on("resize",function(){e.$apply(b)}),r(k,0,!1),r(w,0,!1)}function l(e){t[e?"removeClass":"hasClass"]("md-no-tab-content")}function m(){var e={};return e.wrapper=t[0].getElementsByTagName("md-tabs-wrapper")[0],e.canvas=e.wrapper.getElementsByTagName("md-tabs-canvas")[0],e.paging=e.canvas.getElementsByTagName("md-pagination-wrapper")[0],e.tabs=e.paging.getElementsByTagName("md-tab-item"),e.dummies=e.canvas.getElementsByTagName("md-dummy-tab"),e.inkBar=e.paging.getElementsByTagName("md-ink-bar")[0],e.contentsWrapper=t[0].getElementsByTagName("md-tabs-content-wrapper")[0],e.contents=e.contentsWrapper.getElementsByTagName("md-tab-content"),e}function s(t){switch(t.keyCode){case o.KEY_CODE.LEFT_ARROW:t.preventDefault(),u(-1,!0);break;case o.KEY_CODE.RIGHT_ARROW:t.preventDefault(),u(1,!0);break;case o.KEY_CODE.SPACE:case o.KEY_CODE.ENTER:t.preventDefault(),F||(e.selectedIndex=B.focusIndex)}B.lastClick=!1}function u(t,n){var r,o=n?B.focusIndex:e.selectedIndex;for(r=o+t;B.tabs[r]&&B.tabs[r].scope.disabled;r+=t);B.tabs[r]&&(n?B.focusIndex=r:e.selectedIndex=r)}function f(t){var n=_()?"":"-"+t+"px";angular.element(q.paging).css("left",n),e.$broadcast("$mdTabsPaginationChanged")}function p(e,t){e!==t&&q.tabs[e]&&(g(),h())}function h(){q.dummies[B.focusIndex].focus()}function g(){if(!_()){var e=q.tabs[B.focusIndex],t=e.offsetLeft,n=e.offsetWidth+t;B.offsetLeft=Math.max(B.offsetLeft,D(n-q.canvas.clientWidth)),B.offsetLeft=Math.min(B.offsetLeft,D(t))}}function b(){B.lastSelectedIndex=e.selectedIndex,k(),B.offsetLeft=D(B.offsetLeft)}function E(){U.forEach(function(e){r(e)}),U=[]}function v(t,n){var r={getIndex:function(){return B.tabs.indexOf(o)},isActive:function(){return this.getIndex()===e.selectedIndex},isLeft:function(){return this.getIndex()<e.selectedIndex},isRight:function(){return this.getIndex()>e.selectedIndex},hasFocus:function(){return!B.lastClick&&B.hasFocus&&this.getIndex()===B.focusIndex},id:i.nextUid()},o=angular.extend(r,t);return angular.isDefined(n)?B.tabs.splice(n,0,o):B.tabs.push(o),E(),M(),o}function M(){var e=!1;angular.forEach(B.tabs,function(t){t.template&&(e=!0)}),B.hasContent=e}function $(e){B.tabs.splice(e.getIndex(),1),A(),r(function(){k(),B.offsetLeft=D(B.offsetLeft)})}function A(){e.selectedIndex=x(e.selectedIndex),B.focusIndex=x(B.focusIndex)}function T(t,n){t!==n&&(e.selectedIndex=x(t),B.lastSelectedIndex=n,k(),w(),e.$broadcast("$mdTabsChanged"),B.tabs[n]&&B.tabs[n].scope.deselect(),B.tabs[t]&&B.tabs[t].scope.select())}function C(){C.watcher||(C.watcher=e.$watch(function(){r(function(){C.watcher&&t.prop("offsetParent")&&(C.watcher(),C.watcher=null,e.$apply(b))},0,!1)}))}function w(){if(!e.dynamicHeight)return t.css("height","");if(!B.tabs.length)return U.push(w);var n=q.contents[e.selectedIndex],r=n?n.offsetHeight:0,o=q.wrapper.offsetHeight,a=r+o,i=t.prop("clientHeight");i!==a&&(F=!0,d.animate(t,{height:i+"px"},{height:a+"px"}).then(function(){t.css("height",""),F=!1}))}function k(){if(!B.tabs.length)return U.push(k);if(!t.prop("offsetParent"))return C();var n=e.selectedIndex,r=q.paging.offsetWidth,o=q.tabs[n],a=o.offsetLeft,i=r-a-o.offsetWidth;y(),angular.element(q.inkBar).css({left:a+"px",right:i+"px"})}function y(){var t=e.selectedIndex,n=B.lastSelectedIndex,r=angular.element(q.inkBar);r.removeClass("md-left md-right"),angular.isNumber(n)&&(n>t?r.addClass("md-left"):t>n&&r.addClass("md-right"))}function x(e){var t,n,r=Math.max(B.tabs.length-e,e);for(t=0;r>=t;t++){if(n=B.tabs[e+t],n&&n.scope.disabled!==!0)return n.getIndex();if(n=B.tabs[e-t],n&&n.scope.disabled!==!0)return n.getIndex()}return e}function N(){switch(e.stretchTabs){case"always":return!0;case"never":return!1;default:return!H()&&n.matchMedia("(max-width: 600px)").matches}}function _(){return e.centerTabs&&!H()}function H(){if(e.noPagination)return!1;var n=t.prop("clientWidth");return angular.forEach(q.tabs,function(e){n-=e.offsetWidth}),0>n}function S(t){F||(B.focusIndex=e.selectedIndex=t),B.lastClick=!0}function I(e){H()&&(e.preventDefault(),B.offsetLeft=D(B.offsetLeft-e.wheelDelta))}function D(e){if(!q.tabs.length||!H())return 0;var t=q.tabs[q.tabs.length-1],n=t.offsetLeft+t.offsetWidth;return e=Math.max(0,e),e=Math.min(n-q.canvas.clientWidth,e)}function O(){var e,t,n=q.canvas.clientWidth,r=n+B.offsetLeft;for(e=0;e<q.tabs.length&&(t=q.tabs[e],!(t.offsetLeft+t.offsetWidth>r));e++);B.offsetLeft=D(t.offsetLeft)}function R(){var e,t;for(e=0;e<q.tabs.length&&(t=q.tabs[e],!(t.offsetLeft+t.offsetWidth>=B.offsetLeft));e++);B.offsetLeft=D(t.offsetLeft+t.offsetWidth-q.canvas.clientWidth)}function L(){return B.offsetLeft>0}function P(){var e=q.tabs[q.tabs.length-1];return e&&e.offsetLeft+e.offsetWidth>q.canvas.clientWidth+B.offsetLeft}function j(e,t){var n={colorElement:angular.element(q.inkBar)};a.attachTabBehavior(e,t,n)}var B=this,F=!1,q=m(),U=[];B.scope=e,B.parent=e.$parent,B.tabs=[],B.lastSelectedIndex=null,B.focusIndex=0,B.offsetLeft=0,B.hasContent=!1,B.hasFocus=!1,B.lastClick=!1,B.redirectFocus=h,B.attachRipple=j,B.shouldStretchTabs=N,B.shouldPaginate=H,B.shouldCenterTabs=_,B.insertTab=v,B.removeTab=$,B.select=S,B.scroll=I,B.nextPage=O,B.previousPage=R,B.keydown=s,B.canPageForward=P,B.canPageBack=L,B.refreshIndex=A,B.incrementSelectedIndex=u,B.updateInkBarStyles=k,c()}angular.module("material.components.tabs").controller("MdTabsController",e),e.$inject=["$scope","$element","$window","$timeout","$mdConstant","$mdInkRipple","$mdUtil","$animate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-836b438

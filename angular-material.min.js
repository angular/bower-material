 ...
 * v0.6.1-master-6caccf7
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(i,m,u,s){function f(t){f.value=!!t,f.queued||(t?(f.queued=!0,e(function(){i.visible=f.value,f.queued=!1},c)):e(function(){i.visible=!1}))}function p(){m.removeClass("md-hide"),b.attr("aria-describedby",m.attr("id")),l.append(m),n(function(){n(function(){g(),i.visible&&m.addClass("md-show")})})}function h(){m.removeClass("md-show").addClass("md-hide"),b.removeAttr("aria-describedby"),e(function(){i.visible||m.detach()},200,!1)}function g(){var e=m[0].getBoundingClientRect(),n=b[0].getBoundingClientRect();s&&(n.top+=s.$element.prop("scrollTop"),n.left+=s.$element.prop("scrollLeft"));var r="bottom",o={left:n.left+n.width/2-e.width/2,top:n.top+n.height};o.left=Math.min(o.left,t.innerWidth-e.width-d),o.left=Math.max(o.left,d),o.top+e.height>t.innerHeight&&(o.top=n.top-e.height,r="top"),m.css({top:o.top+"px",left:o.left+"px"}),m.attr("width-32",Math.ceil(e.width/32)),m.attr("md-direction",r)}a(m);var b=m.parent();m.detach(),m.attr("role","tooltip"),m.attr("id",u.id||"tooltip_"+o.nextUid()),b.on("focus mouseenter touchstart",function(){f(!0)}),b.on("blur mouseleave touchend touchcancel",function(){r[0].activeElement!==b[0]&&f(!1)}),i.$watch("visible",function(e){e?p():h()});var E=n.debounce(function(){i.visible&&g()});angular.element(t).on("resize",E),i.$on("$destroy",function(){i.visible=!1,m.remove(),angular.element(t).off("resize",E)})}var c=400,d=8,l=angular.element(document.body);return{restrict:"E",transclude:!0,require:"^?mdContent",template:'<div class="md-background"></div><div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible"},link:i}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.6.1-master-6caccf7

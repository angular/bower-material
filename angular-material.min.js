 ...
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(){return{restrict:"E"}}function t(e){function t(e,t,r,a,i,d,c,l,m){function s(n,o,m){o=r.extractElementByName(o,"md-bottom-sheet"),p=i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n),p.on("click",function(){a(c.cancel)}),d.inherit(p,m.parent),e.enter(p,m.parent,null);var s=new f(o,m.parent);return m.bottomSheet=s,m.targetEvent&&angular.element(m.targetEvent.target).blur(),d.inherit(s.element,m.parent),m.disableParentScroll&&(m.lastOverflow=m.parent.css("overflow"),m.parent.css("overflow","hidden")),e.enter(s.element,m.parent).then(function(){var e=angular.element(o[0].querySelector("button")||o[0].querySelector("a")||o[0].querySelector("[ng-click]"));e.focus(),m.escapeToClose&&(m.rootElementKeyupCallback=function(e){e.keyCode===t.KEY_CODE.ESCAPE&&a(c.cancel)},l.on("keyup",m.rootElementKeyupCallback))})}function u(t,n,o){var r=o.bottomSheet;return e.leave(p),e.leave(r.element).then(function(){o.disableParentScroll&&(o.parent.css("overflow",o.lastOverflow),delete o.lastOverflow),r.cleanup(),o.targetEvent&&angular.element(o.targetEvent.target).focus()})}function f(e,r){function i(n){e.css(t.CSS.TRANSITION_DURATION,"0ms")}function d(n){var r=n.pointer.distanceY;5>r&&(r=Math.max(-o,r/2)),e.css(t.CSS.TRANSFORM,"translate3d(0,"+(o+r)+"px,0)")}function l(o){if(o.pointer.distanceY>0&&(o.pointer.distanceY>20||Math.abs(o.pointer.velocityY)>n)){var r=e.prop("offsetHeight")-o.pointer.distanceY,i=Math.min(r/o.pointer.velocityY*.75,500);e.css(t.CSS.TRANSITION_DURATION,i+"ms"),a(c.cancel)}else e.css(t.CSS.TRANSITION_DURATION,""),e.css(t.CSS.TRANSFORM,"")}var s=m.register(r,"drag",{horizontal:!1});return r.on("$md.dragstart",i).on("$md.drag",d).on("$md.dragend",l),{element:e,cleanup:function(){s(),r.off("$md.dragstart",i).off("$md.drag",d).off("$md.dragend",l)}}}var p;return{themable:!0,targetEvent:null,onShow:s,onRemove:u,escapeToClose:!0,disableParentScroll:!0}}var n=.5,o=80;return t.$inject=["$animate","$mdConstant","$mdUtil","$timeout","$compile","$mdTheming","$mdBottomSheet","$rootElement","$mdGesture"],e("$mdBottomSheet").setDefaults({methods:["disableParentScroll","escapeToClose","targetEvent"],options:t})}angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",e).provider("$mdBottomSheet",t),t.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e){return{restrict:"E",link:function(t,n,o){e(n)}}}angular.module("material.components.card",["material.core"]).directive("mdCard",e),e.$inject=["$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o){function r(e){return angular.isDefined(e.href)||angular.isDefined(e.ngHref)||angular.isDefined(e.uiSref)}function a(e,t){return r(t)?'<a class="md-button" ng-transclude></a>':'<button class="md-button" ng-transclude></button>'}function i(a,i,d){var c=i[0];t(i),e.attachButtonBehavior(a,i);var l=c.textContent.trim();l||n.expect(i,"aria-label"),r(d)&&angular.isDefined(d.ngDisabled)&&a.$watch(d.ngDisabled,function(e){i.attr("tabindex",e?-1:0)}),a.mouseActive=!1,i.on("mousedown",function(){a.mouseActive=!0,o(function(){a.mouseActive=!1},100)}).on("focus",function(){a.mouseActive===!1&&i.addClass("md-focused")}).on("blur",function(){i.removeClass("md-focused")})}return{restrict:"EA",replace:!0,transclude:!0,template:a,link:i}}angular.module("material.components.button",["material.core"]).directive("mdButton",e),e.$inject=["$mdInkRipple","$mdTheming","$mdAria","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o,r,a,i){function d(t,d){return d.type="checkbox",d.tabindex=d.tabindex||"0",t.attr("role",d.type),function(t,d,l,m){function s(e,n,o){l[e]&&t.$watch(l[e],function(e){o[e]&&d.attr(n,o[e])})}function u(e){var t=e.which||e.keyCode;(t===o.KEY_CODE.SPACE||t===o.KEY_CODE.ENTER)&&(e.preventDefault(),d.hasClass("md-focused")||d.addClass("md-focused"),f(e))}function f(e){d[0].hasAttribute("disabled")||t.$apply(function(){var t=l.ngChecked?l.checked:!m.$viewValue;m.$setViewValue(t,e&&e.type),m.$render()})}function p(){m.$viewValue?d.addClass(c):d.removeClass(c)}m=m||a.fakeNgModel(),r(d),l.ngChecked&&t.$watch(t.$eval.bind(t,l.ngChecked),m.$setViewValue.bind(m)),s("ngDisabled","tabindex",{"true":"-1","false":l.tabindex}),n.expectWithText(d,"aria-label"),e.link.pre(t,{on:angular.noop,0:{}},l,[m]),t.mouseActive=!1,d.on("click",f).on("keypress",u).on("mousedown",function(){t.mouseActive=!0,i(function(){t.mouseActive=!1},100)}).on("focus",function(){t.mouseActive===!1&&d.addClass("md-focused")}).on("blur",function(){d.removeClass("md-focused")}),m.$render=p}}e=e[0];var c="md-checked";return{restrict:"E",transclude:!0,require:"?ngModel",template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:d}}angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",e),e.$inject=["inputDirective","$mdInkRipple","$mdAria","$mdConstant","$mdTheming","$mdUtil","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 ...
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,n,o,r){function a(t,a,i,d){function c(){for(var e in n.MEDIA)r(e),r.getQuery(n.MEDIA[e]).addListener(A);return r.watchResponsiveAttributes(["md-cols","md-row-height"],i,m)}function l(){T();for(var e in n.MEDIA)r.getQuery(n.MEDIA[e]).removeListener(A)}function m(e){null==e?d.invalidateLayout():r(e)&&d.invalidateLayout()}function s(e){var n={tileSpans:g(),colCount:b(),rowMode:M(),rowHeight:v(),gutter:E()};if(e||!angular.equals(n,C)){var r=h(),i=o(n.colCount,n.tileSpans,r).map(function(e,t){return{grid:{element:a,style:p(n.colCount,t,n.gutter,n.rowMode,n.rowHeight)},tiles:e.map(function(e,t){return{element:angular.element(r[t]),style:f(e.position,e.spans,n.colCount,n.rowCount,n.gutter,n.rowMode,n.rowHeight)}})}}).reflow().performance();t.mdOnLayout({$event:{performance:i}}),C=n}}function u(e){return w+e+k}function f(e,t,n,o,r,a,i){var d=1/n*100,c=(n-1)/n,l=y({share:d,gutterShare:c,gutter:r}),m={left:x({unit:l,offset:e.col,gutter:r}),width:N({unit:l,span:t.col,gutter:r}),paddingTop:"",marginTop:"",top:"",height:""};switch(a){case"fixed":m.top=x({unit:i,offset:e.row,gutter:r}),m.height=N({unit:i,span:t.row,gutter:r});break;case"ratio":var s=d/i,u=y({share:s,gutterShare:c,gutter:r});m.paddingTop=N({unit:u,span:t.row,gutter:r}),m.marginTop=x({unit:u,offset:e.row,gutter:r});break;case"fit":var f=(o-1)/o,s=1/o*100,u=y({share:s,gutterShare:f,gutter:r});m.top=x({unit:u,offset:e.row,gutter:r}),m.height=N({unit:u,span:t.row,gutter:r})}return m}function p(e,t,n,o,r){var a={height:"",paddingBottom:""};switch(o){case"fixed":a.height=N({unit:r,span:t,gutter:n});break;case"ratio":var i=1===e?0:(e-1)/e,d=1/e*100,c=d*(1/r),l=y({share:c,gutterShare:i,gutter:n});a.paddingBottom=N({unit:l,span:t,gutter:n});break;case"fit":}return a}function h(){return d.tiles.map(function(e){return e.element})}function g(){return d.tiles.map(function(e){return{row:parseInt(r.getResponsiveAttribute(e.attrs,"md-rowspan"),10)||1,col:parseInt(r.getResponsiveAttribute(e.attrs,"md-colspan"),10)||1}})}function b(){var e=parseInt(r.getResponsiveAttribute(i,"md-cols"),10);if(isNaN(e))throw"md-grid-list: md-cols attribute was not found, or contained a non-numeric value";return e}function E(){return $(r.getResponsiveAttribute(i,"md-gutter")||1)}function v(){var e=r.getResponsiveAttribute(i,"md-row-height");switch(M()){case"fixed":return $(e);case"ratio":var t=e.split(":");return parseFloat(t[0])/parseFloat(t[1]);case"fit":return 0}}function M(){var e=r.getResponsiveAttribute(i,"md-row-height");return"fit"==e?"fit":-1!==e.indexOf(":")?"ratio":"fixed"}function $(e){return/\D$/.test(e)?e:e+"px"}a.attr("role","list"),d.layoutDelegate=s;var A=angular.bind(d,d.invalidateLayout),T=c();t.$on("$destroy",l);var C,w=e.startSymbol(),k=e.endSymbol(),y=e(u("share")+"% - ("+u("gutter")+" * "+u("gutterShare")+")"),x=e("calc(("+u("unit")+" + "+u("gutter")+") * "+u("offset")+")"),N=e("calc(("+u("unit")+") * "+u("span")+" + ("+u("span")+" - 1) * "+u("gutter")+")")}return{restrict:"E",controller:t,scope:{mdOnLayout:"&"},link:a}}function t(e){this.invalidated=!1,this.tilesAdded=!1,this.$timeout_=e,this.tiles=[],this.layoutDelegate=angular.noop}function n(e){function t(t,n){var a,i,d,c,l,m;return c=e.time(function(){i=o(t,n)}),a={layoutInfo:function(){return i},map:function(t){return l=e.time(function(){var e=a.layoutInfo();d=t(e.positioning,e.rowCount)}),a},reflow:function(t){return m=e.time(function(){var e=t||r;e(d.grid,d.tiles)}),a},performance:function(){return{tileCount:n.length,layoutTime:c,mapTime:l,reflowTime:m,totalTime:c+l+m}}}}function n(e,t){e.element.css(e.style),t.forEach(function(e){e.element.css(e.style)})}function o(e,t){function n(t,n){if(t.col>e)throw"md-grid-list: Tile at position "+n+" has a colspan ("+t.col+") that exceeds the column count ("+e+")";for(var i=0,m=0;m-i<t.col;)d>=e?o():(i=l.indexOf(0,d),-1!==i&&-1!==(m=a(i+1))?d=m+1:(i=m=0,o()));return r(i,t.col,t.row),d=i+t.col,{col:i,row:c}}function o(){d=0,c++,r(0,e,-1)}function r(e,t,n){for(var o=e;e+t>o;o++)l[o]=Math.max(l[o]+n,0)}function a(e){var t;for(t=e;t<l.length;t++)if(0!==l[t])return t;return t===l.length?t:void 0}function i(){for(var t=[],n=0;e>n;n++)t.push(0);return t}var d=0,c=0,l=i();return{positioning:t.map(function(e,t){return{spans:e,position:n(e,t)}}),rowCount:c+Math.max.apply(Math,l)}}var r=n;return t.animateWith=function(e){r=angular.isFunction(e)?e:n},t}function o(e){function t(t,n,o,r){n.attr("role","listitem");var a=e.watchResponsiveAttributes(["md-colspan","md-rowspan"],o,angular.bind(r,r.invalidateLayout));r.addTile(n,o,t.$parent.$index),t.$on("$destroy",function(){a(),r.removeTile(n,o)}),angular.isDefined(t.$parent.$index)&&t.$watch(function(){return t.$parent.$index},function(e,t){r.removeTile(n,o),r.addTile(n,o,e)})}return{restrict:"E",require:"^mdGridList",template:"<figure ng-transclude></figure>",transclude:!0,scope:{},link:t}}function r(){return{template:"<figcaption ng-transclude></figcaption>",transclude:!0}}angular.module("material.components.gridList",["material.core"]).directive("mdGridList",e).directive("mdGridTile",o).directive("mdGridTileFooter",r).directive("mdGridTileHeader",r).factory("$mdGridLayout",n),e.$inject=["$interpolate","$mdConstant","$mdGridLayout","$mdMedia"],t.$inject=["$timeout"],t.prototype={addTile:function(e,t,n){var o={element:e,attrs:t};angular.isUndefined(n)?this.tiles.push(o):this.tiles.splice(n,0,o),this.tilesAdded=!0,this.invalidateLayout()},removeTile:function(e,t){var n=this._findTileIndex(t);-1!==n&&(this.tiles.splice(n,1),this.invalidateLayout())},invalidateLayout:function(){this.invalidated||(this.invalidated=!0,this.$timeout_(angular.bind(this,this.layout)))},layout:function(){try{this.layoutDelegate(this.tilesAdded)}finally{this.invalidated=!1,this.tilesAdded=!1}},_findTileIndex:function(e){for(var t=0;t<this.tiles.length;t++)if(this.tiles[t].attrs==e)return t;return-1}},n.$inject=["$mdUtil"],o.$inject=["$mdMedia"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 ...
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(){}function t(e,t){this.url=e,this.iconSize=t||o.defaultIconSize}function n(e,t,n,o,r){function a(t){return function(n){return h[t]=s(n)?n:new u(n,e[t]),h[t].clone()}}function i(t){var o=e[t];return o?c(o.url).then(function(e){return new u(e,o)}):n.reject(t)}function d(t){function o(e){var o=t.slice(t.lastIndexOf(":")+1),r=e.querySelector("#"+o);return r?new u(r,a):n.reject(t)}var r=t.substring(0,t.lastIndexOf(":"))||"$default",a=e[r];return a?c(a.url).then(o):n.reject(t)}function c(e){return t.get(e,{cache:r}).then(function(e){return angular.element("<div>").append(e.data).find("svg")[0]})}function l(e){var t;return angular.isString(e)&&(t="icon "+e+" not found",o.warn(t)),n.reject(t||e)}function m(e){var t=angular.isString(e)?e:e.message||e.data||e.statusText;return o.warn(t),n.reject(t)}function s(e){return angular.isDefined(e.element)&&angular.isDefined(e.config)}function u(e,t){"svg"!=e.tagName&&(e=angular.element('<svg xmlns="http://www.w3.org/2000/svg">').append(e)[0]),e.getAttribute("xmlns")||e.setAttribute("xmlns","http://www.w3.org/2000/svg"),this.element=e,this.config=t,this.prepare()}function f(){var t=this.config?this.config.iconSize:e.defaultIconSize;angular.forEach({fit:"",height:"100%",width:"100%",preserveAspectRatio:"xMidYMid meet",viewBox:this.element.getAttribute("viewBox")||"0 0 "+t+" "+t},function(e,t){this.element.setAttribute(t,e)},this),angular.forEach({"pointer-events":"none",display:"block"},function(e,t){this.element.style[t]=e},this)}function p(){return this.element.cloneNode(!0)}var h={},g=/[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?/i;return u.prototype={clone:p,prepare:f},function(e){return e=e||"",h[e]?n.when(h[e].clone()):g.test(e)?c(e).then(a(e)):(-1==e.indexOf(":")&&(e="$default:"+e),i(e)["catch"](d)["catch"](l)["catch"](m).then(a(e)))}}angular.module("material.components.icon").provider("$mdIcon",e);var o={defaultIconSize:24};e.prototype={icon:function(e,n,r){return-1==e.indexOf(":")&&(e="$default:"+e),o[e]=new t(n,r),this},iconSet:function(e,n,r){return o[e]=new t(n,r),this},defaultIconSet:function(e,n){var r="$default";return o[r]||(o[r]=new t(e,n)),o[r].iconSize=n||o.defaultIconSize,this},defaultIconSize:function(e){return o.defaultIconSize=e,this},preloadIcons:function(e){var t=this,n=[{id:"tabs-arrow",url:"tabs-arrow.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><polygon points="15.4,7.4 14,6 8,12 14,18 15.4,16.6 10.8,12 "/></g></svg>'},{id:"close",url:"close.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M19 6.41l-1.41-1.41-5.59 5.59-5.59-5.59-1.41 1.41 5.59 5.59-5.59 5.59 1.41 1.41 5.59-5.59 5.59 5.59 1.41-1.41-5.59-5.59z"/></g></svg>'},{id:"cancel",url:"cancel.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M12 2c-5.53 0-10 4.47-10 10s4.47 10 10 10 10-4.47 10-10-4.47-10-10-10zm5 13.59l-1.41 1.41-3.59-3.59-3.59 3.59-1.41-1.41 3.59-3.59-3.59-3.59 1.41-1.41 3.59 3.59 3.59-3.59 1.41 1.41-3.59 3.59 3.59 3.59z"/></g></svg>'},{id:"menu",url:"menu.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 100 100"><path d="M 50 0 L 100 14 L 92 80 L 50 100 L 8 80 L 0 14 Z" fill="#b2b2b2"></path><path d="M 50 5 L 6 18 L 13.5 77 L 50 94 Z" fill="#E42939"></path><path d="M 50 5 L 94 18 L 86.5 77 L 50 94 Z" fill="#B72833"></path><path d="M 50 7 L 83 75 L 72 75 L 65 59 L 50 59 L 50 50 L 61 50 L 50 26 Z" fill="#b2b2b2"></path><path d="M 50 7 L 17 75 L 28 75 L 35 59 L 50 59 L 50 50 L 39 50 L 50 26 Z" fill="#fff"></path></svg>'},{id:"toggle-arrow",url:"toggle-arrow-svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 48 48"><path d="M24 16l-12 12 2.83 2.83 9.17-9.17 9.17 9.17 2.83-2.83z"/><path d="M0 0h48v48h-48z" fill="none"/></svg>'}];n.forEach(function(n){t.icon(n.id,n.url),e.put(n.url,n.svg)})},$get:["$http","$q","$log","$templateCache",function(e,t,r,a){return this.preloadIcons(a),new n(o,e,t,r,a)}]}}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){function e(e,t){function n(t,n,o){e(n)}function o(e,n,o){var r=this;r.isErrorGetter=o.mdIsError&&t(o.mdIsError),r.delegateClick=function(){r.input.focus()},r.element=n,r.setFocused=function(e){n.toggleClass("md-input-focused",!!e)},r.setHasValue=function(e){n.toggleClass("md-input-has-value",!!e)},r.setInvalid=function(e){n.toggleClass("md-input-invalid",!!e)},e.$watch(function(){return r.label&&r.input},function(e){e&&!r.label.attr("for")&&r.label.attr("for",r.input.attr("id"))})}return o.$inject=["$scope","$element","$attrs"],{restrict:"E",link:n,controller:o}}function t(){return{restrict:"E",require:"^?mdInputContainer",link:function(e,t,n,o){o&&!n.mdNoFloat&&(o.label=t,e.$on("$destroy",function(){o.label=null}))}}}function n(e,t){function n(n,o,r,a){function i(e){return l.setHasValue(!m.$isEmpty(e)),e}function d(){l.setHasValue(o.val().length>0||(o[0].validity||{}).badInput)}function c(){function r(e){return l(),e}function a(){c.style.height="auto",c.scrollTop=0;var e=i();e&&(c.style.height=e+"px")}function i(){var e=c.scrollHeight-c.offsetHeight;return c.offsetHeight+(e>0?e:0)}function d(e){c.scrollTop=0;var t=c.scrollHeight-c.offsetHeight,n=c.offsetHeight+t;c.style.height=n+"px"}var c=o[0],l=e.debounce(a,1);m?(m.$formatters.push(r),m.$viewChangeListeners.push(r)):l(),o.on("keydown input",l),o.on("scroll",d),angular.element(t).on("resize",l),n.$on("$destroy",function(){angular.element(t).off("resize",l)})}var l=a[0],m=a[1]||e.fakeNgModel(),s=angular.isDefined(r.readonly);if(l){if(l.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");l.input=o,o.addClass("md-input"),o.attr("id")||o.attr("id","input_"+e.nextUid()),"textarea"===o[0].tagName.toLowerCase()&&c();var u=l.isErrorGetter||function(){return m.$invalid&&m.$touched};n.$watch(u,l.setInvalid),m.$parsers.push(i),m.$formatters.push(i),o.on("input",d),s||o.on("focus",function(e){l.setFocused(!0)}).on("blur",function(e){l.setFocused(!1),d()}),n.$on("$destroy",function(){l.setFocused(!1),l.setHasValue(!1),l.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel"],link:n}}function o(e){function t(t,n,o,r){function a(e){return l.text((n.val()||e||"").length+"/"+i),e}var i,d=r[0],c=r[1],l=angular.element('<div class="md-char-counter">');o.$set("ngTrim","false"),c.element.append(l),d.$formatters.push(a),d.$viewChangeListeners.push(a),n.on("input keydown",function(){a()}),t.$watch(o.mdMaxlength,function(t){i=t,angular.isNumber(t)&&t>0?(l.parent().length||e.enter(l,c.element,angular.element(c.element[0].lastElementChild)),a()):e.leave(l)}),d.$validators["md-maxlength"]=function(e,t){return!angular.isNumber(i)||0>i?!0:(e||n.val()||t||"").length<=i}}return{restrict:"A",require:["ngModel","^mdInputContainer"],link:t}}function r(){function e(e,t,n,o){if(o&&!angular.isDefined(o.element.attr("md-no-float"))){var r=n.placeholder;t.removeAttr("placeholder");var a='<div class="md-placeholder" ng-click="delegateClick()">'+r+"</div>";o.element.append(a)}}return{restrict:"A",require:"^^?mdInputContainer",link:e}}angular.module("material.components.input",["material.core"]).directive("mdInputContainer",e).directive("label",t).directive("input",n).directive("textarea",n).directive("mdMaxlength",o).directive("placeholder",r),e.$inject=["$mdTheming","$parse"],n.$inject=["$mdUtil","$window"],o.$inject=["$animate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e){return{restrict:"E",compile:function(t){return t[0].setAttribute("role","list"),e}}}function t(e,t,n){var o=["md-checkbox","md-switch"];return{restrict:"E",controller:"MdListController",compile:function(r,a){function i(){for(var e,t,n=["md-switch","md-checkbox"],o=0;t=n[o];++o)if((e=r.find(t)[0])&&!e.hasAttribute("aria-label")){var a=r.find("p")[0];if(!a)return;e.setAttribute("aria-label","Toggle "+a.textContent)}}function d(t){var n;if("div"==t?(n=angular.element('<div class="md-no-style md-list-item-inner">'),n.append(r.contents()),r.addClass("md-proxy-focus")):(n=angular.element('<md-button class="md-no-style"><div class="md-list-item-inner"></div></md-button>'),n[0].setAttribute("ng-click",r[0].getAttribute("ng-click")),r[0].removeAttribute("ng-click"),n.children().eq(0).append(r.contents())),r[0].setAttribute("tabindex","-1"),r.append(n),u&&u.hasAttribute("ng-click")){e.expect(u,"aria-label");var o=angular.element('<md-button class="md-secondary-container md-icon-button">');o.attr("ng-click",u.getAttribute("ng-click")),u.removeAttribute("ng-click"),u.setAttribute("tabindex","-1"),u.classList.remove("md-secondary"),o.append(u),u=o[0]}u&&(u.hasAttribute("ng-click")||a.ngClick&&c(u))&&(r.addClass("md-with-secondary"),r.append(u))}function c(e){return-1!=o.indexOf(e.nodeName.toLowerCase())}function l(e,r,a,i){function d(){r.children()[0].hasAttribute("ng-click")||angular.forEach(o,function(e){angular.forEach(r[0].firstElementChild.querySelectorAll(e),function(e){l.push(e)})})}function c(){(l.length||r[0].firstElementChild.hasAttribute("ng-click"))&&(r.addClass("md-clickable"),i.attachRipple(e,angular.element(r[0].querySelector(".md-no-style"))))}var l=[];d(),c(),r.hasClass("md-proxy-focus")&&l.length&&angular.forEach(l,function(t){t=angular.element(t),e.mouseActive=!1,t.on("mousedown",function(){e.mouseActive=!0,n(function(){e.mouseActive=!1},100)}).on("focus",function(){e.mouseActive===!1&&r.addClass("md-focused"),t.on("blur",function n(){r.removeClass("md-focused"),t.off("blur",n)})})}),r[0].firstElementChild.hasAttribute("ng-click")||l.length||r[0].firstElementChild.addEventListener("keypress",function(e){"INPUT"!=e.target.nodeName&&e.keyCode==t.KEY_CODE.SPACE&&(r[0].firstElementChild.click(),e.preventDefault(),e.stopPropagation())}),r.off("click"),r.off("keypress"),l.length&&r.children().eq(0).on("click",function(e){r[0].firstElementChild.contains(e.target)&&angular.forEach(l,function(t){e.target===t||t.contains(e.target)||angular.element(t).triggerHandler("click")})})}var m,s,u=r[0].querySelector(".md-secondary");if(r[0].setAttribute("role","listitem"),a.ngClick)d("button");else{for(var f,p=0;f=o[p];++p)if(s=r[0].querySelector(f)){m=!0;break}m?d("div"):r.addClass("md-no-proxy")}return i(),l}}}function n(e,t,n){function o(e,t){var o={};n.attachListControlBehavior(e,t,o)}var r=this;r.attachRipple=o}angular.module("material.components.list",["material.core"]).controller("MdListController",n).directive("mdList",e).directive("mdListItem",t),e.$inject=["$mdTheming"],t.$inject=["$mdAria","$mdConstant","$timeout"],n.$inject=["$scope","$element","$mdInkRipple"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 ...
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,n,o){function r(e,t,n){return e.attr("aria-valuemin",0),e.attr("aria-valuemax",100),e.attr("role","progressbar"),a}function a(r,a,d){o(a);var c=a[0].querySelector(".md-bar1").style,l=a[0].querySelector(".md-bar2").style,m=angular.element(a[0].querySelector(".md-container"));d.$observe("value",function(e){if("query"!=d.mdMode){var o=i(e);a.attr("aria-valuenow",o),l[n.CSS.TRANSFORM]=t[o]}}),d.$observe("mdBufferValue",function(e){c[n.CSS.TRANSFORM]=t[i(e)]}),e(function(){m.addClass("md-ready")})}function i(e){return e>100?100:0>e?0:Math.ceil(e||0)}return{restrict:"E",template:'<div class="md-container"><div class="md-dashed"></div><div class="md-bar md-bar1"></div><div class="md-bar md-bar2"></div></div>',compile:r}}angular.module("material.components.progressLinear",["material.core"]).directive("mdProgressLinear",e),e.$inject=["$$rAF","$mdConstant","$mdTheming"];var t=function(){function e(e){var t=e/100,n=(e-100)/2;return"translateX("+n.toString()+"%) scale("+t.toString()+", 1)"}for(var t=new Array(101),n=0;101>n;n++)t[n]=e(n);return t}()}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o){function r(r,a,i,d){function c(){a.hasClass("md-focused")||a.addClass("md-focused")}function l(n){var o=n.which||n.keyCode;switch(o){case t.KEY_CODE.LEFT_ARROW:case t.KEY_CODE.UP_ARROW:n.preventDefault(),m.selectPrevious(),c();break;case t.KEY_CODE.RIGHT_ARROW:case t.KEY_CODE.DOWN_ARROW:n.preventDefault(),m.selectNext(),c();break;case t.KEY_CODE.ENTER:var r=angular.element(e.getClosest(a[0],"form"));r.length>0&&r.triggerHandler("submit")}}n(a);var m=d[0],s=d[1]||e.fakeNgModel();m.init(s),r.mouseActive=!1,a.attr({role:"radiogroup",tabIndex:a.attr("tabindex")||"0"}).on("keydown",l).on("mousedown",function(e){r.mouseActive=!0,o(function(){r.mouseActive=!1},100)}).on("focus",function(){r.mouseActive===!1&&m.$element.addClass("md-focused")}).on("blur",function(){m.$element.removeClass("md-focused")})}function a(e){this._radioButtonRenderFns=[],this.$element=e}function i(){return{init:function(e){this._ngModelCtrl=e,this._ngModelCtrl.$render=angular.bind(this,this.render)},add:function(e){this._radioButtonRenderFns.push(e)},remove:function(e){var t=this._radioButtonRenderFns.indexOf(e);-1!==t&&this._radioButtonRenderFns.splice(t,1)},render:function(){this._radioButtonRenderFns.forEach(function(e){e()})},setViewValue:function(e,t){this._ngModelCtrl.$setViewValue(e,t),this.render()},getViewValue:function(){return this._ngModelCtrl.$viewValue},selectNext:function(){return d(this.$element,1)},selectPrevious:function(){return d(this.$element,-1)},setActiveDescendant:function(e){this.$element.attr("aria-activedescendant",e)}}}function d(t,n){var o=e.iterator(t[0].querySelectorAll("md-radio-button"),!0);if(o.count()){var r=function(e){return!angular.element(e).attr("disabled")},a=t[0].querySelector("md-radio-button.md-checked"),i=o[0>n?"previous":"next"](a,r)||o.first();angular.element(i).triggerHandler("click")}}return a.prototype=i(),{restrict:"E",controller:["$element",a],require:["mdRadioGroup","?ngModel"],link:{pre:r}}}function t(e,t,n){function o(o,a,i,d){function c(e){a[0].hasAttribute("disabled")||o.$apply(function(){d.setViewValue(i.value,e&&e.type)})}function l(){var e=d.getViewValue()==i.value;e!==s&&(s=e,a.attr("aria-checked",e),e?(a.addClass(r),d.setActiveDescendant(a.attr("id"))):a.removeClass(r))}function m(n,o){function r(){return i.id||"radio_"+t.nextUid()}o.ariaId=r(),n.attr({id:o.ariaId,role:"radio","aria-checked":"false"}),e.expectWithText(n,"aria-label")}var s;n(a),m(a,o),d.add(l),i.$observe("value",l),a.on("click",c).on("$destroy",function(){d.remove(l)})}var r="md-checked";return{restrict:"E",require:"^mdRadioGroup",transclude:!0,template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-off"></div><div class="md-on"></div></div><div ng-transclude class="md-label"></div>',link:o}}angular.module("material.components.radioButton",["material.core"]).directive("mdRadioGroup",e).directive("mdRadioButton",t),e.$inject=["$mdUtil","$mdConstant","$mdTheming","$timeout"],t.$inject=["$mdAria","$mdUtil","$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o,r,a){function i(o,i){var d=o.find("md-select-label").remove();if(d.length){if(!d[0].firstElementChild){var c=angular.element("<span>");c.append(d.contents()),d.append(c)}}else d=angular.element("<md-select-label><span></span></md-select-label>");if(d.append('<span class="md-select-icon" aria-hidden="true"></span>'),d.addClass("md-select-label"),d.attr("id","select_label_"+t.nextUid()),o.find("md-content").length||o.append(angular.element("<md-content>").append(o.contents())),i.mdOnOpen&&o.find("md-content").prepend(angular.element("<md-progress-circular>").attr("md-mode","indeterminate").attr("ng-hide","$$loadingAsyncDone").wrap("<div>").parent()),i.name){var l=angular.element('<select class="md-visually-hidden">');l.attr({name:"."+i.name,"ng-model":i.ngModel,"aria-hidden":"true",tabindex:"-1"});var m=o.find("md-option");angular.forEach(m,function(e){var t=angular.element("<option>"+e.innerHTML+"</option>");e.hasAttribute("ng-value")?t.attr("ng-value",e.getAttribute("ng-value")):e.hasAttribute("value")&&t.attr("value",e.getAttribute("value")),l.append(t)}),o.parent().append(l)}var s='<div class="md-select-menu-container"><md-select-menu '+(angular.isDefined(i.multiple)?"multiple":"")+">"+o.html()+"</md-select-menu></div>";return o.empty().append(d),i.tabindex=i.tabindex||"0",n(o),function(n,o,i,d){function c(){h&&(b=b||h.find("md-select-menu").controller("mdSelectMenu"),E.setLabelText(b.selectedLabels()))}function l(){h=angular.element(s);var e=h.find("md-select-menu");e.data("$ngModelController",v),e.data("$mdSelectController",E),g=n.$new(),h=r(h)(g),b=h.find("md-select-menu").controller("mdSelectMenu")}function m(e){var t=[32,13,38,40];if(-1!=t.indexOf(e.keyCode))e.preventDefault(),u(e);else if(e.keyCode<=90&&e.keyCode>=31){e.preventDefault();var n=b.optNodeForKeyboardSearch(e);if(!n)return;var o=angular.element(n).controller("mdOption");b.isMultiple||b.deselect(Object.keys(b.selected)[0]),b.select(o.hashKey,o.value),b.refreshViewValue(),v.$render()}}function u(){n.$evalAsync(function(){f=!0,e.show({scope:g,preserveScope:!0,skipCompile:!0,element:h,target:o[0],hasBackdrop:!0,loadingAsync:i.mdOnOpen?n.$eval(i.mdOnOpen)||!0:!1}).then(function(e){f=!1})})}var f,p,h,g,b,E=d[0],v=d[1],M=d[2],$=o.find("md-select-label"),A=0!==$.text().length;if(l(),i.name&&M){var T=o.parent()[0].querySelector('select[name=".'+i.name+'"]');M.$removeControl(angular.element(T).controller())}var C=v.$render;v.$render=function(){C(),c()};var w;E.setLabelText=function(e){if(!A){E.setIsPlaceholder(!e);var t=e||i.placeholder||"",n=A?$:$.children().eq(0);w||(n.text("M"),w=n[0].offsetHeight);var o=!1,r=!1;do n.text(t),n[0].offsetHeight>w?(t=t.slice(0,-1),r=!0):(1==r&&(t=t.slice(0,-3)+"...",n.text(t)),o=!0);while(!o)}},E.setIsPlaceholder=function(e){e?$.addClass("md-placeholder"):$.removeClass("md-placeholder")},n.$$postDigest(c);var b,k;i.$observe("ngMultiple",function(e){k&&k();var t=a(e);k=n.$watch(function(){return t(n)},function(e,t){(void 0!==e||void 0!==t)&&(e?o.attr("multiple","multiple"):o.removeAttr("multiple"),h&&(b.setMultiple(e),C=v.$render,v.$render=function(){C(),c()},b.refreshViewValue(),v.$render()))})}),i.$observe("disabled",function(e){"string"==typeof e&&(e=!0),(void 0===p||p!==e)&&(p=e,e?(o.attr({tabindex:-1,"aria-disabled":"true"}),o.off("click",u),o.off("keydown",m)):(o.attr({tabindex:i.tabindex,"aria-disabled":"false"}),o.on("click",u),o.on("keydown",m)))}),i.disabled||i.ngDisabled||(o.attr({tabindex:i.tabindex,"aria-disabled":"false"}),o.on("click",u),o.on("keydown",m)),o.attr({role:"combobox",id:"select_"+t.nextUid(),"aria-expanded":"false","aria-labelledby":$.attr("id")}),n.$on("$destroy",function(){f?e.cancel().then(function(){h.remove()}):h.remove()})}}o.startSymbol(),o.endSymbol();return{restrict:"E",require:["mdSelect","ngModel","?^form"],compile:i,controller:function(){}}}function t(e,t,n){function o(e,o,r,a){function i(){o.attr({id:"select_menu_"+t.nextUid(),role:"listbox","aria-multiselectable":l.isMultiple?"true":"false"})}function d(e){(13==e.keyCode||32==e.keyCode)&&c(e)}function c(n){var o=t.getClosest(n.target,"md-option"),r=o&&angular.element(o).data("$mdOptionController");if(o&&r){var a=l.hashGetter(r.value),i=angular.isDefined(l.selected[a]);e.$apply(function(){l.isMultiple?i?l.deselect(a):l.select(a,r.value):i||(l.deselect(Object.keys(l.selected)[0]),l.select(a,r.value)),l.refreshViewValue()})}}var l=a[0],m=a[1];n(o),o.on("click",c),o.on("keypress",d),m&&l.init(m),i()}function r(t,n,o){function r(){var e=c.ngModel.$modelValue||c.ngModel.$viewValue;if(angular.isArray(e)){var t=Object.keys(c.selected),n=e.map(c.hashGetter),o=t.filter(function(e){return-1===n.indexOf(e)});o.forEach(c.deselect),n.forEach(function(t,n){c.select(t,e[n])})}}function i(){var e=c.ngModel.$viewValue||c.ngModel.$modelValue;Object.keys(c.selected).forEach(c.deselect),c.select(c.hashGetter(e),e)}var c=this;c.isMultiple=angular.isDefined(n.multiple),c.selected={},c.options={};var l;c.setMultiple=function(e){function o(e,t){return angular.isArray(e||t||[])}var a=c.ngModel;c.isMultiple=e,l&&l(),c.isMultiple?(a.$validators["md-multiple"]=o,a.$render=r,t.$watchCollection(n.ngModel,function(e){o(e)&&r(e)})):(delete a.$validators["md-multiple"],a.$render=i)};var m,s,u,f="",p=300;c.optNodeForKeyboardSearch=function(e){m&&clearTimeout(m),m=setTimeout(function(){m=void 0,f="",u=void 0,s=void 0},p),f+=String.fromCharCode(e.keyCode);var t=new RegExp("^"+f,"i");s||(s=o.find("md-option"),u=new Array(s.length),angular.forEach(s,function(e,t){u[t]=e.textContent.trim()}));for(var n=0;n<u.length;++n)if(t.test(u[n]))return s[n]},c.init=function(n){if(c.ngModel=n,n.$options&&n.$options.trackBy){var o={},r=e(n.$options.trackBy);c.hashGetter=function(e,n){return o.$value=e,r(n||t,o)}}else c.hashGetter=function(e){return angular.isObject(e)?"$$object_"+(e.$$mdSelectId||(e.$$mdSelectId=++d)):e};c.setMultiple(c.isMultiple)},c.selectedLabels=function(){var e=a(o[0].querySelectorAll("md-option[selected]"));return e.length?e.map(function(e){return e.textContent}).join(", "):""},c.select=function(e,t){var n=c.options[e];n&&n.setSelected(!0),c.selected[e]=t},c.deselect=function(e){var t=c.options[e];t&&t.setSelected(!1),delete c.selected[e]},c.addOption=function(e,t){if(angular.isDefined(c.options[e]))throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "'+t.value+'" found.');c.options[e]=t,angular.isDefined(c.selected[e])&&(c.select(e,t.value),c.refreshViewValue())},c.removeOption=function(e){delete c.options[e]},c.refreshViewValue=function(){var e,t=[];for(var n in c.selected)t.push((e=c.options[n])?e.value:c.selected[n]);c.ngModel.$setViewValue(c.isMultiple?t:t[0])}}return r.$inject=["$scope","$attrs","$element"],{restrict:"E",require:["mdSelectMenu","?ngModel"],controller:r,link:{pre:o}}}function n(e,t){function n(e,t){return e.append(angular.element('<div class="md-text">').append(e.contents())),e.attr("tabindex",t.tabindex||"0"),o}function o(n,o,r,a){function i(e,t){var o=l.hashGetter(t,n),r=l.hashGetter(e,n);c.hashKey=r,c.value=e,l.removeOption(o,c),l.addOption(r,c)}function d(){o.attr({role:"option","aria-selected":"false",id:"select_option_"+t.nextUid()})}var c=a[0],l=a[1];angular.isDefined(r.ngValue)?n.$watch(r.ngValue,i):angular.isDefined(r.value)?i(r.value):n.$watch(function(){return o.text()},i),n.$$postDigest(function(){r.$observe("selected",function(e){angular.isDefined(e)&&(e?(l.isMultiple||l.deselect(Object.keys(l.selected)[0]),l.select(c.hashKey,c.value)):l.deselect(c.hashKey),l.refreshViewValue(),l.ngModel.$render())})}),e.attachButtonBehavior(n,o),d(),n.$on("$destroy",function(){l.removeOption(c.hashKey,c)})}function r(e){this.selected=!1,this.setSelected=function(t){t&&!this.selected?e.attr({selected:"selected","aria-selected":"true"}):!t&&this.selected&&(e.removeAttr("selected"),e.attr("aria-selected","false")),this.selected=t}}return r.$inject=["$element"],{restrict:"E",require:["mdOption","^^mdSelectMenu"],controller:r,compile:n}}function o(){function e(e,t){var n=e.find("label");n.length||(n=angular.element("<label>"),e.prepend(n)),t.label&&n.text(t.label)}return{restrict:"E",compile:e}}function r(e){function t(e,t,r,d,c,l,m,s){function u(n,o,i){function s(){i.selectEl.attr("aria-labelledby",i.target.attr("id")),i.target.attr("aria-expanded","true")}function u(){function r(e){var t=a(f),n=t.indexOf(i.focusedNode);-1===n?n=0:"next"===e&&n<t.length-1?n++:"prev"===e&&n>0&&n--;var o=i.focusedNode=t[n];o&&o.focus()}function c(){r("next")}function l(){r("prev")}function m(){s.isMultiple||(i.restoreFocus=!0,n.$evalAsync(function(){e.hide(s.ngModel.$viewValue)}))}if(!i.isRemoved){var s=i.selectEl.controller("mdSelectMenu")||{};o.addClass("md-clickable"),i.backdrop&&i.backdrop.on("click",function(t){t.preventDefault(),t.stopPropagation(),i.restoreFocus=!1,n.$apply(e.cancel)}),i.selectEl.on("keydown",function(o){switch(o.keyCode){case t.KEY_CODE.SPACE:case t.KEY_CODE.ENTER:var r=d.getClosest(o.target,"md-option");r&&(i.selectEl.triggerHandler({type:"click",target:r}),o.preventDefault());break;case t.KEY_CODE.TAB:case t.KEY_CODE.ESCAPE:o.preventDefault(),i.restoreFocus=!0,n.$apply(e.cancel)}}),i.selectEl.on("keydown",function(e){switch(e.keyCode){case t.KEY_CODE.UP_ARROW:return l();case t.KEY_CODE.DOWN_ARROW:return c();default:if(e.keyCode>=31&&e.keyCode<=90){var n=i.selectEl.controller("mdSelectMenu").optNodeForKeyboardSearch(e);n&&n.focus()}}}),i.selectEl.on("click",m),i.selectEl.on("keydown",function(e){(32==e.keyCode||13==e.keyCode)&&m()})}}if(!i.target)throw new Error('$mdSelect.show() expected a target element in options.target but got "'+i.target+'"!');angular.extend(i,{isRemoved:!1,target:angular.element(i.target),parent:angular.element(i.parent),selectEl:o.find("md-select-menu"),contentEl:o.find("md-content"),backdrop:i.hasBackdrop&&angular.element('<md-backdrop class="md-select-backdrop md-click-catcher">')}),i.resizeFn=function(){r(function(){r(function(){p(n,o,i)})})},angular.element(m).on("resize",i.resizeFn),angular.element(m).on("orientationchange",i.resizeFn),s(),o.removeClass("md-leave");var f=i.selectEl[0].getElementsByTagName("md-option");return i.loadingAsync&&i.loadingAsync.then?i.loadingAsync.then(function(){n.$$loadingAsyncDone=!0,r(function(){r(function(){i.isRemoved||p(n,o,i)})})}):i.loadingAsync&&(n.$$loadingAsyncDone=!0),i.disableParentScroll&&(i.restoreScroll=d.disableScrollAround(i.target)),l(u,75,!1),i.backdrop&&(c.inherit(i.backdrop,i.parent),i.parent.append(i.backdrop)),i.parent.append(o),r(function(){r(function(){i.isRemoved||p(n,o,i)})}),d.transitionEndPromise(i.selectEl,{timeout:350})}function f(e,t,n){n.isRemoved=!0,t.addClass("md-leave").removeClass("md-clickable"),n.target.attr("aria-expanded","false"),angular.element(m).off("resize",n.resizefn),angular.element(m).off("orientationchange",n.resizefn),n.resizeFn=void 0;var o=n.selectEl.controller("mdSelect");return o&&o.setLabelText(n.selectEl.controller("mdSelectMenu").selectedLabels()),d.transitionEndPromise(t,{timeout:350}).then(function(){t.removeClass("md-active"),n.parent[0].removeChild(t[0]),n.backdrop&&n.backdrop.remove(),n.disableParentScroll&&n.restoreScroll(),n.restoreFocus&&n.target.focus()})}function p(e,a,c){var l,m=a[0],s=c.target[0],u=c.parent[0],f=c.selectEl[0],p=c.contentEl[0],h=u.getBoundingClientRect(),g=s.getBoundingClientRect(),b=!1,E={left:h.left+i,top:i,bottom:h.height-i,right:h.width-i-(d.floatingScrollbars()?16:0)},v={top:g.top-E.top,left:g.left-E.left,right:E.right-(g.left+g.width),bottom:E.bottom-(g.top+g.height)},M=h.width-2*i,$=p.scrollHeight>p.offsetHeight,A=f.querySelector("md-option[selected]"),T=f.getElementsByTagName("md-option"),C=f.getElementsByTagName("md-optgroup");l=A?A:C.length?C[0]:T.length?T[0]:p.firstElementChild||p,p.offsetWidth>M&&(p.style["max-width"]=M+"px"),b&&(p.style["min-width"]=g.width+"px"),$&&f.classList.add("md-overflow");var w=f.getBoundingClientRect(),k=o(l);if(l){var y=window.getComputedStyle(l);k.paddingLeft=parseInt(y.paddingLeft,10)||0,k.paddingRight=parseInt(y.paddingRight,10)||0}var x=l;if("MD-OPTGROUP"===(x.tagName||"").toUpperCase()&&(x=T[0]||p.firstElementChild||p),$){var N=p.offsetHeight/2;p.scrollTop=k.top+k.height/2-N,v.top<N?p.scrollTop=Math.min(k.top,p.scrollTop+N-v.top):v.bottom<N&&(p.scrollTop=Math.max(k.top+k.height-w.height,p.scrollTop-N+v.bottom))}var _,H,S;b?(_=g.left,H=g.top+g.height,S="50% 0",H+w.height>E.bottom&&(H=g.top-w.height,S="50% 100%")):(_=g.left+k.left-k.paddingLeft,H=g.top+g.height/2-k.height/2-k.top+p.scrollTop,S=k.left+g.width/2+"px "+(k.top+k.height/2-p.scrollTop)+"px 0px",m.style.minWidth=g.width+k.paddingLeft+k.paddingRight+"px");var I=m.getBoundingClientRect();m.style.left=n(E.left,_,E.right-I.width)+"px",m.style.top=n(E.top,H,E.bottom-I.height)+"px",f.style[t.CSS.TRANSFORM_ORIGIN]=S,f.style[t.CSS.TRANSFORM]="scale("+Math.min(g.width/w.width,1)+","+Math.min(g.height/w.height,1)+")",r(function(){a.addClass("md-active"),f.style[t.CSS.TRANSFORM]="",x&&(c.focusedNode=x,x.focus())})}return{parent:"body",onShow:u,onRemove:f,hasBackdrop:!0,disableParentScroll:!0,themable:!0}}function n(e,t,n){return Math.max(e,Math.min(t,n))}function o(e){return e?{left:e.offsetLeft,top:e.offsetTop,width:e.offsetWidth,height:e.offsetHeight}:{left:0,top:0,width:0,height:0}}return t.$inject=["$mdSelect","$mdConstant","$$rAF","$mdUtil","$mdTheming","$timeout","$window","$document"],e("$mdSelect").setDefaults({methods:["target"],options:t})}function a(e){for(var t=[],n=0;n<e.length;++n)t.push(e.item(n));return t}var i=8,d=0;angular.module("material.components.select",["material.core","material.components.backdrop"]).directive("mdSelect",e).directive("mdSelectMenu",t).directive("mdOption",n).directive("mdOptgroup",o).provider("$mdSelect",r),e.$inject=["$mdSelect","$mdUtil","$mdTheming","$interpolate","$compile","$parse"],t.$inject=["$parse","$mdUtil","$mdTheming"],n.$inject=["$mdInkRipple","$mdUtil"],r.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t){return function(n){function o(){return e.when(n).then(function(e){return i=e,e})}var r,a="SideNav '"+n+"' is not available!",i=e.get(n);return i||e.notFoundError(n),r={isOpen:function(){return i&&i.isOpen()},isLockedOpen:function(){return i&&i.isLockedOpen()},toggle:function(){return i?i.toggle():t.reject(a)},open:function(){return i?i.open():t.reject(a)},close:function(){return i?i.close():t.reject(a)},then:function(e){var n=i?t.when(i):o();return n.then(e||angular.noop)}}}}function t(){return{restrict:"A",require:"^mdSidenav",link:function(e,t,n,o){o.focusElement(t)}}}function n(e,t,n,o,r,a,i,d,c,l){function m(m,s,u,f){function p(e,n){m.isLockedOpen=e,e===n?s.toggleClass("md-locked-open",!!e):t[e?"addClass":"removeClass"](s,"md-locked-open"),w.toggleClass("md-locked-open",!!e)}function h(e){var n=s.parent();n[e?"on":"off"]("keydown",E),w[e?"on":"off"]("click",v),e&&($=l[0].activeElement);var o=f.focusElement();return g(e),A=c.all([e?t.enter(w,n):t.leave(w),t[e?"removeClass":"addClass"](s,"md-closed")]).then(function(){m.isOpen&&o&&o.focus()})}function g(e){var t=s.parent();e?(M=t.css("overflow"),t.css("overflow","hidden")):angular.isDefined(M)&&(t.css("overflow",M),M=void 0)}function b(t){if(m.isOpen==t)return c.when(!0);var n=c.defer();return m.isOpen=t,e(function(){A.then(function(e){m.isOpen||($&&$.focus(),$=null),n.resolve(e)})},0,!1),n.promise}function E(e){var t=e.keyCode===a.KEY_CODE.ESCAPE;return t?v(e):c.when(!0)}function v(e){return e.preventDefault(),e.stopPropagation(),f.close()}var M,$=null,A=c.when(!0),T=n(u.mdIsLockedOpen),C=function(){return T(m.$parent,{$media:function(e){return o.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."),r(e)},$mdMedia:r})},w=i('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(m);s.on("$destroy",f.destroy),d.inherit(w,s),m.$watch(C,p),m.$watch("isOpen",h),f.$toggleOpen=b,f.focusElement(f.focusElement()||s)}return{restrict:"E",scope:{isOpen:"=?mdIsOpen"},controller:"$mdSidenavController",compile:function(e){return e.addClass("md-closed"),e.attr("tabIndex","-1"),m}}}function o(e,t,n,o,r){var a,i=this;i.isOpen=function(){return!!e.isOpen},i.isLockedOpen=function(){return!!e.isLockedOpen},i.open=function(){return i.$toggleOpen(!0)},i.close=function(){return i.$toggleOpen(!1)},i.toggle=function(){return i.$toggleOpen(!e.isOpen)},i.focusElement=function(e){return angular.isDefined(e)&&(a=e),a},i.$toggleOpen=function(){return r.when(e.isOpen)},i.destroy=o.register(i,n.mdComponentId)}angular.module("material.components.sidenav",["material.core","material.components.backdrop"]).factory("$mdSidenav",e).directive("mdSidenav",n).directive("mdSidenavFocus",t).controller("$mdSidenavController",o),e.$inject=["$mdComponentRegistry","$q"],n.$inject=["$timeout","$animate","$parse","$log","$mdMedia","$mdConstant","$compile","$mdTheming","$q","$document"],o.$inject=["$scope","$element","$attrs","$mdComponentRegistry","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o,r,a,i,d){function c(e,t){return e.attr({tabIndex:0,role:"slider"}),n.expect(e,"aria-label"),l}function l(n,c,l,m){function s(){b(),$(),g()}function u(e){W=parseFloat(e),c.attr("aria-valuemin",e),s()}function f(e){z=parseFloat(e),c.attr("aria-valuemax",e),s()}function p(e){G=parseFloat(e),g()}function h(e){c.attr("aria-disabled",!!e)}function g(){if(angular.isDefined(l.mdDiscrete)){var e=Math.floor((z-W)/G);if(!X){var n=t.getComputedStyle(U[0]);X=angular.element('<canvas style="position:absolute;">'),Z=X[0].getContext("2d"),Z.fillStyle=n.backgroundColor||"black",U.append(X)}var o=E();X[0].width=o.width,X[0].height=o.height;for(var r,a=0;e>=a;a++)r=Math.floor(o.width*(a/e)),Z.fillRect(r-1,0,2,o.height)}}function b(){Q=F[0].getBoundingClientRect()}function E(){return K(),Q}function v(e){if(!c[0].hasAttribute("disabled")){var t;e.keyCode===r.KEY_CODE.LEFT_ARROW?t=-G:e.keyCode===r.KEY_CODE.RIGHT_ARROW&&(t=G),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),n.$evalAsync(function(){M(m.$viewValue+t)}))}}function M(e){m.$setViewValue(A(T(e)))}function $(){isNaN(m.$viewValue)&&(m.$viewValue=m.$modelValue);var e=(m.$viewValue-W)/(z-W);n.modelValue=m.$viewValue,c.attr("aria-valuenow",m.$viewValue),C(e),j.text(m.$viewValue)}function A(e){return angular.isNumber(e)?Math.max(W,Math.min(z,e)):void 0}function T(e){return angular.isNumber(e)?Math.round(e/G)*G:void 0}function C(e){q.css("width",100*e+"%"),B.css("left",100*e+"%"),c.toggleClass("md-min",0===e)}function w(e){if(!L()){c.addClass("active"),c[0].focus(),b();var t=D(I(e.pointer.x)),o=A(T(t));n.$apply(function(){M(o),C(O(o))})}}function k(e){if(!L()){c.removeClass("dragging active");var t=D(I(e.pointer.x)),o=A(T(t));n.$apply(function(){M(o),$()})}}function y(e){L()||(J=!0,e.stopPropagation(),c.addClass("dragging"),_(e))}function x(e){J&&(e.stopPropagation(),_(e))}function N(e){J&&(e.stopPropagation(),J=!1)}function _(e){ee?S(e.pointer.x):H(e.pointer.x)}function H(e){n.$evalAsync(function(){M(D(I(e)))})}function S(e){var t=D(I(e)),n=A(T(t));C(I(e)),j.text(n)}function I(e){return Math.max(0,Math.min(1,(e-Q.left)/Q.width))}function D(e){return W+e*(z-W)}function O(e){return(e-W)/(z-W)}a(c),m=m||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var R=l.ngDisabled&&d(l.ngDisabled),L=R?function(){return R(n.$parent)}:angular.noop,P=angular.element(c[0].querySelector(".md-thumb")),j=angular.element(c[0].querySelector(".md-thumb-text")),B=P.parent(),F=angular.element(c[0].querySelector(".md-track-container")),q=angular.element(c[0].querySelector(".md-track-fill")),U=angular.element(c[0].querySelector(".md-track-ticks")),K=o.throttle(b,5e3);l.min?l.$observe("min",u):u(0),l.max?l.$observe("max",f):f(100),l.step?l.$observe("step",p):p(1);var V=angular.noop;l.ngDisabled&&(V=n.$parent.$watch(l.ngDisabled,h)),i.register(c,"drag"),c.on("keydown",v).on("$md.pressdown",w).on("$md.pressup",k).on("$md.dragstart",y).on("$md.drag",x).on("$md.dragend",N),setTimeout(s);var Y=e.throttle(s);angular.element(t).on("resize",Y),n.$on("$destroy",function(){angular.element(t).off("resize",Y),V()}),m.$render=$,m.$viewChangeListeners.push($),m.$formatters.push(A),m.$formatters.push(T);var W,z,G,X,Z,Q={};b();var J=!1,ee=angular.isDefined(l.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-slider-wrapper">        <div class="md-track-container">          <div class="md-track"></div>          <div class="md-track md-track-fill"></div>          <div class="md-track-ticks"></div>        </div>        <div class="md-thumb-container">          <div class="md-thumb"></div>          <div class="md-focus-thumb"></div>          <div class="md-focus-ring"></div>          <div class="md-sign">            <span class="md-thumb-text"></span>          </div>          <div class="md-disabled-thumb"></div>        </div>      </div>',compile:c}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o,r){function a(e){function n(e,t){t.addClass("md-sticky-clone"),t.css("top",p+"px");var n={element:e,clone:t};return f.items.push(n),s.parent().prepend(n.clone),u(),function(){f.items.forEach(function(t,n){t.element[0]===e[0]&&(f.items.splice(n,1),t.clone.remove())}),u()}}function r(){f.items.forEach(a),f.items=f.items.sort(function(e,t){return e.top<t.top?-1:1});for(var e,t=s.prop("scrollTop"),n=f.items.length-1;n>=0;n--)if(t>f.items[n].top){e=f.items[n];break}c(e)}function a(e){var t=e.element[0];for(e.top=0,e.left=0;t&&t!==s[0];)e.top+=t.offsetTop,e.left+=t.offsetLeft,t=t.offsetParent;e.height=e.element.prop("offsetHeight"),e.clone.css("margin-left",e.left+"px")}function i(){var e=s.prop("scrollTop"),t=e>(i.prevScrollTop||0);i.prevScrollTop=e,0===e?c(null):t&&f.next?f.next.top-e<=0?c(f.next):f.current&&(f.next.top-e<=f.next.height?m(f.current,f.next.top-f.next.height-e):m(f.current,null)):!t&&f.current&&(e<f.current.top&&c(f.prev),f.current&&f.next&&(e>=f.next.top-f.current.height?m(f.current,f.next.top-e-f.current.height):m(f.current,null)))}function c(e){if(f.current!==e){f.current&&(m(f.current,null),l(f.current,null)),e&&l(e,"active"),f.current=e;var t=f.items.indexOf(e);f.next=f.items[t+1],f.prev=f.items[t-1],l(f.next,"next"),l(f.prev,"prev")}}function l(e,t){e&&e.state!==t&&(e.state&&(e.clone.attr("sticky-prev-state",e.state),e.element.attr("sticky-prev-state",e.state)),e.clone.attr("sticky-state",t),e.element.attr("sticky-state",t),e.state=t)}function m(e,n){e&&(null===n||void 0===n?e.translateY&&(e.translateY=null,e.clone.css(t.CSS.TRANSFORM,"")):(e.translateY=n,e.clone.css(t.CSS.TRANSFORM,"translate3d("+e.left+"px,"+n+"px,0)")))}var s=e.$element,u=o.throttle(r);d(s),s.on("$scrollstart",u),s.on("$scroll",i);var f,p=s.prop("offsetTop");return f={prev:null,current:null,next:null,items:[],add:n,refreshElements:r}}function i(t){var n,o=angular.element("<div>");e[0].body.appendChild(o[0]);for(var r=["sticky","-webkit-sticky"],a=0;a<r.length;++a)if(o.css({position:r[a],top:0,"z-index":2}),o.css("position")==r[a]){n=r[a];break}return o.remove(),n}function d(e){function t(){+r.now()-a>i?(n=!1,e.triggerHandler("$scrollend")):(e.triggerHandler("$scroll"),o(t))}var n,a,i=200;e.on("scroll touchmove",function(){n||(n=!0,o(t),e.triggerHandler("$scrollstart")),e.triggerHandler("$scroll"),a=+r.now()})}var c=i();return function(e,t,n){var o=t.controller("mdContent");if(o)if(c)t.css({position:c,top:0,"z-index":2});else{var r=o.$element.data("$$sticky");r||(r=a(o),o.$element.data("$$sticky",r));var i=r.add(t,n||t.clone());e.$on("$destroy",i)}}}angular.module("material.components.sticky",["material.core","material.components.content"]).factory("$mdSticky",e),e.$inject=["$document","$mdConstant","$compile","$$rAF","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n){return{restrict:"E",replace:!0,transclude:!0,template:'<h2 class="md-subheader"><div class="md-subheader-inner"><span class="md-subheader-content"></span></div></h2>',compile:function(o,r,a){var i=o[0].outerHTML;return function(o,r,d){function c(e){return angular.element(e[0].querySelector(".md-subheader-content"))}n(r),a(o,function(e){c(r).append(e)}),r.hasClass("md-no-sticky")||a(o,function(a){var d=t(angular.element(i))(o);n(d),c(d).append(a),e(o,r,d)})}}}}angular.module("material.components.subheader",["material.core","material.components.sticky"]).directive("mdSubheader",e),e.$inject=["$mdSticky","$compile","$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";var e=angular.module("material.components.swipe",[]);["SwipeLeft","SwipeRight"].forEach(function(t){var n="md"+t,o="$md."+t.toLowerCase();e.directive(n,["$parse",function(e){function t(t,r,a){var i=e(a[n]);r.on(o,function(e){t.$apply(function(){i(t,{$event:e})})})}return{restrict:"A",link:t}}])})}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o,r,a,i,d){function c(e,t){var o=l.compile(e,t);return e.addClass("md-dragging"),function(e,t,c,l){function m(n){p(e)||(n.stopPropagation(),t.addClass("md-dragging"),b={width:h.prop("offsetWidth")},t.removeClass("transition"))}function s(e){if(b){e.stopPropagation(),e.srcEvent&&e.srcEvent.preventDefault();var t=e.pointer.distanceX/b.width,n=l.$viewValue?1+t:t;n=Math.max(0,Math.min(1,n)),h.css(r.CSS.TRANSFORM,"translate3d("+100*n+"%,0,0)"),b.translate=n}}function u(e){if(b){e.stopPropagation(),t.removeClass("md-dragging"),h.css(r.CSS.TRANSFORM,"");var n=l.$viewValue?b.translate<.5:b.translate>.5;n&&f(!l.$viewValue),b=null}}function f(t){e.$apply(function(){l.$setViewValue(t),l.$render()})}l=l||n.fakeNgModel();var p=a(c.ngDisabled),h=angular.element(t[0].querySelector(".md-thumb-container")),g=angular.element(t[0].querySelector(".md-container"));i(function(){t.removeClass("md-dragging")}),o(e,t,c,l),angular.isDefined(c.ngDisabled)&&e.$watch(p,function(e){t.attr("tabindex",e?-1:0)}),d.register(g,"drag"),g.on("$md.dragstart",m).on("$md.drag",s).on("$md.dragend",u);var b}}var l=e[0];return{restrict:"E",transclude:!0,template:'<div class="md-container"><div class="md-bar"></div><div class="md-thumb-container"><div class="md-thumb" md-ink-ripple md-ink-ripple-checkbox></div></div></div><div ng-transclude class="md-label"></div>',require:"?ngModel",compile:c}}angular.module("material.components.switch",["material.core","material.components.checkbox"]).directive("mdSwitch",e),e.$inject=["mdCheckboxDirective","$mdTheming","$mdUtil","$document","$mdConstant","$parse","$$rAF","$mdGesture"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 ...
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(){return{restrict:"E"}}function t(e){function t(e,t,o,r){function a(a,i,c){return i=r.extractElementByName(i,"md-toast"),n=c.content,i.addClass(c.position.split(" ").map(function(e){return"md-"+e}).join(" ")),c.parent.addClass(d(c.position)),c.onSwipe=function(t,n){i.addClass("md-"+t.type.replace("$md.","")),e(o.cancel)},i.on("$md.swipeleft $md.swiperight",c.onSwipe),t.enter(i,c.parent)}function i(e,n,o){return n.off("$md.swipeleft $md.swiperight",o.onSwipe),o.parent.removeClass(d(o.position)),t.leave(n)}function d(e){return"md-toast-open-"+(e.indexOf("top")>-1?"top":"bottom")}return{onShow:a,onRemove:i,position:"bottom left",themable:!0,hideDelay:3e3}}var n,o=e("$mdToast").setDefaults({methods:["position","hideDelay","capsule"],options:t}).addPreset("simple",{argOption:"content",methods:["content","action","highlightAction","theme","parent"],options:["$mdToast","$mdTheming",function(e,t){var o={template:['<md-toast md-theme="{{ toast.theme }}" ng-class="{\'md-capsule\': toast.capsule}">',"<span flex>{{ toast.content }}</span>",'<md-button class="md-action" ng-if="toast.action" ng-click="toast.resolve()" ng-class="{\'md-highlight\': toast.highlightAction}">',"{{ toast.action }}","</md-button>","</md-toast>"].join(""),controller:["$scope",function(t){var o=this;t.$watch(function(){return n},function(){o.content=n}),this.resolve=function(){e.hide()}}],theme:t.defaultTheme(),controllerAs:"toast",bindToController:!0};return o}]}).addMethod("updateContent",function(e){n=e});return t.$inject=["$timeout","$animate","$mdToast","$mdUtil"],o}angular.module("material.components.toast",["material.core","material.components.button"]).directive("mdToast",e).provider("$mdToast",t),t.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o){return{restrict:"E",controller:angular.noop,link:function(r,a,i){function d(){function o(t,n){a.parent()[0]===n.parent()[0]&&(m&&m.off("scroll",p),n.on("scroll",p),n.attr("scroll-shrink","true"),m=n,e(d))}function d(){l=a.prop("offsetHeight"),m.css("margin-top",-l*f+"px"),c()}function c(e){var n=e?e.target.scrollTop:u;h(),s=Math.min(l/f,Math.max(0,s+n-u)),a.css(t.CSS.TRANSFORM,"translate3d(0,"+-s*f+"px,0)"),m.css(t.CSS.TRANSFORM,"translate3d(0,"+(l-s)*f+"px,0)"),u=n}var l,m,s=0,u=0,f=i.mdShrinkSpeedFactor||.5,p=e.throttle(c),h=n.debounce(d,5e3);r.$on("$mdContentLoaded",o)}o(a),angular.isDefined(i.mdScrollShrink)&&d()}}}angular.module("material.components.toolbar",["material.core","material.components.content"]).directive("mdToolbar",e),e.$inject=["$$rAF","$mdConstant","$mdUtil","$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o,r,a,i,d,c){function l(l,u,f){function p(){h(),b(),M(),g()}function h(){angular.isDefined(f.mdDelay)||(l.delay=m)}function g(){l.$watch("visible",function(e){e?A():T()}),l.$on("$destroy",function(){l.visible=!1,u.remove(),angular.element(t).off("resize",H)})}function b(){u.detach(),u.attr("role","tooltip"),u.attr("id",f.id||"tooltip_"+r.nextUid())}function E(){for(var e=u.parent();"none"==t.getComputedStyle(e[0])["pointer-events"];)e=e.parent();return e}function v(){for(var e=u.parent()[0];e&&e!==i[0]&&e!==document.body&&(!e.tagName||"md-content"!=e.tagName.toLowerCase());)e=e.parentNode;return e}function M(){var e=l.hasOwnProperty("autohide")?l.autohide:f.hasOwnProperty("mdAutohide");w.on("focus mouseenter touchstart",function(){$(!0)}),w.on("blur mouseleave touchend touchcancel",function(){(o[0].activeElement!==w[0]||e)&&$(!1)}),angular.element(t).on("resize",H)}function $(t){$.value=!!t,$.queued||(t?($.queued=!0,e(function(){l.visible=$.value,$.queued=!1},l.delay)):e(function(){l.visible=!1}))}function A(){w.attr("aria-describedby",u.attr("id")),_.append(u),C(),angular.forEach([u,k,y],function(e){d.addClass(e,"md-show")})}function T(){w.removeAttr("aria-describedby"),c.all([d.removeClass(y,"md-show"),d.removeClass(k,"md-show"),d.removeClass(u,"md-show")]).then(function(){l.visible||u.detach()})}function C(){function e(){var e="left"===x||"right"===x?2*Math.sqrt(Math.pow(o.width,2)+Math.pow(o.height/2,2)):2*Math.sqrt(Math.pow(o.width/2,2)+Math.pow(o.height,2)),t="left"===x?{left:100,top:50}:"right"===x?{left:0,top:50}:"top"===x?{left:50,top:100}:{left:50,top:0};k.css({width:e+"px",height:e+"px",left:t.left+"%",top:t.top+"%"})}function t(e){var t={left:e.left,top:e.top};return t.left=Math.min(t.left,_.prop("scrollWidth")-o.width-s),t.left=Math.max(t.left,s),t.top=Math.min(t.top,_.prop("scrollHeight")-o.height-s),t.top=Math.max(t.top,s),t}function n(e){return"left"===e?{left:a.left-o.width-s,top:a.top+a.height/2-o.height/2}:"right"===e?{left:a.left+a.width+s,top:a.top+a.height/2-o.height/2}:"top"===e?{left:a.left+a.width/2-o.width/2,top:a.top-o.height-s}:{left:a.left+a.width/2-o.width/2,top:a.top+a.height+s}}var o=r.offsetRect(u,_),a=r.offsetRect(w,_),i=n(x);x?i=t(i):i.top>u.prop("offsetParent").scrollHeight-o.height-s&&(i=t(n("top"))),u.css({top:i.top+"px",left:i.left+"px"}),e()}a(u);var w=E(),k=angular.element(u[0].getElementsByClassName("md-background")[0]),y=angular.element(u[0].getElementsByClassName("md-content")[0]),x=f.mdDirection,N=v(),_=angular.element(N||document.body),H=n.throttle(function(){l.visible&&C()});return p()}var m=300,s=8;return{restrict:"E",transclude:!0,template:'        <div class="md-background"></div>        <div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay",autohide:"=?mdAutohide"},link:l}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 ...
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,r,a,i,d,c,l,m){function s(){h(),d(function(){g(),p(),f()})}function u(){function e(){var e=K.ul.getBoundingClientRect(),n={};e.right>a.right-o&&(n.left=t.right-e.width+"px"),K.$.ul.css(n)}if(!K)return d(u,0,!1);var t=K.wrap.getBoundingClientRect(),r=K.snap.getBoundingClientRect(),a=K.root.getBoundingClientRect(),i=r.bottom-a.top,c=a.bottom-r.top,l=t.left-a.left,m=t.width,s={left:l+"px",minWidth:m+"px",maxWidth:Math.max(t.right-a.left,a.right-t.left)-o+"px"};i>c&&a.height-t.bottom-o<n?(s.top="auto",s.bottom=c+"px",s.maxHeight=Math.min(n,t.top-a.top-o)+"px"):(s.top=i+"px",s.bottom="auto",s.maxHeight=Math.min(n,a.bottom-t.bottom-o)+"px"),K.$.ul.css(s),d(e,0,!1)}function f(){K.$.root.length&&(c(K.$.ul),K.$.ul.detach(),K.$.root.append(K.$.ul))}function p(){e.autofocus&&K.input.focus()}function h(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(T,t):T),$(v),e.$watch("selectedItem",M),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){!e&&t&&u()}),angular.element(l).on("resize",u)}function g(){K={main:r[0],ul:r.find("ul")[0],input:r.find("input")[0],wrap:r.find("md-autocomplete-wrap")[0],root:document.body},K.snap=b(),K.$=E(K)}function b(){for(var e=r;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return K.wrap}function E(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function v(t,n){t&&(e.searchText=x(t)),e.itemChange&&t!==n&&e.itemChange(N(t))}function M(e,t){for(var n=0;n<z.length;++n)z[n](e,t)}function $(e){-1==z.indexOf(e)&&z.push(e)}function A(e){var t=z.indexOf(e);-1!=t&&z.splice(t,1)}function T(t,n){F.index=_(),(t||t!==n)&&t!==x(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(N(e.selectedItem)),I()?B():(F.loading=!1,F.matches=[],F.hidden=H(),L()))}function C(){W||(F.hidden=!0)}function w(){return angular.isString(e.searchText)?(F.hidden=H(),void(F.hidden||B())):e.searchText=""}function k(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(F.loading)return;e.preventDefault(),F.index=Math.min(F.index+1,F.matches.length-1),j(),P();break;case i.KEY_CODE.UP_ARROW:if(F.loading)return;e.preventDefault(),F.index=F.index<0?F.matches.length-1:Math.max(0,F.index-1),j(),P();break;case i.KEY_CODE.ENTER:if(F.hidden||F.loading||F.index<0)return;e.preventDefault(),D(F.index);break;case i.KEY_CODE.ESCAPE:F.matches=[],F.hidden=!0,F.index=_();break;case i.KEY_CODE.TAB:}}function y(){return angular.isNumber(e.minLength)?e.minLength:1}function x(t){return t&&e.itemText?e.itemText(N(t)):t}function N(e){if(e){var t={};return F.itemName&&(t[F.itemName]=e),t}}function _(){return e.autoselect?0:-1}function H(){return I()?1===F.matches.length&&e.searchText===x(F.matches[0])&&e.selectedItem===F.matches[0]:!0}function S(){return x(F.matches[F.index])}function I(){return e.searchText.length>=y()}function D(t){e.selectedItem=F.matches[t],e.searchText=x(e.selectedItem)||e.searchText,F.hidden=!0,F.index=0,F.matches=[]}function O(){e.searchText="",D(-1),K.input.focus()}function R(t){function n(n){Y[r]=n,t===e.searchText&&(V=null,F.loading=!1,F.matches=n,F.hidden=H(),L(),u())}var o=e.$parent.$eval(U),r=t.toLowerCase();angular.isArray(o)?n(o):(F.loading=!0,o.success&&o.success(n),o.then&&o.then(n),o.error&&o.error(function(){F.loading=!1}))}function L(){if(!F.hidden)switch(F.matches.length){case 0:return F.messages.splice(0);case 1:return F.messages.push({display:"There is 1 match available."});default:return F.messages.push({display:"There are "+F.matches.length+" matches available."})}}function P(){F.messages.push({display:S()})}function j(){var e=t*F.index,n=e+t,o=K.ul.clientHeight;e<K.ul.scrollTop?K.ul.scrollTop=e:n>K.ul.scrollTop+o&&(K.ul.scrollTop=n-o)}function B(){var t=e.searchText,n=t.toLowerCase();V&&V.cancel&&(V.cancel(),V=null),!e.noCache&&Y[n]?(F.matches=Y[n],L()):R(t),F.hidden=H()}var F=this,q=e.itemsExpr.split(/ in /i),U=q[1],K=null,V=null,Y={},W=!1,z=[];return F.scope=e,F.parent=e.$parent,F.itemName=q[0],F.matches=[],F.loading=!1,F.hidden=!0,F.index=null,F.messages=[],F.id=a.nextUid(),F.keydown=k,F.blur=C,F.focus=w,F.clear=O,F.select=D,F.getCurrentDisplayValue=S,F.registerSelectedItemWatcher=$,F.unregisterSelectedItemWatcher=A,F.listEnter=function(){W=!0},F.listLeave=function(){W=!1},F.mouseUp=function(){K.input.focus()},s()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,o=8;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window","$rootElement"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e){function t(t,n,o){t.contents=o.$mdAutocompleteTemplate,delete o.$mdAutocompleteTemplate,angular.forEach(t.$$isolateBindings,function(e,n){e.optional&&angular.isUndefined(t[n])&&(t[n]=o.hasOwnProperty(o.$normalize(e.attrName)))}),e(n)}return{controller:"MdAutocompleteCtrl",controllerAs:"$mdAutocompleteCtrl",link:t,scope:{name:"@",searchText:"=?mdSearchText",selectedItem:"=?mdSelectedItem",itemsExpr:"@mdItems",itemText:"&mdItemText",placeholder:"@placeholder",noCache:"=?mdNoCache",itemChange:"&?mdSelectedItemChange",textChange:"&?mdSearchTextChange",isDisabled:"=?ngDisabled",minLength:"=?mdMinLength",delay:"=?mdDelay",autofocus:"=?mdAutofocus",floatingLabel:"@?mdFloatingLabel",autoselect:"=?mdAutoselect",menuClass:"@?mdMenuClass"},template:function(e,t){return t.$mdAutocompleteTemplate=e.html(),'          <md-autocomplete-wrap role="listbox">            <md-input-container ng-if="floatingLabel">              <label>{{floatingLabel}}</label>              <input type="text"                  id="fl-input-{{$mdAutocompleteCtrl.id}}"                  name="{{name}}"                  autocomplete="off"                  ng-disabled="isDisabled"                  ng-model="$mdAutocompleteCtrl.scope.searchText"                  ng-keydown="$mdAutocompleteCtrl.keydown($event)"                  ng-blur="$mdAutocompleteCtrl.blur()"                  ng-focus="$mdAutocompleteCtrl.focus()"                  aria-owns="ul-{{$mdAutocompleteCtrl.id}}"                  aria-label="{{floatingLabel}}"                  aria-autocomplete="list"                  aria-haspopup="true"                  aria-activedescendant=""                  aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>                            </md-input-container>            <input type="text"                id="input-{{$mdAutocompleteCtrl.id}}"                name="{{name}}"                ng-if="!floatingLabel"                autocomplete="off"                ng-disabled="isDisabled"                ng-model="$mdAutocompleteCtrl.scope.searchText"                ng-keydown="$mdAutocompleteCtrl.keydown($event)"                ng-blur="$mdAutocompleteCtrl.blur()"                ng-focus="$mdAutocompleteCtrl.focus()"                placeholder="{{placeholder}}"                aria-owns="ul-{{$mdAutocompleteCtrl.id}}"                aria-label="{{placeholder}}"                aria-autocomplete="list"                aria-haspopup="true"                aria-activedescendant=""                aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>            <button                type="button"                tabindex="-1"                ng-if="$mdAutocompleteCtrl.scope.searchText && !isDisabled"                ng-click="$mdAutocompleteCtrl.clear()">              <md-icon md-svg-icon="cancel"></md-icon>              <span class="md-visually-hidden">Clear</span>            </button>            <md-progress-linear                ng-if="$mdAutocompleteCtrl.loading"                md-mode="indeterminate"></md-progress-linear>            <ul role="presentation"                class="md-autocomplete-suggestions {{menuClass || \'\'}}"                id="ul-{{$mdAutocompleteCtrl.id}}"                ng-mouseenter="$mdAutocompleteCtrl.listEnter()"                ng-mouseleave="$mdAutocompleteCtrl.listLeave()"                ng-mouseup="$mdAutocompleteCtrl.mouseUp()">              <li ng-repeat="(index, item) in $mdAutocompleteCtrl.matches"                  ng-class="{ selected: index === $mdAutocompleteCtrl.index }"                  ng-hide="$mdAutocompleteCtrl.hidden"                  ng-click="$mdAutocompleteCtrl.select(index)"                  md-autocomplete-list-item-template="contents"                  md-autocomplete-list-item="$mdAutocompleteCtrl.itemName">              </li>            </ul>          </md-autocomplete-wrap>          <aria-status              class="md-visually-hidden"              role="status"              aria-live="assertive">            <p ng-repeat="message in $mdAutocompleteCtrl.messages">{{message.display}}</p>          </aria-status>'}}}angular.module("material.components.autocomplete").directive("mdAutocomplete",e),e.$inject=["$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n){function o(e){return e?e.replace(/[\*\[\]\(\)\{\}\\\^\$]/g,"\\$&"):e}function r(e,t){var n="";return t.indexOf("^")>=1&&(n+="^"),n+=e,t.indexOf("$")>=1&&(n+="$"),new RegExp(o(n),t.replace(/[\$\^]/g,""))}var a=t.attr("md-highlight-text"),i=n(t.text())(e),d=t.attr("md-highlight-flags")||"",c=e.$watch(a,function(e){var n=r(e,d),o=i.replace(n,'<span class="highlight">$&</span>');t.html(o)});t.on("$destroy",function(){c()})}angular.module("material.components.autocomplete").controller("MdHighlightCtrl",e),e.$inject=["$scope","$element","$interpolate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 ...
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t){function n(n,o,r){var a=n.$parent.$mdAutocompleteCtrl,i=a.parent.$new(!1,a.parent),d=a.scope.$eval(r.mdAutocompleteListItem);i[d]=n.item,o.html(a.scope.$eval(r.mdAutocompleteListItemTemplate)),e(o.contents())(i),o.attr({role:"option",id:"item_"+t.nextUid()})}return{terminal:!0,link:n,scope:!1}}angular.module("material.components.autocomplete").directive("mdAutocompleteListItem",e),e.$inject=["$compile","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e){function n(n,o){return n.append(t),function(t,n,o){n.addClass("md-chip"),e(n)}}return{restrict:"E",requires:"^mdChips",compile:n}}angular.module("material.components.chips").directive("mdChip",e);var t='      <span ng-if="!$mdChipsCtrl.readonly" class="md-visually-hidden">        {{$mdChipsCtrl.deleteHint}}      </span>';e.$inject=["$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e){function t(t,n,o,r){n.on("click",function(e){t.$apply(function(){r.removeChip(t.$$replacedScope.$index)})}),e(function(){n.attr({tabindex:-1,ariaHidden:!0}),n.find("button").attr("tabindex","-1")})}return{restrict:"A",require:"^mdChips",scope:!1,link:t}}angular.module("material.components.chips").directive("mdChipRemove",e),e.$inject=["$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t){function n(t,n,o){var r=t.$parent.$mdChipsCtrl,a=r.parent.$new(!1,r.parent);a.$$replacedScope=t,a.$chip=t.$chip,a.$mdChipsCtrl=r,n.html(r.$scope.$eval(o.mdChipTransclude)),e(n.contents())(a)}return{restrict:"EA",terminal:!0,link:n,scope:!1}}angular.module("material.components.chips").directive("mdChipTransclude",e),e.$inject=["$compile","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,t,n,o,r){this.$timeout=r,this.$mdConstant=t,this.$scope=e,this.parent=e.$parent,this.$log=n,this.$element=o,this.ngModelCtrl=null,this.userInputNgModelCtrl=null,this.userInputElement=null,this.items=[],this.selectedChip=-1,this.deleteHint="Press delete to remove this chip.",this.deleteButtonLabel="Remove",this.chipBuffer="",this.useMdOnAppend=!1}angular.module("material.components.chips").controller("MdChipsCtrl",e),e.$inject=["$scope","$mdConstant","$log","$element","$timeout"],e.prototype.inputKeydown=function(e){var t=this.getChipBuffer();switch(e.keyCode){case this.$mdConstant.KEY_CODE.ENTER:if(this.$scope.requireMatch||!t)break;e.preventDefault(),this.appendChip(t),this.resetChipBuffer();break;case this.$mdConstant.KEY_CODE.BACKSPACE:if(t)break;e.stopPropagation(),this.items.length&&this.selectAndFocusChipSafe(this.items.length-1)}},e.prototype.chipKeydown=function(e){if(!this.getChipBuffer())switch(e.keyCode){case this.$mdConstant.KEY_CODE.BACKSPACE:case this.$mdConstant.KEY_CODE.DELETE:if(this.selectedChip<0)return;e.preventDefault(),this.removeAndSelectAdjacentChip(this.selectedChip);break;case this.$mdConstant.KEY_CODE.LEFT_ARROW:e.preventDefault(),this.selectedChip<0&&(this.selectedChip=this.items.length),this.items.length&&this.selectAndFocusChipSafe(this.selectedChip-1);break;case this.$mdConstant.KEY_CODE.RIGHT_ARROW:e.preventDefault(),this.selectAndFocusChipSafe(this.selectedChip+1);break;case this.$mdConstant.KEY_CODE.ESCAPE:case this.$mdConstant.KEY_CODE.TAB:if(this.selectedChip<0)return;e.preventDefault(),this.onFocus()}},e.prototype.getPlaceholder=function(){var e=this.items.length&&(""==this.secondaryPlaceholder||this.secondaryPlaceholder);return e?this.placeholder:this.secondaryPlaceholder},e.prototype.removeAndSelectAdjacentChip=function(e){var t=this.getAdjacentChipIndex(e);this.removeChip(e),this.$timeout(function(){this.selectAndFocusChipSafe(t)}.bind(this))},e.prototype.resetSelectedChip=function(){this.selectedChip=-1},e.prototype.getAdjacentChipIndex=function(e){var t=this.items.length-1;return 0==t?-1:e==t?e-1:e},e.prototype.appendChip=function(e){this.items.indexOf(e)+1||(this.useMdOnAppend&&this.mdOnAppend&&(e=this.mdOnAppend({$chip:e})),this.items.push(e))},e.prototype.useMdOnAppendExpression=function(){this.useMdOnAppend=!0},e.prototype.getChipBuffer=function(){return this.userInputElement?this.userInputNgModelCtrl?this.userInputNgModelCtrl.$viewValue:this.userInputElement[0].value:this.chipBuffer},e.prototype.resetChipBuffer=function(){this.userInputElement?this.userInputNgModelCtrl?(this.userInputNgModelCtrl.$setViewValue(""),this.userInputNgModelCtrl.$render()):this.userInputElement[0].value="":this.chipBuffer=""},e.prototype.removeChip=function(e){this.items.splice(e,1)},e.prototype.removeChipAndFocusInput=function(e){this.removeChip(e),this.onFocus()},e.prototype.selectAndFocusChipSafe=function(e){return this.items.length?e===this.items.length?this.onFocus():(e=Math.max(e,0),e=Math.min(e,this.items.length-1),this.selectChip(e),void this.focusChip(e)):(this.selectChip(-1),void this.onFocus())},e.prototype.selectChip=function(e){e>=-1&&e<=this.items.length?this.selectedChip=e:this.$log.warn("Selected Chip index out of bounds; ignoring.")},e.prototype.selectAndFocusChip=function(e){this.selectChip(e),-1!=e&&this.focusChip(e)},e.prototype.focusChip=function(e){this.$element[0].querySelector('md-chip[index="'+e+'"] .md-chip-content').focus()},e.prototype.configureNgModel=function(e){this.ngModelCtrl=e;var t=this;e.$render=function(){t.items=t.ngModelCtrl.$viewValue}},e.prototype.onFocus=function(){var e=this.$element[0].querySelectorAll("input")[0];e&&e.focus(),this.resetSelectedChip()},e.prototype.configureUserInput=function(e){this.userInputElement=e;var t=e.controller("ngModel");t!=this.ngModelCtrl&&(this.userInputNgModelCtrl=t);var n=this.$scope,o=this;e.attr({tabindex:0}).on("keydown",function(e){n.$apply(function(){o.inputKeydown(e)})}).on("focus",function(){o.selectedChip=-1})},e.prototype.configureAutocomplete=function(e){e.registerSelectedItemWatcher(function(e){e&&(this.appendChip(e),this.resetChipBuffer())}.bind(this))}}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376
 */
function(){"use strict";function e(e,a,i){function d(t,d){function c(e){if(d.ngModel){var t=l[0].querySelector(e);return t&&t.outerHTML}}var l=d.$mdUserTemplate;d.$mdUserTemplate=null;var m=c("[md-chip-remove]")||r,s=c("md-chip-template")||o,u=c("md-autocomplete")||c("input")||n,f=l.find("md-chip");return function(t,o,r,c){angular.forEach(t.$$isolateBindings,function(e,n){e.optional&&angular.isUndefined(t[n])&&(t[n]=d.hasOwnProperty(d.$normalize(e.attrName)))}),e(o);var l=c[0];if(l.chipContentsTemplate=s,l.chipRemoveTemplate=m,l.chipInputTemplate=u,o.attr({ariaHidden:!0,tabindex:-1}).on("focus",function(){l.onFocus()}),d.ngModel&&(l.configureNgModel(o.controller("ngModel")),r.mdOnAppend&&l.useMdOnAppendExpression(),u!=n&&i(function(){0===u.indexOf("<md-autocomplete")&&l.configureAutocomplete(o.find("md-autocomplete").controller("mdAutocomplete")),l.configureUserInput(o.find("input"))})),f.length>0){var p=a(f)(t.$parent);i(function(){o.find("md-chips-wrap").prepend(p)})}}}return{template:function(e,n){return n.$mdUserTemplate=e.clone(),t},require:["mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:d,scope:{readonly:"=readonly",placeholder:"@",secondaryPlaceholder:"@",mdOnAppend:"&",deleteHint:"@",deleteButtonLabel:"@",requireMatch:"=?mdRequireMatch"}}}angular.module("material.components.chips").directive("mdChips",e);var t='      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index}">          <div class="md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div class="md-chip-remove-container"              md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',n='        <input            tabindex="0"            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.resetSelectedChip()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',o="      <span>{{$chip}}</span>",r='      <button          class="md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index)"          aria-hidden="true"          tabindex="-1">        <md-icon md-svg-icon="close"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>';e.$inject=["$mdTheming","$compile","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-d7b2376

 ...
 * v0.7.1-master-4080122
 */
function(){function e(e,t){function n(){return[].concat(b)}function r(){return b.length}function o(e){return b.length&&e>-1&&e<b.length}function a(e){return e?o(s(e)+1):!1}function i(e){return e?o(s(e)-1):!1}function c(e){return o(e)?b[e]:null}function d(e,t){return b.filter(function(n){return n[e]===t})}function l(e,t){return e?(angular.isNumber(t)||(t=b.length),b.splice(t,0,e),s(e)):-1}function m(e){u(e)&&b.splice(s(e),1)}function s(e){return b.indexOf(e)}function u(e){return e&&s(e)>-1}function f(){return b.length?b[0]:null}function p(){return b.length?b[b.length-1]:null}function h(e,n,r,a){r=r||g;var i=s(n);if(!o(i))return null;var c=i+(e?-1:1),d=null;return o(c)?d=b[c]:t&&(d=e?p():f(),c=s(d)),null===d||c===a?null:(angular.isUndefined(a)&&(a=c),r(d)?d:h(e,d,r,a))}var g=function(){return!0};e&&!angular.isArray(e)&&(e=Array.prototype.slice.call(e)),t=!!t;var b=e||[];return{items:n,count:r,inRange:o,contains:u,indexOf:s,itemAt:c,findBy:d,add:l,remove:m,first:f,last:p,next:angular.bind(null,h,!1),previous:angular.bind(null,h,!0),hasPrevious:i,hasNext:a}}angular.module("material.core").config(["$provide",function(t){t.decorator("$mdUtil",["$delegate",function(t){return t.iterator=e,t}])}])}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 ...
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(t,i){return i.type="checkbox",i.tabIndex=0,t.attr("role",i.type),function(t,i,d,l){function m(e){e.which===r.KEY_CODE.SPACE&&(e.preventDefault(),s(e))}function s(e){i[0].hasAttribute("disabled")||t.$apply(function(){f=!f,l.$setViewValue(f,e&&e.type),l.$render()})}function u(){f=l.$viewValue,f?i.addClass(c):i.removeClass(c)}l=l||a.fakeNgModel();var f=!1;o(i),d.ngChecked&&t.$watch(t.$eval.bind(t,d.ngChecked),l.$setViewValue.bind(l)),n.expectWithText(i,"aria-label"),e.link.pre(t,{on:angular.noop,0:{}},d,[l]),i.on("click",s).on("keypress",m),l.$render=u}}e=e[0];var c="md-checked";return{restrict:"E",transclude:!0,require:"?ngModel",template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:i}}angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",e),e.$inject=["inputDirective","$mdInkRipple","$mdAria","$mdConstant","$mdTheming","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 ...
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n){function r(r,o,a,i){function c(n){switch(n.keyCode){case t.KEY_CODE.LEFT_ARROW:case t.KEY_CODE.UP_ARROW:n.preventDefault(),d.selectPrevious();break;case t.KEY_CODE.RIGHT_ARROW:case t.KEY_CODE.DOWN_ARROW:n.preventDefault(),d.selectNext();break;case t.KEY_CODE.ENTER:var r=angular.element(e.getClosest(o[0],"form"));r.length>0&&r.triggerHandler("submit")}}n(o);var d=i[0],l=i[1]||e.fakeNgModel();d.init(l),o.attr({role:"radiogroup",tabIndex:o.attr("tabindex")||"0"}).on("keydown",c)}function o(e){this._radioButtonRenderFns=[],this.$element=e}function a(){return{init:function(e){this._ngModelCtrl=e,this._ngModelCtrl.$render=angular.bind(this,this.render)},add:function(e){this._radioButtonRenderFns.push(e)},remove:function(e){var t=this._radioButtonRenderFns.indexOf(e);-1!==t&&this._radioButtonRenderFns.splice(t,1)},render:function(){this._radioButtonRenderFns.forEach(function(e){e()})},setViewValue:function(e,t){this._ngModelCtrl.$setViewValue(e,t),this.render()},getViewValue:function(){return this._ngModelCtrl.$viewValue},selectNext:function(){return i(this.$element,1)},selectPrevious:function(){return i(this.$element,-1)},setActiveDescendant:function(e){this.$element.attr("aria-activedescendant",e)}}}function i(t,n){var r=e.iterator(t[0].querySelectorAll("md-radio-button"),!0);if(r.count()){var o=function(e){return!angular.element(e).attr("disabled")},a=t[0].querySelector("md-radio-button.md-checked"),i=r[0>n?"previous":"next"](a,o)||r.first();angular.element(i).triggerHandler("click")}}return o.prototype=a(),{restrict:"E",controller:["$element",o],require:["mdRadioGroup","?ngModel"],link:{pre:r}}}function t(e,t,n){function r(r,a,i,c){function d(e){a[0].hasAttribute("disabled")||r.$apply(function(){c.setViewValue(i.value,e&&e.type)})}function l(){var e=c.getViewValue()==i.value;e!==s&&(s=e,a.attr("aria-checked",e),e?(a.addClass(o),c.setActiveDescendant(a.attr("id"))):a.removeClass(o))}function m(n,r){function o(){return i.id||"radio_"+t.nextUid()}r.ariaId=o(),n.attr({id:r.ariaId,role:"radio","aria-checked":"false"}),e.expectWithText(n,"aria-label")}var s;n(a),m(a,r),c.add(l),i.$observe("value",l),a.on("click",d).on("$destroy",function(){c.remove(l)})}var o="md-checked";return{restrict:"E",require:"^mdRadioGroup",transclude:!0,template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-off"></div><div class="md-on"></div></div><div ng-transclude class="md-label"></div>',link:r}}angular.module("material.components.radioButton",["material.core"]).directive("mdRadioGroup",e).directive("mdRadioButton",t),e.$inject=["$mdUtil","$mdConstant","$mdTheming"],t.$inject=["$mdAria","$mdUtil","$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n,r){function o(t,n){var o=t.find("md-select-label").remove();o.length||((o=t.find("input")).length?o.remove():o=angular.element('<md-select-label">').html("{{"+n.ngModel+" ? "+n.ngModel+": '"+n.placeholder+"'}}")),o.addClass("md-select-label"),o.addClass("{{ "+n.ngModel+" ? '' : 'md-placeholder'}}"),t.find("md-content").length||t.append(angular.element("<md-content>").append(t.contents())),n.mdOnOpen&&t.find("md-content").prepend(angular.element("<md-progress-circular>").attr("md-mode","indeterminate").attr("ng-hide","$$loadingAsyncDone").wrap("<div>").parent());var a='<div class="md-select-menu-container"><md-select-menu ng-model="$parent.'+n.ngModel+'" '+(angular.isDefined(n.multiple)?"multiple":"")+">"+t.html()+"</md-select-menu></div>";return t.empty().append(o),r(t),function(t,n,r){function o(){t.$evalAsync(function(){e.show({scope:t.$new(),template:a,target:n[0],inputTriggerEl:i,hasBackdrop:0===i.length,loadingAsync:r.mdOnOpen?t.$eval(r.mdOnOpen):!1})})}var i=n.find("input");i.length?i.on("focus",o).on("blur",function(){t.$evalAsync(e.cancel)}):n.on("click",o)}}return{restrict:"E",compile:o}}function t(e,t,n,r){function o(e,t,o,a){function i(t){var r=n.getClosest(t.target,"md-option"),o=r&&angular.element(r).data("$mdOptionController");if(r&&o){var a=c.hashGetter(o.value),i=angular.isDefined(c.selected[a]);e.$apply(function(){c.isMultiple?i?c.deselect(a):c.select(a,o.value):i||(c.deselect(Object.keys(c.selected)[0]),c.select(a,o.value)),c.refreshViewValue()})}}var c=a[0],d=a[1];r(t),t.on("click",i),c.init(d)}function a(t,n,r){function o(){var e=c.ngModel.$modelValue||c.ngModel.$viewValue;if(angular.isArray(e)){var t=Object.keys(c.selected),n=e.map(c.hashGetter),r=t.filter(function(e){return-1===n.indexOf(e)});r.forEach(c.deselect),n.forEach(function(t,n){c.select(t,e[n])})}}function a(){var e=c.ngModel.$viewValue||c.ngModel.$modelValue;Object.keys(c.selected).forEach(c.deselect),c.select(c.hashGetter(e),e)}var c=this;c.isMultiple=angular.isDefined(r.multiple),c.selected={},c.options={},c.init=function(n){function d(e,t){return angular.isArray(e||t||[])}if(c.ngModel=n,n.$options&&n.$options.trackBy){var l={},m=e(n.$options.trackBy);c.hashGetter=function(e,n){return l.$value=e,m(n||t,l)}}else c.hashGetter=function(e){return angular.isObject(e)?"$$object_"+(e.$$mdSelectId||(e.$$mdSelectId=++i)):e};c.isMultiple?(n.$validators["md-multiple"]=d,n.$render=o,t.$watchCollection(r.ngModel,function(e){d(e)&&o(e)})):n.$render=a},c.select=function(e,t){var n=c.options[e];n&&n.setSelected(!0),c.selected[e]=t},c.deselect=function(e){var t=c.options[e];t&&t.setSelected(!1),delete c.selected[e]},c.addOption=function(e,t){if(angular.isDefined(c.options[e]))throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "'+t.value+'" found.');c.options[e]=t,angular.isDefined(c.selected[e])&&(c.select(e,t.value),c.refreshViewValue())},c.removeOption=function(e){delete c.options[e]},c.refreshViewValue=function(){var e,t=[];for(var n in c.selected)(e=c.options[n])?t.push(e.value):t.push(c.selected[n]);c.ngModel.$setViewValue(c.isMultiple?t:t[0])}}return a.$inject=["$scope","$element","$attrs"],{restrict:"E",require:["mdSelectMenu","ngModel"],controller:a,link:{pre:o}}}function n(e){function t(e){return e.append(angular.element('<div class="md-text">').append(e.contents())),n}function n(t,n,r,o){function a(e,n){var r=c.hashGetter(n,t),o=c.hashGetter(e,t);i.hashKey=o,i.value=e,c.removeOption(r,i),c.addOption(o,i)}var i=o[0],c=o[1];if(angular.isDefined(r.ngValue))t.$watch(r.ngValue,a);else{if(!angular.isDefined(r.value))throw new Error("Expected either ngValue or value attr");a(r.value)}e.attachButtonBehavior(t,n),t.$on("$destroy",function(){c.removeOption(i.hashKey,i)})}function r(e,t){this.selected=!1,this.setSelected=function(e){e&&!this.selected?t.attr("selected","selected"):!e&&this.selected&&t.removeAttr("selected"),this.selected=e}}return r.$inject=["$scope","$element"],{restrict:"E",require:["mdOption","^^mdSelectMenu"],controller:r,compile:t}}function r(){function e(e,t){var n=e.find("label");n.length||(n=angular.element("<label>"),e.prepend(n)),t.label&&n.text(t.label)}return{restrict:"E",compile:e}}function o(e){function t(e,t,o,i,c,d,l){function m(e,n,r){function o(){if(!r.isRemoved){var o=r.selectEl.controller("mdSelectMenu")||{};n.addClass("md-clickable"),r.backdrop&&r.backdrop.on("click",function(){e.$apply(t.cancel)}),o.isMultiple||r.selectEl.on("click",function(){e.$evalAsync(function(){t.hide(o.ngModel.$viewValue)})})}}if(!r.target)throw new Error('$mdSelect.show() expected a target element in options.target but got "'+r.target+'"!');return angular.extend(r,{target:angular.element(r.target),parent:angular.element(r.parent),selectEl:n.find("md-select-menu"),contentEl:n.find("md-content"),backdrop:r.hasBackdrop&&angular.element("<md-backdrop>")}),r.loadingAsync&&r.loadingAsync.then&&r.loadingAsync.then(function(){e.$$loadingAsyncDone=!0,i(function(){i(function(){u(e,n,r)})})}),l(o,75,!1),r.backdrop&&(d.inherit(r.backdrop,r.parent),r.parent.append(r.backdrop)),r.parent.append(n),i(function(){i(function(){r.isRemoved||u(e,n,r)})}),c.transitionEndPromise(r.selectEl)}function s(e,t,n){return n.isRemoved=!0,t.addClass("md-leave").removeClass("md-clickable"),c.transitionEndPromise(t).then(function(){t.remove(),n.backdrop&&n.backdrop.remove()})}function u(e,t,d){var l,m=t[0],s=d.target[0],u=d.parent[0],f=d.selectEl[0],p=d.contentEl[0],h=d.inputTriggerEl&&d.inputTriggerEl[0],g=u.getBoundingClientRect(),b=c.clientRect(s,u),E=!!h,v={left:u.scrollLeft+a,top:u.scrollTop+a,bottom:g.height+u.scrollTop-a,right:g.width-u.scrollLeft-a},$={top:b.top-v.top,left:b.left-v.bottom},M=g.width-2*a,A=p.scrollHeight>p.offsetHeight,T=f.querySelector("md-option[selected]"),w=f.getElementsByTagName("md-option"),k=f.getElementsByTagName("md-optgroup");l=T?T:k.length?w[0]:w.length?w[Math.floor(w.length/2)]:p.firstElementChild,p.offsetWidth>M&&(p.style["max-width"]=M+"px"),E&&(p.style["min-width"]=b.width+"px"),A&&f.classList.add("md-overflow");var y=f.getBoundingClientRect(),C=r(l),x=window.getComputedStyle(l);if(C.paddingLeft=parseInt(x["padding-left"],10),C.paddingRight=parseInt(x["padding-right"],10),A){var N=p.offsetHeight/2;p.scrollTop=C.top+C.height/2-N,$.top<N?p.scrollTop=Math.min(C.top,p.scrollTop+N-$.top):$.bottom<N&&(p.scrollTop=Math.max(C.top+C.height-y.height,p.scrollTop-N+$.bottom))}var _,S,H;E?(_=b.left,S=b.top+b.height,H="50% 0",S+y.height>v.bottom&&(S=b.top-y.height,H="50% 100%")):(_=b.left+C.left-C.paddingLeft,S=b.top+b.height/2-C.height/2-C.top+p.scrollTop,H=C.left+b.width/2+"px "+(C.top+C.height/2-p.scrollTop)+"px 0px",m.style.width=b.width+C.paddingLeft+C.paddingRight+"px"),m.style.left=n(v.left,_,v.right)+"px",m.style.top=n(v.top,S,v.bottom)+"px",f.style[o.CSS.TRANSFORM_ORIGIN]=H,f.style[o.CSS.TRANSFORM]="scale("+Math.min(b.width/y.width,1)+","+Math.min(b.height/y.height,1)+")",i(function(){t.addClass("md-active"),f.style[o.CSS.TRANSFORM]=""})}return{parent:"body",onShow:m,onRemove:s,hasBackdrop:!0,themable:!0}}function n(e,t,n){return Math.min(n,Math.max(t,e))}function r(e){return e?{left:e.offsetLeft,top:e.offsetTop,width:e.offsetWidth,height:e.offsetHeight}:{left:0,top:0,width:0,height:0}}return t.$inject=["$animate","$mdSelect","$mdConstant","$$rAF","$mdUtil","$mdTheming","$timeout"],e("$mdSelect").setDefaults({methods:["target"],options:t})}var a=8,i=0;angular.module("material.components.select",["material.core","material.components.backdrop"]).directive("mdSelect",e).directive("mdSelectMenu",t).directive("mdOption",n).directive("mdOptgroup",r).provider("$mdSelect",o),e.$inject=["$mdSelect","$mdUtil","$q","$mdTheming"],t.$inject=["$parse","$mdSelect","$mdUtil","$mdTheming"],n.$inject=["$mdInkRipple"],o.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t){return function(n){var r="SideNav '"+n+"' is not available!",o=e.get(n);return o||e.notFoundError(n),{isOpen:function(){return o&&o.isOpen()},isLockedOpen:function(){return o&&o.isLockedOpen()},toggle:function(){return o?o.toggle():t.reject(r)},open:function(){return o?o.open():t.reject(r)},close:function(){return o?o.close():t.reject(r)}}}}function t(e,t,n,r,o,a,i,c,d){function l(l,m,s,u){function f(e,n){l.isLockedOpen=e,e===n?m.toggleClass("md-locked-open",!!e):t[e?"addClass":"removeClass"](m,"md-locked-open"),A.toggleClass("md-locked-open",!!e)}function p(e){var n=m.parent();return n[e?"on":"off"]("keydown",g),A[e?"on":"off"]("click",b),e&&(E=d[0].activeElement),v=c.all([t[e?"enter":"leave"](A,n),t[e?"removeClass":"addClass"](m,"md-closed").then(function(){l.isOpen&&m.focus()})])}function h(t){if(l.isOpen==t)return c.when(!0);var n=c.defer();return l.isOpen=t,e(function(){v.then(function(e){l.isOpen||(E&&E.focus(),E=null),n.resolve(e)})},0,!1),n.promise}function g(e){var t=e.keyCode===o.KEY_CODE.ESCAPE;return t?b(e):c.when(!0)}function b(e){return e.preventDefault(),e.stopPropagation(),u.close()}var E=null,v=c.when(!0),$=n(s.mdIsLockedOpen),M=function(){return $(l.$parent,{$media:r})},A=a('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(l);m.on("$destroy",u.destroy),i.inherit(A,m),l.$watch(M,f),l.$watch("isOpen",p),u.$toggleOpen=h}return{restrict:"E",scope:{isOpen:"=?mdIsOpen"},controller:"$mdSidenavController",compile:function(e){return e.addClass("md-closed"),e.attr("tabIndex","-1"),l}}}function n(e,t,n,r,o){var a=this;a.$toggleOpen=function(){return o.when(e.isOpen)},a.isOpen=function(){return!!e.isOpen},a.isLockedOpen=function(){return!!e.isLockedOpen},a.open=function(){return a.$toggleOpen(!0)},a.close=function(){return a.$toggleOpen(!1)},a.toggle=function(){return a.$toggleOpen(!e.isOpen)},a.destroy=r.register(a,n.mdComponentId)}angular.module("material.components.sidenav",["material.core","material.components.backdrop"]).factory("$mdSidenav",e).directive("mdSidenav",t).controller("$mdSidenavController",n),e.$inject=["$mdComponentRegistry","$q"],t.$inject=["$timeout","$animate","$parse","$mdMedia","$mdConstant","$compile","$mdTheming","$q","$document"],n.$inject=["$scope","$element","$attrs","$mdComponentRegistry","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n,r,o,a,i,c){function d(e){return e.attr({tabIndex:0,role:"slider"}),n.expect(e,"aria-label"),l}function l(n,d,l,m){function s(){b(),M(),g()}function u(e){K=parseFloat(e),d.attr("aria-valuemin",e),s()}function f(e){z=parseFloat(e),d.attr("aria-valuemax",e),s()}function p(e){W=parseFloat(e),g()}function h(e){d.attr("aria-disabled",!!e)}function g(){if(angular.isDefined(l.mdDiscrete)){var e=Math.floor((z-K)/W);if(!X){var n=t.getComputedStyle(V[0]);X=angular.element('<canvas style="position:absolute;">'),Q=X[0].getContext("2d"),Q.fillStyle=n.backgroundColor||"black",V.append(X)}var r=E();X[0].width=r.width,X[0].height=r.height;for(var o,a=0;e>=a;a++)o=Math.floor(r.width*(a/e)),Q.fillRect(o-1,0,2,r.height)}}function b(){Z=q[0].getBoundingClientRect()}function E(){return U(),Z}function v(e){if(!d[0].hasAttribute("disabled")){var t;e.keyCode===o.KEY_CODE.LEFT_ARROW?t=-W:e.keyCode===o.KEY_CODE.RIGHT_ARROW&&(t=W),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),n.$evalAsync(function(){$(m.$viewValue+t)}))}}function $(e){m.$setViewValue(A(T(e)))}function M(){isNaN(m.$viewValue)&&(m.$viewValue=m.$modelValue);var e=(m.$viewValue-K)/(z-K);n.modelValue=m.$viewValue,d.attr("aria-valuenow",m.$viewValue),w(e),L.text(m.$viewValue)}function A(e){return angular.isNumber(e)?Math.max(K,Math.min(z,e)):void 0}function T(e){return angular.isNumber(e)?Math.round(e/W)*W:void 0}function w(e){B.css("width",100*e+"%"),F.css("left",100*e+"%"),d.toggleClass("md-min",0===e)}function k(e){if(!j()){d.addClass("active"),d[0].focus(),b();var t=O(D(e.pointer.x)),r=A(T(t));n.$apply(function(){$(r),w(R(r))})}}function y(e){if(!j()){d.removeClass("dragging active");var t=O(D(e.pointer.x)),r=A(T(t));n.$apply(function(){$(r),M()})}}function C(e){j()||(J=!0,e.stopPropagation(),d.addClass("dragging"),_(e))}function x(e){J&&(e.stopPropagation(),_(e))}function N(e){J&&(e.stopPropagation(),J=!1)}function _(e){et?H(e.pointer.x):S(e.pointer.x)}function S(e){n.$evalAsync(function(){$(O(D(e)))})}function H(e){var t=O(D(e)),n=A(T(t));w(D(e)),L.text(n)}function D(e){return Math.max(0,Math.min(1,(e-Z.left)/Z.width))}function O(e){return K+e*(z-K)}function R(e){return(e-K)/(z-K)}a(d),m=m||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var I=l.ngDisabled&&c(l.ngDisabled),j=I?function(){return I(n.$parent)}:angular.noop,P=angular.element(d[0].querySelector(".md-thumb")),L=angular.element(d[0].querySelector(".md-thumb-text")),F=P.parent(),q=angular.element(d[0].querySelector(".md-track-container")),B=angular.element(d[0].querySelector(".md-track-fill")),V=angular.element(d[0].querySelector(".md-track-ticks")),U=r.throttle(b,5e3);l.min?l.$observe("min",u):u(0),l.max?l.$observe("max",f):f(100),l.step?l.$observe("step",p):p(1);var Y=angular.noop;l.ngDisabled&&(Y=n.$parent.$watch(l.ngDisabled,h)),i.register(d,"drag"),d.on("keydown",v).on("$md.pressdown",k).on("$md.pressup",y).on("$md.dragstart",C).on("$md.drag",x).on("$md.dragend",N),setTimeout(s);var G=e.throttle(s);angular.element(t).on("resize",G),n.$on("$destroy",function(){angular.element(t).off("resize",G),Y()}),m.$render=M,m.$viewChangeListeners.push(M),m.$formatters.push(A),m.$formatters.push(T);var K,z,W,X,Q,Z={};b();var J=!1,et=angular.isDefined(l.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-slider-wrapper">        <div class="md-track-container">          <div class="md-track"></div>          <div class="md-track md-track-fill"></div>          <div class="md-track-ticks"></div>        </div>        <div class="md-thumb-container">          <div class="md-thumb"></div>          <div class="md-focus-thumb"></div>          <div class="md-focus-ring"></div>          <div class="md-sign">            <span class="md-thumb-text"></span>          </div>          <div class="md-disabled-thumb"></div>        </div>      </div>',compile:d}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n,r,o){function a(e){function n(e,t){t.addClass("md-sticky-clone"),t.css("top",p+"px");var n={element:e,clone:t};return f.items.push(n),s.parent().prepend(n.clone),u(),function(){f.items.forEach(function(t,n){t.element[0]===e[0]&&(f.items.splice(n,1),t.clone.remove())}),u()}}function o(){f.items.forEach(a),f.items=f.items.sort(function(e,t){return e.top<t.top?-1:1});for(var e,t=s.prop("scrollTop"),n=f.items.length-1;n>=0;n--)if(t>f.items[n].top){e=f.items[n];break}d(e)}function a(e){var t=e.element[0];for(e.top=0,e.left=0;t&&t!==s[0];)e.top+=t.offsetTop,e.left+=t.offsetLeft,t=t.offsetParent;e.height=e.element.prop("offsetHeight"),e.clone.css("margin-left",e.left+"px")}function i(){var e=s.prop("scrollTop"),t=e>(i.prevScrollTop||0);i.prevScrollTop=e,0===e?d(null):t&&f.next?f.next.top-e<=0?d(f.next):f.current&&(f.next.top-e<=f.next.height?m(f.current,f.next.top-f.next.height-e):m(f.current,null)):!t&&f.current&&(e<f.current.top&&d(f.prev),f.current&&f.next&&(e>=f.next.top-f.current.height?m(f.current,f.next.top-e-f.current.height):m(f.current,null)))}function d(e){if(f.current!==e){f.current&&(m(f.current,null),l(f.current,null)),e&&l(e,"active"),f.current=e;var t=f.items.indexOf(e);f.next=f.items[t+1],f.prev=f.items[t-1],l(f.next,"next"),l(f.prev,"prev")}}function l(e,t){e&&e.state!==t&&(e.state&&(e.clone.attr("sticky-prev-state",e.state),e.element.attr("sticky-prev-state",e.state)),e.clone.attr("sticky-state",t),e.element.attr("sticky-state",t),e.state=t)}function m(e,n){e&&(null===n||void 0===n?e.translateY&&(e.translateY=null,e.clone.css(t.CSS.TRANSFORM,"")):(e.translateY=n,e.clone.css(t.CSS.TRANSFORM,"translate3d("+e.left+"px,"+n+"px,0)")))}var s=e.$element,u=r.throttle(o);c(s),s.on("$scrollstart",u),s.on("$scroll",i);var f,p=s.prop("offsetTop");return f={prev:null,current:null,next:null,items:[],add:n,refreshElements:o}}function i(){var t,n=angular.element("<div>");e[0].body.appendChild(n[0]);for(var r=["sticky","-webkit-sticky"],o=0;o<r.length;++o)if(n.css({position:r[o],top:0,"z-index":2}),n.css("position")==r[o]){t=r[o];break}return n.remove(),t}function c(e){function t(){+o.now()-a>i?(n=!1,e.triggerHandler("$scrollend")):(e.triggerHandler("$scroll"),r(t))}var n,a,i=200;e.on("scroll touchmove",function(){n||(n=!0,r(t),e.triggerHandler("$scrollstart")),e.triggerHandler("$scroll"),a=+o.now()})}var d=i();return function(e,t,n){var r=t.controller("mdContent");if(r)if(d)t.css({position:d,top:0,"z-index":2});else{var o=r.$element.data("$$sticky");o||(o=a(r),r.$element.data("$$sticky",o));var i=o.add(t,n||t.clone());e.$on("$destroy",i)}}}angular.module("material.components.sticky",["material.core","material.components.content"]).factory("$mdSticky",e),e.$inject=["$document","$mdConstant","$compile","$$rAF","$mdUtil"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 ...
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n,r){return{restrict:"E",controller:angular.noop,link:function(o,a,i){function c(){function r(t,n){a.parent()[0]===n.parent()[0]&&(m&&m.off("scroll",p),n.on("scroll",p),n.attr("scroll-shrink","true"),m=n,e(c))}function c(){l=a.prop("offsetHeight"),m.css("margin-top",-l*f+"px"),d()}function d(e){var n=e?e.target.scrollTop:u;h(),s=Math.min(l/f,Math.max(0,s+n-u)),a.css(t.CSS.TRANSFORM,"translate3d(0,"+-s*f+"px,0)"),m.css(t.CSS.TRANSFORM,"translate3d(0,"+(l-s)*f+"px,0)"),u=n}var l,m,s=0,u=0,f=i.mdShrinkSpeedFactor||.5,p=e.throttle(d),h=n.debounce(c,5e3);o.$on("$mdContentLoaded",r)}r(a),angular.isDefined(i.mdScrollShrink)&&c()}}}angular.module("material.components.toolbar",["material.core","material.components.content"]).directive("mdToolbar",e),e.$inject=["$$rAF","$mdConstant","$mdUtil","$mdTheming"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n,r,o,a,i,c,d){function l(l,u,f){function p(t){p.value=!!t,p.queued||(t?(p.queued=!0,e(function(){l.visible=p.value,p.queued=!1},l.delay)):e(function(){l.visible=!1}))}function h(){E.attr("aria-describedby",u.attr("id")),A.append(u),b(),c.addClass(u,"md-show"),c.addClass(v,"md-show")}function g(){E.removeAttr("aria-describedby"),d.all([c.removeClass(v,"md-show"),c.removeClass(u,"md-show")]).then(function(){l.visible||u.detach()})}function b(){function e(){var e="left"===$||"right"===$?2*Math.sqrt(Math.pow(t.width,2)+Math.pow(t.height/2,2)):2*Math.sqrt(Math.pow(t.width/2,2)+Math.pow(t.height,2)),n="left"===$?{left:100,top:50}:"right"===$?{left:0,top:50}:"top"===$?{left:50,top:100}:{left:50,top:0};v.css({width:e+"px",height:e+"px",left:n.left+"%",top:n.top+"%"})}var t=o.offsetRect(u,A),n=o.offsetRect(E,A),r="bottom",a={left:n.left+n.width/2-t.width/2,top:n.top+n.height};a.left=Math.min(a.left,A.prop("scrollWidth")-t.width-s),a.left=Math.max(a.left,s),a.top+t.height>A.prop("scrollHeight")&&(a.top=n.top-t.height,r="top"),u.css({top:a.top+"px",left:a.left+"px"}),e()}a(u);for(var E=u.parent(),v=angular.element(u[0].getElementsByClassName("md-background")[0]),$=f.mdDirection;"none"==t.getComputedStyle(E[0])["pointer-events"];)E=E.parent();for(var M=u.parent()[0];M&&M!==i[0]&&M!==document.body&&(!M.tagName||"md-content"!=M.tagName.toLowerCase());)M=M.parentNode;var A=angular.element(M||document.body);angular.isDefined(f.mdDelay)||(l.delay=m),u.detach(),u.attr("role","tooltip"),u.attr("id",f.id||"tooltip_"+o.nextUid()),E.on("focus mouseenter touchstart",function(){p(!0)}),E.on("blur mouseleave touchend touchcancel",function(){r[0].activeElement!==E[0]&&p(!1)}),l.$watch("visible",function(e){e?h():g()});var T=n.throttle(function(){l.visible&&b()});angular.element(t).on("resize",T),l.$on("$destroy",function(){l.visible=!1,u.remove(),angular.element(t).off("resize",T)})}var m=0,s=8;return{restrict:"E",transclude:!0,template:'<div class="md-background"></div><div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay"},link:l}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122
 ...
 * v0.7.1-master-4080122
 */
function(){"use strict";function e(e,t,n,r,o,a){function i(){d(),c()}function c(){var e=angular.element(v.ul),t=angular.element(v.input),n=e.attr("id")||"ul_"+o.nextUid();e.attr("id",n),t.attr("aria-owns",n)}function d(){e.$watch("searchText",function(e){if(!e)return g.loading=!1,g.matches=[];var t=e.toLowerCase();$&&$.cancel&&($.cancel(),$=null),M[t]?g.matches=M[t]:g.hidden||(g.loading=!0,g.fetch(e))})}function l(t){var n=e.$parent.$eval(E),o=t.toLowerCase();$=r.when(n).then(function(n){M[o]=n,t===e.searchText&&($=null,g.loading=!1,g.matches=n)})}function m(e){switch(e.keyCode){case a.KEY_CODE.DOWN_ARROW:if(g.loading)return;e.preventDefault(),g.index=Math.min(g.index+1,g.matches.length-1),h();break;case a.KEY_CODE.UP_ARROW:if(g.loading)return;e.preventDefault(),g.index=Math.max(0,g.index-1),h();break;case a.KEY_CODE.ENTER:if(g.loading)return;e.preventDefault(),p(g.index);break;case a.KEY_CODE.ESCAPE:g.matches=[],g.hidden=!0,g.index=-1;break;default:g.index=-1,g.hidden=!1,n(function(){g.hidden=u()})}}function s(){e.searchText="",p(-1)}function u(){return 1===g.matches.length&&e.searchText===f(g.matches[0])}function f(t){return t&&e.itemText?t[e.itemText]:t}function p(t){e.searchText=f(g.matches[t])||e.searchText,g.hidden=!0,g.index=-1,g.matches=[]}function h(){var e=41*g.index,t=e+41,n=225.5;e<v.ul.scrollTop?v.ul.scrollTop=e:t>v.ul.scrollTop+n&&(v.ul.scrollTop=t-n)}var g=this,b=e.itemsExpr.split(/\ in\ /i),E=b[1],v={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0]},$=null,M={};return g.scope=e,g.parent=e.$parent,g.itemName=b[0],g.matches=[],g.loading=!1,g.hidden=!0,g.index=0,g.keydown=m,g.clear=s,g.select=p,g.fetch=o.debounce(l),i()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$timeout","$q","$mdUtil","$mdConstant"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.1-master-4080122

 ...
 * v0.8.3-master-0e1820c
 */
function(){"use strict";function e(e,t,n,r,o,a,i,d,c){function l(l,u,f){function p(){h(),b(),$(),g()}function h(){angular.isDefined(f.mdDelay)||(l.delay=s)}function g(){l.$watch("visible",function(e){e?A():T()}),l.$on("$destroy",function(){l.visible=!1,u.remove(),angular.element(t).off("resize",S)})}function b(){u.detach(),u.attr("role","tooltip"),u.attr("id",f.id||"tooltip_"+o.nextUid())}function E(){for(var e=u.parent();"none"==t.getComputedStyle(e[0])["pointer-events"];)e=e.parent();return e}function v(){for(var e=u.parent()[0];e&&e!==i[0]&&e!==document.body&&(!e.tagName||"md-content"!=e.tagName.toLowerCase());)e=e.parentNode;return e}function $(){var e=l.hasOwnProperty("autohide")?l.autohide:f.hasOwnProperty("mdAutohide");k.on("focus mouseenter touchstart",function(){M(!0)}),k.on("blur mouseleave touchend touchcancel",function(){(r[0].activeElement!==k[0]||e)&&M(!1)}),angular.element(t).on("resize",S)}function M(t){M.value=!!t,M.queued||(t?(M.queued=!0,e(function(){l.visible=M.value,M.queued=!1},l.delay)):e(function(){l.visible=!1}))}function A(){k.attr("aria-describedby",u.attr("id")),_.append(u),w(),angular.forEach([u,y,x],function(e){d.addClass(e,"md-show")})}function T(){k.removeAttr("aria-describedby"),c.all([d.removeClass(x,"md-show"),d.removeClass(y,"md-show"),d.removeClass(u,"md-show")]).then(function(){l.visible||u.detach()})}function w(){function e(){var e="left"===C||"right"===C?2*Math.sqrt(Math.pow(r.width,2)+Math.pow(r.height/2,2)):2*Math.sqrt(Math.pow(r.width/2,2)+Math.pow(r.height,2)),t="left"===C?{left:100,top:50}:"right"===C?{left:0,top:50}:"top"===C?{left:50,top:100}:{left:50,top:0};y.css({width:e+"px",height:e+"px",left:t.left+"%",top:t.top+"%"})}function t(e){var t={left:e.left,top:e.top};return t.left=Math.min(t.left,_.prop("scrollWidth")-r.width-m),t.left=Math.max(t.left,m),t.top=Math.min(t.top,_.prop("scrollHeight")-r.height-m),t.top=Math.max(t.top,m),t}function n(e){return"left"===e?{left:a.left-r.width-m,top:a.top+a.height/2-r.height/2}:"right"===e?{left:a.left+a.width+m,top:a.top+a.height/2-r.height/2}:"top"===e?{left:a.left+a.width/2-r.width/2,top:a.top-r.height-m}:{left:a.left+a.width/2-r.width/2,top:a.top+a.height+m}}var r=o.offsetRect(u,_),a=o.offsetRect(k,_),i=n(C);C?i=t(i):i.top>u.prop("offsetParent").scrollHeight-r.height-m&&(i=t(n("top"))),u.css({top:i.top+"px",left:i.left+"px"}),e()}a(u);var k=E(),y=angular.element(u[0].getElementsByClassName("md-background")[0]),x=angular.element(u[0].getElementsByClassName("md-content")[0]),C=f.mdDirection,N=v(),_=angular.element(N||document.body),S=n.throttle(function(){l.visible&&w()});return p()}var s=300,m=8;return{restrict:"E",transclude:!0,template:'        <div class="md-background"></div>        <div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay",autohide:"=?mdAutohide"},link:l}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-0e1820c
 ...
 * v0.8.3-master-0e1820c
 */
function(){"use strict";function e(e,t,n,r,o){function a(){e.autofocus&&w.input.focus(),c(),o(i)}function i(){w={main:t[0],ul:t[0].getElementsByTagName("ul")[0],input:t[0].getElementsByTagName("input")[0]}}function d(e){if(e){var t={};return M.itemName&&(t[M.itemName]=e),t}}function c(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?n.debounce(l,t):l),e.$watch("selectedItem",function(t,n){t&&(e.searchText=E(t)),e.itemChange&&t!==n&&e.itemChange(d(t))})}function l(t,n){if(M.index=0,(t||t!==n)&&t!==E(e.selectedItem)){if(e.selectedItem=null,!t||t.length<Math.max(parseInt(e.minLength,10),1))return M.loading=!1,M.matches=[],M.hidden=g(),m(),void 0;var r=t.toLowerCase();k&&k.cancel&&(k.cancel(),k=null),!e.noCache&&y[r]?(M.matches=y[r],m()):s(t),M.hidden=g(),e.textChange&&t!==n&&e.textChange(d(e.selectedItem))}}function s(t){function n(n){y[o]=n,t===e.searchText&&(k=null,M.loading=!1,M.matches=n,M.hidden=g(),m())}var r=e.$parent.$eval(T),o=t.toLowerCase();angular.isArray(r)?n(r):(M.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){M.loading=!1}))}function m(){if(!M.hidden)switch(M.matches.length){case 0:return M.messages.splice(0);case 1:return M.messages.push({display:"There is 1 match available."});default:return M.messages.push({display:"There are "+M.matches.length+" matches available."})}}function u(){M.messages.push({display:b()})}function f(){x||(M.hidden=!0)}function p(e){switch(e.keyCode){case r.KEY_CODE.DOWN_ARROW:if(M.loading)return;e.preventDefault(),M.index=Math.min(M.index+1,M.matches.length-1),$(),u();break;case r.KEY_CODE.UP_ARROW:if(M.loading)return;e.preventDefault(),M.index=Math.max(0,M.index-1),$(),u();break;case r.KEY_CODE.ENTER:if(M.loading||M.index<0)return;e.preventDefault(),v(M.index);break;case r.KEY_CODE.ESCAPE:M.matches=[],M.hidden=!0,M.index=0;break;case r.KEY_CODE.TAB:}}function h(){e.searchText="",v(-1),w.input.focus()}function g(){return 1===M.matches.length&&e.searchText===E(M.matches[0])&&e.selectedItem===M.matches[0]}function b(){return E(M.matches[M.index])}function E(t){return t&&e.itemText?e.itemText(d(t)):t}function v(t){e.selectedItem=M.matches[t],e.searchText=E(e.selectedItem)||e.searchText,M.hidden=!0,M.index=0,M.matches=[]}function $(){var e=41*M.index,t=e+41,n=225.5;e<w.ul.scrollTop?w.ul.scrollTop=e:t>w.ul.scrollTop+n&&(w.ul.scrollTop=t-n)}var M=this,A=e.itemsExpr.split(/ in /i),T=A[1],w=null,k=null,y={},x=!1;return M.scope=e,M.parent=e.$parent,M.itemName=A[0],M.matches=[],M.loading=!1,M.hidden=!0,M.index=0,M.keydown=p,M.blur=f,M.clear=h,M.select=v,M.getCurrentDisplayValue=b,M.fetch=n.debounce(s),M.messages=[],M.id=n.nextUid(),M.listEnter=function(){x=!0},M.listLeave=function(){x=!1},M.mouseUp=function(){w.input.focus()},a()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e),e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-0e1820c
 */
function(){"use strict";function e(){return{template:'        <md-autocomplete-wrap role="listbox">          <md-input-container ng-if="floatingLabel">            <label>{{floatingLabel}}</label>            <input type="text"                id="fl-input-{{$mdAutocompleteCtrl.id}}"                name="fl-input-{{$mdAutocompleteCtrl.id}}"                autocomplete="off"                ng-disabled="isDisabled"                ng-model="$mdAutocompleteCtrl.scope.searchText"                ng-keydown="$mdAutocompleteCtrl.keydown($event)"                ng-blur="$mdAutocompleteCtrl.blur()"                aria-owns="ul-{{$mdAutocompleteCtrl.id}}"                aria-label="{{floatingLabel}}"                aria-autocomplete="list"                aria-haspopup="true"                aria-activedescendant=""                aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>                        </md-input-container>          <input type="text"              id="input-{{$mdAutocompleteCtrl.id}}"              name="input-{{$mdAutocompleteCtrl.id}}"              ng-if="!floatingLabel"              autocomplete="off"              ng-disabled="isDisabled"              ng-model="$mdAutocompleteCtrl.scope.searchText"              ng-keydown="$mdAutocompleteCtrl.keydown($event)"              ng-blur="$mdAutocompleteCtrl.blur()"              placeholder="{{placeholder}}"              aria-owns="ul-{{$mdAutocompleteCtrl.id}}"              aria-label="{{placeholder}}"              aria-autocomplete="list"              aria-haspopup="true"              aria-activedescendant=""              aria-expanded="{{!$mdAutocompleteCtrl.hidden}}"/>          <button              type="button"              ng-if="$mdAutocompleteCtrl.scope.searchText && !isDisabled"              ng-click="$mdAutocompleteCtrl.clear()">            <md-icon md-svg-icon="cancel"></md-icon>            <span class="visually-hidden">Clear</span>          </button>          <md-progress-linear              ng-if="$mdAutocompleteCtrl.loading"              md-mode="indeterminate"></md-progress-linear>          <ul role="presentation"              id="ul-{{$mdAutocompleteCtrl.id}}"              ng-mouseenter="$mdAutocompleteCtrl.listEnter()"              ng-mouseleave="$mdAutocompleteCtrl.listLeave()"              ng-mouseup="$mdAutocompleteCtrl.mouseUp()">            <li ng-repeat="(index, item) in $mdAutocompleteCtrl.matches"                ng-class="{ selected: index === $mdAutocompleteCtrl.index }"                ng-show="$mdAutocompleteCtrl.scope.searchText && !$mdAutocompleteCtrl.hidden"                ng-click="$mdAutocompleteCtrl.select(index)"                ng-transclude                md-autocomplete-list-item="$mdAutocompleteCtrl.itemName">            </li>          </ul>        </md-autocomplete-wrap>        <aria-status            class="visually-hidden"            role="status"            aria-live="assertive">          <p ng-repeat="message in $mdAutocompleteCtrl.messages">{{message.display}}</p>        </aria-status>',transclude:!0,controller:"MdAutocompleteCtrl",controllerAs:"$mdAutocompleteCtrl",scope:{searchText:"=mdSearchText",selectedItem:"=mdSelectedItem",itemsExpr:"@mdItems",itemText:"&mdItemText",placeholder:"@placeholder",noCache:"=mdNoCache",itemChange:"&mdSelectedItemChange",textChange:"&mdSearchTextChange",isDisabled:"=ngDisabled",minLength:"=mdMinLength",delay:"=mdDelay",autofocus:"=mdAutofocus",floatingLabel:"@mdFloatingLabel"}}}angular.module("material.components.autocomplete").directive("mdAutocomplete",e)}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3-master-0e1820c

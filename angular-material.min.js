 ...
 * v0.9.0-rc1-master-1e7b982
 */
function(){function e(e,t){function n(t,n,r){e(n)}function r(e,n,r){var o=this;o.isErrorGetter=r.mdIsError&&t(r.mdIsError),o.delegateClick=function(){o.input.focus()},o.element=n,o.setFocused=function(e){n.toggleClass("md-input-focused",!!e)},o.setHasValue=function(e){n.toggleClass("md-input-has-value",!!e)},o.setInvalid=function(e){n.toggleClass("md-input-invalid",!!e)},e.$watch(function(){return o.label&&o.input},function(e){e&&!o.label.attr("for")&&o.label.attr("for",o.input.attr("id"))})}return r.$inject=["$scope","$element","$attrs"],{restrict:"E",link:n,controller:r}}function t(){return{restrict:"E",require:"^?mdInputContainer",link:function(e,t,n,r){r&&!n.mdNoFloat&&(r.label=t,e.$on("$destroy",function(){r.label=null}))}}}function n(e,t){function n(n,r,o,a){function i(e){return l.setHasValue(!m.$isEmpty(e)),e}function d(){l.setHasValue(r.val().length>0||(r[0].validity||{}).badInput)}function c(){function o(e){return l(),e}function a(){c.style.height="auto",c.scrollTop=0;var e=i();e&&(c.style.height=e+"px")}function i(){var e=c.scrollHeight-c.offsetHeight;return c.offsetHeight+(e>0?e:0)}function d(e){c.scrollTop=0;var t=c.scrollHeight-c.offsetHeight,n=c.offsetHeight+t;c.style.height=n+"px"}var c=r[0],l=e.debounce(a,1);m?(m.$formatters.push(o),m.$viewChangeListeners.push(o)):l(),r.on("keydown input",l),r.on("scroll",d),angular.element(t).on("resize",l),n.$on("$destroy",function(){angular.element(t).off("resize",l)})}var l=a[0],m=a[1]||e.fakeNgModel(),s=angular.isDefined(o.readonly);if(l){if(l.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");l.input=r,r.addClass("md-input"),r.attr("id")||r.attr("id","input_"+e.nextUid()),"textarea"===r[0].tagName.toLowerCase()&&c();var u=l.isErrorGetter||function(){return m.$invalid&&m.$touched};n.$watch(u,l.setInvalid),m.$parsers.push(i),m.$formatters.push(i),r.on("input",d),s||r.on("focus",function(e){l.setFocused(!0)}).on("blur",function(e){l.setFocused(!1),d()}),n.$on("$destroy",function(){l.setFocused(!1),l.setHasValue(!1),l.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel"],link:n}}function r(e){function t(t,n,r,o){function a(e){return l.text((n.val()||e||"").length+"/"+i),e}var i,d=o[0],c=o[1],l=angular.element('<div class="md-char-counter">');r.$set("ngTrim","false"),c.element.append(l),d.$formatters.push(a),d.$viewChangeListeners.push(a),n.on("input keydown",function(){a()}),t.$watch(r.mdMaxlength,function(t){i=t,angular.isNumber(t)&&t>0?(l.parent().length||e.enter(l,c.element,angular.element(c.element[0].lastElementChild)),a()):e.leave(l)}),d.$validators["md-maxlength"]=function(e,t){return!angular.isNumber(i)||0>i?!0:(e||n.val()||t||"").length<=i}}return{restrict:"A",require:["ngModel","^mdInputContainer"],link:t}}function o(){function e(e,t,n,r){if(r&&!angular.isDefined(r.element.attr("md-no-float"))){var o=n.placeholder;t.removeAttr("placeholder");var a='<div class="md-placeholder" ng-click="delegateClick()">'+o+"</div>";r.element.append(a)}}return{restrict:"A",require:"^^?mdInputContainer",link:e}}angular.module("material.components.input",["material.core"]).directive("mdInputContainer",e).directive("label",t).directive("input",n).directive("textarea",n).directive("mdMaxlength",r).directive("placeholder",o),e.$inject=["$mdTheming","$parse"],n.$inject=["$mdUtil","$window"],r.$inject=["$animate"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e7b982
 */
function(){"use strict";function e(e){return{restrict:"E",compile:function(t){return t[0].setAttribute("role","list"),e}}}function t(e,t){var n=["md-checkbox","md-switch"];return{restrict:"E",compile:function(r,o){function a(){for(var e,t,n=["md-switch","md-checkbox"],o=0;t=n[o];++o)if((e=r.find(t)[0])&&!e.hasAttribute("aria-label")){var a=r.find("p")[0];if(!a)return;e.setAttribute("aria-label","Toggle "+a.textContent)}}function i(t){var n;if("div"==t?(n=angular.element('<div class="md-no-style md-list-item-inner">'),n.append(r.contents()),r.addClass("md-proxy-focus")):(n=angular.element('<button tabindex="0" class="md-no-style"><div class="md-list-item-inner"></div></button>'),n[0].setAttribute("ng-click",r[0].getAttribute("ng-click")),r[0].removeAttribute("ng-click"),n.children().eq(0).append(r.contents())),r[0].setAttribute("tabindex","-1"),r.append(n),s&&s.hasAttribute("ng-click")){e.expect(s,"aria-label");var a=angular.element('<md-button class="md-secondary-container">');a.attr("ng-click",s.getAttribute("ng-click")),s.removeAttribute("ng-click"),s.setAttribute("tabindex","-1"),s.classList.remove("md-secondary"),a.append(s),s=a[0]}s&&(s.hasAttribute("ng-click")||o.ngClick&&d(s))&&(r.addClass("md-with-secondary"),r.append(s))}function d(e){return-1!=n.indexOf(e.nodeName.toLowerCase())}function c(e,r,o){function a(){r.children()[0].hasAttribute("ng-click")||angular.forEach(n,function(e){angular.forEach(r[0].firstElementChild.querySelectorAll(e),function(e){d.push(e)})})}function i(){(d.length||r[0].firstElementChild.hasAttribute("ng-click"))&&r.addClass("md-clickable")}var d=[];a(),i(),r.hasClass("md-proxy-focus")&&d.length&&angular.forEach(d,function(e){e=angular.element(e),e.on("focus",function(){r.addClass("md-focused"),e.on("blur",function t(){r.removeClass("md-focused"),e.off("blur",t)})})}),r[0].firstElementChild.hasAttribute("ng-click")||d.length||r[0].firstElementChild.addEventListener("keypress",function(e){"INPUT"!=e.target.nodeName&&e.keyCode==t.KEY_CODE.SPACE&&(r[0].firstElementChild.click(),e.preventDefault(),e.stopPropagation())}),r.off("click"),r.off("keypress"),d.length&&r.children().eq(0).on("click",function(e){r[0].firstElementChild.contains(e.target)&&angular.forEach(d,function(t){e.target===t||t.contains(e.target)||(angular.element(t).triggerHandler("click"),t.focus())})})}var l,m,s=r[0].querySelector(".md-secondary");if(r[0].setAttribute("role","listitem"),o.ngClick)i("button");else{for(var u,p=0;u=n[p];++p)if(m=r[0].querySelector(u)){l=!0;break}l?i("div"):r.addClass("md-no-proxy")}return a(),c}}}angular.module("material.components.list",["material.core"]).directive("mdList",e).directive("mdListItem",t),e.$inject=["$mdTheming"],t.$inject=["$mdAria","$mdConstant"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e7b982
 ...
 * v0.9.0-rc1-master-1e7b982
 */
function(){"use strict";function e(e,o,a,i,d,c,l,m){function s(){h(),d(function(){g(),f(),p()})}function u(){function e(){var e=V.ul.getBoundingClientRect(),n={};e.right>a.right-r&&(n.left=t.right-e.width+"px"),V.$.ul.css(n)}if(!V)return d(u,0,!1);var t=V.wrap.getBoundingClientRect(),o=V.snap.getBoundingClientRect(),a=V.root.getBoundingClientRect(),i=o.bottom-a.top,c=a.bottom-o.top,l=t.left-a.left,m=t.width,s={left:l+"px",minWidth:m+"px",maxWidth:Math.max(t.right-a.left,a.right-t.left)-r+"px"};i>c&&a.height-t.bottom-r<n?(s.top="auto",s.bottom=c+"px",s.maxHeight=Math.min(n,t.top-a.top-r)+"px"):(s.top=i+"px",s.bottom="auto",s.maxHeight=Math.min(n,a.bottom-t.bottom-r)+"px"),V.$.ul.css(s),d(e,0,!1)}function p(){V.$.root.length&&(c(V.$.ul),V.$.ul.detach(),V.$.root.append(V.$.ul))}function f(){e.autofocus&&V.input.focus()}function h(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(T,t):T),$(v),e.$watch("selectedItem",M),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){!e&&t&&u()}),angular.element(l).on("resize",u)}function g(){V={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:document.body},V.snap=b(),V.$=E(V)}function b(){for(var e=o;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return V.wrap}function E(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function v(t,n){t&&(e.searchText=N(t)),e.itemChange&&t!==n&&e.itemChange(x(t))}function M(e,t){for(var n=0;n<z.length;++n)z[n](e,t)}function $(e){-1==z.indexOf(e)&&z.push(e)}function A(e){var t=z.indexOf(e);-1!=t&&z.splice(t,1)}function T(t,n){F.index=_(),(t||t!==n)&&t!==N(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(x(e.selectedItem)),I()?B():(F.loading=!1,F.matches=[],F.hidden=H(),L()))}function C(){W||(F.hidden=!0)}function w(){return angular.isString(e.searchText)?(F.hidden=H(),void(F.hidden||B())):e.searchText=""}function k(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(F.loading)return;e.preventDefault(),F.index=Math.min(F.index+1,F.matches.length-1),j(),P();break;case i.KEY_CODE.UP_ARROW:if(F.loading)return;e.preventDefault(),F.index=F.index<0?F.matches.length-1:Math.max(0,F.index-1),j(),P();break;case i.KEY_CODE.ENTER:if(F.hidden||F.loading||F.index<0)return;e.preventDefault(),D(F.index);break;case i.KEY_CODE.ESCAPE:F.matches=[],F.hidden=!0,F.index=_();break;case i.KEY_CODE.TAB:}}function y(){return angular.isNumber(e.minLength)?e.minLength:1}function N(t){return t&&e.itemText?e.itemText(x(t)):t}function x(e){if(e){var t={};return F.itemName&&(t[F.itemName]=e),t}}function _(){return e.autoselect?0:-1}function H(){return I()?1===F.matches.length&&e.searchText===N(F.matches[0])&&e.selectedItem===F.matches[0]:!0}function S(){return N(F.matches[F.index])}function I(){return e.searchText.length>=y()}function D(t){e.selectedItem=F.matches[t],e.searchText=N(e.selectedItem)||e.searchText,F.hidden=!0,F.index=0,F.matches=[]}function O(){e.searchText="",D(-1),V.input.focus()}function R(t){function n(n){Y[o]=n,t===e.searchText&&(K=null,F.loading=!1,F.matches=n,F.hidden=H(),L(),u())}var r=e.$parent.$eval(U),o=t.toLowerCase();angular.isArray(r)?n(r):(F.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){F.loading=!1}))}function L(){if(!F.hidden)switch(F.matches.length){case 0:return F.messages.splice(0);case 1:return F.messages.push({display:"There is 1 match available."});default:return F.messages.push({display:"There are "+F.matches.length+" matches available."})}}function P(){F.messages.push({display:S()})}function j(){var e=t*F.index,n=e+t,r=V.ul.clientHeight;e<V.ul.scrollTop?V.ul.scrollTop=e:n>V.ul.scrollTop+r&&(V.ul.scrollTop=n-r)}function B(){var t=e.searchText,n=t.toLowerCase();K&&K.cancel&&(K.cancel(),K=null),!e.noCache&&Y[n]?(F.matches=Y[n],L()):R(t),F.hidden=H()}var F=this,q=e.itemsExpr.split(/ in /i),U=q[1],V=null,K=null,Y={},W=!1,z=[];return F.scope=e,F.parent=e.$parent,F.itemName=q[0],F.matches=[],F.loading=!1,F.hidden=!0,F.index=null,F.messages=[],F.id=a.nextUid(),F.keydown=k,F.blur=C,F.focus=w,F.clear=O,F.select=D,F.getCurrentDisplayValue=S,F.registerSelectedItemWatcher=$,F.unregisterSelectedItemWatcher=A,F.listEnter=function(){W=!0},F.listLeave=function(){W=!1},F.mouseUp=function(){V.input.focus()},s()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=8;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window","$rootElement"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1-master-1e7b982

...
MenuDirective.$inject = ["$mdMenu", "$mdUtil", "$timeout"];
...
MenuBarCtrl.$inject = ["$scope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"];
...
MenuItemCtrl.$inject = ["$scope", "$element", "$attrs"];

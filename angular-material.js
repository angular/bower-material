...
MenuController.$inject = ["$mdMenu", "$attrs", "$element", "$scope", "$mdUtil", "$timeout", "$rootScope"];
...
})(window, window.angular);;window.ngMaterial={version:{full: "1.0.0-rc3-master-3ab6aa3"}};